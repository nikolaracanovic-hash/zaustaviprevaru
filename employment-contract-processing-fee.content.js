...
window.SCAM_CONTENT["employment-contract-processing-fee"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Šalje se PDF koji liči na ugovor i odmah sledi zahtev za naknadu za notara, pečat ili registraciju u sistemu rada." data-en="A PDF that looks like a contract is sent and a fee for notary, stamp, or registration in a work system follows immediately.">Šalje se PDF koji liči na ugovor i odmah sledi zahtev za naknadu za notara, pečat ili registraciju u sistemu rada.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se osećaj da je posao već osvojen pa je mala taksa prihvatljiva." data-en="The feeling that the job is already won makes a small fee feel acceptable.">Koristi se osećaj da je posao već osvojen pa je mala taksa prihvatljiva.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Dokument izgleda zvanično uz logotip i broj predmeta." data-en="The document looks official with a logo and reference number.">Dokument izgleda zvanično uz logotip i broj predmeta.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Pravi poslodavac objašnjava ko plaća notara i kada, obično bez hitnog privatnog naloga." data-en="A real employer explains who pays the notary and when, usually without an urgent private transfer.">Pravi poslodavac objašnjava ko plaća notara i kada, obično bez hitnog privatnog naloga.</li>
        ...
        <li data-sr="Priča o obradi ugovora se menja kada tražiš pauzu od 24 sata." data-en="The story about contract processing changes when you ask for a 24-hour pause.">Priča o obradi ugovora se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za obradi ugovora. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to contract processing. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za obradi ugovora. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Naknada mora biti instant platna ili kripto." data-en="The fee must be instant or crypto.">Naknada mora biti instant platna ili kripto.</li>
        <li data-sr="Ugovor nema potpis strane koju možeš proveriti." data-en="The contract lacks a signature you can verify.">Ugovor nema potpis strane koju možeš proveriti.</li>
        <li data-sr="Broj predmeta ne postoji u pravoj HR službi." data-en="The reference number does not exist with real HR.">Broj predmeta ne postoji u pravoj HR službi.</li>
        <li data-sr="Traže se dodatni troškovi za svaku stranicu ugovora." data-en="Extra costs are requested per contract page.">Traže se dodatni troškovi za svaku stranicu ugovora.</li>
        <li data-sr="Datum početka rada se pomera posle svake uplate." data-en="The start date shifts after each payment.">Datum početka rada se pomera posle svake uplate.</li>
        <li data-sr="Notar se ne može pozvati na javnom broju." data-en="The notary cannot be reached on a public number.">Notar se ne može pozvati na javnom broju.</li>
        <li data-sr="Uplata ide na ime fizičkog lica advokata." data-en="Payment goes to a private person named lawyer.">Uplata ide na ime fizičkog lica advokata.</li>
        <li data-sr="Zabrana deljenja ugovora sa tvojim advokatom." data-en="You are told not to share the contract with your lawyer.">Zabrana deljenja ugovora sa tvojim advokatom.</li>
        <li data-sr="PDF je skeniran i nejasne su strane." data-en="The PDF is scanned and pages are unclear.">PDF je skeniran i nejasne su strane.</li>
        <li data-sr="Nema onboarding liste sa IT i opremom." data-en="There is no onboarding list with IT and equipment.">Nema onboarding liste sa IT i opremom.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za obradi ugovora." data-en="Can I find the same offer on an official site or vacancy for contract processing.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za obradi ugovora.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Osoba misli da je korak do posla. Predložite da advokat pozove HR na broj sa sajta firme." data-en="The person thinks it is one step to the job. Suggest a lawyer call HR on the website number.">Osoba misli da je korak do posla. Predložite da advokat pozove HR na broj sa sajta firme.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za obradi ugovora." data-en="Have you ever seen a real employer ask for the same step for contract processing.">Da li si ikada video da pravi poslodavac traži isti korak za obradi ugovora.</li>
