...
window.SCAM_CONTENT["refund-capture"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: lažni povrat i preusmeravanje isplate" data-en="Introduction: fake refund and payout redirect">Uvod: lažni povrat i preusmeravanje isplate</h2>
      <p data-sr="Kontakt tvrdi da je povrat spreman i traži nove podatke za isplatu ili potvrdu linka, a podaci vode na račun napadača." data-en="Contact claims a refund is ready and asks for new payout details or link confirmation, but details route to the attacker.">Kontakt tvrdi da je povrat spreman i traži nove podatke za isplatu ili potvrdu linka, a podaci vode na račun napadača.</p>
      <p data-sr="Poruka može glumiti trgovca, državu ili banku, ali kanal ne možete potvrditi na zvaničnom portalu." data-en="The message may pose as merchant, government, or bank, but you cannot verify the channel on the official portal.">Poruka može glumiti trgovca, državu ili banku, ali kanal ne možete potvrditi na zvaničnom portalu.</p>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
            <li data-sr="Povrat koji niste tražili se pojavljuje kao hitna dobra vest." data-en="A refund you did not request appears as urgent good news.">Povrat koji niste tražili se pojavljuje kao hitna dobra vest.</li>
            <li data-sr="Formular traži zamenu IBAN-a na osnovu jednog linka bez drugog faktora." data-en="Form asks to swap IBAN based on one link without a second factor.">Formular traži zamenu IBAN-a na osnovu jednog linka bez drugog faktora.</li>
            <li data-sr="Link vodi na domen koji nije isti kao zvanični sajt brenda." data-en="Link leads to a domain not identical to the brand&#x27;s official site.">Link vodi na domen koji nije isti kao zvanični sajt brenda.</li>
            <li data-sr="SMS traži da potvrdite povrat unosom kartičnih podataka." data-en="SMS asks you to confirm a refund by entering card data.">SMS traži da potvrdite povrat unosom kartičnih podataka.</li>
            <li data-sr="Pozivalac zna tačan iznos koji očekujete, ali ne i broj vaše prijave." data-en="Caller knows the exact amount you expect but not your case number.">Pozivalac zna tačan iznos koji očekujete, ali ne i broj vaše prijave.</li>
            <li data-sr="Pritisak da završite formu pre isteka istog dana." data-en="Pressure to finish the form before the same day ends.">Pritisak da završite formu pre isteka istog dana.</li>
            <li data-sr="Traže fotografiju kartice prednje i zadnje strane." data-en="They ask for front and back photos of the card.">Traže fotografiju kartice prednje i zadnje strane.</li>
            <li data-sr="Dva različita kontakta šalju suprotne uputstva za isti povrat." data-en="Two different contacts send conflicting instructions for the same refund.">Dva različita kontakta šalju suprotne uputstva za isti povrat.</li>
            <li data-sr="U e-bankingu nema transakcije koja bi pokrenula ovaj povrat." data-en="No transaction in e-banking would trigger this refund.">U e-bankingu nema transakcije koja bi pokrenula ovaj povrat.</li>
            <li data-sr="Imejl pošiljaoca je skoro isti ali ne i identičan zvaničnom." data-en="Sender email is almost but not identical to the official one.">Imejl pošiljaoca je skoro isti ali ne i identičan zvaničnom.</li>
      </ul>
    </section>
