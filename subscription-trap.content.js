  ...
  raw_html: `
    ...
    <section class="card">
      ...
      <article class="phase warn">
        ...
        <p data-sr="Naplata počinje. Žrtva primeće na kartičnom izvodu. Pokušava otkazati — ali pronalazi komplikovane procedure. Naplate se nastavljaju tokom celog procesa otkazivanja." data-en="Billing starts. The victim notices on the card statement. Tries to cancel — but finds complicated procedures. Charges continue throughout the cancellation process.">Naplata nastavlja tokom komplikovanog otkazivanja. Svaka odgoda generiše novu naplatu.</p>
        <div class="branch">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        ...
        <li data-sr="Da li se iznos mesečne naplate jasno navodi ili je sakrijen u sitnim slovima?" data-en="Is the monthly billing amount clearly stated or hidden in small print?">Da li se iznos mesečne naplate jasno navodi ili je sakriven u sitnim slovima?</li>
