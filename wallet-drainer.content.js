...
<section class="content-section">
  ...
  <article class="phase">
    ...
    <div class="callout"><strong data-sr="Prag faze:" data-en="Phase threshold:">Prag faze:</strong> <span data-sr="Korisnik klikće na link i posećuje lažni sajt." data-en="The user clicks the link and visits the fake site.">Korisnik klikće na link i posećuje lažni sajt.</span></div>
  </article>
  ...
  <article class="phase">
    ...
    <div class="callout"><strong data-sr="Prag faze:" data-en="Phase threshold:">Prag faze:</strong> <span data-sr="Svi tokeni su premešeni i napadačev bot je zatvorio poziciju — povratak nije moguć." data-en="All tokens are moved and the attacker's bot has closed the position — reversal is not possible.">Svi tokeni su premešeni i napadačev bot je zatvorio poziciju — povratak nije moguć.</span></div>
  </article>
...
<section class="content-section">
  ...
  <ul class="bullets">
    <li><a href="airdrop-scam.html" data-sr="Airdrop prevara — drainer koji se distribuira kroz lažne airdrop kampanje" data-en="Airdrop scam — drainer distributed through fake airdrop campaigns">Airdrop prevara — drainer koji se distribuira kroz lažne airdrop kampanje</a></li>
    <li><a href="nft-scam.html" data-sr="NFT prevara — drainer koji ciljano praznid NFT kolekcije" data-en="NFT scam — drainer specifically targeting NFT collections">NFT prevara — drainer koji ciljano praznid NFT kolekcije</a></li>
    <li><a href="recovery-scam.html" data-sr="Recovery prevara — napadač nudi lažni povrat posle wallet drainera" data-en="Recovery scam — attacker offers fake recovery after wallet drainer">Recovery prevara — napadač nudi lažni povrat posle wallet drainera</a></li>
    <li><a href="phishing.html" data-sr="Fišing — distribucioni kanal za wallet drainer linkove" data-en="Phishing — distribution channel for wallet drainer links">Fišing — distribucioni kanal za wallet drainer linkove</a></li>
    <li><a href="fake-crypto-exchange-scam.html" data-sr="Lažna kripto menjačnica — sličan mehanizam lažnog UI-a za krađu podataka" data-en="Fake crypto exchange — similar fake UI mechanism for data theft">Lažna kripto menjačnica — sličan mehanizam lažnog UI-a za krađu podataka</a></li>
    <li><a href="pig-butchering.html" data-sr="Pig butchering — dugotrajna varijanta kripto prevare sa istim finansijskim gubitkom" data-en="Pig butchering — long-term crypto scam variant with same financial loss">Pig butchering — dugotrajna varijanta kripto prevare sa istim finansijskim gubitkom</a></li>
  </ul>
</section>
`
};
