...
window.SCAM_CONTENT["courier-fraud"] = {
  raw_html: `
    <section class="card">
      ...
      <p data-sr="Kurirska prevara je varijanta bankovnog lažnog predstavljanja u kojoj prevarant šalje fizičkog kurira na adresu žrtve da preuzme njenu bankovnu karticu, gotovinu ili nakit. Poziv priprema žrtvu — lažni bankovni ili policijski agent objašnjava „incident“ i traži predaju kartice za „analizu“ ili „zaštitu“. Kurir stiže kao potvrda institucionalne legitimnosti." data-en="Courier fraud is a variant of bank impersonation in which the fraudster sends a physical courier to the victim's address to collect their bank card, cash, or jewelry. A call prepares the victim — a fake bank or police agent explains an 'incident' and requests the card for 'analysis' or 'protection'. The courier arrives as confirmation of institutional legitimacy.">Lažni bankovni ili policijski agent poziva da pripremi žrtvu, zatim fizički kurir dolazi po karticu, gotovinu ili nakit. Prisustvo kurira gradi lažnu legitimnost.</p>
      <p data-sr="Fizičko prisustvo kurira je psihološki ubedljivo — prevaranti koriste uniformisane dostavljače ili taksi vozače koji ne znaju za šemu. Kartice se odmah koriste za podizanje gotovine ili online kupovinu pre nego žrtva shvati što se dešava." data-en="The physical presence of a courier is psychologically convincing — fraudsters use uniformed delivery people or taxi drivers who are unaware of the scheme. Cards are immediately used for cash withdrawals or online purchases before the victim realizes what is happening.">Fizičko prisustvo kurira je ubedljivo. Kartice se odmah troše pre nego žrtva reaguje.</p>
