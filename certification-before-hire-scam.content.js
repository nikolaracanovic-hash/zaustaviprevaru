...
window.SCAM_CONTENT["certification-before-hire-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Regruter kaže da moraš završiti brzi kurs kod partnera da bi bio prihvatljiv. Drugi poslodavci u industriji taj sertifikat ne traže." data-en="The recruiter says you must finish a quick course with a partner to be eligible. Other employers in the industry do not ask for that certificate.">Regruter kaže da moraš završiti brzi kurs kod partnera da bi bio prihvatljiv. Drugi poslodavci u industriji taj sertifikat ne traže.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se strah od diskvalifikacije bez kursa." data-en="Fear of disqualification without the course is exploited.">Koristi se strah od diskvalifikacije bez kursa.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Kurs je predstavljen kao jedini put do intervjua." data-en="The course is presented as the only path to interview.">Kurs je predstavljen kao jedini put do intervjua.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Poslodavac na zvaničnom sajtu ne navodi taj sertifikat kao uslov." data-en="The employer’s official site does not list that certificate as a requirement.">Poslodavac na zvaničnom sajtu ne navodi taj sertifikat kao uslov.</li>
        ...
        <li data-sr="Priča o sertifikatu se menja kada tražiš pauzu od 24 sata." data-en="The story about the certificate changes when you ask for a 24-hour pause.">Priča o sertifikatu se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za sertifikatu pre zaposlenja. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to pre-hire certificate. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za sertifikatu pre zaposlenja. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Cena kursa je skoro ista kao registraciona taksa za posao." data-en="The course price is almost the same as a job registration fee.">Cena kursa je skoro ista kao registraciona taksa za posao.</li>
        <li data-sr="Sertifikat izdaje firma bez akreditacije." data-en="The certificate is issued by a firm with no accreditation.">Sertifikat izdaje firma bez akreditacije.</li>
        <li data-sr="Nema besplatnog probnog modula." data-en="There is no free trial module.">Nema besplatnog probnog modula.</li>
        <li data-sr="Ugovor o radu se šalje posle kursa." data-en="The work contract will be sent after the course.">Ugovor o radu se šalje posle kursa.</li>
        <li data-sr="Kurs je na platformi koju vlasnik regrutera pominje kao partnera." data-en="The course is on a platform the recruiter owner calls a partner.">Kurs je na platformi koju vlasnik regrutera pominje kao partnera.</li>
        <li data-sr="Pritisak da kupiš danas sa popustom." data-en="Pressure to buy today with a discount.">Pritisak da kupiš danas sa popustom.</li>
        <li data-sr="Recenzije kursa su kopirane." data-en="Course reviews are copied.">Recenzije kursa su kopirane.</li>
        <li data-sr="Traže se podaci kartice za verifikaciju identiteta." data-en="Card details are requested for identity verification.">Traže se podaci kartice za verifikaciju identiteta.</li>
        <li data-sr="Nakon kursa traže se dodatni nivoi plaćanja." data-en="After the course, more paid levels are requested.">Nakon kursa traže se dodatni nivoi plaćanja.</li>
        <li data-sr="LinkedIn profil instruktora ne postoji." data-en="The instructor LinkedIn profile does not exist.">LinkedIn profil instruktora ne postoji.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za sertifikatu pre zaposlenja." data-en="Can I find the same offer on an official site or vacancy for pre-hire certificate.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za sertifikatu pre zaposlenja.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Kandidat želi kvalifikaciju. Uporedite zahteve sa oglasom iste firme na LinkedIn ili sajtu." data-en="The candidate wants a qualification. Compare requirements with the same company’s vacancy on LinkedIn or its site.">Kandidat želi kvalifikaciju. Uporedite zahteve sa oglasom iste firme na LinkedIn ili sajtu.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za sertifikatu pre zaposlenja." data-en="Have you ever seen a real employer ask for the same step for pre-hire certificate.">Da li si ikada video da pravi poslodavac traži isti korak za sertifikatu pre zaposlenja.</li>
