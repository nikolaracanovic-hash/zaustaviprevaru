      ...
      <div class="grid-2">
        ...
        <div class="phase">
          ...
          <ul class="bullets">
            ...
            <li data-sr="lažna stranica traži bankovne podatke prodavca pod okriljem 'registracije za primanje uplate'." data-en="the fake page requests the sellers banking data under the guise of 'registering to receive payment'.">lažna stranica traži bankovne podatke prodavca pod okriljem 'registracije za primanje uplate'.</li>
