...
window.SCAM_CONTENT["organ-donor-transplant-fee-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Prevarant tvrdi da se lista čeka može ubrzati uz naknadu ili donaciju u zdravstveni fond, što nije kako zvanični transplantacioni sistemi funkcionišu." data-en="A fraudster claims a waitlist can be sped up with a fee or a donation to a health fund, which is not how legitimate transplant systems work.">Prevarant tvrdi da se lista čeka može ubrzati uz naknadu ili donaciju u zdravstveni fond, što nije kako zvanični transplantacioni sistemi funkcionišu.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Poziv → obećanje prioriteta → uplata → prevara." data-en="<strong>Model:</strong> Contact → priority promise → payment → fraud."><strong>Model:</strong> Poziv → obećanje prioriteta → uplata → prevara.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnom naknadom za transplantaciju organa." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: fake organ transplant fee scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnom naknadom za transplantaciju organa.</p>
        <ul class="bullets">
