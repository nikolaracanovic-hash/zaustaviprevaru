...
window.SCAM_CONTENT["cruise-ship-job-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Regruter traži brzu uplatu za medicinski pregled, STCW ili uniformu. Prave brodarice imaju jasne kanale i često ne naplaćuju preko ličnog naloga." data-en="A recruiter asks quick payment for medical, STCW, or uniform. Real cruise lines have clear channels and rarely charge via personal accounts.">Regruter traži brzu uplatu za medicinski pregled, STCW ili uniformu. Prave brodarice imaju jasne kanale i često ne naplaćuju preko ličnog naloga.</p>
      <p data-sr="Prava brodarica retko naplaćuje STCW, medicinu ili uniformu na lični račun agenta pre ugovora koji možeš proveriti na zvaničnom crewing ili karijernom portalu kompanije." data-en="A real cruise line rarely bills STCW, medical, or uniform fees to an agent’s personal account before a contract you can verify on the official crewing or careers portal.">Prava brodarica retko naplaćuje STCW, medicinu ili uniformu na lični račun agenta pre ugovora koji možeš proveriti na zvaničnom crewing ili karijernom portalu kompanije.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se privlačnost putovanja i rada na moru." data-en="The appeal of travel and work at sea is exploited.">Koristi se privlačnost putovanja i rada na moru.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Obećanje obilaska više luka i besplatnog smeštaja." data-en="Visiting multiple ports and free cabin housing are promised.">Obećanje obilaska više luka i besplatnog smeštaja.</li>
        <li data-sr="Komunikacija ide preko privatnog četa ili lažnog crewing agenta, ne kroz zvanični karijerni portal brodarice koji možeš sam da pronađeš." data-en="Communication runs on private chat or a fake crewing agent, not the cruise line careers portal you can find yourself.">Komunikacija ide preko privatnog četa ili lažnog crewing agenta, ne kroz zvanični karijerni portal brodarice koji možeš sam da pronađeš.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Ime brodarice ne odgovara zvaničnom sajtu karijera." data-en="The cruise line name does not match the official careers site.">Ime brodarice ne odgovara zvaničnom sajtu karijera.</li>
        ...
        <li data-sr="Priča o brodskom poslu se menja kada tražiš pauzu od 24 sata." data-en="The story about ship job changes when you ask for a 24-hour pause.">Priča o brodskom poslu se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za poslu na krstarenju. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to cruise ship work. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za poslu na krstarenju. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
          ...
          <li data-sr="Signal: ponuda obećava brz izlazak na brod bez broja kontrakta, imena broda ili jasnog opisa smene." data-en="Signal: the offer promises quick ship deployment without a contract number, ship name, or clear rotation details.">Signal: ponuda obećava brz izlazak na brod bez broja kontrakta, imena broda ili jasnog opisa smene.</li>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Uplata ide na ime maritime agenta." data-en="Payment goes to a maritime agent’s personal name.">Uplata ide na ime maritime agenta.</li>
        <li data-sr="Nema broja rezervacije ukrcaja koji proveravaš." data-en="There is no embarkation reference you can verify.">Nema broja rezervacije ukrcaja koji proveravaš.</li>
        <li data-sr="Medicinski zahtevi se plaćaju pre zakazivanja kod akreditovane klinike." data-en="Medical fees are paid before booking at an accredited clinic.">Medicinski zahtevi se plaćaju pre zakazivanja kod akreditovane klinike.</li>
        <li data-sr="Ugovor nosi logo koji ne odgovara zvaničnom." data-en="The contract logo does not match the official one.">Ugovor nosi logo koji ne odgovara zvaničnom.</li>
        <li data-sr="Intervju je samo poruke." data-en="The interview is messages only.">Intervju je samo poruke.</li>
        <li data-sr="Traže se podaci pasoša i uplata u istom koraku." data-en="Passport data and payment are requested in one step.">Traže se podaci pasoša i uplata u istom koraku.</li>
        <li data-sr="Zabrana kontakta sa posadom na brodu." data-en="Contact with crew on the ship is discouraged.">Zabrana kontakta sa posadom na brodu.</li>
        <li data-sr="Isti regruter nudi poslove na različitim brodovima bez adrese." data-en="The same recruiter offers jobs on different ships with no address.">Isti regruter nudi poslove na različitim brodovima bez adrese.</li>
        <li data-sr="Hitnost jer kabinа se puni." data-en="Urgency because cabins are filling.">Hitnost jer kabinа se puni.</li>
        <li data-sr="Zahtev za kripto plaćanje." data-en="Crypto payment is requested.">Zahtev za kripto plaćanje.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za poslu na brodu." data-en="Can I find the same offer on an official site or vacancy for ship job.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za poslu na brodu.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Kandidat sanja o putovanju. Proverite oglas na zvaničnom careers sajtu brodarice." data-en="The candidate dreams of travel. Check the vacancy on the cruise line’s official careers site.">Kandidat sanja o putovanju. Proverite oglas na zvaničnom careers sajtu brodarice.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za poslu na krstarenju." data-en="Have you ever seen a real employer ask for the same step for cruise ship work.">Da li si ikada video da pravi poslodavac traži isti korak za poslu na krstarenju.</li>
