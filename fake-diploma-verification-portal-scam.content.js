...
window.SCAM_CONTENT["fake-diploma-verification-portal-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Pojavljuje se sajt ili link koji tvrdi da možeš za nekoliko minuta proveriti istinitost diplome uz malu naknadu ili prijavu." data-en="A site or link appears claiming you can verify a diploma in minutes for a small fee or registration.">Pojavljuje se sajt ili link koji tvrdi da možeš za nekoliko minuta proveriti istinitost diplome uz malu naknadu ili prijavu.</p>
      <p data-sr="Pravi postupak ide preko ustanove koja je diplomu izdala ili preko propisanih državnih servisa, uz objavljene tarife i račun primaoca." data-en="The real process runs through the issuing institution or prescribed state services, with published fees and payee accounts.">Pravi postupak ide preko ustanove koja je diplomu izdala ili preko propisanih državnih servisa, uz objavljene tarife i račun primaoca.</p>
      <div class="callout" data-sr="<strong>Model:</strong> lažni portal → prikupljanje podataka → prag (uplata) → eskalacija → nestanak." data-en="<strong>Model:</strong> fake portal → data collection → threshold (payment) → escalation → disappearance."><strong>Model:</strong> lažni portal → prikupljanje podataka → prag (uplata) → eskalacija → nestanak.</div>
    </section>
    <section class="card">
      <h2 data-sr="Kako generalno radi" data-en="How it generally works">Kako generalno radi</h2>
      <p data-sr="Koristi se žurba oko zaposlenja, nostrifikacije ili stranog puta." data-en="Urgency around employment, recognition, or travel is exploited.">Koristi se žurba oko zaposlenja, nostrifikacije ili stranog puta.</p>
      <div class="grid-2">
        <div class="phase">
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže link ka nacionalnom ili međunarodnom registru diplome. Traži se broj diplome, JMBG i mejl da bi se prikazao rezultat provere." data-en="A link arrives to a national or international diploma register. Diploma number, national ID, and email are requested to show a check result.">Stiže link ka nacionalnom ili međunarodnom registru diplome. Traži se broj diplome, JMBG i mejl da bi se prikazao rezultat provere.</p>
        <ul class="bullets">
      ...
      <article class="phase">
        ...
        <p data-sr="Pre rezultata forma traži potvrdu identiteta karticom ili naknadu za otključavanje izveštaja." data-en="Before any result, the form asks for card confirmation or a fee to unlock the report.">Pre rezultata forma traži potvrdu identiteta karticom ili naknadu za otključavanje izveštaja.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Portal traži uplatu pre nego što zvanična ustanova potvrdi isti postupak." data-en="The portal asks for payment before the official body confirms the same process.">Portal traži uplatu pre nego što zvanična ustanova potvrdi isti postupak.</li>
        <li data-sr="Domen sadrži reč verify, diploma ili global umesto zvaničnog državnog domena." data-en="The domain uses words like verify, diploma, or global instead of the official state domain.">Domen sadrži reč verify, diploma ili global umesto zvaničnog državnog domena.</li>
        <li data-sr="Rezultat provere stiže samo kao slika ili PDF bez pečata koji možeš uporediti." data-en="The check result is only an image or PDF without a stamp you can match.">Rezultat provere stiže samo kao slika ili PDF bez pečata koji možeš uporediti.</li>
        <li data-sr="Traže se lozinka studentskog ili poslovnog mejla." data-en="They ask for your student or work email password.">Traže se lozinka studentskog ili poslovnog mejla.</li>
        <li data-sr="Naknada ide na fizičko lice ili inostrani račun." data-en="The fee goes to a private person or foreign account.">Naknada ide na fizičko lice ili inostrani račun.</li>
        <li data-sr="Pritisak da završiš plaćanje u roku od jednog sata." data-en="Pressure to finish payment within one hour.">Pritisak da završiš plaćanje u roku od jednog sata.</li>
        <li data-sr="Lažni chat podrške traži kod sa kartice." data-en="Fake support chat asks for a card code.">Lažni chat podrške traži kod sa kartice.</li>
        <li data-sr="Ne postoji kontakt ustanove koji potvrđuje ovaj portal." data-en="No contact at the institution confirms this portal.">Ne postoji kontakt ustanove koji potvrđuje ovaj portal.</li>
        <li data-sr="Isti sajt nudi i brzu legalizaciju za dodatnu cenu." data-en="The same site also offers fast legalization for an extra price.">Isti sajt nudi i brzu legalizaciju za dodatnu cenu.</li>
        <li data-sr="Pretraga slike loga na mreži pokazuje drugačiju adresu pravog organa." data-en="A reverse image search of the logo shows a different address for the real body.">Pretraga slike loga na mreži pokazuje drugačiju adresu pravog organa.</li>
      </ul>
    </section>
    <section class="card">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li sam platio proveru diplome pre nego što sam zvao ustanovu koja ju je izdala." data-en="Did I pay for diploma verification before calling the issuing institution.">Da li sam platio proveru diplome pre nego što sam zvao ustanovu koja ju je izdala.</li>
        <li data-sr="Da li domen portala odgovara domenu na zvaničnom sajtu ministarstva ili univerziteta." data-en="Does the portal domain match the ministry or university official site.">Da li domen portala odgovara domenu na zvaničnom sajtu ministarstva ili univerziteta.</li>
        ...
        <li data-sr="Da li bih prijavio ovaj link IT službi ustanove." data-en="Would I report this link to the institution IT service.">Da li bih prijavio ovaj link IT službi ustanove.</li>
      </ul>
    </section>
    <section class="card">
    ...
    <section class="card">
      ...
      <p data-sr="Osoba traži brzu potvrdu diplome za posao. Predložite poziv na javni broj ustanove koja je diplomu izdala i zabranu slanja lozinki." data-en="Someone needs fast diploma proof for a job. Suggest calling the issuing institution’s public number and refusing to send passwords.">Osoba traži brzu potvrdu diplome za posao. Predložite poziv na javni broj ustanove koja je diplomu izdala i zabranu slanja lozinki.</p>
      <div class="grid-2">
        <div class="phase">
