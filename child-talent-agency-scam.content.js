...
window.SCAM_CONTENT["child-talent-agency-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Kontakt hvali dete i traži hitan depozit za casting ili portfolio. Prave agencije retko traže velike iznose pre ugovora i provere." data-en="The contact praises the child and asks an urgent deposit for casting or portfolio. Real agencies rarely ask large sums before contract and checks.">Kontakt hvali dete i traži hitan depozit za casting ili portfolio. Prave agencije retko traže velike iznose pre ugovora i provere.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se ponos roditelja i želja za uspehom deteta." data-en="Parental pride and wish for the child’s success are exploited.">Koristi se ponos roditelja i želja za uspehom deteta.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Poruka kaže da je dete izabrano bez audicije uživo." data-en="The message says the child was selected without a live audition.">Poruka kaže da je dete izabrano bez audicije uživo.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Produkcija na zvaničnom sajtu nema isti casting ni kontakt." data-en="The production on the official site has no matching casting or contact.">Produkcija na zvaničnom sajtu nema isti casting ni kontakt.</li>
        ...
        <li data-sr="Priča o agenciji se menja kada tražiš pauzu od 24 sata." data-en="The story about the agency changes when you ask for a 24-hour pause.">Priča o agenciji se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za dečjoj agenciji za talente. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to child talent agency. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za dečjoj agenciji za talente. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Cena foto seta je neobično visoka." data-en="The photo package price is unusually high.">Cena foto seta je neobično visoka.</li>
        <li data-sr="Traže se novac i snimci deteta u istom danu." data-en="Money and child photos are requested the same day.">Traže se novac i snimci deteta u istom danu.</li>
        <li data-sr="Zabrana prisustva roditelja na snimanju." data-en="Parents are banned from attending the shoot.">Zabrana prisustva roditelja na snimanju.</li>
        <li data-sr="Ugovor je prazan oko prava na slike deteta." data-en="The contract is vague on rights to the child’s images.">Ugovor je prazan oko prava na slike deteta.</li>
        <li data-sr="Casting je u privatnom stanu bez identifikacije." data-en="Casting is in a private flat without ID checks.">Casting je u privatnom stanu bez identifikacije.</li>
        <li data-sr="Tvrdi se da će dete dobiti ulogu ako platiš viši paket." data-en="You are told the child gets a role if you pay a higher package.">Tvrdi se da će dete dobiti ulogu ako platiš viši paket.</li>
        <li data-sr="Agencija nema reference koje možeš pozvati." data-en="The agency has no references you can call.">Agencija nema reference koje možeš pozvati.</li>
        <li data-sr="Pritisak da ne uništiš šansu detetu." data-en="Pressure that you will ruin the child’s chance.">Pritisak da ne uništiš šansu detetu.</li>
        <li data-sr="Isti agent šalje istu poruku desetinama roditelja." data-en="The same agent sends the same message to dozens of parents.">Isti agent šalje istu poruku desetinama roditelja.</li>
        <li data-sr="Traže se lični podaci deteta i roditelja u istoj formi." data-en="Child and parent personal data are requested in one form.">Traže se lični podaci deteta i roditelja u istoj formi.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za dečjoj agenciji." data-en="Can I find the same offer on an official site or vacancy for child talent agency.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za dečjoj agenciji.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Roditelj je emotivan. Predložite pauzu i proveru imena produkcije kod sindikata glumaca ili lokalnog pozorišta." data-en="The parent is emotional. Suggest a pause and verify the production name with an actors union or local theatre.">Roditelj je emotivan. Predložite pauzu i proveru imena produkcije kod sindikata glumaca ili lokalnog pozorišta.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za dečjoj agenciji za talente." data-en="Have you ever seen a real employer ask for the same step for child talent agency.">Da li si ikada video da pravi poslodavac traži isti korak za dečjoj agenciji za talente.</li>
