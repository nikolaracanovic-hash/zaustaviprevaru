...
window.SCAM_CONTENT["medical-device-doorstep-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Posetilac nudi besplatnu proveru ili zdravstveni aparat uz potpis ugovora o ratama koji vezuje na skupe obaveze." data-en="A visitor offers a free check or a medical device with a contract that locks in expensive installment obligations.">Posetilac nudi besplatnu proveru ili zdravstveni aparat uz potpis ugovora o ratama koji vezuje na skupe obaveze.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Poseta → potpis → rata → visok dug." data-en="<strong>Model:</strong> Visit → signature → installments → heavy debt."><strong>Model:</strong> Poseta → potpis → rata → visok dug.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara medicinskim aparatom na vratima." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: medical device doorstep scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara medicinskim aparatom na vratima.</p>
        <ul class="bullets">
