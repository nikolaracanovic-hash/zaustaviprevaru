...
window.SCAM_CONTENT["publisher-literary-agent-fee"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Izdavač ili agent hvali rukopis i traži naknadu za čitanje, brzu štampu ili promociju. Prava i distribucija ostaju mutni." data-en="A publisher or agent praises the manuscript and asks a fee for reading, fast printing, or promotion. Rights and distribution stay vague.">Izdavač ili agent hvali rukopis i traži naknadu za čitanje, brzu štampu ili promociju. Prava i distribucija ostaju mutni.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se želja autora da vidi knjigu na pijaci." data-en="The author’s desire to see the book on the market is exploited.">Koristi se želja autora da vidi knjigu na pijaci.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Brza pohvala rukopisa bez konkretne kritike odlomaka." data-en="Fast praise of the manuscript without concrete critique of excerpts.">Brza pohvala rukopisa bez konkretne kritike odlomaka.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Ugovor ne navodi jasno tiraž, teritoriju i rok isporuke knjige u prodaju." data-en="The contract does not clearly state print run, territory, and time to market.">Ugovor ne navodi jasno tiraž, teritoriju i rok isporuke knjige u prodaju.</li>
        ...
        <li data-sr="Priča o izdavanju se menja kada tražiš pauzu od 24 sata." data-en="The story about publishing changes when you ask for a 24-hour pause.">Priča o izdavanju se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za naknadi izdavača ili agenta. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to publisher or agent fees. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za naknadi izdavača ili agenta. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Naknada za čitanje je uslov pre bilo kakvog ugovora." data-en="A reading fee is required before any contract.">Naknada za čitanje je uslov pre bilo kakvog ugovora.</li>
        <li data-sr="Traže se sva prava uz jednokratnu malu uplatu." data-en="All rights are requested for a small one-time payment.">Traže se sva prava uz jednokratnu malu uplatu.</li>
        <li data-sr="Izdavač nema katalog koji možeš kupiti u knjižari." data-en="The publisher has no catalogue you can find in bookshops.">Izdavač nema katalog koji možeš kupiti u knjižari.</li>
        <li data-sr="ISBN ili distribucija nisu objašnjeni." data-en="ISBN or distribution is not explained.">ISBN ili distribucija nisu objašnjeni.</li>
        <li data-sr="Pritisak da platiš danas da zadržiš mesto." data-en="Pressure to pay today to keep a slot.">Pritisak da platiš danas da zadržiš mesto.</li>
        <li data-sr="Recenzije izdavača su kopirane ili generičke." data-en="Publisher reviews are copied or generic.">Recenzije izdavača su kopirane ili generičke.</li>
        <li data-sr="Adresa je virtuelna kancelarija bez tima." data-en="The address is a virtual office with no team.">Adresa je virtuelna kancelarija bez tima.</li>
        <li data-sr="Traže se dodatni troškovi za svaku rundu korekture." data-en="Extra costs are requested for each proof round.">Traže se dodatni troškovi za svaku rundu korekture.</li>
        <li data-sr="Agent traži novac pre nego što pokaže listu prodaja drugim autorima." data-en="The agent asks for money before showing sales records for other authors.">Agent traži novac pre nego što pokaže listu prodaja drugim autorima.</li>
        <li data-sr="Kontakt odbija video poziv." data-en="The contact refuses a video call.">Kontakt odbija video poziv.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za naknadi izdavača." data-en="Can I find the same offer on an official site or vacancy for publisher fees.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za naknadi izdavača.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Autor je emotivno vezan za tekst. Predložite proveru imena izdavača kod udruženja izdavača ili bibliotekara." data-en="The author is emotionally tied to the text. Suggest checking the publisher name with a publishers association or librarian.">Autor je emotivno vezan za tekst. Predložite proveru imena izdavača kod udruženja izdavača ili bibliotekara.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za naknadi izdavača ili agenta." data-en="Have you ever seen a real employer ask for the same step for publisher or agent fees.">Da li si ikada video da pravi poslodavac traži isti korak za naknadi izdavača ili agenta.</li>
