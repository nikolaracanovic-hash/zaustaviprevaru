...
window.SCAM_CONTENT["payroll-card"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: lažna payroll ili prepaid kartica" data-en="Introduction: fake payroll or prepaid card">Uvod: lažna payroll ili prepaid kartica</h2>
      <p data-sr="Imejl glumi HR ili platu i traži aktivaciju kartice na tuđem sajtu, naknadu ili broj kartice telefonom." data-en="Email pretends to be HR or payroll and asks for card activation on third-party site, fee, or card number by phone.">Imejl glumi HR ili platu i traži aktivaciju kartice na tuđem sajtu, naknadu ili broj kartice telefonom.</p>
      <p data-sr="URL i ton se ne poklapaju sa internim HR portalom." data-en="URL and tone do not match internal HR portal.">URL i ton se ne poklapaju sa internim HR portalom.</p>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
            <li data-sr="Aktivacija traži pun PAN i CVC na veb formi." data-en="Activation asks full PAN and CVC on web form.">Aktivacija traži pun PAN i CVC na veb formi.</li>
            <li data-sr="Naknada za izdavanje kartice traži se pre prvog učitavanja plate." data-en="Issuance fee is requested before first salary load.">Naknada za izdavanje kartice traži se pre prvog učitavanja plate.</li>
            <li data-sr="Imejl Reply-To pokazuje na spoljni domen." data-en="Reply-To points to external domain.">Imejl Reply-To pokazuje na spoljni domen.</li>
            <li data-sr="HR osoba čije ime koriste kaže da nije slala poruku." data-en="HR person whose name is used says they did not send message.">HR osoba čije ime koriste kaže da nije slala poruku.</li>
            <li data-sr="Traže da ne diskutujete sa kolegama o novoj kartici." data-en="They ask you not to discuss the new card with colleagues.">Traže da ne diskutujete sa kolegama o novoj kartici.</li>
            <li data-sr="Datum isplate u poruci ne odgovara kalendaru firme." data-en="Pay date in message does not match company calendar.">Datum isplate u poruci ne odgovara kalendaru firme.</li>
            <li data-sr="PDF u prilogu nema isti brendiranje kao raniji HR dokumenti." data-en="Attached PDF branding differs from earlier HR documents.">PDF u prilogu nema isti brendiranje kao raniji HR dokumenti.</li>
            <li data-sr="Link vodi na sajt koji traži pristup kontaktima telefona." data-en="Link leads to site requesting phone contacts access.">Link vodi na sajt koji traži pristup kontaktima telefona.</li>
            <li data-sr="Zaposleni bez pristupa platnom spisku dobiju istu poruku." data-en="Employees without payroll access receive the same message.">Zaposleni bez pristupa platnom spisku dobiju istu poruku.</li>
            <li data-sr="IT ne vidi zapis o službenom šalju kartica u tiket sistemu." data-en="IT sees no ticket for official card rollout.">IT ne vidi zapis o službenom šalju kartica u tiket sistemu.</li>
      </ul>
    </section>
