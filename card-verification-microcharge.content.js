...
window.SCAM_CONTENT["card-verification-microcharge"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: lažna verifikacija kartice mikroiznosom" data-en="Introduction: fake card verification micro-charge">Uvod: lažna verifikacija kartice mikroiznosom</h2>
      <p data-sr="Traže da prijavite mali iznos sa izvoda na tuđem sajtu ili da potvrdite plaćanje kod trgovca koga kontroliše napadač." data-en="You must report a small statement amount on a third-party site or confirm payment at a merchant the attacker controls.">Traže da prijavite mali iznos sa izvoda na tuđem sajtu ili da potvrdite plaćanje kod trgovca koga kontroliše napadač.</p>
      <p data-sr="Cilj je prikupiti pun broj kartice, datum isteka i CVC." data-en="Goal is to collect full PAN, expiry, and CVC.">Cilj je prikupiti pun broj kartice, datum isteka i CVC.</p>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
            <li data-sr="Sajt traži CVC za navodnu verifikaciju mikroiznosa." data-en="Site asks for CVC for alleged micro-amount verification.">Sajt traži CVC za navodnu verifikaciju mikroiznosa.</li>
            <li data-sr="Iznos na izvodu ne odgovara tipičnom 1 jedinici valute testu." data-en="Statement amount does not match typical 1-unit test.">Iznos na izvodu ne odgovara tipičnom 1 jedinici valute testu.</li>
            <li data-sr="Naziv trgovca na izvodu je generička fraza bez brenda." data-en="Merchant name on statement is generic text without brand.">Naziv trgovca na izvodu je generička fraza bez brenda.</li>
            <li data-sr="Traže fotografiju kartice umesto unosa u 3DS prozor." data-en="Card photo requested instead of entering data in 3DS window.">Traže fotografiju kartice umesto unosa u 3DS prozor.</li>
            <li data-sr="Link stiže sa ličnog broja na WhatsApp-u." data-en="Link arrives from personal number on WhatsApp.">Link stiže sa ličnog broja na WhatsApp-u.</li>
            <li data-sr="Pritisak da završite verifikaciju pre isteka sesije od pet minuta." data-en="Pressure to finish verification before five-minute session expiry.">Pritisak da završite verifikaciju pre isteka sesije od pet minuta.</li>
            <li data-sr="Nakon unosa, stiže drugi zahtev za dodatnu uplatu." data-en="After entry, a second payment request arrives.">Nakon unosa, stiže drugi zahtev za dodatnu uplatu.</li>
            <li data-sr="Banka nema evidenciju o istom mikrotestu kada pitate podršku." data-en="Bank support has no record of same micro-test when asked.">Banka nema evidenciju o istom mikrotestu kada pitate podršku.</li>
            <li data-sr="Forma nema PCI oznaku ili poznat procesor u footeru." data-en="Form lacks PCI badge or known processor in footer.">Forma nema PCI oznaku ili poznat procesor u footeru.</li>
            <li data-sr="Browser pokazuje upozorenje o nesačuvanom sertifikatu." data-en="Browser shows warning about untrusted certificate.">Browser pokazuje upozorenje o nesačuvanom sertifikatu.</li>
      </ul>
    </section>
