...
window.SCAM_CONTENT["ai-deepfake"] = {
  raw_html: `
    <!-- 1) UVOD -->
    <section class="card">
      <h2 data-sr="Šta je AI deepfake prevara i zašto je opasna" data-en="What is AI deepfake scam and why is it dangerous">
        Šta je AI deepfake prevara i zašto je opasna
      </h2>
      ...
      <p
        ...
        data-en="Deepfake scams work because people trust their eyes. We've been taught our whole lives that video is proof. If I see someone say something, it's true. Scammers exploit this. They create fake videos of famous people offering investments, asking for money, or sharing false information.">
      Deepfake prevara funkcioniše zato što ljudi veruju svojim očima. Ceo život smo učeni da je video dokaz. Ako vidim kako neko nešto kaže, to je istina. Prevaranti to koriste. Prave lažne video zapise poznatih ljudi koji nude ulaganja, traže novac ili dele lažne informacije.</p>

      <p
        data-sr="Problem je masovan. Svaki dan se pojavi na stotine novih lažnih videa. YouTube, Facebook, Instagram — pune su deepfake prevara. Većina ljudi ne može da prepozna razliku. Milioni dolara se gube svake nedelje."
        data-en="The problem is massive. Hundreds of new fake videos appear every day. YouTube, Facebook, Instagram — they're full of deepfake scams. Most people can't tell the difference. Millions of dollars are lost every week.">
      Problem je masovan. Svaki dan se pojavi na stotine novih lažnih videa. YouTube, Facebook, Instagram — pune su deepfake prevara. Većina ljudi ne može da prepozna razliku. Milioni dolara se gube svake nedelje.</p>

      <div class="callout"
        data-sr="<strong>Ključna činjenica:</strong> Računar može napraviti lažni video bilo koje osobe za koju ima nekoliko minuta pravog snimka. Političari, zvezde, poslovni lideri — svi su meta."
        data-en="<strong>Key fact:</strong> A computer can create a fake video of anyone it has a few minutes of real footage of. Politicians, celebrities, business leaders — all are targets.">
      <strong>Ključna činjenica:</strong> Računar može napraviti lažni video bilo koje osobe za koju ima nekoliko minuta pravog snimka. Političari, zvezde, poslovni lideri — svi su meta.</div>
    </section>
    ...
    <!-- 4) CRVENE ZASTAVICE -->
    <section class="card">
      <h2 data-sr="Kako prepoznati deepfake prevaru" data-en="How to recognize deepfake scam">
        Kako prepoznati deepfake prevaru
      </h2>
      ...
      <div class="callout"
        data-sr="<strong>Pravilo br. 1:</strong> Ako ti video kaže da brzo postupiš, da pošalješ novac ili podatke — ZASTANI. To je prevara dok se ne dokaže suprotno."
        data-en="<strong>Rule #1:</strong> If video tells you to act fast, send money or data — STOP. It's a scam until proven otherwise.">
      <strong>Pravilo br. 1:</strong> Ako ti video kaže da brzo postupiš, da pošalješ novac ili podatke — ZASTANI. To je prevara dok se ne dokaže suprotno.</div>
    </section>
    ...
    <section class="card">
      ...
      <div class="callout"
        data-sr="<strong>Najvažnije:</strong> Proveri UVEK preko više izvora pre nego što pošalješ novac ili podatke. Poznate osobe ne nude brze zarade."
        data-en="<strong>Most important:</strong> ALWAYS verify via multiple sources before sending money or data. Famous people don't offer quick profits.">
      <strong>Najvažnije:</strong> Proveri UVEK preko više izvora pre nego što pošalješ novac ili podatke. Poznate osobe ne nude brze zarade.</div>
    </section>

    <!-- 6) DODATNE INFORMACIJE -->
    <section class="card">
      <h2 data-sr="Zašto je problem sve gori" data-en="Why problem is getting worse">
        Zašto je problem sve gori
      </h2>

      <p
        data-sr="Pre pet godina, pravljenje lažnog videa zahtevalo je profesionalnu ekipu i nedelje rada. Sad može svako sa računarom da napravi uverljiv deepfake za nekoliko sati. Alati su besplatni i dostupni svima. Razlika između pravog i lažnog postaje nevidljiva."
        data-en="Five years ago, creating fake video required professional team and weeks of work. Now anyone with computer can make convincing deepfake in few hours. Tools are free and available to everyone. Difference between real and fake becomes invisible.">
      Pre pet godina, pravljenje lažnog videa zahtevalo je profesionalnu ekipu i nedelje rada. Sad može svako sa računarom da napravi uverljiv deepfake za nekoliko sati. Alati su besplatni i dostupni svima. Razlika između pravog i lažnog postaje nevidljiva.</p>
      ...
      <div class="callout"
        data-sr="<strong>Upozorenje:</strong> Tehnologija se razvija brže nego što ljudi mogu da je prepoznaju. Budućnost nije „veruj svojim očima” — budućnost je „proveri više puta pre nego što veruješ”."
        data-en="<strong>Warning:</strong> Technology develops faster than people can recognize it. Future isn't 'trust your eyes' — future is 'verify multiple times before trusting'.">
      <strong>Upozorenje:</strong> Tehnologija se razvija brže nego što ljudi mogu da je prepoznaju. Budućnost nije „veruj svojim očima” — budućnost je „proveri više puta pre nego što veruješ”.</div>
    </section>
    ...
    <section class="card sources" id="sources">
      ...
      <ul>
        ...
        <li><a href="https://www.europol.europa.eu/publications-events/publications/facing-reality-law-enforcement-and-challenge-of-deepfakes" target="_blank" rel="noopener noreferrer">Europol — Deepfakes Threat Assessment</a></li>
        <li><a href="https://www.intel.com/content/www/us/en/newsroom/news/intel-introduces-real-time-deepfake-detector.html" target="_blank" rel="noopener noreferrer">Intel — FakeCatcher Technology</a></li>
