...
window.SCAM_CONTENT["telecom-contract-scam"] = {
  raw_html: `
    ...
    <section class="card">
      <h2 data-sr="Kako generalno radi: mehanika lažnog ugovora" data-en="How it works: fake contract mechanics">Kako generalno radi: mehanika lažnog ugovora</h2>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta gradi poverenje" data-en="What builds trust">Šta gradi poverenje</div>
          <ul class="bullets">
            <li data-sr="profesionalan izgled agenta, uniforma ili vizit karta s logotipom operatera." data-en="professional appearance, uniform, or business card with operator logo.">profesionalan izgled agenta, uniforma ili vizit karta s logotipom operatera.</li>
            <li data-sr="poznavanje detalja tekućeg ugovora žrtve koji se mogu naći u bazi podataka ili curenja." data-en="knowledge of the victim's current contract details findable in databases or leaks.">poznavanje detalja tekućeg ugovora žrtve koji se mogu naći u bazi podataka ili curenja.</li>
            <li data-sr="dokument koji vizualno liči na standardni ugovor operatera." data-en="document that visually resembles a standard operator contract.">dokument koji vizualno liči na standardni ugovor operatera.</li>
            <li data-sr="prezentovanje ušteđevine — mesečna cena koja je niža od trenutne." data-en="presenting savings — a monthly price lower than the current one.">prezentovanje ušteđevine — mesečna cena koja je niža od trenutne.</li>
          </ul>
        </div>
        <div class="phase">
          ...
          <ul class="bullets">
            <li data-sr="promena operatera bez jasnog navođenja u naslovu dokumenta." data-en="operator change without clear statement in the document title.">promena operatera bez jasnog navođenja u naslovu dokumenta.</li>
            <li data-sr="dvogodišnji ili trogodišnji ugovor s penalom za raskid." data-en="two or three year contract with cancellation penalty.">dvogodišnji ili trogodišnji ugovor s penalom za raskid.</li>
            <li data-sr="inicijalna niža cena koja raste posle prvog kvartala prema sitnom pismu." data-en="initially lower price that increases after the first quarter as per small print.">inicijalna niža cena koja raste posle prvog kvartala prema sitnom pismu.</li>
            <li data-sr="aktivacija skupih opcija koje nisu jasno objašnjene tokom prezentacije." data-en="activation of expensive options not clearly explained during presentation.">aktivacija skupih opcija koje nisu jasno objašnjene tokom prezentacije.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <div class="callout" data-sr="<strong>Prag faze:</strong> meta pristane da čuje ponudu i počne razgovarati o uslovima." data-en="<strong>Threshold:</strong> the target agrees to hear the offer and starts discussing terms."><strong>Prag faze:</strong> meta pristane da čuje ponudu i počne razgovarati o uslovima.</div>
      </article>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="agent dolazi na vrata za obnovu telekomunikacionog ugovora bez prethodne najave." data-en="agent comes to the door for telecom contract renewal without prior notice.">agent dolazi na vrata za obnovu telekomunikacionog ugovora bez prethodne najave.</li>
        ...
        <li data-sr="dokument ima sitan font i agent skreće pažnju samo na mesečni iznos." data-en="document has small print and agent only draws attention to the monthly amount.">dokument ima sitan font i agent skreće pažnju samo na mesečni iznos.</li>
        <li data-sr="agent obeshrabruje čitanje čitavog dokumenta ili tvrdi da je to standardni formular." data-en="agent discourages reading the full document or claims it is just a standard form.">agent obeshrabruje čitanje čitavog dokumenta ili tvrdi da je to standardni formular.</li>
        <li data-sr="posle potpisivanja stižu računi od operatera kojeg meta nije birala." data-en="after signing, bills arrive from an operator the target did not choose.">posle potpisivanja stižu računi od operatera kojeg meta nije birala.</li>
      </ul>
    </section>

    <section class="card">
      <h2 data-sr="Checklista: 10 pitanja pre potpisivanja telekomunikacionog dokumenta" data-en="Checklist: 10 questions before signing a telecom document">Checklista: 10 pitanja pre potpisivanja telekomunikacionog dokumenta</h2>
      <ul class="bullets">
        <li data-sr="Da li je agent ovlašćen zastupnik tog operatera prema zvaničnoj listi zastupnika?" data-en="Is the agent an authorized representative of that operator according to the official representative list?">Da li je agent ovlašćen zastupnik tog operatera prema zvaničnoj listi zastupnika?</li>
        <li data-sr="Da li je u dokumentu jasno navedeno da je to produžetak tekućeg ugovora — a ne novi ugovor?" data-en="Is it clearly stated in the document that it is an extension of the current contract — not a new contract?">Da li je u dokumentu jasno navedeno da je to produžetak tekućeg ugovora — a ne novi ugovor?</li>
        <li data-sr="Da li je operater u dokumentu isti kao tekući operater?" data-en="Is the operator in the document the same as the current operator?">Da li je operater u dokumentu isti kao tekući operater?</li>
        <li data-sr="Da li su uslovi raskida i penali jasno navedeni na prvoj strani dokumenta?" data-en="Are cancellation terms and penalties clearly stated on the first page of the document?">Da li su uslovi raskida i penali jasno navedeni na prvoj strani dokumenta?</li>
        <li data-sr="Da li je mesečni iznos garanovan tokom čitavog trajanja ugovora ili raste posle perioda X?" data-en="Is the monthly amount guaranteed for the full contract duration or does it increase after period X?">Da li je mesečni iznos garanovan tokom čitavog trajanja ugovora ili raste posle perioda X?</li>
    ...
    <section class="card">
      ...
      <div class="grid-2">
        <div class="phase">
          ...
          <ul class="bullets">
            <li data-sr="Da li je dokument pažljivo pročitan pre potpisivanja?" data-en="Was the document carefully read before signing?">Da li je dokument pažljivo pročitan pre potpisivanja?</li>
            <li data-sr="Da li je u dokumentu navedeno ime tekućeg operatera?" data-en="Was the current operator's name stated in the document?">Da li je u dokumentu navedeno ime tekućeg operatera?</li>
            <li data-sr="Da li sada stižu računi od drugog operatera?" data-en="Are bills now arriving from a different operator?">Da li sada stižu računi od drugog operatera?</li>
          </ul>
        </div>
        <div class="phase">
          <div class="label" data-sr="Rečenice koje rade" data-en="Phrases that work">Rečenice koje rade</div>
          <ul class="bullets">
            <li data-sr="Ako su dostavljeni novi računi od drugog operatera, postoji pravo na prigovor i raskid." data-en="If new bills from a different operator arrived, there is a right to complaint and cancellation.">Ako su dostavljeni novi računi od drugog operatera, postoji pravo na prigovor i raskid.</li>
            <li data-sr="Legitimni agent operatera uvek daje vreme za čitanje i proveravanje." data-en="A legitimate operator agent always gives time for reading and verification.">Legitimni agent operatera uvek daje vreme za čitanje i proveravanje.</li>
            <li data-sr="Pravo na raskid od 14 dana postoji za ugovore zaključene na vrata ili telefonom." data-en="The right to cancel within 14 days exists for contracts concluded at the door or by phone.">Pravo na raskid od 14 dana postoji za ugovore zaključene na vrata ili telefonom.</li>
          </ul>
        </div>
      </div>
    </section>
