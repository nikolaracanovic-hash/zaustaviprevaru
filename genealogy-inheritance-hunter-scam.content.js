...
window.SCAM_CONTENT["genealogy-inheritance-hunter-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Kontakt tvrdi da postoji nepoznato nasledstvo i traži naknadu za istraživanje, takse ili oslobađanje sredstava pre nego što se pokaže zvaničan dokument." data-en="Contact claims unknown inheritance exists and asks for research fees, taxes, or release payments before any genuine document appears.">Kontakt tvrdi da postoji nepoznato nasledstvo i traži naknadu za istraživanje, takse ili oslobađanje sredstava pre nego što se pokaže zvaničan dokument.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Priča → taksa → dokumenti koji ne stižu → ponavljanje." data-en="<strong>Model:</strong> Story → fee → documents never arrive → repeat."><strong>Model:</strong> Priča → taksa → dokumenti koji ne stižu → ponavljanje.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lovca na nasledstvo preko genealogije." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: genealogy inheritance hunter scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lovca na nasledstvo preko genealogije.</p>
        <ul class="bullets">
