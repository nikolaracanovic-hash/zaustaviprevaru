...
window.SCAM_CONTENT["fake-recruiter-relocation-housing-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Lažni regruter nudi posao u drugom gradu ili državi i traži depozit za korporativni stan ili rezervaciju smeštaja pre potpisanog ugovora o radu." data-en="A fake recruiter offers a job in another city or country and asks a deposit for a corporate flat or housing reservation before a signed employment contract.">Lažni regruter nudi posao u drugom gradu ili državi i traži depozit za korporativni stan ili rezervaciju smeštaja pre potpisanog ugovora o radu.</p>
      <p data-sr="Pravi poslodavac retko naplaćuje smeštaj pre zvaničnog angažmana; dogovor ide kroz HR na javnom kontaktu firme i pisani dokument, ne preko ličnog računa regrutera." data-en="A real employer rarely charges for housing before official engagement; arrangements go through HR on the company’s public contact and written documents, not the recruiter’s personal account.">Pravi poslodavac retko naplaćuje smeštaj pre zvaničnog angažmana; dogovor ide kroz HR na javnom kontaktu firme i pisani dokument, ne preko ličnog računa regrutera.</p>
      <div class="callout" data-sr="<strong>Model:</strong> ponuda posla → prag (depozit za smeštaj) → lažni ugovor ili ključ → eskalacija → nestanak." data-en="<strong>Model:</strong> job offer → threshold (housing deposit) → fake contract or keys → escalation → disappearance."><strong>Model:</strong> ponuda posla → prag (depozit za smeštaj) → lažni ugovor ili ključ → eskalacija → nestanak.</div>
    </section>
    <section class="card">
      <h2 data-sr="Kako generalno radi" data-en="How it generally works">Kako generalno radi</h2>
      <p data-sr="Koristi se želja za relokacijom, boljom platom i brzim početkom rada." data-en="The wish to relocate, earn more, and start work quickly is exploited.">Koristi se želja za relokacijom, boljom platom i brzim početkom rada.</p>
      <div class="grid-2">
        <div class="phase">
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Posle usmenog prijema stiže link ka stanodavcu ili agenciji koja traži depozit da zadrži apartman za zaposlenog." data-en="After a verbal hire comes a link to a landlord or agency asking a deposit to hold the flat for the new hire.">Posle usmenog prijema stiže link ka stanodavcu ili agenciji koja traži depozit da zadrži apartman za zaposlenog.</p>
        <ul class="bullets">
      ...
      <article class="phase">
        ...
        <p data-sr="Traže se kopija pasoša, potvrda o radu koja još nije overena i uplata na račun koji nije račun poslodavca sa javnog sajta." data-en="Passport copy, an employment letter not yet verified, and payment to an account that is not the employer’s from the public site are requested.">Traže se kopija pasoša, potvrda o radu koja još nije overena i uplata na račun koji nije račun poslodavca sa javnog sajta.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Depozit za stan traži se pre potpisanog ugovora o radu koji HR potvrđuje na javnom broju." data-en="Flat deposit is asked before an employment contract HR confirms on the public number.">Depozit za stan traži se pre potpisanog ugovora o radu koji HR potvrđuje na javnom broju.</li>
        <li data-sr="Ime firme na ponudi se ne poklapa sa imenom na zvaničnom sajtu ili registru." data-en="The company name on the offer does not match the official site or registry.">Ime firme na ponudi se ne poklapa sa imenom na zvaničnom sajtu ili registru.</li>
        <li data-sr="Regruter koristi lični mejl umesto domena poslodavca." data-en="The recruiter uses personal email instead of the employer domain.">Regruter koristi lični mejl umesto domena poslodavca.</li>
        <li data-sr="Uplata ide na stanodavca ili agenciju koju ne možeš proveriti kroz poslodavca." data-en="Payment goes to a landlord or agency you cannot verify through the employer.">Uplata ide na stanodavca ili agenciju koju ne možeš proveriti kroz poslodavca.</li>
        <li data-sr="Odbijaju video razgovor sa HR-om sa poznatog broja firme." data-en="They refuse a video call with HR from a known company number.">Odbijaju video razgovor sa HR-om sa poznatog broja firme.</li>
        <li data-sr="Nema adrese stana koju možeš proveriti na mapi uživo." data-en="There is no address you can verify on a map in real time.">Nema adrese stana koju možeš proveriti na mapi uživo.</li>
        <li data-sr="Pritisak da platiš isti dan jer drugi kandidat čeka smeštaj." data-en="Pressure to pay the same day because another candidate is waiting for housing.">Pritisak da platiš isti dan jer drugi kandidat čeka smeštaj.</li>
        <li data-sr="Traže se darovne kartice ili kripto za brzu rezervaciju." data-en="Gift cards or crypto are requested for a fast reservation.">Traže se darovne kartice ili kripto za brzu rezervaciju.</li>
        <li data-sr="Isti scenario se ponavlja sa različitim imenima agencija za nekretnine." data-en="The same scenario repeats under different estate agency names.">Isti scenario se ponavlja sa različitim imenima agencija za nekretnine.</li>
        <li data-sr="Posle uplate traže dodatnu proviziju agencije." data-en="After payment they ask for another agency commission.">Posle uplate traže dodatnu proviziju agencije.</li>
      </ul>
    </section>
    <section class="card">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li HR na javnom broju firme potvrđuje smeštaj i depozit." data-en="Does HR on the company public number confirm housing and the deposit.">Da li HR na javnom broju firme potvrđuje smeštaj i depozit.</li>
        <li data-sr="Da li sam platio stan pre pisanog ugovora o radu." data-en="Did I pay for housing before a written employment contract.">Da li sam platio stan pre pisanog ugovora o radu.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Kandidat veruje u posao u inostranstvu. Predložite poziv HR-u na broju sa sajta poslodavca i zabranu depozita pre overenog ugovora." data-en="A candidate believes in a foreign job. Suggest calling HR on the number from the employer site and refusing deposits before a verified contract.">Kandidat veruje u posao u inostranstvu. Predložite poziv HR-u na broju sa sajta poslodavca i zabranu depozita pre overenog ugovora.</p>
      <div class="grid-2">
        <div class="phase">
