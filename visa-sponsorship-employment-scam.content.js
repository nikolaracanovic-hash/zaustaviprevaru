...
window.SCAM_CONTENT["visa-sponsorship-employment-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Nudi se posao sa sponzorstvom uz hitne troškove za dokumentaciju, prioritet ili kvotu. Pravi poslodavac koristi zvanične kanale i jasne rokove." data-en="A job with sponsorship is offered alongside urgent documentation, priority, or quota fees. A real employer uses official channels and clear timelines.">Nudi se posao sa sponzorstvom uz hitne troškove za dokumentaciju, prioritet ili kvotu. Pravi poslodavac koristi zvanične kanale i jasne rokove.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se složenost imigracionih procedura." data-en="Immigration complexity is exploited.">Koristi se složenost imigracionih procedura.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Obećanje legalnog boravka i stabilnog posla u jednom paketu." data-en="Legal stay and stable work are promised in one package.">Obećanje legalnog boravka i stabilnog posla u jednom paketu.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Ne možeš potvrditi sponzora kroz zvanični registar poslodavaca ili imigracioni portal zemlje." data-en="You cannot verify the sponsor through an official employer registry or the country immigration portal.">Ne možeš potvrditi sponzora kroz zvanični registar poslodavaca ili imigracioni portal zemlje.</li>
        ...
        <li data-sr="Priča o sponzorstvu se menja kada tražiš pauzu od 24 sata." data-en="The story about sponsorship changes when you ask for a 24-hour pause.">Priča o sponzorstvu se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za sponzorstvu vize. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to visa sponsorship. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za sponzorstvu vize. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Traže se novac za rezervaciju kvote vize." data-en="Money is requested to reserve a visa quota.">Traže se novac za rezervaciju kvote vize.</li>
        <li data-sr="Tvrdi se da advokat firme traži uplatu na lični račun." data-en="You are told the company lawyer requires payment to a personal account.">Tvrdi se da advokat firme traži uplatu na lični račun.</li>
        <li data-sr="Nema COS, LMIA ili drugog broja koji proveravaš kod zvaničnika." data-en="There is no COS, LMIA, or other number you can check with authorities.">Nema COS, LMIA ili drugog broja koji proveravaš kod zvaničnika.</li>
        <li data-sr="Datum početka je pre nego što je viza uopšte podneta." data-en="The start date is before a visa is even filed.">Datum početka je pre nego što je viza uopšte podneta.</li>
        <li data-sr="Zabrana angažovanja sopstvenog advokata." data-en="You are discouraged from hiring your own lawyer.">Zabrana angažovanja sopstvenog advokata.</li>
        <li data-sr="Jezik ugovora ne odgovara zemlji rada." data-en="Contract language does not match the work country.">Jezik ugovora ne odgovara zemlji rada.</li>
        <li data-sr="Plata je daleko iznad tržišta za istu ulogu." data-en="Pay is far above market for the role.">Plata je daleko iznad tržišta za istu ulogu.</li>
        <li data-sr="Intervju je isključivo čet." data-en="The interview is chat-only.">Intervju je isključivo čet.</li>
        <li data-sr="Traže se svi lični dokumenti uz depozit." data-en="All personal documents are requested with a deposit.">Traže se svi lični dokumenti uz depozit.</li>
        <li data-sr="Isti sponzor nudi poslove u više zemalja istovremeno." data-en="The same sponsor offers jobs in many countries at once.">Isti sponzor nudi poslove u više zemalja istovremeno.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za sponzorstvu vize." data-en="Can I find the same offer on an official site or vacancy for visa sponsorship.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za sponzorstvu vize.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Kandidat želi legalan boravak. Zajedno pozovite imigracionog advokata koji nije iz poruke." data-en="The candidate wants legal stay. Together call an immigration lawyer not from the message.">Kandidat želi legalan boravak. Zajedno pozovite imigracionog advokata koji nije iz poruke.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za sponzorstvu vize." data-en="Have you ever seen a real employer ask for the same step for visa sponsorship.">Da li si ikada video da pravi poslodavac traži isti korak za sponzorstvu vize.</li>
