...
window.SCAM_CONTENT["package-redelivery-scam"] = {
  raw_html: `
...
<section class="content-section">
  ...
  <div class="phase">
    ...
    <p data-sr="Obaveštenje o propuštenoj isporuci → link ili poziv za zakazivanje → uplata naknade → prikupljanje podataka → gubitak" data-en="Missed delivery notification → link or call to schedule → fee payment → data collection → loss">Obaveštenje o propuštenoj isporuci → link ili poziv za zakazivanje → uplata naknade → prikupljanje podataka → gubitak</p>
  </div>
  <div class="callout">
    <strong data-sr="Prag:" data-en="Threshold:">Prag:</strong>
    <span data-sr="Zakazivanje ponovne isporuke nikad ne zahteva plaćanje unapred — idite direktno na sajt kurira, ne putem linka." data-en="Scheduling a redelivery never requires upfront payment — go directly to the courier's site, not via a link.">Zakazivanje ponovne isporuke nikad ne zahteva plaćanje unapred — idite direktno na sajt kurira, ne putem linka.</span>
  </div>
</section>
...
<section class="content-section">
  ...
  <div class="grid-2">
    ...
    <article>
      <h3 data-sr="Šta prevarant prikuplja" data-en="What the fraudster collects">Šta prevarant prikuplja</h3>
      <ul class="bullets">
        <li data-sr="Podaci kartice — broj, istek, CVV — za dalje neautorizovane transakcije." data-en="Card data — number, expiry, CVV — for further unauthorized transactions.">Podaci kartice — broj, istek, CVV — za dalje neautorizovane transakcije.</li>
        <li data-sr="Lična adresa, e-mail i telefon koji se koriste za prodaju ili dalji targeting phishingom." data-en="Personal address, email, and phone used for sales or further phishing targeting.">Lična adresa, e-mail i telefon koji se koriste za prodaju ili dalji targeting phishingom.</li>
        <li data-sr="Potvrda da je broj aktivan — aktivni brojevi su vredni jer znači da žrtva prima i reaguje na poruke." data-en="Confirmation that the number is active — active numbers are valuable as it means the victim receives and responds to messages.">Potvrda da je broj aktivan — aktivni brojevi su vredni jer znači da žrtva prima i reaguje na poruke.</li>
      </ul>
    </article>
  </div>
</section>
...
<section class="content-section">
  ...
  <div class="phase">
    <div class="label" data-sr="Faza 1: Prijem obaveštenja o propuštenoj isporuci" data-en="Phase 1: Receipt of missed delivery notification">Faza 1: Prijem obaveštenja o propuštenoj isporuci</div>
    <p data-sr="SMS, e-pošta ili push notifikacija sadrži poruku da je kurir pokušao isporuku i da paket čeka." data-en="SMS, email, or push notification contains a message that the courier attempted delivery and the package is waiting.">SMS, e-pošta ili push notifikacija sadrži poruku da je kurir pokušao isporuku i da paket čeka.</p>
    <ul class="bullets">
      <li data-sr="Proverite da li zaista čekate pošiljku pre bilo kakve akcije." data-en="Verify whether you are actually awaiting a shipment before any action.">Proverite da li zaista čekate pošiljku pre bilo kakve akcije.</li>
  ...
  <div class="phase">
    <div class="label" data-sr="Faza 2: Zakazivanje ponovne isporuke" data-en="Phase 2: Scheduling redelivery">Faza 2: Zakazivanje ponovne isporuke</div>
    <p data-sr="Link vodi na lažni sajt za zakazivanje koji izgleda kao pravi. Žrtva bira datum i upisuje adresu za isporuku." data-en="The link leads to a fake scheduling site that looks real. The victim selects a date and enters a delivery address.">Link vodi na lažni sajt za zakazivanje koji izgleda kao pravi. Žrtva bira datum i upisuje adresu za isporuku.</p>
    <ul class="bullets">
      <li data-sr="Unos adrese na lažnom sajtu daje prevarantu vaše lične podatke koji se mogu zloupotrebiti za identity theft." data-en="Entering an address on a fake site gives the fraudster your personal data that can be misused for identity theft.">Unos adrese na lažnom sajtu daje prevarantu vaše lične podatke koji se mogu zloupotrebiti za identity theft.</li>
  ...
  <div class="phase">
    <div class="label" data-sr="Faza 4: Telefonska varijanta — lažni kurir" data-en="Phase 4: Phone variant — fake courier">Faza 4: Telefonska varijanta — lažni kurir</div>
    <p data-sr="Umesto SMS-a, prevarant zove telefonom, predstavlja se kao kurir i traži potvrdu adrese plus plaćanje naknade za ponovnu isporuku putem bankovnog transfera ili kupovinom poklon kartica." data-en="Instead of an SMS, the fraudster calls by phone, presents themselves as a courier, and requests address confirmation plus payment of a redelivery fee via bank transfer or gift card purchase.">Umesto SMS-a, prevarant zove telefonom, predstavlja se kao kurir i traži potvrdu adrese plus plaćanje naknade za ponovnu isporuku putem bankovnog transfera ili kupovinom poklon kartica.</p>
    <ul class="bullets">
      <li data-sr="Kuriri ne naplaćuju ponovnu isporuku telefonskim pozivom — to nije legitimna praksa ni jedne kurirske službe." data-en="Couriers do not charge for redelivery by phone call — that is not legitimate practice of any courier service.">Kuriri ne naplaćuju ponovnu isporuku telefonskim pozivom — to nije legitimna praksa ni jedne kurirske službe.</li>
  ...
  <div class="phase">
    <div class="label" data-sr="Faza 5: Sekundarne transakcije i krađa identiteta" data-en="Phase 5: Secondary transactions and identity theft">Faza 5: Sekundarne transakcije i krađa identiteta</div>
    <p data-sr="Prikupljeni podaci kartice i adresa se koriste za neautorizovane kupovine i, ako su prikupljeni dovoljni podaci, za identity theft." data-en="Collected card data and address are used for unauthorized purchases and, if sufficient data is collected, for identity theft.">Prikupljeni podaci kartice i adresa se koriste za neautorizovane kupovine i, ako su prikupljeni dovoljni podaci, za identity theft.</p>
    <ul class="bullets">
      <li data-sr="Kontaktirajte banku odmah za blokiranje kartice i chargeback za sve neautorizovane transakcije." data-en="Contact the bank immediately to block the card and chargeback all unauthorized transactions.">Kontaktirajte banku odmah za blokiranje kartice i chargeback za sve neautorizovane transakcije.</li>
  ...
  <div class="phase">
    <div class="label" data-sr="Faza 6: Masovne kampanje — isti prevaranti, hiljade žrtava" data-en="Phase 6: Mass campaigns — same fraudsters, thousands of victims">Faza 6: Masovne kampanje — isti prevaranti, hiljade žrtava</div>
    <p data-sr="Lažni kuriski SMS se šalje istovremeno milionima korisnika. Mali procenat koji klikne i unese podatke donosi prevarantima značajne prihode." data-en="Fake courier SMS is sent simultaneously to millions of users. The small percentage who click and enter data brings fraudsters significant revenues.">Lažni kuriski SMS se šalje istovremeno milionima korisnika. Mali procenat koji klikne i unese podatke donosi prevarantima značajne prihode.</p>
    <ul class="bullets">
...
<section class="content-section">
  ...
  <ul class="bullets">
    <li data-sr="SMS ili e-pošta o propuštenoj isporuci sadrži link koji traži plaćanje naknade." data-en="SMS or email about a missed delivery contains a link requesting fee payment.">SMS ili e-pošta o propuštenoj isporuci sadrži link koji traži plaćanje naknade.</li>
    <li data-sr="URL linka ne odgovara tačno zvaničnom domenu kurirske službe." data-en="The link URL does not exactly match the courier service's official domain.">URL linka ne odgovara tačno zvaničnom domenu kurirske službe.</li>
    <li data-sr="Niste naručili ništa niti čekate pošiljku od navedene kurirske službe." data-en="You have not ordered anything or are awaiting a shipment from the named courier service.">Niste naručili ništa niti čekate pošiljku od navedene kurirske službe.</li>
    <li data-sr="Poruka je stigla od nepoznatog broja, a ne od zvaničnog kratkog koda kurirske službe." data-en="The message arrived from an unknown number, not from the courier service's official short code.">Poruka je stigla od nepoznatog broja, a ne od zvaničnog kratkog koda kurirske službe.</li>
    <li data-sr="Lažni kurir koji poziva telefonom zahteva plaćanje poklon karticama ili direktnim transferom." data-en="A fake courier calling by phone requests payment by gift cards or direct transfer.">Lažni kurir koji poziva telefonom zahteva plaćanje poklon karticama ili direktnim transferom.</li>
  </ul>
</section>
...
<section class="content-section">
  <h2 data-sr="Checklista pri prijemu obaveštenja o propuštenoj isporuci" data-en="Checklist upon receiving a missed delivery notification">Checklista pri prijemu obaveštenja o propuštenoj isporuci</h2>
  <ul class="bullets">
    ...
    <li data-sr="Da li sam proverio tracking broj direktno na zvaničnom sajtu kurira?" data-en="Have I checked the tracking number directly on the courier's official site?">Da li sam proverio tracking broj direktno na zvaničnom sajtu kurira?</li>
    <li data-sr="Da li sam otišao na sajt kurira direktno upisom adrese — ne klikom na link?" data-en="Have I gone to the courier's site directly by typing the address — not by clicking the link?">Da li sam otišao na sajt kurira direktno upisom adrese — ne klikom na link?</li>
    <li data-sr="Da li URL linka tačno odgovara zvaničnom domenu kurirske službe?" data-en="Does the link URL exactly match the courier service's official domain?">Da li URL linka tačno odgovara zvaničnom domenu kurirske službe?</li>
    <li data-sr="Da li zakazivanje isporuke zahteva plaćanje — ako da, to je signal prevare?" data-en="Does scheduling delivery require payment — if yes, is that a fraud signal?">Da li zakazivanje isporuke zahteva plaćanje — ako da, to je signal prevare?</li>
    <li data-sr="Da li je poruka stigla od zvaničnog kratkog koda kurirske službe?" da-en="Did the message arrive from the courier service's official short code?">Da li je poruka stigla od zvaničnog kratkog koda kurirske službe?</li>
  </ul>
</section>
...
<section class="content-section">
  ...
  <ul class="bullets">
    <li data-sr="Blokirajte karticu odmah ako ste uneli podatke na sajtu dostupnom putem SMS linka." data-en="Block the card immediately if you entered details on a site reached via SMS link.">Blokirajte karticu odmah ako ste uneli podatke na sajtu dostupnom putem SMS linka.</li>
    <li data-sr="Promenite lozinke za e-poštu i online servise ako ste uneli lične podatke." data-en="Change passwords for email and online services if you entered personal data.">Promenite lozinke za e-poštu i online servise ako ste uneli lične podatke.</li>
    <li data-sr="Skenirajte uređaj antivirusnim softverom ako ste kliknuli na link iz poruke." data-en="Scan the device with antivirus software if you clicked the link in the message.">Skenirajte uređaj antivirusnim softverom ako ste kliknuli na link iz poruke.</li>
    <li data-sr="Prijavite lažni domen CERT-u ili antivirusnim platformama za uklanjanje." data-en="Report the fake domain to CERT or antivirus platforms for removal.">Prijavite lažni domen CERT-u ili antivirusnim platformama za uklanjanje.</li>
    <li data-sr="Prijavite slučaj policiji s dokumentacijom SMS-a i transakcija ako je novac izgubljen." data-en="Report the case to the police with documentation of the SMS and transactions if money was lost.">Prijavite slučaj policiji s dokumentacijom SMS-a i transakcija ako je novac izgubljen.</li>
  </ul>
</section>
