...
window.SCAM_CONTENT["wallet-top-up"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: lažni top-up novčanika ili vaučera" data-en="Introduction: fake wallet or voucher top-up">Uvod: lažni top-up novčanika ili vaučera</h2>
      <p data-sr="Podrška ili kupac traži da učitate određeni novčanik, vaučer ili prepaid da biste dobili isplatu ili robu." data-en="Support or buyer asks you to load a specific wallet, voucher, or prepaid to receive payout or goods.">Podrška ili kupac traži da učitate određeni novčanik, vaučer ili prepaid da biste dobili isplatu ili robu.</p>
      <p data-sr="Kanal plaćanja nije onaj koji zvanična platforma navodi u pomoći." data-en="Payment rail is not the one the official platform lists in help.">Kanal plaćanja nije onaj koji zvanična platforma navodi u pomoći.</p>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
            <li data-sr="Uputstvo se razlikuje od FAQ-a na zvaničnom sajtu." data-en="Instructions differ from FAQ on official site.">Uputstvo se razlikuje od FAQ-a na zvaničnom sajtu.</li>
            <li data-sr="Traže fotografiju koda sa dara kartice ili vaučera." data-en="Photo of gift card or voucher code is requested.">Traže fotografiju koda sa dara kartice ili vaučera.</li>
            <li data-sr="Pritisak da kupite više vaučera u seriji." data-en="Pressure to buy multiple vouchers in a row.">Pritisak da kupite više vaučera u seriji.</li>
            <li data-sr="Kažu da je greška sistema i da samo top-up rešava problem." data-en="They claim a system error only top-up can fix.">Kažu da je greška sistema i da samo top-up rešava problem.</li>
            <li data-sr="Čet podrške nije u istom domenu kao prodavnica." data-en="Support chat is not on same domain as store.">Čet podrške nije u istom domenu kao prodavnica.</li>
            <li data-sr="Ne mogu da vam pošalju potvrdu naloga iz svog sistema." data-en="They cannot send order confirmation from their system.">Ne mogu da vam pošalju potvrdu naloga iz svog sistema.</li>
            <li data-sr="Zahtevaju plaćanje kripto na privatni adrese." data-en="Crypto payment to private address is demanded.">Zahtevaju plaćanje kripto na privatni adrese.</li>
            <li data-sr="Nude povrat veći od vaše uplate kao mamac." data-en="They offer refund larger than your payment as bait.">Nude povrat veći od vaše uplate kao mamac.</li>
            <li data-sr="Traže da obrišete istoriju četa nakon uplate." data-en="They ask you to delete chat history after payment.">Traže da obrišete istoriju četa nakon uplate.</li>
            <li data-sr="Zvanična podrška platforme kaže da ne koriste taj postupak." data-en="Official platform support says they do not use that procedure.">Zvanična podrška platforme kaže da ne koriste taj postupak.</li>
      </ul>
    </section>
