...
window.SCAM_CONTENT["security-clearance-job-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Tvrdi se da moraš platiti brzu proveru ili nivo pristupa da bi dobio osetljiv posao. Državne i velike firme imaju unutrašnje procedure bez instant uplate." data-en="You must pay for a fast check or access level to get a sensitive job. Government and large firms use internal procedures without instant payment.">Tvrdi se da moraš platiti brzu proveru ili nivo pristupa da bi dobio osetljiv posao. Državne i velike firme imaju unutrašnje procedure bez instant uplate.</p>
      <p data-sr="Prava firma ili državni partner retko traži instant uplatu za nivo pristupa pre zvaničnog angažmana; provera identiteta ide kroz ustanovljene kanale, ne preko ličnog naloga u četu." data-en="A real firm or government partner rarely asks for instant payment for an access level before a formal engagement; identity checks follow established channels, not a personal account in chat.">Prava firma ili državni partner retko traži instant uplatu za nivo pristupa pre zvaničnog angažmana; provera identiteta ide kroz ustanovljene kanale, ne preko ličnog naloga u četu.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se poštovanje prema institucijama odbrane ili kritičnoj infrastrukturi." data-en="Respect for defence or critical infrastructure institutions is exploited.">Koristi se poštovanje prema institucijama odbrane ili kritičnoj infrastrukturi.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Ponuda spominje tajne projekte i visoku platu." data-en="Secret projects and high pay are mentioned.">Ponuda spominje tajne projekte i visoku platu.</li>
        <li data-sr="Komunikacija ide preko privatnog četa ili lažnog bezbednosnog koordinatora, a ne kroz objavljeni kanal za osetljive pozicije na sajtu firme ili državnog partnera." data-en="Communication runs on private chat or a fake security coordinator, not the published channel for sensitive roles on the company or government partner site.">Komunikacija ide preko privatnog četa ili lažnog bezbednosnog koordinatora, a ne kroz objavljeni kanal za osetljive pozicije na sajtu firme ili državnog partnera.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Poslodavac na zvaničnom sajtu ne navodi takvu taksi kandidatu." data-en="The employer’s official site does not list such a candidate fee.">Poslodavac na zvaničnom sajtu ne navodi takvu taksi kandidatu.</li>
        ...
        <li data-sr="Priča o proveri se menja kada tražiš pauzu od 24 sata." data-en="The story about clearance changes when you ask for a 24-hour pause.">Priča o proveri se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za bezbednosnoj proveri. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to security clearance. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za bezbednosnoj proveri. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Traži se uplata u kriptu radi anonimnosti provere." data-en="Crypto payment is requested for check anonymity.">Traži se uplata u kriptu radi anonimnosti provere.</li>
        <li data-sr="Tvrdi se da je službenik koji prima novac." data-en="You are told an official receives the money.">Tvrdi se da je službenik koji prima novac.</li>
        <li data-sr="Nema broja predmeta koji proveravaš kod HR bezbednosti." data-en="There is no reference you can verify with security HR.">Nema broja predmeta koji proveravaš kod HR bezbednosti.</li>
        <li data-sr="Intervju je samo čet." data-en="The interview is chat-only.">Intervju je samo čet.</li>
        <li data-sr="Zabrana obaveštavanja trenutnog poslodavca." data-en="You are told not to inform your current employer.">Zabrana obaveštavanja trenutnog poslodavca.</li>
        <li data-sr="Traže se vojni podaci i bankovni podaci u istoj formi." data-en="Military and bank details are requested in one form.">Traže se vojni podaci i bankovni podaci u istoj formi.</li>
        <li data-sr="Sertifikat clearance je generički PDF." data-en="A generic PDF is called a clearance certificate.">Sertifikat clearance je generički PDF.</li>
        <li data-sr="Hitnost jer projekat počinje ponedeljkom." data-en="Urgency because the project starts Monday.">Hitnost jer projekat počinje ponedeljkom.</li>
        <li data-sr="Plata je neobično visoka za ulaznu ulogu." data-en="Pay is unusually high for an entry role.">Plata je neobično visoka za ulaznu ulogu.</li>
        <li data-sr="Kompanija nema javnu registraciju." data-en="The company has no public registration.">Kompanija nema javnu registraciju.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za bezbednosnoj proveri." data-en="Can I find the same offer on an official site or vacancy for security clearance.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za bezbednosnoj proveri.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Kandidat želi ozbiljan posao. Predložite direktan poziv HR-u firme na javnom broju, ne agentu iz poruke." data-en="The candidate wants a serious job. Suggest calling the company HR on a public number, not the message agent.">Kandidat želi ozbiljan posao. Predložite direktan poziv HR-u firme na javnom broju, ne agentu iz poruke.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za bezbednosnoj proveri." data-en="Have you ever seen a real employer ask for the same step for security clearance.">Da li si ikada video da pravi poslodavac traži isti korak za bezbednosnoj proveri.</li>
