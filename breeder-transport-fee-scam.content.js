...
window.SCAM_CONTENT["breeder-transport-fee-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Lažni uzgajivač traži seriju naknada za transport, karantin, osiguranje ili carinu pre nego što ljubimac navodno krene, a zatim prekine kontakt." data-en="A fake breeder requests a series of fees for shipping, quarantine, insurance, or customs before the pet supposedly ships, then cuts contact.">Lažni uzgajivač traži seriju naknada za transport, karantin, osiguranje ili carinu pre nego što ljubimac navodno krene, a zatim prekine kontakt.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Rezervacija → transport → dodatne takse → nestanak." data-en="<strong>Model:</strong> Reservation → shipping → extra fees → disappearance."><strong>Model:</strong> Rezervacija → transport → dodatne takse → nestanak.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara naknadom za transport od uzgajivača." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: breeder transport fee scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara naknadom za transport od uzgajivača.</p>
        <ul class="bullets">
