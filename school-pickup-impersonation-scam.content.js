...
window.SCAM_CONTENT["school-pickup-impersonation-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Poruka ili poziv glumi školu, dete ili treću osobu i traži hitnu promenu plana preuzimanja ili uplatu za aktivnost, što služi za planiranje otmice ili krađu podataka." data-en="A message or call impersonates the school, child, or a third party and demands an urgent pickup change or payment for an activity, enabling abduction planning or data theft.">Poruka ili poziv glumi školu, dete ili treću osobu i traži hitnu promenu plana preuzimanja ili uplatu za aktivnost, što služi za planiranje otmice ili krađu podataka.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Hitnost → promena plana → rizik po dete i porodicu." data-en="<strong>Model:</strong> Urgency → plan change → risk to child and family."><strong>Model:</strong> Hitnost → promena plana → rizik po dete i porodicu.</div>
