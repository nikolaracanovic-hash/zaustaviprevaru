...
window.SCAM_CONTENT["parking-qr-scam"] = {
  raw_html: `
    <section class="card">
      ...
      <p data-sr="Lažni QR kodovi na parkiralištima su fizički napad: prevarant lepi nalepnicu s lažnim QR kodom direktno na parkomat ili na znakove uz parkiralište. Kada vozač skenira kod, biva preusmeren na portal koji imitira zvaničnu parking aplikaciju. Portal traži karticne podatke za plaćanje parkinga koji nikad ne bude registrovan u sistemu." data-en="Fake QR codes on parking meters are a physical attack: the fraudster sticks a sticker with a fake QR code directly onto the parking meter or signs near the parking area. When a driver scans the code, they are redirected to a portal that imitates the official parking app. The portal requests card data for parking payment that is never registered in the system.">Prevarant lepi nalepnicu s lažnim QR kodom na parkomat. Skeniranje preusmerava na lažni parking portal koji krade karticne podatke.</p>
      <p data-sr="Napad je efikasan jer vozači su navikli na QR kodove za plaćanje parkinga i ne proveravaju URL portala koji se otvara. Vremenski pritisak parkiranja — treba se parkirati brzo — doprinosi žurbi i smanjuje pažnju pri unosu podataka." data-en="The attack is effective because drivers are accustomed to QR codes for parking payment and do not check the URL of the portal that opens. The time pressure of parking — needing to park quickly — contributes to hurrying and reduces attention when entering data.">Vozači su navikli na QR plaćanje i ne proveravaju URL. Vremenski pritisak parkiranja smanjuje pažnju.</p>
      ...
      <div class="grid-2">
        ...
        <div class="phase">
          ...
          <ul class="bullets">
            ...
            <li data-sr="Uvek provjeri URL adresu portala pre unosa karticnih podataka na bilo kom mestu." data-en="Always verify the portal URL before entering card details anywhere.">Uvek provjeri URL adresu portala pre unosa karticnih podataka na bilo kom mestu.</li>
          </ul>
        </div>
      </div>
    </section>
