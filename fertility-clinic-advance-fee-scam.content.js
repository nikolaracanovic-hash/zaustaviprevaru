...
window.SCAM_CONTENT["fertility-clinic-advance-fee-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Lažna klinika traži veliki depozit za IVF ili tretman, šalje generičke uputstva i izbegava licencu i adresu koja se proverava u registru." data-en="A fake clinic demands a large deposit for IVF or treatment, sends generic instructions, and avoids a license and address you can verify in a registry.">Lažna klinika traži veliki depozit za IVF ili tretman, šalje generičke uputstva i izbegava licencu i adresu koja se proverava u registru.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Konsultacija → depozit → odlaganje → nestanak." data-en="<strong>Model:</strong> Consultation → deposit → delays → disappearance."><strong>Model:</strong> Konsultacija → depozit → odlaganje → nestanak.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara avansom lažne klinike za plodnost." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: fertility clinic advance fee scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara avansom lažne klinike za plodnost.</p>
        <ul class="bullets">
