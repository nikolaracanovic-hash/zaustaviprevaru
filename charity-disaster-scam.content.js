...
window.SCAM_CONTENT["charity-disaster-scam"] = {
  raw_html: `
<section class="content-section">
  <h2 data-sr="Uvod: kako radi lažna humanitarna organizacija u katastrofi" data-en="Intro: how the charity disaster scam works">Uvod: kako radi lažna humanitarna organizacija u katastrofi</h2>
  <p data-sr="Posle prirodnih katastrofa, ratnih sukoba ili zdravstvenih kriza, prevaranti brzo osnivaju lažne humanitarne organizacije ili lažno se predstavljaju kao prave. Koriste fotografije stvarnih žrtava, emotivne apele i domene koji podsećaju na poznate organizacije. Donacije odlaze direktno prevarantima, nikad žrtvama." data-en="After natural disasters, armed conflicts, or health crises, fraudsters quickly create fake charities or impersonate real ones. They use photographs of actual victims, emotional appeals, and domains resembling well-known organizations. Donations go directly to fraudsters, never to victims.">Posle prirodnih katastrofa, ratnih sukoba ili zdravstvenih kriza, prevaranti brzo osnivaju lažne humanitarne organizacije ili lažno se predstavljaju kao prave. Koriste fotografije stvarnih žrtava, emotivne apele i domene koji podsećaju na poznate organizacije. Donacije odlaze direktno prevarantima, nikad žrtvama.</p>
</section>
...
<section class="content-section">
  ...
  <div class="phase">
    ...
    <p data-sr="Katastrofa ili kriza → lažna humanitarna organizacija → urgentni apel za donacijom → donacija neproverljivim kanalom → novac odlazi prevarantu → žrtve ne dobijaju ništa → gubitak" data-en="Disaster or crisis → fake charity → urgent donation appeal → donation through unverifiable channel → money goes to fraudster → victims receive nothing → loss">Katastrofa ili kriza → lažna humanitarna organizacija → urgentni apel za donacijom → donacija neproverljivim kanalom → novac odlazi prevarantu → žrtve ne dobijaju ništa → gubitak</p>
  </div>
  <div class="callout">
    <strong data-sr="Prag:" data-en="Threshold:">Prag:</strong>
    <span data-sr="Svaka humanitarna organizacija koja nema proverljiv registarski broj i javno dostupne finansijske izveštaje nosi visok rizik." data-en="Any charitable organization without a verifiable registration number and publicly available financial reports carries high risk.">Svaka humanitarna organizacija koja nema proverljiv registarski broj i javno dostupne finansijske izveštaje nosi visok rizik.</span>
  </div>
</section>
...
<section class="content-section">
  ...
  <div class="grid-2">
    ...
    <article>
      <h3 data-sr="Kako se uvodi donacija" data-en="How donation is introduced">Kako se uvodi donacija</h3>
      <ul class="bullets">
        <li data-sr="Donacije se traže isključivo putem kriptovaluta, Western Union transfera ili prepaid kartica." data-en="Donations are requested exclusively via cryptocurrency, Western Union transfers, or prepaid cards.">Donacije se traže isključivo putem kriptovaluta, Western Union transfera ili prepaid kartica.</li>
        <li data-sr="Legitimne humanitarne organizacije prihvataju bankarske transfere na registrovane račune s potvrdom o donaciji." data-en="Legitimate charitable organizations accept bank transfers to registered accounts with a donation confirmation.">Legitimne humanitarne organizacije prihvataju bankarske transfere na registrovane račune s potvrdom o donaciji.</li>
        <li data-sr="Potraživanje potvrde o poreskom odbitku donacije otkriva da organizacija nije registrovana za poreske olakšice." data-en="Requesting confirmation of a tax deduction for the donation reveals that the organization is not registered for tax relief.">Potraživanje potvrde o poreskom odbitku donacije otkriva da organizacija nije registrovana za poreske olakšice.</li>
      </ul>
    </article>
  </div>
</section>
...
<section class="content-section">
  ...
  <div class="phase">
    <div class="label" data-sr="Faza 1: Katastrofa i hitni apeli" data-en="Phase 1: Disaster and urgent appeals">Faza 1: Katastrofa i hitni apeli</div>
  ...
  <div class="phase">
    ...
    <p data-sr="Posle dovoljno donacija, organizacija nestaje — sajt se gasi, profili na društvenim mrežama se brišu, e-pošta ne odgovara. Donatori nemaju načina za povrat." data-en="After enough donations, the organization disappears — the website goes dark, social media profiles are deleted, emails go unanswered. Donors have no way to recover funds.">Posle dovoljno donacija, organizacija nestaje — sajt se gasi, profili na društvenim mrežama se brišu, e-pošta ne odgovara. Donatori nemaju načina za povrat.</p>
    <ul class="bullets">
...
<section class="content-section">
  ...
  <ul class="bullets">
    <li data-sr="Organizacija nema proverljiv registarski broj u državnom registru nevladinih organizacija." data-en="The organization has no verifiable registration number in the state register of non-governmental organizations.">Organizacija nema proverljiv registarski broj u državnom registru nevladinih organizacija.</li>
    <li data-sr="Sajt organizacije je star manje od mesec dana ili nema javnih podataka o rukovodstvu." data-en="The organization's website is less than a month old or has no public information about leadership.">Sajt organizacije je star manje od mesec dana ili nema javnih podataka o rukovodstvu.</li>
    <li data-sr="Donacije se prihvataju isključivo kriptovalutama, Western Union transferom ili gotovinom — bez bankovnog transfera." data-en="Donations are accepted exclusively by cryptocurrency, Western Union transfer, or cash — without a bank transfer.">Donacije se prihvataju isključivo kriptovalutama, Western Union transferom ili gotovinom — bez bankovnog transfera.</li>
    <li data-sr="Organizacija ne može da pruži potvrdu o donaciji niti poresku dokumentaciju." data-en="The organization cannot provide a donation receipt or tax documentation.">Organizacija ne može da pruži potvrdu o donaciji niti poresku dokumentaciju.</li>
    <li data-sr="Apeli dolaze samo s privatnih profila na društvenim mrežama bez veze s verifikovanom organizacijom." data-en="Appeals come only from private social media profiles with no link to a verified organization.">Apeli dolaze samo s privatnih profila na društvenim mrežama bez veze s verifikovanom organizacijom.</li>
    <li data-sr="Fotografije na sajtu organizacije su reverse-image pretragom pronađene na drugom sajtu ili Stock foto servisu." data-en="Photographs on the organization's site are found by reverse image search on another site or stock photo service.">Fotografije na sajtu organizacije su reverse-image pretragom pronađene na drugom sajtu ili Stock foto servisu.</li>
  </ul>
</section>
...
<section class="content-section">
  ...
  <ul class="bullets">
    <li data-sr="Pretražite naziv organizacije u državnom registru nevladinih organizacija pre doniranja." data-en="Search the organization's name in the state register of non-governmental organizations before donating.">Pretražite naziv organizacije u državnom registru nevladinih organizacija pre doniranja.</li>
    <li data-sr="Proverite datum registracije domena organizacije putem WHOIS pretrage." data-en="Check the registration date of the organization's domain via a WHOIS search.">Proverite datum registracije domena organizacije putem WHOIS pretrage.</li>
    <li data-sr="Pretražite fotografije s apela putem reverse-image pretrage da proverite da li su originalne." data-en="Search the photographs from appeals via reverse image search to verify they are original.">Pretražite fotografije s apela putem reverse-image pretrage da proverite da li su originalne.</li>
    <li data-sr="Tražite finansijski izveštaj organizacije za prethodnu godinu i proverite da li je javno dostupan." data-en="Request the organization's financial report for the previous year and check whether it is publicly available.">Tražite finansijski izveštaj organizacije za prethodnu godinu i proverite da li je javno dostupan.</li>
    <li data-sr="Doniranje direktno poznatim i proverenim organizacijama je bezbednije od doniranja novim organizacijama po katastrofi." data-en="Donating directly to well-known and verified organizations is safer than donating to new organizations after a disaster.">Doniranje direktno poznatim i proverenim organizacijama je bezbednije od doniranja novim organizacijama po katastrofi.</li>
    <li data-sr="Proverite da li organizacija ima bankovni račun registrovan na ime kompanije — ne na ime fizičkog lica." data-en="Check whether the organization has a bank account registered in the company name — not in the name of an individual.">Proverite da li organizacija ima bankovni račun registrovan na ime kompanije — ne na ime fizičkog lica.</li>
  </ul>
</section>

<section class="content-section">
  <h2 data-sr="Checklista pre donacije humanitarnoj organizaciji" data-en="Checklist before donating to a charitable organization">Checklista pre donacije humanitarnoj organizaciji</h2>
  <ul class="bullets">
    <li data-sr="Da li organizacija ima proverljiv registarski broj u državnom registru?" data-en="Does the organization have a verifiable registration number in the state register?">Da li organizacija ima proverljiv registarski broj u državnom registru?</li>
    <li data-sr="Da li organizacija ima finansijski izveštaj za prethodnu godinu koji je javno dostupan?" data-en="Does the organization have a publicly available financial report for the previous year?">Da li organizacija ima finansijski izveštaj za prethodnu godinu koji je javno dostupan?</li>
    <li data-sr="Da li organizacija nudi bankovni transfer na registrovani poslovni račun?" data-en="Does the organization offer a bank transfer to a registered business account?">Da li organizacija nudi bankovni transfer na registrovani poslovni račun?</li>
    <li data-sr="Da li postoje javni podaci o rukovodstvu organizacije — ime, biografija, kontakt?" data-en="Is there public information about the organization's leadership — name, biography, contact?">Da li postoje javni podaci o rukovodstvu organizacije — ime, biografija, kontakt?</li>
    <li data-sr="Da li je sajt organizacije star više od godinu dana?" data-en="Is the organization's website more than a year old?">Da li je sajt organizacije star više od godinu dana?</li>
    <li data-sr="Da li su fotografije u apelu autentične i ne pojavljuju se na drugim sajtovima?" data-en="Are the photographs in the appeal authentic and do not appear on other websites?">Da li su fotografije u apelu autentične i ne pojavljuju se na drugim sajtovima?</li>
...
<section class="content-section">
  ...
  <ul class="bullets">
    <li data-sr="Proverite registarski status organizacije u državnom registru pre ikakve donacije." data-en="Check the organization's registration status in the state register before any donation.">Proverite registarski status organizacije u državnom registru pre ikakve donacije.</li>
    <li data-sr="Ako ste već donirali, kontaktirajte banku odmah — chargeback je moguć ako je uplata bila kartičnom transakcijom." data-en="If you have already donated, contact the bank immediately — a chargeback is possible if the payment was by card transaction.">Ako ste već donirali, kontaktirajte banku odmah — chargeback je moguć ako je uplata bila kartičnom transakcijom.</li>
    <li data-sr="Kripto donacije su nepovratne — prijavite adresu novčanika nadležnim organima ako raspolažete tim informacijama." data-en="Crypto donations are irreversible — report the wallet address to the relevant authorities if you have that information.">Kripto donacije su nepovratne — prijavite adresu novčanika nadležnim organima ako raspolažete tim informacijama.</li>
    <li data-sr="Prijavite lažnu organizaciju državnom registru i policiji radi zaštite budućih donatora." data-en="Report the fake organization to the state register and the police to protect future donors.">Prijavite lažnu organizaciju državnom registru i policiji radi zaštite budućih donatora.</li>
    <li data-sr="Upozorite kontakte koji su podelili ili prosledili apel — prevaranti računaju na organsko širenje." data-en="Warn contacts who shared or forwarded the appeal — fraudsters count on organic spread.">Upozorite kontakte koji su podelili ili prosledili apel — prevaranti računaju na organsko širenje.</li>
  </ul>
</section>
