...
window.SCAM_CONTENT["elder-tech-support-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Poziv ili iskačući prozor tvrdi da je računar zaražen, traži daljinski pristup ili uplatu za aktivaciju, što vodi u krađu naloga i novca." data-en="A call or pop-up claims the computer is infected, asks for remote access or a payment for activation, leading to account and money theft.">Poziv ili iskačući prozor tvrdi da je računar zaražen, traži daljinski pristup ili uplatu za aktivaciju, što vodi u krađu naloga i novca.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Upozorenje → daljinski pristup → uplata → šteta." data-en="<strong>Model:</strong> Warning → remote access → payment → harm."><strong>Model:</strong> Upozorenje → daljinski pristup → uplata → šteta.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnom tehničkom podrškom za starije osobe." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: elder tech support scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnom tehničkom podrškom za starije osobe.</p>
        <ul class="bullets">
