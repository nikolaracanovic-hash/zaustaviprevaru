...
window.SCAM_CONTENT["home-nursing-subscription-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Ponuda pretplate za neograničene posete ili telemedicinu ima teško otkazivanje, skrivene clause ili naplatu mesečno bez stvarnih usluga." data-en="A subscription for unlimited visits or telemedicine has hard cancellation, hidden clauses, or monthly charges without real services.">Ponuda pretplate za neograničene posete ili telemedicinu ima teško otkazivanje, skrivene clause ili naplatu mesečno bez stvarnih usluga.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Ugovor → pretplata → otkaz ne prolazi → dug." data-en="<strong>Model:</strong> Contract → subscription → cancel fails → debt."><strong>Model:</strong> Ugovor → pretplata → otkaz ne prolazi → dug.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara pretplatom na kućnu negu." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: home nursing subscription scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara pretplatom na kućnu negu.</p>
        <ul class="bullets">
