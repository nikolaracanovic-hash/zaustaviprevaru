...
window.SCAM_CONTENT["hospice-billing-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Poruka ili poziv traži doplatu osiguranja, aktivaciju pokrića ili plaćanje računa koji ne odgovara stvarnoj ustanovi koja brine o pacijentu." data-en="A message or call demands an insurance top-up, coverage activation, or payment for a bill that does not match the real hospice provider.">Poruka ili poziv traži doplatu osiguranja, aktivaciju pokrića ili plaćanje računa koji ne odgovara stvarnoj ustanovi koja brine o pacijentu.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Račun → žurba → link ili račun prevaranta." data-en="<strong>Model:</strong> Invoice → rush → link or fraudster account."><strong>Model:</strong> Račun → žurba → link ili račun prevaranta.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnim računom ili doplatom za hospis." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: hospice billing scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnim računom ili doplatom za hospis.</p>
        <ul class="bullets">
