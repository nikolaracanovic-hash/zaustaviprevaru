...
window.SCAM_CONTENT["seasonal-work-placement-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Oglas obećava posao na moru, skijalištu ili festivalu uz mali depozit za smeštaj ili uniformu. Po dolasku nema potpisa ni ključeva." data-en="An ad promises work at the sea, ski resort, or festival with a small deposit for housing or uniform. On arrival there is no contract or keys.">Oglas obećava posao na moru, skijalištu ili festivalu uz mali depozit za smeštaj ili uniformu. Po dolasku nema potpisa ni ključeva.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se želja za putovanjem i brzom zaradom u sezoni." data-en="The desire to travel and earn fast in season is exploited.">Koristi se želja za putovanjem i brzom zaradom u sezoni.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Oglas ima lepe fotografije lokacije bez imena firme." data-en="The ad has nice location photos without a company name.">Oglas ima lepe fotografije lokacije bez imena firme.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Hotel ili lanac na zvaničnom sajtu nema isti oglas." data-en="The hotel or chain on the official site has no matching vacancy.">Hotel ili lanac na zvaničnom sajtu nema isti oglas.</li>
        ...
        <li data-sr="Priča o sezonskom poslu se menja kada tražiš pauzu od 24 sata." data-en="The story about seasonal work changes when you ask for a 24-hour pause.">Priča o sezonskom poslu se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za sezonskom zapošljavanju. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to seasonal work. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za sezonskom zapošljavanju. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Depozit ide na privatni račun koordinatora." data-en="Deposit goes to a coordinator’s personal account.">Depozit ide na privatni račun koordinatora.</li>
        <li data-sr="Adresa smeštaja ne postoji na mapi." data-en="The housing address does not exist on the map.">Adresa smeštaja ne postoji na mapi.</li>
        <li data-sr="Ugovor o radu ne stiže pre puta." data-en="The work contract does not arrive before travel.">Ugovor o radu ne stiže pre puta.</li>
        <li data-sr="Traže se svi novčani resursi za vizu za rad bez broja predmeta." data-en="All funds are requested for a work visa with no file number.">Traže se svi novčani resursi za vizu za rad bez broja predmeta.</li>
        <li data-sr="Komunikacija je samo preko jednog broja koji se gasi." data-en="Communication is only through one number that goes dead.">Komunikacija je samo preko jednog broja koji se gasi.</li>
        <li data-sr="Isti oglas je kopiran u više gradova." data-en="The same ad is copied across cities.">Isti oglas je kopiran u više gradova.</li>
        <li data-sr="Nema JMB/poreskog broja poslodavca koji možeš proveriti." data-en="There is no employer tax ID you can verify.">Nema JMB/poreskog broja poslodavca koji možeš proveriti.</li>
        <li data-sr="Traže se dodatni troškovi na granici." data-en="Extra costs at the border are claimed.">Traže se dodatni troškovi na granici.</li>
        <li data-sr="Zabrana kontakta sa drugim zaposlenima." data-en="Contact with other workers is discouraged.">Zabrana kontakta sa drugim zaposlenima.</li>
        <li data-sr="Let ili bus se kupuje preko njihovog linka." data-en="Flight or bus must be bought through their link.">Let ili bus se kupuje preko njihovog linka.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za sezonskom poslu." data-en="Can I find the same offer on an official site or vacancy for seasonal work.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za sezonskom poslu.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Mladi žele letnji posao. Pozovite hotel direktno na broj sa zvaničnog sajta." data-en="Young people want summer work. Call the hotel directly on the official site number.">Mladi žele letnji posao. Pozovite hotel direktno na broj sa zvaničnog sajta.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za sezonskom zapošljavanju." data-en="Have you ever seen a real employer ask for the same step for seasonal work.">Da li si ikada video da pravi poslodavac traži isti korak za sezonskom zapošljavanju.</li>
