...
window.SCAM_CONTENT["pharmacy-impersonation-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Poziv ili sajt glumi apoteku, traži podatke recepta i plaćanje za lek koji ne stiže ili nije registrovan, ili preusmerava na lažnu formu." data-en="A call or site impersonates a pharmacy, asks for prescription details and payment for medicine that never arrives or is not legitimate, or redirects to a fake form.">Poziv ili sajt glumi apoteku, traži podatke recepta i plaćanje za lek koji ne stiže ili nije registrovan, ili preusmerava na lažnu formu.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Kontakt → recept → uplata → nema isporuke." data-en="<strong>Model:</strong> Contact → prescription → payment → no delivery."><strong>Model:</strong> Kontakt → recept → uplata → nema isporuke.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnom apotekom ili dostavom lekova." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: pharmacy impersonation scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnom apotekom ili dostavom lekova.</p>
        <ul class="bullets">
