...
window.SCAM_CONTENT["embassy-local-hire-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Poruka tvrdi da ambasada hitno traži lokalno osoblje i da se plaća mala naknada za proveru. Zvanični poslovi su javni i bez takvih uplata." data-en="A message claims the embassy urgently needs local staff and a small vetting fee must be paid. Real jobs are public and do not use such payments.">Poruka tvrdi da ambasada hitno traži lokalno osoblje i da se plaća mala naknada za proveru. Zvanični poslovi su javni i bez takvih uplata.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se autoritet državnog simbola." data-en="State authority symbolism is exploited.">Koristi se autoritet državnog simbola.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Ponuda zvuči zvanično i koristi grb ili zastavu." data-en="The offer sounds official and uses a coat of arms or flag.">Ponuda zvuči zvanično i koristi grb ili zastavu.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Na zvaničnom sajtu misije nema istog oglasa ni istog kontakta." data-en="The official mission site has neither the same vacancy nor the same contact.">Na zvaničnom sajtu misije nema istog oglasa ni istog kontakta.</li>
        ...
        <li data-sr="Priča o ambasadi se menja kada tražiš pauzu od 24 sata." data-en="The story about the embassy changes when you ask for a 24-hour pause.">Priča o ambasadi se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za poslu u ambasadi. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to embassy work. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za poslu u ambasadi. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Komunikacija je Gmail ili WhatsApp." data-en="Communication is Gmail or WhatsApp.">Komunikacija je Gmail ili WhatsApp.</li>
        <li data-sr="Traži se uplata za ID karticu zaposlenog ambasade." data-en="Payment for an embassy employee ID card is requested.">Traži se uplata za ID karticu zaposlenog ambasade.</li>
        <li data-sr="Tvrdi se da je konkurs zatvoren ali postoji izuzetak." data-en="You are told the competition is closed but an exception exists.">Tvrdi se da je konkurs zatvoren ali postoji izuzetak.</li>
        <li data-sr="Nema imena oficira kog možeš proveriti na sajtu." data-en="There is no officer name you can verify on the site.">Nema imena oficira kog možeš proveriti na sajtu.</li>
        <li data-sr="Adresa intervjua je kafić ili privatni stan." data-en="The interview address is a café or private flat.">Adresa intervjua je kafić ili privatni stan.</li>
        <li data-sr="Traže se svi lični dokumenti uz gotovinu." data-en="All personal documents are requested with cash.">Traže se svi lični dokumenti uz gotovinu.</li>
        <li data-sr="Zabrana obaveštavanja policije o procesu." data-en="You are told not to inform police about the process.">Zabrana obaveštavanja policije o procesu.</li>
        <li data-sr="Isti tekst kruži u više zemalja." data-en="The same text circulates in multiple countries.">Isti tekst kruži u više zemalja.</li>
        <li data-sr="Hitnost jer vizna kvota ističe." data-en="Urgency because a visa quota expires.">Hitnost jer vizna kvota ističe.</li>
        <li data-sr="Lažni pečat na PDF-u." data-en="A fake stamp appears on a PDF.">Lažni pečat na PDF-u.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za poslu u ambasadi." data-en="Can I find the same offer on an official site or vacancy for embassy work.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za poslu u ambasadi.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Kandidat poštuje instituciju. Zajedno otvorite sajt ambasade i tražite sekciju karijera ili tendera." data-en="The candidate respects the institution. Together open the embassy site and look for careers or tenders.">Kandidat poštuje instituciju. Zajedno otvorite sajt ambasade i tražite sekciju karijera ili tendera.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za poslu u ambasadi." data-en="Have you ever seen a real employer ask for the same step for embassy work.">Da li si ikada video da pravi poslodavac traži isti korak za poslu u ambasadi.</li>
