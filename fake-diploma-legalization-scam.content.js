...
window.SCAM_CONTENT["fake-diploma-legalization-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Tvrdi se da mogu ubrzati apostil ili prevod bez reda. Zvanični organi imaju jasne rokove i ne naplaćuju na lični račun posrednika." data-en="They claim they can speed apostille or translation without a queue. Official bodies have clear timelines and do not charge a broker’s personal account.">Tvrdi se da mogu ubrzati apostil ili prevod bez reda. Zvanični organi imaju jasne rokove i ne naplaćuju na lični račun posrednika.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se žurba za inostranstvo ili posao." data-en="Rush for abroad or a job is exploited.">Koristi se žurba za inostranstvo ili posao.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Obećanje završetka za nekoliko dana bez reda." data-en="Completion in days without a queue is promised.">Obećanje završetka za nekoliko dana bez reda.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Zvanična ustanova kaže da ne koristi tog posrednika." data-en="The official body says it does not use that broker.">Zvanična ustanova kaže da ne koristi tog posrednika.</li>
        ...
        <li data-sr="Priča o legalizaciji se menja kada tražiš pauzu od 24 sata." data-en="The story about legalization changes when you ask for a 24-hour pause.">Priča o legalizaciji se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za legalizaciji diplome. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to diploma legalization. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za legalizaciji diplome. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Traži se original diplome kuriru bez potpisa primaoca." data-en="The original diploma is requested by courier without recipient signature rules.">Traži se original diplome kuriru bez potpisa primaoca.</li>
        <li data-sr="Cena je mnogo viša od zvaničnog tarifa." data-en="The price is far above official tariffs.">Cena je mnogo viša od zvaničnog tarifa.</li>
        <li data-sr="Pečat na dokumentu ne odgovara uzorku sa sajta." data-en="The document stamp does not match samples on the site.">Pečat na dokumentu ne odgovara uzorku sa sajta.</li>
        <li data-sr="Uplata je samo gotovina ili kripto." data-en="Payment is cash or crypto only.">Uplata je samo gotovina ili kripto.</li>
        <li data-sr="Zabrana odlaska lično u kancleriju." data-en="You are discouraged from going to the chancellery in person.">Zabrana odlaska lično u kancleriju.</li>
        <li data-sr="Nema broja predmeta u sistemu." data-en="There is no file number in the system.">Nema broja predmeta u sistemu.</li>
        <li data-sr="Posrednik nema adresu kancelarije." data-en="The broker has no office address.">Posrednik nema adresu kancelarije.</li>
        <li data-sr="Traže se dodatni troškovi za hitnu dostavu." data-en="Extra fees for urgent delivery are requested.">Traže se dodatni troškovi za hitnu dostavu.</li>
        <li data-sr="Isti broj nudi pasoše i vize." data-en="The same number offers passports and visas.">Isti broj nudi pasoše i vize.</li>
        <li data-sr="Kopija diplome se traži pre nego što vidiš identitet posrednika." data-en="A diploma copy is requested before you see the broker’s identity.">Kopija diplome se traži pre nego što vidiš identitet posrednika.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za legalizaciji diplome." data-en="Can I find the same offer on an official site or vacancy for diploma legalization.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za legalizaciji diplome.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Kandidat žuri za inostranstvo. Zajedno pozovite kancleriju na zvanični broj iz uputstva ministarstva." data-en="The candidate rushes abroad. Together call the chancellery on the ministry guide’s official number.">Kandidat žuri za inostranstvo. Zajedno pozovite kancleriju na zvanični broj iz uputstva ministarstva.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za legalizaciji diplome." data-en="Have you ever seen a real employer ask for the same step for diploma legalization.">Da li si ikada video da pravi poslodavac traži isti korak za legalizaciji diplome.</li>
