...
window.SCAM_CONTENT["investment-seminar"] = {
  raw_html: `
    <!-- 1) UVOD -->
    <section class="card">
      <h2 data-sr="Uvod: kako rade lažni investicioni seminari" data-en="Introduction: how fake investment seminars work">
        Uvod: kako rade lažni investicioni seminari
      </h2>
    ...
    <section class="card">
      <h2 data-sr="Tipovi lažnih investicionih seminara" data-en="Types of fake investment seminars">
        Tipovi lažnih investicionih seminara
      </h2>
    ...
    <section class="card">
      ...
      <!-- FAZA 1 -->
      <article class="phase">
        <h3 class="phase-title" data-sr="Faza 1 — Mamac: besplatni vebinar ili sadržaj" data-en="Phase 1 — Bait: free webinar or content">
          Faza 1 — Mamac: besplatni vebinar ili sadržaj
        </h3>
      ...
      <!-- FAZA 2 -->
      <article class="phase">
        <h3 class="phase-title" data-sr="Faza 2 — Prodajni pritisak" data-en="Phase 2 — Sales pressure">
          Faza 2 — Prodajni pritisak
        </h3>
      ...
      <article class="phase warn">
        <h3 class="phase-title" data-sr="Faza 3 — Uplata za kurs" data-en="Phase 3 — Course payment">
          Faza 3 — Uplata za kurs
        </h3>

        <p
          data-sr="Meta plaća za pristup kursu. Sadržaj je često generički: informacije dostupne besplatno na YouTube, blogovima, ili u knjigama. Vrednost je minimalna, ali je to tek početak." data-en="The target pays for course access. Content is often generic: information freely available on YouTube, blogs, or in books. Value is minimal, but this is just the beginning."
        >Meta plaća za pristup kursu. Sadržaj je često generički: informacije dostupne besplatno na YouTube, blogovima, ili u knjigama. Vrednost je minimalna, ali je to tek početak.</p>

        <div class="callout"
          data-sr="<strong>Prag:</strong> prva uplata za kurs ili pristup." data-en="<strong>Threshold:</strong> first payment for course or access."
        ><strong>Prag:</strong> prva uplata za kurs ili pristup.</div>
      </article>

      <!-- FAZA 4 -->
      <article class="phase bad">
        <h3 class="phase-title" data-sr="Faza 4 — Prodaja skupljih nivoa" data-en="Phase 4 — Upsell to higher levels">
          Faza 4 — Prodaja skupljih nivoa
        </h3>
      ...
      <!-- FAZA 5 -->
      <article class="phase bad">
        <h3 class="phase-title" data-sr="Faza 5 — Investiciona prevara" data-en="Phase 5 — Investment scam">
          Faza 5 — Investiciona prevara
        </h3>
