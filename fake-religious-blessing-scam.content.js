...
window.SCAM_CONTENT["fake-religious-blessing-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Prevarant se predstavlja kao sveštenik ili posrednik i traži novac za blagoslov, sveću ili ritual koji se plaća unapred na sumnjiv račun." data-en="Someone poses as clergy or an intermediary and asks for money for a blessing, candle, or ritual paid upfront to a suspicious account.">Prevarant se predstavlja kao sveštenik ili posrednik i traži novac za blagoslov, sveću ili ritual koji se plaća unapred na sumnjiv račun.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Autoritet → dar → uplata → nema dokaza o ritualu." data-en="<strong>Model:</strong> Authority → offering → payment → no proof of ritual."><strong>Model:</strong> Autoritet → dar → uplata → nema dokaza o ritualu.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnim verskim blagoslovom ili darom." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: fake religious blessing scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnim verskim blagoslovom ili darom.</p>
        <ul class="bullets">
