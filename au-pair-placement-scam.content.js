...
window.SCAM_CONTENT["au-pair-placement-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Porodica ili agencija traži depozit da rezerviše mesto. Pravi programi imaju jasne korake i često besplatnu inicijalnu proveru." data-en="A family or agency asks a deposit to reserve a spot. Real programmes have clear steps and often free initial screening.">Porodica ili agencija traži depozit da rezerviše mesto. Pravi programi imaju jasne korake i često besplatnu inicijalnu proveru.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se želja za životom u inostranstvu i učenjem jezika." data-en="The desire to live abroad and learn a language is exploited.">Koristi se želja za životom u inostranstvu i učenjem jezika.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Brza potvrda da si odabran bez dubokog intervjua." data-en="Fast confirmation that you are selected without a deep interview.">Brza potvrda da si odabran bez dubokog intervjua.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Ne možeš razgovarati direktno sa porodicom pre uplate." data-en="You cannot speak directly with the family before paying.">Ne možeš razgovarati direktno sa porodicom pre uplate.</li>
        ...
        <li data-sr="Priča o au pair programu se menja kada tražiš pauzu od 24 sata." data-en="The story about au pair programme changes when you ask for a 24-hour pause.">Priča o au pair programu se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za au pair plasmanu. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to au pair placement. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za au pair plasmanu. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Agencija nema adresu koju možeš posetiti ili proveriti." data-en="The agency has no address you can visit or verify.">Agencija nema adresu koju možeš posetiti ili proveriti.</li>
        <li data-sr="Traže se svi novci za prvi mesec unapred." data-en="All money for the first month is requested upfront.">Traže se svi novci za prvi mesec unapred.</li>
        <li data-sr="Porodica šalje samo fotografije dece bez video poziva." data-en="The family sends only child photos with no video call.">Porodica šalje samo fotografije dece bez video poziva.</li>
        <li data-sr="Ugovor je na jeziku koji ne razumeš bez prevoda." data-en="The contract is in a language you do not understand without translation.">Ugovor je na jeziku koji ne razumeš bez prevoda.</li>
        <li data-sr="Viza se rešava preko njihovog partnera uz dodatnu taksu." data-en="The visa is handled through their partner for an extra fee.">Viza se rešava preko njihovog partnera uz dodatnu taksu.</li>
        <li data-sr="Zabrana kontakta sa drugim au pair kandidatima." data-en="Contact with other au pair candidates is discouraged.">Zabrana kontakta sa drugim au pair kandidatima.</li>
        <li data-sr="Isti program se reklamira pod različitim imenima." data-en="The same programme is advertised under different names.">Isti program se reklamira pod različitim imenima.</li>
        <li data-sr="Nema reference koje možeš nezavisno pozvati." data-en="There are no references you can call independently.">Nema reference koje možeš nezavisno pozvati.</li>
        <li data-sr="Traže se lični dokumenti uz uplatu u istom mejlu." data-en="Personal documents are requested with payment in the same email.">Traže se lični dokumenti uz uplatu u istom mejlu.</li>
        <li data-sr="Hitnost jer porodice nestaju." data-en="Urgency because families are disappearing.">Hitnost jer porodice nestaju.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za au pair plasmanu." data-en="Can I find the same offer on an official site or vacancy for au pair placement.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za au pair plasmanu.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Kandidat želi iskustvo u inostranstvu. Zajedno potražite zvanični au pair kanal zemlje odredišta." data-en="The candidate wants experience abroad. Together look up the official au pair channel for the destination country.">Kandidat želi iskustvo u inostranstvu. Zajedno potražite zvanični au pair kanal zemlje odredišta.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za au pair plasmanu." data-en="Have you ever seen a real employer ask for the same step for au pair placement.">Da li si ikada video da pravi poslodavac traži isti korak za au pair plasmanu.</li>
