...
window.SCAM_CONTENT["event-staffing-fee-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Regruter traži brzu uplatu da uđeš na listu osoblja za veliki događaj. Zvanični angažmani imaju jasan ugovor i isplatu, ne predplatu uniforme posredniku." data-en="A recruiter asks quick payment to get on staff for a big event. Official engagements have clear contracts and pay, not uniform prepayment to a broker.">Regruter traži brzu uplatu da uđeš na listu osoblja za veliki događaj. Zvanični angažmani imaju jasan ugovor i isplatu, ne predplatu uniforme posredniku.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se privlačnost velikih imena i gužve." data-en="Big names and crowds are exploited.">Koristi se privlačnost velikih imena i gužve.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Oglas spominje poznat izvođač ili brend bez linka ka zvaničnoj agenciji." data-en="The ad mentions a famous act or brand with no link to the official agency.">Oglas spominje poznat izvođač ili brend bez linka ka zvaničnoj agenciji.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Organizator na zvaničnom sajtu nema istu agenciju za zapošljavanje." data-en="The organizer on the official site does not list that hiring agency.">Organizator na zvaničnom sajtu nema istu agenciju za zapošljavanje.</li>
        ...
        <li data-sr="Priča o osoblju se menja kada tražiš pauzu od 24 sata." data-en="The story about staffing changes when you ask for a 24-hour pause.">Priča o osoblju se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za angažovanju na događaju. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to event staffing. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za angažovanju na događaju. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Plata se isplaćuje tek posle što platiš uniformu." data-en="Pay is sent only after you pay for uniform.">Plata se isplaćuje tek posle što platiš uniformu.</li>
        <li data-sr="Nema imena menadžmenta događaja kog možeš proveriti." data-en="There is no event management name you can verify.">Nema imena menadžmenta događaja kog možeš proveriti.</li>
        <li data-sr="Lokacija sastanka je parking ili stan." data-en="The meeting location is a parking lot or flat.">Lokacija sastanka je parking ili stan.</li>
        <li data-sr="Traže se depozit u kriptu." data-en="A crypto deposit is requested.">Traže se depozit u kriptu.</li>
        <li data-sr="Smena traje 16 sati uz minimalnu naknadu." data-en="A 16-hour shift is offered with minimal pay.">Smena traje 16 sati uz minimalnu naknadu.</li>
        <li data-sr="Isti broj regrutuje za koncert i sajam istovremeno." data-en="The same number recruits for a concert and fair at once.">Isti broj regrutuje za koncert i sajam istovremeno.</li>
        <li data-sr="Zabrana nošenja ličnog telefona." data-en="Personal phones are banned without safety reason.">Zabrana nošenja ličnog telefona.</li>
        <li data-sr="Ugovor je na engleskom za lokalni događaj bez prevoda." data-en="The contract is in English for a local event without translation.">Ugovor je na engleskom za lokalni događaj bez prevoda.</li>
        <li data-sr="Traže se podaci za poreznu registraciju pre prvog dana." data-en="Tax registration details are requested before day one.">Traže se podaci za poreznu registraciju pre prvog dana.</li>
        <li data-sr="Nema ID kartice osoblja sa fotografijom." data-en="There is no photo staff ID card.">Nema ID kartice osoblja sa fotografijom.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za angažovanju na događaju." data-en="Can I find the same offer on an official site or vacancy for event staffing.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za angažovanju na događaju.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Kandidat želi biti blizu scene. Pozovite organizatora događaja na javni kontakt sa plakata ili sajta." data-en="The candidate wants to be near the stage. Call the event organizer on a public contact from a poster or site.">Kandidat želi biti blizu scene. Pozovite organizatora događaja na javni kontakt sa plakata ili sajta.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za angažovanju na događaju." data-en="Have you ever seen a real employer ask for the same step for event staffing.">Da li si ikada video da pravi poslodavac traži isti korak za angažovanju na događaju.</li>
