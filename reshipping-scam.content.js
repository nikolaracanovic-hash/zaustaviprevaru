...
window.SCAM_CONTENT["reshipping-scam"] = {
  raw_html: `
...
<section class="content-section">
  ...
  <div class="callout">
    ...
    <span data-sr="Prihvatanje prvog paketa na kućnu adresu i prosleđivanje po uputstvima. Kućna adresa žrtve postaje deo kriminalnog lanca." data-en="Accepting the first package at the home address and forwarding it per instructions. The victim's home address becomes part of the criminal chain.">Prihvatanje prvog paketa na kućnu adresu i prosleđivanje po uputstvima. Kućna adresa žrtve postaje deo kriminalnog lanca.</span>
  </div>
</section>
...
<section class="content-section">
  ...
  <div class="grid-2">
    ...
    <div class="phase">
      ...
      <ul class="bullets">
        <li data-sr="Žrtva daje kućnu adresu kao adresu za dostavu — to je ključna informacija za napadača." data-en="The victim provides their home address as the delivery address — that is the key information for the attacker.">Žrtva daje kućnu adresu kao adresu za dostavu — to je ključna informacija za napadača.</li>
        <li data-sr="Uputstvo je da se sadržaj proveri, eventualno prepakuje i pošalje na drugu adresu — najčešće u inostranstvo." data-en="The instruction is to check the contents, optionally repackage and send to another address — usually abroad.">Uputstvo je da se sadržaj proveri, eventualno prepakuje i pošalje na drugu adresu — najčešće u inostranstvo.</li>
        <li data-sr="Žrtva plaća troškove slanja iz sopstvenog džepa uz obećanje refundacije — refundacija ne stiže." data-en="The victim pays shipping costs from their own pocket with a promise of reimbursement — reimbursement never arrives.">Žrtva plaća troškove slanja iz sopstvenog džepa uz obećanje refundacije — refundacija ne stiže.</li>
        <li data-sr="Roba u paketima je često skupocena elektronika, nakit ili luksuzna roba kupljena ukradenim karticama." data-en="Goods in the packages are often expensive electronics, jewelry or luxury goods purchased with stolen cards.">Roba u paketima je često skupocena elektronika, nakit ili luksuzna roba kupljena ukradenim karticama.</li>
      </ul>
    </div>
  </div>
</section>
...
<section class="content-section">
  ...
  <article class="phase">
    <h3 data-sr="Faza 2 — Prve pošiljke" data-en="Phase 2 — First shipments">Faza 2 — Prve pošiljke</h3>
    <p data-sr="Paketi počinju da stižu na kućnu adresu žrtve. Sadržaj je neupitan — standardna roba. Plaćanje po paketu stiže tačno na vreme." data-en="Packages begin arriving at the victim's home address. The contents are unquestioned — standard goods. Per-package payment arrives on time.">Paketi počinju da stižu na kućnu adresu žrtve. Sadržaj je neupitan — standardna roba. Plaćanje po paketu stiže tačno na vreme.</p>
    <ul class="bullets">
      <li data-sr="Žrtva prati uputstvo i šalje pakete dalje bez sumnje jer sve funkcioniše kao obećano." data-en="The victim follows instructions and forwards packages without suspicion because everything works as promised.">Žrtva prati uputstvo i šalje pakete dalje bez sumnje jer sve funkcioniše kao obećano.</li>
  ...
  <article class="phase">
    <h3 data-sr="Faza 3 — Skupocena roba i prvi troškovi" data-en="Phase 3 — Expensive goods and first costs">Faza 3 — Skupocena roba i prvi troškovi</h3>
    <p data-sr="Sadržaj paketa postaje skupoceniji — elektronika, nakit, satovi. Troškovi slanja rastu i žrtva plaća iz džepa uz obećanje naknade koja kasni ili ne stiže." data-en="Package contents become more expensive — electronics, jewelry, watches. Shipping costs increase and the victim pays out of pocket with a promise of reimbursement that is late or never arrives.">Sadržaj paketa postaje skupoceniji — elektronika, nakit, satovi. Troškovi slanja rastu i žrtva plaća iz džepa uz obećanje naknade koja kasni ili ne stiže.</p>
    <ul class="bullets">
      <li data-sr="Žrtva počinje da troši sopstveni novac na dostavu koji se nikad ne refundira." data-en="The victim begins spending their own money on shipping that is never reimbursed.">Žrtva počinje da troši sopstveni novac na dostavu koji se nikad ne refundira.</li>
    ...
    <div class="branch">
      ...
      <ul class="bullets">
        <li><a href="money-mule-recruitment.html" data-sr="Regrutovanje finansijske mule — isti model ali sa finansijskim tokovima umesto paketa." data-en="Money mule recruitment — same model but with financial flows instead of packages.">Regrutovanje finansijske mule — isti model ali sa finansijskim tokovima umesto paketa.</a></li>
      </ul>
    </div>
  </article>

  <article class="phase">
    <h3 data-sr="Faza 4 — Istraga i nestanak napadača" data-en="Phase 4 — Investigation and attacker disappearance">Faza 4 — Istraga i nestanak napadača</h3>
    <p data-sr="Policija ili prodavac prati ukradenu robu do kućne adrese žrtve. Napadač nestaje čim se pojave znaci istrage i komunikacija se prekida." data-en="Police or a seller traces stolen goods to the victim's home address. The attacker disappears as soon as signs of investigation appear and communication cuts off.">Policija ili prodavac prati ukradenu robu do kućne adrese žrtve. Napadač nestaje čim se pojave znaci istrage i komunikacija se prekida.</p>
    <ul class="bullets">
      <li data-sr="Napadač je koristio anonimne kanale komunikacije i ne može se identifikovati." data-en="The attacker used anonymous communication channels and cannot be identified.">Napadač je koristio anonimne kanale komunikacije i ne može se identifikovati.</li>
...
<section class="content-section">
  ...
  <ul class="bullets">
    <li data-sr="Posao traži prijem paketa na kućnu adresu i prosleđivanje na drugu adresu." data-en="The job requires receiving packages at a home address and forwarding them to another address.">Posao traži prijem paketa na kućnu adresu i prosleđivanje na drugu adresu.</li>
    <li data-sr="Adrese na koje se šalju paketi su u inostranstvu bez jasnog poslovnog razloga." data-en="The addresses to which packages are sent are abroad without a clear business reason.">Adrese na koje se šalju paketi su u inostranstvu bez jasnog poslovnog razloga.</li>
    <li data-sr="Troškovi slanja se ne refundiraju redovno ili se obećava naknadna uplata koja ne stiže." data-en="Shipping costs are not reimbursed regularly or a later payment is promised that never arrives.">Troškovi slanja se ne refundiraju redovno ili se obećava naknadna uplata koja ne stiže.</li>
    <li data-sr="Roba u paketima je skupocena elektronika ili nakit bez jasnog opisa odakle dolazi." data-en="Goods in the packages are expensive electronics or jewelry without a clear description of their origin.">Roba u paketima je skupocena elektronika ili nakit bez jasnog opisa odakle dolazi.</li>
    <li data-sr="Kompanija nema fizičku adresu koja se može proveriti ili se ne može naći u poslovnom registru." data-en="The company has no verifiable physical address or cannot be found in the business registry.">Kompanija nema fizičku adresu koja se može proveriti ili se ne može naći u poslovnom registru.</li>
    <li data-sr="Nema razloga zašto bi legitimna kompanija koristila privatne kućne adrese za prolaz robe." data-en="There is no reason why a legitimate company would use private home addresses as routing points for goods.">Nema razloga zašto bi legitimna kompanija koristila privatne kućne adrese za prolaz robe.</li>
...
<section class="content-section">
  <h2 data-sr="Checklista: pitanja pre prihvatanja reshipping posla" data-en="Checklist: questions before accepting a reshipping job">Checklista: pitanja pre prihvatanja reshipping posla</h2>
  <ul class="bullets">
    <li data-sr="Da li posao traži korišćenje može kućne adrese za prijem poslovnih paketa?" data-en="Does the job require using my home address for receiving business packages?">Da li posao traži korišćenje može kućne adrese za prijem poslovnih paketa?</li>
    <li data-sr="Da li je kompanija registrovana i ima proverljivu fizičku adresu?" data-en="Is the company registered and does it have a verifiable physical address?">Da li je kompanija registrovana i ima proverljivu fizičku adresu?</li>
    <li data-sr="Zašto kompanija koristi kućne adrese umesto sopstvenih skladišta ili poslovnih adresa?" data-en="Why does the company use home addresses instead of its own warehouses or business addresses?">Zašto kompanija koristi kućne adrese umesto sopstvenih skladišta ili poslovnih adresa?</li>
    <li data-sr="Da li se adrese za prosleđivanje paketa nalaze u inostranstvu?" data-en="Are the package forwarding addresses located abroad?">Da li se adrese za prosleđivanje paketa nalaze u inostranstvu?</li>
    <li data-sr="Da li mi je objašnjeno odakle roba dolazi i ko je originalni vlasnik?" data-en="Have I been explained where goods come from and who the original owner is?">Da li mi je objašnjeno odakle roba dolazi i ko je originalni vlasnik?</li>
    <li data-sr="Da li me uputstvo ograničava u postavljanju pitanja o sadržaju paketa?" data-en="Do the instructions restrict me from asking questions about package contents?">Da li me uputstvo ograničava u postavljanju pitanja o sadržaju paketa?</li>
    <li data-sr="Da li su troškovi slanja garantovani i refundirani bez odlaganja?" data-en="Are shipping costs guaranteed and reimbursed without delay?">Da li su troškovi slanja garantovani i refundirani bez odlaganja?</li>
    <li data-sr="Da li sam proverio naziv kompanije u poslovnom registru i na Google-u?" data-en="Have I checked the company name in the business registry and on Google?">Da li sam proverio naziv kompanije u poslovnom registru i na Google-u?</li>
    <li data-sr="Da li bi moja pošta ili kurirska služba imali pitanja o ovakvom toku paketa?" data-en="Would my post office or courier service have questions about this kind of package flow?">Da li bi moja pošta ili kurirska služba imali pitanja o ovakvom toku paketa?</li>
    <li data-sr="Da li sam konsultovao advokata ili policiju pre prihvatanja ovakve ponude?" data-en="Have I consulted a lawyer or police before accepting this kind of offer?">Da li sam konsultovao advokata ili policiju pre prihvatanja ovakve ponude?</li>
    <li data-sr="Da li me kompanija može pozvati na video sastanak sa HR osobom pre potpisivanja ugovora?" data-en="Can the company invite me to a video meeting with an HR person before signing the contract?">Da li me kompanija može pozvati na video sastanak sa HR osobom pre potpisivanja ugovora?</li>
  </ul>
</section>
...
<section class="content-section">
  ...
  <ol class="steps">
    <li data-sr="Odmah prestani sa primanjem i prosleđivanjem paketa." data-en="Immediately stop receiving and forwarding packages.">Odmah prestani sa primanjem i prosleđivanjem paketa.</li>
    <li data-sr="Sačuvaj sve pakete koji su kod tebe i ne šalji ih dalje do konsultacije sa advokatom." data-en="Keep all packages currently with you and do not forward them until consulting a lawyer.">Sačuvaj sve pakete koji su kod tebe i ne šalji ih dalje do konsultacije sa advokatom.</li>
    <li data-sr="Dokumentuj svu komunikaciju — imejlove, poruke iz aplikacija za dopisivanje, ugovor, uputstva i adrese dostave." data-en="Document all communication — emails, chat messages, contract, instructions and delivery addresses.">Dokumentuj svu komunikaciju — imejlove, poruke iz aplikacija za dopisivanje, ugovor, uputstva i adrese dostave.</li>
    <li data-sr="Angažuj advokata specijalizovanog za krivično pravo pre kontakta sa policijom." data-en="Engage a lawyer specializing in criminal law before contact with police.">Angažuj advokata specijalizovanog za krivično pravo pre kontakta sa policijom.</li>
    <li data-sr="Prijavi slučaj policiji dobrovoljno uz svu dokumentaciju — to demonstrira dobru veru." data-en="Report the case to police voluntarily with all documentation — that demonstrates good faith.">Prijavi slučaj policiji dobrovoljno uz svu dokumentaciju — to demonstrira dobru veru.</li>
    <li data-sr="Prijavi oglas platformi za zapošljavanje kako bi sprečio dalje žrtve." data-en="Report the ad to the job platform to prevent further victims.">Prijavi oglas platformi za zapošljavanje kako bi sprečio dalje žrtve.</li>
  </ol>
</section>
...
<section class="content-section">
  ...
  <ul class="bullets">
    <li data-sr="Da li primaju pakete na kućnu adresu i prosleđuju ih na adrese u inostranstvu?" data-en="Are they receiving packages at their home address and forwarding them to addresses abroad?">Da li primaju pakete na kućnu adresu i prosleđuju ih na adrese u inostranstvu?</li>
    <li data-sr="Da li plaćaju troškove slanja iz sopstvenog džepa sa obećanjem naknade?" data-en="Are they paying shipping costs from their own pocket with a promise of reimbursement?">Da li plaćaju troškove slanja iz sopstvenog džepa sa obećanjem naknade?</li>
    <li data-sr="Da li kompanija može da se nađe u zvaničnom poslovnom registru?" data-en="Can the company be found in the official business registry?">Da li kompanija može da se nađe u zvaničnom poslovnom registru?</li>
    <li data-sr="Da li su već kontaktirani od strane policije ili prodavca koji traži ukradenu robu?" data-en="Have they already been contacted by police or a seller looking for stolen goods?">Da li su već kontaktirani od strane policije ili prodavca koji traži ukradenu robu?</li>
  </ul>
  <p data-sr="Rečenice koje rade:" data-en="Sentences that help:">Rečenice koje rade:</p>
  <ul class="bullets">
    <li data-sr="Roba koja prolazi kroz tvoju adresu je kupljena ukradenim karticama — to te pravno čini delom lanca krađe." data-en="Goods passing through your address are purchased with stolen cards — that legally makes you part of the theft chain.">Roba koja prolazi kroz tvoju adresu je kupljena ukradenim karticama — to te pravno čini delom lanca krađe.</li>
    <li data-sr="Prestani odmah i ne šalji više pakete — svaki paket koji pošalješ pojačava tvoju pravnu odgovornost." data-en="Stop immediately and do not forward any more packages — each package you send increases your legal liability.">Prestani odmah i ne šalji više pakete — svaki paket koji pošalješ pojačava tvoju pravnu odgovornost.</li>
    <li data-sr="Angažuj advokata pre nego što razgovaraš sa policijom — to je tvoje pravo i štiti tvoje interese." data-en="Engage a lawyer before talking to police — that is your right and it protects your interests.">Angažuj advokata pre nego što razgovaraš sa policijom — to je tvoje pravo i štiti tvoje interese.</li>
    <li data-sr="Sačuvaj sve — pakete, uputstva, imejlove — to je jedina odbrana koja pokazuje da si bio prevaren." data-en="Keep everything — packages, instructions, emails — that is the only defense showing you were deceived.">Sačuvaj sve — pakete, uputstva, imejlove — to je jedina odbrana koja pokazuje da si bio prevaren.</li>
  </ul>
</section>
