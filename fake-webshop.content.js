...
window.SCAM_CONTENT["fake-webshop"] = {
  raw_html: `
<section class="content-section">
  <h2 data-sr="Uvod: kako radi lažna internet prodavnica" data-en="Intro: how the fake webshop works">Uvod: kako radi lažna internet prodavnica</h2>
  <p data-sr="Lažna internet prodavnica izgleda kao legitimni e-commerce sajt — profesionalan dizajn, fotografije proizvoda, ocene korisnika i lažne politike povrata. Kupac naručuje i plaća, a roba nikad ne stigne ili stigne kao jeftina krivotvorina. Povrat je praktično nemoguć jer kompanija ne postoji ili je registrovana u nedostupnoj nadležnosti." data-en="A fake online store looks like a legitimate e-commerce site — professional design, product photographs, user ratings, and fake return policies. The buyer orders and pays, and the goods never arrive or arrive as a cheap counterfeit. Refunds are practically impossible because the company does not exist or is registered in an inaccessible jurisdiction.">Lažna internet prodavnica izgleda kao legitimni e-commerce sajt — profesionalan dizajn, fotografije proizvoda, ocene korisnika i lažne politike povrata. Kupac naručuje i plaća, a roba nikad ne stigne ili stigne kao jeftina krivotvorina. Povrat je praktično nemoguć jer kompanija ne postoji ili je registrovana u nedostupnoj nadležnosti.</p>
</section>
...
<section class="content-section">
  ...
  <div class="phase">
    ...
    <p data-sr="Lažna prodavnica → oglas → kupovina → uplata → roba ne stigne ili je krivotvorina → povrat odbijen → gubitak" data-en="Fake store → ad → purchase → payment → goods never arrive or are counterfeit → refund denied → loss">Lažna prodavnica → oglas → kupovina → uplata → roba ne stigne ili je krivotvorina → povrat odbijen → gubitak</p>
  </div>
  <div class="callout">
    <strong data-sr="Prag:" data-en="Threshold:">Prag:</strong>
    <span data-sr="Prodavnica bez proverljive fizičke adrese, bez verifikovanih recenzija i bez jasnih uslova povrata ne sme primiti uplatu." data-en="A store without a verifiable physical address, verified reviews, and clear return terms must not receive payment.">Prodavnica bez proverljive fizičke adrese, bez verifikovanih recenzija i bez jasnih uslova povrata ne sme primiti uplatu.</span>
  </div>
</section>
...
<section class="content-section">
  ...
  <div class="grid-2">
    <article>
      ...
      <ul class="bullets">
        <li data-sr="Sajt koristi ukradene fotografije, lažne recenzije i lažne sigurnosne bedževe (SSL, PayPal)." data-en="The site uses stolen photographs, fake reviews, and fake security badges (SSL, PayPal).">Sajt koristi ukradene fotografije, lažne recenzije i lažne sigurnosne bedževe (SSL, PayPal).</li>
        <li data-sr="Cene su agresivno snižene — 60–90% popusta na brendiranu robu — da privuku kupce koji bi inače bili skeptični." data-en="Prices are aggressively reduced — 60–90% discounts on branded goods — to attract buyers who would otherwise be skeptical.">Cene su agresivno snižene — 60–90% popusta na brendiranu robu — da privuku kupce koji bi inače bili skeptični.</li>
        <li data-sr="Platforma prihvata kreditne kartice što daje lažan osećaj bezbednosti jer kupci misle da su zaštićeni." data-en="The platform accepts credit cards, giving a false sense of security as buyers think they are protected.">Platforma prihvata kreditne kartice što daje lažan osećaj bezbednosti jer kupci misle da su zaštićeni.</li>
        <li data-sr="Lažne politike povrata i kontakt forme postoje, ali ne funkcionišu ili ne odgovaraju." data-en="Fake return policies and contact forms exist but do not work or do not respond.">Lažne politike povrata i kontakt forme postoje, ali ne funkcionišu ili ne odgovaraju.</li>
      </ul>
    </article>
    <article>
      <h3 data-sr="Kako se odvija prevara" data-en="How the fraud unfolds">Kako se odvija prevara</h3>
      <ul class="bullets">
        <li data-sr="Roba nikad ne stiže, stiže posle veoma dugog čekanja, ili je potpuno drugačija od opisane." data-en="Goods never arrive, arrive after a very long wait, or are completely different from the description.">Roba nikad ne stiže, stiže posle veoma dugog čekanja, ili je potpuno drugačija od opisane.</li>
        <li data-sr="Podrška ne odgovara, broj telefona ne funkcioniše ili vodi na drugu kompaniju." data-en="Support does not respond, the phone number does not work, or leads to a different company.">Podrška ne odgovara, broj telefona ne funkcioniše ili vodi na drugu kompaniju.</li>
        <li data-sr="Chargeback je moguć za kartične uplate, ali prodavnica može osporiti s lažnim dokazima o isporuci." data-en="Chargeback is possible for card payments, but the store may dispute with fake delivery evidence.">Chargeback je moguć za kartične uplate, ali prodavnica može osporiti s lažnim dokazima o isporuci.</li>
      </ul>
    </article>
  </div>
</section>
...
<section class="content-section">
  ...
  <div class="phase">
    <div class="label" data-sr="Faza 1: Oglas i privlačna ponuda" data-en="Phase 1: Ad and attractive offer">Faza 1: Oglas i privlačna ponuda</div>
    <p data-sr="Kupac vidi oglas na društvenim mrežama, u pretragivaču ili na comparison sajtu s neobično niskom cenom za traženi proizvod." data-en="The buyer sees an ad on social media, in a search engine, or on a comparison site with an unusually low price for the sought product.">Kupac vidi oglas na društvenim mrežama, u pretragivaču ili na comparison sajtu s neobično niskom cenom za traženi proizvod.</p>
    <ul class="bullets">
      <li data-sr="Cena daleko ispod tržišne za brendiranu robu je pouzdan signal krivotvorine ili prevare." data-en="A price far below market value for branded goods is a reliable signal of a counterfeit or fraud.">Cena daleko ispod tržišne za brendiranu robu je pouzdan signal krivotvorine ili prevare.</li>
  ...
  <div class="phase">
    <div class="label" data-sr="Faza 4: Isporuka krivotvorine ili pogrešne robe" data-en="Phase 4: Counterfeit or wrong item delivery">Faza 4: Isporuka krivotvorine ili pogrešne robe</div>
  ...
  <div class="phase">
    <div class="label" data-sr="Faza 5: Odbijanje povrata" data-en="Phase 5: Refund denial">Faza 5: Odbijanje povrata</div>
    <p data-sr="Kupac traži povrat. Prodavnica traži vraćanje robe na adresu u Kini ili drugoj udaljnoj državi s troškovima slanja koji premašuju vrednost robe." data-en="The buyer requests a refund. The store demands return of goods to an address in China or another distant country with shipping costs that exceed the value of the goods.">Kupac traži povrat. Prodavnica traži vraćanje robe na adresu u Kini ili drugoj udaljnoj državi s troškovima slanja koji premašuju vrednost robe.</p>
    <ul class="bullets">
      <li data-sr="Adresa za povrat je nerealistična — troškovi slanja su veći od vrednosti robe." data-en="The return address is unrealistic — shipping costs are greater than the value of the goods.">Adresa za povrat je nerealistična — troškovi slanja su veći od vrednosti robe.</li>
...
<section class="content-section">
  ...
  <ul class="bullets">
    <li data-sr="Cena je 60–90% niža od tržišne za brendiranu robu." data-en="The price is 60–90% lower than the market price for branded goods.">Cena je 60–90% niža od tržišne za brendiranu robu.</li>
    <li data-sr="Sajt nema proverljivu fizičku adresu — samo poštanski sandučić ili generičku adresu." data-en="The site has no verifiable physical address — only a mailbox or generic address.">Sajt nema proverljivu fizičku adresu — samo poštanski sandučić ili generičku adresu.</li>
    <li data-sr="Domen je registrovan nedavno — manje od 6 meseci — što se može proveriti WHOIS pretragom." data-en="The domain was registered recently — less than 6 months ago — which can be verified by WHOIS search.">Domen je registrovan nedavno — manje od 6 meseci — što se može proveriti WHOIS pretragom.</li>
    <li data-sr="Recenzije izgledaju generički ili sve dolaze u kratkom vremenskom periodu bez kritičnih osvrta." data-en="Reviews look generic or all arrive within a short time period without critical comments.">Recenzije izgledaju generički ili sve dolaze u kratkom vremenskom periodu bez kritičnih osvrta.</li>
    <li data-sr="Jedini prihvatljiv metod plaćanja je direktni bankovni transfer ili kripto." data-en="The only acceptable payment method is direct bank transfer or crypto.">Jedini prihvatljiv metod plaćanja je direktni bankovni transfer ili kripto.</li>
    <li data-sr="Kontakt podrška ne odgovara ili su odgovori generički automatski." data-en="Contact support does not respond or responses are generic and automated.">Kontakt podrška ne odgovara ili su odgovori generički automatski.</li>
    <li data-sr="Povratna adresa je u Kini ili udaljenim državama s prohibitivnim troškovima slanja." data-en="The return address is in China or distant countries with prohibitive shipping costs.">Povratna adresa je u Kini ili udaljenim državama s prohibitivnim troškovima slanja.</li>
  </ul>
</section>
...
<section class="content-section">
  ...
  <ul class="bullets">
    <li data-sr="Pretražite naziv prodavnice na ScamAdviser, Trustpilot i Google recenzijama pre kupovine." data-en="Search the store name on ScamAdviser, Trustpilot, and Google reviews before purchasing.">Pretražite naziv prodavnice na ScamAdviser, Trustpilot i Google recenzijama pre kupovine.</li>
    <li data-sr="Proverite datum registracije domena WHOIS pretragom — mladi domeni su signal rizika." data-en="Check the domain registration date via WHOIS — young domains are a risk signal.">Proverite datum registracije domena WHOIS pretragom — mladi domeni su signal rizika.</li>
    <li data-sr="Proverite da li sajt ima proverljivu fizičku adresu koja se može naći na Google Maps." data-en="Check whether the site has a verifiable physical address that can be found on Google Maps.">Proverite da li sajt ima proverljivu fizičku adresu koja se može naći na Google Maps.</li>
    <li data-sr="Pretražite fotografije proizvoda putem reverse-image pretrage da proverite da li su ukradene." data-en="Search product photographs via reverse image search to verify they are not stolen.">Pretražite fotografije proizvoda putem reverse-image pretrage da proverite da li su ukradene.</li>
    <li data-sr="Koristite kreditnu karticu ili PayPal s zaštitom kupca — nikad direktan bankovni transfer." data-en="Use a credit card or PayPal with buyer protection — never a direct bank transfer.">Koristite kreditnu karticu ili PayPal s zaštitom kupca — nikad direktan bankovni transfer.</li>
    <li data-sr="Proverite da li prodavnica ima validnu SSL sertifikaciju (https) i da li je lako naći kontakt podatke." data-en="Check whether the store has a valid SSL certificate (https) and whether contact details are easy to find.">Proverite da li prodavnica ima validnu SSL sertifikaciju (https) i da li je lako naći kontakt podatke.</li>
    <li data-sr="Pretražite naziv brenda čiju robu prodavnica prodaje plus naziv prodavnice da proverite da li je autorizovani prodavac." data-en="Search the brand name of the goods the store sells plus the store name to verify it is an authorized dealer.">Pretražite naziv brenda čiju robu prodavnica prodaje plus naziv prodavnice da proverite da li je autorizovani prodavac.</li>
  </ul>
</section>

<section class="content-section">
  <h2 data-sr="Checklista pre kupovine u nepoznatoj internet prodavnici" data-en="Checklist before purchasing in an unknown online store">Checklista pre kupovine u nepoznatoj internet prodavnici</h2>
  <ul class="bullets">
    ...
    <li data-sr="Da li sam koristio zaštićeni metod plaćanja koji ima opciju chargeback-a?" data-en="Have I used a protected payment method that has a chargeback option?">Da li sam koristio zaštićeni metod plaćanja koji ima opciju chargeback-a?</li>
    <li data-sr="Da li sam sačuvao snimak ekrana stranice s cenom i opisom proizvoda pre kupovine?" data-en="Have I saved a screenshot of the product price and description page before purchasing?">Da li sam sačuvao snimak ekrana stranice s cenom i opisom proizvoda pre kupovine?</li>
  </ul>
</section>
