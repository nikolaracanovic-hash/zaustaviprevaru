...
window.SCAM_CONTENT["social-benefits-scam"] = {
  raw_html: `
    <section class="card">
    ...
    <section class="card">
      <h2 data-sr="Kako generalno radi: mehanika socijalne prevare" data-en="How it works: social scam mechanics">Kako generalno radi: mehanika socijalne prevare</h2>
      <div class="grid-2">
        <div class="phase">
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <div class="callout" data-sr="<strong>Prag faze:</strong> meta angažuje se i traži više detalja o naknadi ili verifikaciji." data-en="<strong>Threshold:</strong> the target engages and asks for more details about the benefit or verification."><strong>Prag faze:</strong> meta angažuje se i traži više detalja o naknadi ili verifikaciji.</div>
      </article>
    ...
    <section class="card">
      ...
      <div class="grid-2">
        <div class="phase">
          ...
          <ul class="bullets">
            <li data-sr="pozovi nadležni centar za socijalni rad iz imenika i pitaj o naknadi ili verifikaciji." data-en="call the responsible social services center from the phone book and ask about the benefit or verification.">pozovi nadležni centar za socijalni rad iz imenika i pitaj o naknadi ili verifikaciji.</li>
            <li data-sr="proveri portal za socijalne usluge da li postoji aktivan zahtev ili predmet." data-en="check the social services portal for any active request or case.">proveri portal za socijalne usluge da li postoji aktivan zahtev ili predmet.</li>
            <li data-sr="centar za socijalni rad koristi pisani kanal za sve zvanične zahteve — ne telefon ili email." data-en="social services use written channels for all official requests — not phone or email.">centar za socijalni rad koristi pisani kanal za sve zvanične zahteve — ne telefon ili email.</li>
          </ul>
        </div>
        <div class="phase">
          <div class="label" data-sr="Provere zahteva" data-en="Demand checks">Provere zahteva</div>
          <ul class="bullets">
            <li data-sr="nova naknada bez prethodnog zahteva na standard obrascima nije standardna procedura." data-en="new benefit without a prior request on standard forms is not standard procedure.">nova naknada bez prethodnog zahteva na standard obrascima nije standardna procedura.</li>
            <li data-sr="socijalna naknada ne zahteva avansnu taksenu uplatu." data-en="social benefit does not require advance fee payment.">socijalna naknada ne zahteva avansnu taksenu uplatu.</li>
            <li data-sr="ne davati JMBG, broj računa niti PIN telefonom ni u poznatom ni u nepoznatom pozivu." data-en="never provide ID number, account number, or PIN over the phone in any call.">ne davati JMBG, broj računa niti PIN telefonom ni u poznatom ni u nepoznatom pozivu.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      <h2 data-sr="Checklista: 10 pitanja pre predaje podataka ili uplate" data-en="Checklist: 10 questions before data submission or payment">Checklista: 10 pitanja pre predaje podataka ili uplate</h2>
      <ul class="bullets">
        <li data-sr="Da li si sam podneo zahtev za ovu naknadu kroz standardne kanale?" data-en="Did you submit a request for this benefit through standard channels yourself?">Da li si sam podneo zahtev za ovu naknadu kroz standardne kanale?</li>
        <li data-sr="Da li centar za socijalni rad koristi telefon za verifikaciju podataka?" data-en="Does the social services center use phone for data verification?">Da li centar za socijalni rad koristi telefon za verifikaciju podataka?</li>
        <li data-sr="Da li primanje naknade zahteva prethodnu uplatu takse ili obrade?" data-en="Does receiving the benefit require prior payment of a fee or processing cost?">Da li primanje naknade zahteva prethodnu uplatu takse ili obrade?</li>
        <li data-sr="Da li kontakt traži JMBG, broj računa ili PIN?" data-en="Is the contact requesting an ID number, account number, or PIN?">Da li kontakt traži JMBG, broj računa ili PIN?</li>
        <li data-sr="Da li kontakt dozvoljava proveru pozivom centru za socijalni rad?" data-en="Does the contact allow verification by calling the social services center?">Da li kontakt dozvoljava proveru pozivom centru za socijalni rad?</li>
        <li data-sr="Da li rok od 24h odgovara standardnom periodu za odgovor državne institucije?" data-en="Does the 24-hour deadline match the standard response period for a state institution?">Da li rok od 24h odgovara standardnom periodu za odgovor državne institucije?</li>
        <li data-sr="Da li posle prve uplate ili predaje podataka dolaze novi zahtevi?" data-en="Do new demands arrive after the first payment or data submission?">Da li posle prve uplate ili predaje podataka dolaze novi zahtevi?</li>
        <li data-sr="Da li portal socijalne službe pokazuje aktivan zahtev ili predmet?" data-en="Does the social services portal show an active request or case?">Da li portal socijalne službe pokazuje aktivan zahtev ili predmet?</li>
        <li data-sr="Da li je tekuća naknada i dalje aktivna prema zvaničnom portalu?" data-en="Is the current benefit still active according to the official portal?">Da li je tekuća naknada i dalje aktivna prema zvaničnom portalu?</li>
    ...
    <section class="card">
      ...
      <ol class="steps">
        <li data-sr="ne davaj JMBG, broj računa niti PIN dok ne proveriš direktno s centrom za socijalni rad." data-en="do not provide your ID number, account number, or PIN until you verify directly with the social services center.">ne davaj JMBG, broj računa niti PIN dok ne proveriš direktno s centrom za socijalni rad.</li>
        <li data-sr="pozovi nadležni centar za socijalni rad iz imenika i pitaj o naknadi i verifikaciji." data-en="call the responsible social services center from the phone book and ask about the benefit and verification.">pozovi nadležni centar za socijalni rad iz imenika i pitaj o naknadi i verifikaciji.</li>
        <li data-sr="proveri portal socijalne službe da li postoji aktivan zahtev ili predmet." data-en="check the social services portal for any active request or case.">proveri portal socijalne službe da li postoji aktivan zahtev ili predmet.</li>
        <li data-sr="sačuvaj poruku ili snimak poziva kao dokaz." data-en="save the message or call recording as evidence.">sačuvaj poruku ili snimak poziva kao dokaz.</li>
        <li data-sr="prijavi incident centru za socijalni rad i policiji." data-en="report the incident to the social services center and police.">prijavi incident centru za socijalni rad i policiji.</li>
      </ol>
    </section>
    ...
    <section class="card">
      ...
      <div class="grid-2">
        <div class="phase">
          ...
          <ul class="bullets">
            <li data-sr="Da li si sam podneo zahtev za tu naknadu?" data-en="Did you submit a request for that benefit yourself?">Da li si sam podneo zahtev za tu naknadu?</li>
            <li data-sr="Da li su tražili JMBG, broj računa ili PIN?" data-en="Did they ask for your ID number, account number, or PIN?">Da li su tražili JMBG, broj računa ili PIN?</li>
            <li data-sr="Da li je centar za socijalni rad tražio verifikaciju pismenim putem?" data-en="Did the social services center request verification in writing?">Da li je centar za socijalni rad tražio verifikaciju pismenim putem?</li>
          </ul>
        </div>
        <div class="phase">
          <div class="label" data-sr="Rečenice koje rade" data-en="Phrases that work">Rečenice koje rade</div>
          <ul class="bullets">
            <li data-sr="Centar za socijalni rad ne nudi naknade telefonom bez prethodnog zahteva." data-en="Social services do not offer benefits by phone without a prior request.">Centar za socijalni rad ne nudi naknade telefonom bez prethodnog zahteva.</li>
            <li data-sr="Socijalna naknada ne zahteva avansnu uplatu — to je definitivni signal prevare." data-en="A social benefit does not require advance payment — that is a definitive scam signal.">Socijalna naknada ne zahteva avansnu uplatu — to je definitivni signal prevare.</li>
            <li data-sr="Hajde da zajedno pozovemo centar iz imenika i proverimo." data-en="Let's call the center from the phone book together and verify.">Hajde da zajedno pozovemo centar iz imenika i proverimo.</li>
          </ul>
        </div>
      </div>
    </section>
