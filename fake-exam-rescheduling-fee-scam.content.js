...
window.SCAM_CONTENT["fake-exam-rescheduling-fee-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Stiže imejl ili poruka da je tvoj termin ispita poništen ili da ćeš biti uklonjen sa liste ako odmah ne platiš naknadu za novi termin." data-en="Email or chat claims your exam sitting was cancelled or you will be removed from the list unless you immediately pay for a new slot.">Stiže imejl ili poruka da je tvoj termin ispita poništen ili da ćeš biti uklonjen sa liste ako odmah ne platiš naknadu za novi termin.</p>
      <p data-sr="Promena termina ide kroz studentsku službu ili elektronski sistem fakulteta; obaveštenje se vidi i nakon prijave na zvanični portal." data-en="Date changes run through student services or the faculty e-system; the notice also appears after login on the official portal.">Promena termina ide kroz studentsku službu ili elektronski sistem fakulteta; obaveštenje se vidi i nakon prijave na zvanični portal.</p>
      <div class="callout" data-sr="<strong>Model:</strong> lažno upozorenje → link → prag (uplata) → lažna potvrda → eskalacija → nestanak." data-en="<strong>Model:</strong> fake warning → link → threshold (payment) → fake confirmation → escalation → disappearance."><strong>Model:</strong> lažno upozorenje → link → prag (uplata) → lažna potvrda → eskalacija → nestanak.</div>
    </section>
    <section class="card">
      <h2 data-sr="Kako generalno radi" data-en="How it generally works">Kako generalno radi</h2>
      <p data-sr="Koristi se strah od gubitka godine, roka za stipendiju ili obaveze prema poslodavcu." data-en="Fear of losing the year, a scholarship deadline, or an employer obligation is exploited.">Koristi se strah od gubitka godine, roka za stipendiju ili obaveze prema poslodavcu.</p>
      <div class="grid-2">
        <div class="phase">
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Poruka sadrži skoro tačan naziv predmeta i vreme ispita da deluje kao interni sistem, uz link za registraciju novog termina." data-en="The message uses an almost correct course name and exam time to look like an internal system, with a link to register for a new slot.">Poruka sadrži skoro tačan naziv predmeta i vreme ispita da deluje kao interni sistem, uz link za registraciju novog termina.</p>
        <ul class="bullets">
      ...
      <article class="phase">
        ...
        <p data-sr="Forma traži indeks, JMBG i ponekad lozinku studentskog naloga, uz mali iznos za sistemsku obradu pre prikaza novog datuma." data-en="The form asks for student ID, national ID, and sometimes a student password, plus a small system processing fee before showing a new date.">Forma traži indeks, JMBG i ponekad lozinku studentskog naloga, uz mali iznos za sistemsku obradu pre prikaza novog datuma.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Nema iste promene termena u zvaničnom studentskom portalu posle prijave." data-en="The same date change does not appear in the official student portal after login.">Nema iste promene termena u zvaničnom studentskom portalu posle prijave.</li>
        <li data-sr="Traži se uplata pre nego što služba na javnom broju potvrdi novi termin ispita." data-en="Payment is asked before the office on the public number confirms the new exam date.">Traži se uplata pre nego što služba na javnom broju potvrdi novi termin ispita.</li>
        <li data-sr="Link vodi na domen koji nije fakultetski sajt." data-en="The link leads to a domain that is not the faculty website.">Link vodi na domen koji nije fakultetski sajt.</li>
        <li data-sr="Ponuda važi samo nekoliko sati uz pretnju gubitka godine." data-en="The offer lasts only a few hours with a threat of losing the year.">Ponuda važi samo nekoliko sati uz pretnju gubitka godine.</li>
        <li data-sr="Plaćanje je kripto, darovna kartica ili račun fizičkog lica." data-en="Payment is crypto, gift card, or a private person’s account.">Plaćanje je kripto, darovna kartica ili račun fizičkog lica.</li>
        <li data-sr="Lažni PDF potvrde nema u sistemu kada ga služba traži po broju." data-en="The fake PDF confirmation is not in the system when the office looks it up by number.">Lažni PDF potvrde nema u sistemu kada ga služba traži po broju.</li>
        <li data-sr="Imejl pošiljaoca je sličan ali ne identičan zvaničnom domenu." data-en="The sender email is similar but not identical to the official domain.">Imejl pošiljaoca je sličan ali ne identičan zvaničnom domenu.</li>
        <li data-sr="Traže se kodovi sa SMS-a ili sa kartice." data-en="SMS or card codes are requested.">Traže se kodovi sa SMS-a ili sa kartice.</li>
        <li data-sr="Isti šablon poruke prijavljen je od studenata više ustanova." data-en="The same message template is reported by students from several institutions.">Isti šablon poruke prijavljen je od studenata više ustanova.</li>
        <li data-sr="Odbijaju pauzu dok ne proveriš termin na javnom broju fakulteta." data-en="They refuse a pause while you verify the slot on the faculty’s public number.">Odbijaju pauzu dok ne proveriš termin na javnom broju fakulteta.</li>
      </ul>
    </section>
    <section class="card">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li novi termin ispita postoji u zvaničnom sistemu posle prijave na portal." data-en="Does the new exam date exist in the official system after portal login.">Da li novi termin ispita postoji u zvaničnom sistemu posle prijave na portal.</li>
        <li data-sr="Da li studentska služba potvrđuje obaveštenje o promeni termena." data-en="Does student services confirm the notice about the date change.">Da li studentska služba potvrđuje obaveštenje o promeni termena.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Student paničari zbog roka. Predložite proveru ispita na zvaničnom portalu i kratak poziv službi na javni broj, bez linka iz poruke." data-en="A student panics about a deadline. Suggest checking the exam on the official portal and a short call to services on the public number, not the link from the message.">Student paničari zbog roka. Predložite proveru ispita na zvaničnom portalu i kratak poziv službi na javni broj, bez linka iz poruke.</p>
      <div class="grid-2">
        <div class="phase">
