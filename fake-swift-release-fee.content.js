...
window.SCAM_CONTENT["fake-swift-release-fee"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: lažna naknada za SWIFT puštanje" data-en="Introduction: fake SWIFT release fee">Uvod: lažna naknada za SWIFT puštanje</h2>
      <p data-sr="Priča da je transfer blokiran dok ne platite korespondentsku ili usaglašenost naknadu na strani račun." data-en="Story that a transfer is blocked until you pay correspondent or compliance fees to a third-party account.">Priča da je transfer blokiran dok ne platite korespondentsku ili usaglašenost naknadu na strani račun.</p>
      <p data-sr="Rok je kratak, jezik zvuči bankarski, ali račun nije račun vaše banke naveden u ugovoru." data-en="Deadline is short, wording sounds banking-like, but the account is not your bank&#x27;s contractual account.">Rok je kratak, jezik zvuči bankarski, ali račun nije račun vaše banke naveden u ugovoru.</p>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
            <li data-sr="Naknada je veća od uobičajenih bankarskih troškova koje ste videli ranije." data-en="Fee is larger than usual bank charges you have seen before.">Naknada je veća od uobičajenih bankarskih troškova koje ste videli ranije.</li>
            <li data-sr="Traže uplatu na račun fizičkog lica ili nepoznate firme." data-en="Payment to an individual or unknown company is requested.">Traže uplatu na račun fizičkog lica ili nepoznate firme.</li>
            <li data-sr="Nema reference na vašu šifru klijenta u pismu koje šalju." data-en="No reference to your client ID appears in their letter.">Nema reference na vašu šifru klijenta u pismu koje šalju.</li>
            <li data-sr="Isti broj zove iz različitih zemalja u krátkom intervalu." data-en="Same number calls from different countries in a short interval.">Isti broj zove iz različitih zemalja u krátkom intervalu.</li>
            <li data-sr="Prete da će transfer biti vraćen ako ne platite u roku od sat vremena." data-en="They threaten the transfer will bounce if you do not pay within an hour.">Prete da će transfer biti vraćen ako ne platite u roku od sat vremena.</li>
            <li data-sr="Šalju lažno pismo sa logotipom banke niske rezolucije." data-en="They send a fake letter with a low-resolution bank logo.">Šalju lažno pismo sa logotipom banke niske rezolucije.</li>
            <li data-sr="Ne mogu da ponove broj vaše poslednje transakcije kada ih pitate." data-en="They cannot repeat your last transaction number when asked.">Ne mogu da ponove broj vaše poslednje transakcije kada ih pitate.</li>
            <li data-sr="Traže tajnost prema vašem pravnom timu." data-en="Secrecy toward your legal team is demanded.">Traže tajnost prema vašem pravnom timu.</li>
            <li data-sr="Kombinuju SWIFT terminologiju sa zahtevom za Western Union ili kripto." data-en="They mix SWIFT jargon with Western Union or crypto requests.">Kombinuju SWIFT terminologiju sa zahtevom za Western Union ili kripto.</li>
            <li data-sr="Vaša banka na zvaničnom kanalu kaže da nema blokiranog transfera." data-en="Your bank on an official channel says no blocked transfer exists.">Vaša banka na zvaničnom kanalu kaže da nema blokiranog transfera.</li>
      </ul>
    </section>
