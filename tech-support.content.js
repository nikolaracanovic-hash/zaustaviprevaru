...
window.SCAM_CONTENT["tech-support-scam"] = {
  raw_html: `
    <!-- 1) UVOD -->
    <section class="card">
      <h2 data-sr="Šta je prevara lažne tehničke podrške i kako funkcioniše" data-en="What a tech support scam is and how it works">
        Šta je prevara tehničke podrške i kako funkcioniše
      </h2>
      ...
      <div class="callout"
        ...
        data-en="<strong>Key fact:</strong> Microsoft, Apple, and Google never call people to tell them their computer is infected. Never. If someone calls saying they're from their support — it's scam."
      ><strong>Ključna činjenica:</strong> Microsoft, Apple, i Google nikad ne zovu ljude da im kažu da im je računar zaražen. Nikad. Ako te neko zove i kaže da je iz njihove podrške — to je prevara.</div>
    </section>
    ...
    <section class="card">
      ...
      <div class="callout"
        data-sr="<strong>Zajednički obrazac:</strong> U svim slučajevima, prevaranti su koristili strah + autoritet + daljinski pristup. Žrtve su verovale jer je zvučalo legitimno."
        data-en="<strong>Common pattern:</strong> In all cases, scammers used fear + authority + remote access. Victims believed because it sounded legitimate."
      ><strong>Zajednički obrazac:</strong> U svim slučajevima, prevaranti su koristili strah + autoritet + daljinski pristup. Žrtve su verovale jer je zvučalo legitimno.</div>
    </section>

    <!-- 4) CRVENE ZASTAVICE -->
    <section class="card">
      <h2 data-sr="Kako prepoznati prevaru lažne tehničke podrške" data-en="How to recognize a tech support scam">
        Kako prepoznati prevaru tehničke podrške
      </h2>

      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Znaci prevare" data-en="Scam signs">Znaci prevare</div>
          <ul class="bullets">
        ...
        <div class="phase">
          <div class="label" data-sr="Kako zaista radi podrška" data-en="How support actually works">Kako zaista radi podrška</div>
          <ul class="bullets">
            <li data-sr="legitimne kompanije ne zovu random ljude." data-en="legitimate companies don't call random people.">legitimne kompanije ne zovu random ljude.</li>
            <li data-sr="ako imaš problem, TI kontaktiraš njih (ne oni tebe)." data-en="if you have problem, YOU contact them (not them you).">ako imaš problem, TI kontaktiraš njih (ne oni tebe).</li>
            <li data-sr="prava podrška nikad ne traži daljinski pristup pri prvom kontaktu." data-en="real support never asks for remote access at first contact.">prava podrška nikad ne traži daljinski pristup pri prvom kontaktu.</li>
            <li data-sr="plaćanje ide preko zvaničnog sajta, ne preko telefona." data-en="payment goes through official site, not over phone.">plaćanje ide preko zvaničnog sajta, ne preko telefona.</li>
          </ul>
        </div>
      </div>

      <div class="callout"
        data-sr="<strong>Pravilo br. 1:</strong> Ako te neko zove i kaže da ti je računar zaražen — spusti slušalicu. Ako vidiš pop-up sa brojem telefona — zatvori browser."
        data-en="<strong>Rule #1:</strong> If someone calls saying your computer is infected — hang up. If you see pop-up with phone number — close browser."
      ><strong>Pravilo br. 1:</strong> Ako te neko zove i kaže da ti je računar zaražen — spusti slušalicu. Ako vidiš pop-up sa brojem telefona — zatvori browser.</div>
    </section>
    ...
    <section class="card">
      ...
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Ako dobiješ poziv" data-en="If you get call">Ako dobiješ poziv</div>
          <ol class="steps">
            <li data-sr="<strong>Spusti slušalicu odmah.</strong> Bez razgovora." data-en="<strong>Hang up immediately.</strong> No conversation."><strong>Spusti slušalicu odmah.</strong> Bez razgovora.</li>
            <li data-sr="blokiraj broj." data-en="block number.">blokiraj broj.</li>
            <li data-sr="nemoj zvati nazad — broj je prevarantski." data-en="don't call back — number is scammer's.">nemoj zvati nazad — broj je prevarantski.</li>
          </ol>
        </div>

        <div class="phase">
          <div class="label" data-sr="Ako vidiš pop-up" data-en="If you see pop-up">Ako vidiš pop-up</div>
          <ol class="steps">
            <li data-sr="<strong>Nemoj zvati broj iz pop-upa</strong>" data-en="<strong>Don't call number from pop-up</strong>"><strong>Nemoj zvati broj iz pop-upa</strong></li>
            <li data-sr="zatvori browser (Ctrl+W ili Alt+F4)." data-en="close browser (Ctrl+W or Alt+F4).">zatvori browser (Ctrl+W ili Alt+F4).</li>
            <li data-sr="ako pop-up blokira ekran: Task Manager (Ctrl+Shift+Esc) → zatvori browser." data-en="if pop-up locks screen: Task Manager (Ctrl+Shift+Esc) → close browser.">ako pop-up blokira ekran: Task Manager (Ctrl+Shift+Esc) → zatvori browser.</li>
          </ol>
        </div>

        <div class="phase warn">
          <div class="label" data-sr="Ako si već dao daljinski pristup" data-en="If you already gave remote access">Ako si već dao daljinski pristup</div>
          <ol class="steps">
            <li data-sr="<strong>HITNO:</strong> Isključi internet (izvuci kabl ili isključi WiFi)." data-en="<strong>URGENT:</strong> Disconnect internet (pull cable or turn off WiFi)."><strong>HITNO:</strong> Isključi internet (izvuci kabl ili isključi WiFi).</li>
            <li data-sr="deinstaliraj program koji si instalirao (AnyDesk, TeamViewer, LogMeIn)." data-en="uninstall program you installed (AnyDesk, TeamViewer, LogMeIn).">deinstaliraj program koji si instalirao (AnyDesk, TeamViewer, LogMeIn).</li>
            <li data-sr="promeni SVE lozinke sa drugog uređaja (telefon, drugi računar)." data-en="change ALL passwords from different device (phone, another computer).">promeni SVE lozinke sa drugog uređaja (telefon, drugi računar).</li>
            <li data-sr="kontaktiraj banku — blokiraj kartice, proveri transakcije." data-en="contact bank — block cards, check transactions.">kontaktiraj banku — blokiraj kartice, proveri transakcije.</li>
            <li data-sr="skeniraj računar legitimnim antivirusom (Windows Defender je dovoljan)." data-en="scan computer with legitimate antivirus (Windows Defender is enough).">skeniraj računar legitimnim antivirusom (Windows Defender je dovoljan).</li>
          </ol>
        </div>

        <div class="phase warn">
          <div class="label" data-sr="Ako si platio" data-en="If you paid">Ako si platio</div>
          <ol class="steps">
      ...
      <div class="callout"
        data-sr="<strong>Najvažnije:</strong> Microsoft/Apple/Google nikad, nikad, nikad ne zovu ljude da im kažu da im je računar zaražen. Ako te neko zove — to je prevara."
        data-en="<strong>Most important:</strong> Microsoft/Apple/Google never, ever, ever call people to tell them their computer is infected. If someone calls you — it's scam."
      ><strong>Najvažnije:</strong> Microsoft/Apple/Google nikad, nikad, nikad ne zovu ljude da im kažu da im je računar zaražen. Ako te neko zove — to je prevara.</div>
    </section>
