...
window.SCAM_CONTENT["funeral-assistance-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Savetnik nudi brzu proceduru, jeftinije usluge ili pomoć oko dokumentacije uz naknadu unapred, bez stvarnog kontakta sa ustanovama." data-en="An advisor offers fast paperwork, cheaper services, or help with documents for an upfront fee, without real coordination with institutions.">Savetnik nudi brzu proceduru, jeftinije usluge ili pomoć oko dokumentacije uz naknadu unapred, bez stvarnog kontakta sa ustanovama.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Ponuda → dokumenta → uplata → nema usluge." data-en="<strong>Model:</strong> Offer → paperwork → payment → no service."><strong>Model:</strong> Ponuda → dokumenta → uplata → nema usluge.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnom pomoći oko sahrane." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: fake funeral assistance scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnom pomoći oko sahrane.</p>
        <ul class="bullets">
