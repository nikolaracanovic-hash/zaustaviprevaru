...
window.SCAM_CONTENT["medication-substitution-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Online prodavac šalje pogrešan, istekao ili lažan preparat umesto propisanog leka, ili traži uplatu za generik koji nije registrovan." data-en="An online seller ships the wrong, expired, or fake product instead of prescribed medicine, or charges for an unregistered generic.">Online prodavac šalje pogrešan, istekao ili lažan preparat umesto propisanog leka, ili traži uplatu za generik koji nije registrovan.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Cena → uplata → isporuka ne odgovara porudžbini." data-en="<strong>Model:</strong> Price → payment → delivery does not match order."><strong>Model:</strong> Cena → uplata → isporuka ne odgovara porudžbini.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara zamene ili lažnih lekova." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: medication substitution scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara zamene ili lažnih lekova.</p>
        <ul class="bullets">
