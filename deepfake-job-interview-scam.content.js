...
window.SCAM_CONTENT["deepfake-job-interview-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Tokom kratkog poziva lice izgleda kao poznati izvršilac ali pokreti usana i odgovori deluju neprirodno ili generički. Zatim sledi zahtev za hitnu uplatu." data-en="During a short call the face looks like a known executive but lip movement and answers feel unnatural or generic. Then an urgent payment is requested.">Tokom kratkog poziva lice izgleda kao poznati izvršilac ali pokreti usana i odgovori deluju neprirodno ili generički. Zatim sledi zahtev za hitnu uplatu.</p>
      <p data-sr="Pravi poslodavac retko traži uplatu, pristup nalogu ili kod sa kartice pre potpisanog ugovora koji možeš proveriti na javnom kontaktu." data-en="A real employer rarely asks for payment, account access, or a card code before a signed contract you can verify on a public contact.">Pravi poslodavac retko traži uplatu, pristup nalogu ili kod sa kartice pre potpisanog ugovora koji možeš proveriti na javnom kontaktu.</p>
      <div class="callout" data-sr="<strong>Model:</strong> ponuda → brza selekcija → prag (novac ili podaci) → eskalacija → nestanak." data-en="<strong>Model:</strong> offer → fast selection → threshold (money or data) → escalation → disappearance."><strong>Model:</strong> ponuda → brza selekcija → prag (novac ili podaci) → eskalacija → nestanak.</div>
    </section>

    <section class="card">
      <h2 data-sr="Kako generalno radi" data-en="How it generally works">Kako generalno radi</h2>
      <p data-sr="Koristi se autoritet lica na ekranu i kratko trajanje poziva." data-en="On-screen authority and a short call duration are exploited.">Koristi se autoritet lica na ekranu i kratko trajanje poziva.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Poziv traje par minuta bez dubokih pitanja o projektu." data-en="The call lasts minutes without deep project questions.">Poziv traje par minuta bez dubokih pitanja o projektu.</li>
        <li data-sr="Komunikacija ide preko privatnog četa ili ličnog imejla, ne kroz zvanični karijerni portal firme." data-en="Communication runs on private chat or personal email, not the employer’s official careers portal.">Komunikacija ide preko privatnog četa ili ličnog imejla, ne kroz zvanični karijerni portal firme.</li>
        <li data-sr="Traže se dokumenta ili potvrde odmah uz obećanje brzog zaposlenja." data-en="Documents or confirmations are requested immediately with a promise of quick hiring.">Traže se dokumenta ili potvrde odmah uz obećanje brzog zaposlenja.</li>
        <li data-sr="Pritisak da potvrdiš učestvovanje isti dan da ne izgubiš mesto." data-en="Pressure to confirm the same day so you do not lose the spot.">Pritisak da potvrdiš učestvovanje isti dan da ne izgubiš mesto.</li>
          </ul>
        </div>
        <div class="phase">
          <div class="label" data-sr="Gde je prevara" data-en="Where the fraud is">Gde je prevara</div>
          <ul class="bullets">
        <li data-sr="Isti izvršilac na zvaničnom snimku sa konferencije ne koristi isti ton i ne traži novac ovako." data-en="The same executive in an official conference clip does not sound the same or ask for money this way.">Isti izvršilac na zvaničnom snimku sa konferencije ne koristi isti ton i ne traži novac ovako.</li>
        <li data-sr="Uplata na privatni račun, kripto ili darovne kartice." data-en="Payment to a private account, crypto, or gift cards.">Uplata na privatni račun, kripto ili darovne kartice.</li>
        ...
        <li data-sr="Priča o video intervjuj se menja kada tražiš pauzu od 24 sata." data-en="The story about video interview changes when you ask for a 24-hour pause.">Priča o video intervjuj se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za lažnom video intervjuj. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to fake video interview. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za lažnom video intervjuj. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
          ...
          <li data-sr="Signal: ponuda obećava brzu zaradu ili ekskluzivni pristup bez konkretnog opisa posla." data-en="Signal: the offer promises fast pay or exclusive access without concrete duties.">Signal: ponuda obećava brzu zaradu ili ekskluzivni pristup bez konkretnog opisa posla.</li>
          <li data-sr="Signal: jezik je šablon sa sitnim greškama ili generičkim naslovom pozicije." data-en="Signal: language is templated with minor errors or a generic job title.">Signal: jezik je šablon sa sitnim greškama ili generičkim naslovom pozicije.</li>
        </ul>
      ...
      <article class="phase">
        ...
        <p data-sr="Intervju je kratak ili ga nema; odluka stiže brzo. Pitanja su površna i ne proveravaju referencu kod bivšeg poslodavca." data-en="The interview is short or absent; a decision arrives quickly. Questions are shallow and do not verify references with a former employer.">Intervju je kratak ili ga nema; odluka stiže brzo. Pitanja su površna i ne proveravaju referencu kod bivšeg poslodavca.</p>
        <ul class="bullets">
          <li data-sr="Signal: primljeni ste stiže istog dana bez testa ili provere identiteta." data-en="Signal: you are hired arrives the same day without a test or identity check.">Signal: primljeni ste stiže istog dana bez testa ili provere identiteta.</li>
          <li data-sr="Signal: traže se lični podaci i dokumenta pre bilo kakvog pisanog ugovora." data-en="Signal: personal data and documents are requested before any written contract.">Signal: traže se lični podaci i dokumenta pre bilo kakvog pisanog ugovora.</li>
          <li data-sr="Signal: odbijaju video poziv sa jasnom identifikacijom firme." data-en="Signal: they refuse a video call with clear company identification.">Signal: odbijaju video poziv sa jasnom identifikacijom firme.</li>
          <li data-sr="Signal: pritisak da potvrdiš odmah da ne izgubiš mesto." data-en="Signal: pressure to confirm immediately so you do not lose the spot.">Signal: pritisak da potvrdiš odmah da ne izgubiš mesto.</li>
        </ul>
      ...
      <article class="phase warn">
        ...
        <p data-sr="Uvodi se naknada, depozit, administracija ili forma koja traži bankovne ili kartične podatke. Objašnjenje zvuči kao rutina." data-en="A fee, deposit, administration, or form requesting bank or card details is introduced. The explanation sounds routine.">Uvodi se naknada, depozit, administracija ili forma koja traži bankovne ili kartične podatke. Objašnjenje zvuči kao rutina.</p>
        <ul class="bullets">
          ...
          <li data-sr="Signal: naknada mora biti isti dan bez konsultacije sa bankom." data-en="Signal: the fee must be paid the same day without consulting your bank.">Signal: naknada mora biti isti dan bez konsultacije sa bankom.</li>
        </ul>
        <div class="branch">
      ...
      <article class="phase bad">
        ...
        <p data-sr="Posle prve uplate sledi nova taksa, korekcija dokumentacije ili kazna za kašnjenje. Ton postaje tvrđi jer si već ušao u proces." data-en="After the first payment comes another fee, document correction, or late penalty. The tone hardens because you are already invested.">Posle prve uplate sledi nova taksa, korekcija dokumentacije ili kazna za kašnjenje. Ton postaje tvrđi jer si već ušao u proces.</p>
        <ul class="bullets">
          ...
          <li data-sr="Signal: novi nadređeni potvrđuje isti zahtev u drugoj poruci." data-en="Signal: a new supervisor confirms the same demand in another message.">Signal: novi nadređeni potvrđuje isti zahtev u drugoj poruci.</li>
      ...
      <article class="phase bad">
        ...
        <p data-sr="Prikupljeni dokumenti mogu poslužiti za zloupotrebu naloga. Ponekad sledi zadatak preusmeravanja novca ili paketa." data-en="Collected documents may feed account abuse. Sometimes a money- or package-forwarding task follows.">Prikupljeni dokumenti mogu poslužiti za zloupotrebu naloga. Ponekad sledi zadatak preusmeravanja novca ili paketa.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Video se prekida kad tražiš jednostavno pitanje o projektu." data-en="Video drops when you ask a simple project question.">Video se prekida kad tražiš jednostavno pitanje o projektu.</li>
        <li data-sr="Lik ne reaguje na signal da podigneš tri prsta." data-en="The figure does not react when you hold up three fingers.">Lik ne reaguje na signal da podigneš tri prsta.</li>
        <li data-sr="Traži se prenos odmah posle poziva." data-en="A transfer is requested right after the call.">Traži se prenos odmah posle poziva.</li>
        <li data-sr="Poziv ide preko nepoznatog linka, ne korporativnog Meet/Teams poziva." data-en="The invite uses an unknown link, not a corporate Meet/Teams invite.">Poziv ide preko nepoznatog linka, ne korporativnog Meet/Teams poziva.</li>
        <li data-sr="Imejl za zakazivanje nije na domenu firme." data-en="The scheduling email is not on the company domain.">Imejl za zakazivanje nije na domenu firme.</li>
        <li data-sr="Tvrdi se da je to beta AI intervju i da moraš platiti pristup." data-en="You are told it is a beta AI interview and you must pay access.">Tvrdi se da je to beta AI intervju i da moraš platiti pristup.</li>
        <li data-sr="Traže se kodovi sa telefona tokom poziva." data-en="Phone codes are requested during the call.">Traže se kodovi sa telefona tokom poziva.</li>
        <li data-sr="Nema drugog zaposlenog u CC na mejlu." data-en="No other employee is CC’d on email.">Nema drugog zaposlenog u CC na mejlu.</li>
        <li data-sr="Profil koji te zove je nov na mreži." data-en="The profile that contacted you is new online.">Profil koji te zove je nov na mreži.</li>
        <li data-sr="Isti scenario prijavljen je kao prevara na forumima." data-en="The same scenario is reported as fraud on forums.">Isti scenario prijavljen je kao prevara na forumima.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za video intervjuj." data-en="Can I find the same offer on an official site or vacancy for video interview.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za video intervjuj.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Kandidat je impresioniran CEO pozivom. Predložite da zakažu ponovni poziv samo preko mejla sa domena firme i sa živim pitanjem koje CEO mora znati." data-en="The candidate is impressed by a CEO call. Suggest rescheduling only via company-domain email with a live question only the CEO would know.">Kandidat je impresioniran CEO pozivom. Predložite da zakažu ponovni poziv samo preko mejla sa domena firme i sa živim pitanjem koje CEO mora znati.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za lažnom video intervjuj." data-en="Have you ever seen a real employer ask for the same step for fake video interview.">Da li si ikada video da pravi poslodavac traži isti korak za lažnom video intervjuj.</li>
