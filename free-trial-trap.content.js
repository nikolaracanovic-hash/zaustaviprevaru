...
window.SCAM_CONTENT["free-trial-trap"] = {
  raw_html: `
...
<section class="content-section">
  ...
  <div class="phase">
    ...
    <p data-sr="Besplatna proba → unos kartičnih podataka → skriveni uslov pretplate → automatska naplata → otkaz blokiran ili komplikovan → serija naplata → gubitak" data-en="Free trial → card details entered → hidden subscription condition → automatic billing → cancellation blocked or complex → payment series → loss">Besplatna proba → unos kartičnih podataka → skriveni uslov pretplate → automatska naplata → otkaz blokiran ili komplikovan → serija naplata → gubitak</p>
  </div>
  <div class="callout">
    <strong data-sr="Prag:" data-en="Threshold:">Prag:</strong>
    <span data-sr="Unos kartičnih podataka za besplatnu probu je pristanak na automatsku pretplatu — otkaz mora biti potvrđen pre isteka probe, ne posle." data-en="Entering card details for a free trial is consent to automatic subscription — cancellation must be confirmed before the trial ends, not after.">Unos kartičnih podataka za besplatnu probu je pristanak na automatsku pretplatu — otkaz mora biti potvrđen pre isteka probe, ne posle.</span>
  </div>
</section>
...
<section class="content-section">
  ...
  <div class="grid-2">
    <article>
      ...
      <ul class="bullets">
        <li data-sr="Prepoznatljiv brend ili platforma stvara utisak legitimne kompanije." data-en="A recognizable brand or platform creates the impression of a legitimate company.">Prepoznatljiv brend ili platforma stvara utisak legitimne kompanije.</li>
        <li data-sr="Marketinška kopija naglašava vrednost usluge i slobodu otkaza." data-en="Marketing copy emphasizes service value and freedom to cancel.">Marketinška kopija naglašava vrednost usluge i slobodu otkaza.</li>
        <li data-sr="Uslovi korišćenja postoje i formalno su potpisani, ali su dugački i nevidljivi tokom prijave." data-en="Terms of service exist and are formally signed, but are long and invisible during sign-up.">Uslovi korišćenja postoje i formalno su potpisani, ali su dugački i nevidljivi tokom prijave.</li>
        <li data-sr="Potvrda e-poštom referencira pretplatu samo u sitnom tisku ili prilogu." data-en="Confirmation email references subscription only in fine print or an attachment.">Potvrda e-poštom referencira pretplatu samo u sitnom tisku ili prilogu.</li>
      </ul>
    </article>
    <article>
      <h3 data-sr="Kako se uvodi naplata" data-en="How billing is introduced">Kako se uvodi naplata</h3>
      <ul class="bullets">
        <li data-sr="Kartica se naplaćuje automatski prvog dana po isteku probe bez posebnog upozorenja." data-en="The card is charged automatically on the first day after the trial ends without specific warning.">Kartica se naplaćuje automatski prvog dana po isteku probe bez posebnog upozorenja.</li>
        <li data-sr="Otkaz zahteva telefonski poziv ili pisani zahtev koji mora stići određen broj dana pre obnove." data-en="Cancellation requires a phone call or written request that must arrive a set number of days before renewal.">Otkaz zahteva telefonski poziv ili pisani zahtev koji mora stići određen broj dana pre obnove.</li>
        <li data-sr="Čak i posle otkazivanja, servis često nastavlja naplatu s argumentom da je otkaz stigao kasno." data-en="Even after cancellation, the service often continues billing with the argument that cancellation arrived too late.">Čak i posle otkazivanja, servis često nastavlja naplatu s argumentom da je otkaz stigao kasno.</li>
      </ul>
    </article>
  </div>
</section>
...
<section class="content-section">
  ...
  <div class="phase">
    <div class="label" data-sr="Faza 2: Korišćenje probe" data-en="Phase 2: Trial use">Faza 2: Korišćenje probe</div>
    <p data-sr="Meta koristi uslugu tokom probe i ostaje zadovoljna. Nema vidljivih podsećanja na datum isteka niti troška pretplate." data-en="Target uses the service during the trial and remains satisfied. No visible reminders of the expiry date or subscription cost appear.">Meta koristi uslugu tokom probe i ostaje zadovoljna. Nema vidljivih podsećanja na datum isteka niti troška pretplate.</p>
    <ul class="bullets">
  ...
  <div class="phase">
    ...
    <div class="branch">
      ...
      <ul class="bullets">
        <li data-sr="Meta kontaktira banku → chargeback je moguć, ali kompanija može sporiti s pozivom na potpisane uslove." data-en="Target contacts the bank → chargeback is possible, but the company may dispute citing the signed terms.">Meta kontaktira banku → chargeback je moguć, ali kompanija može sporiti s pozivom na potpisane uslove.</li>
  ...
  <div class="phase">
    <div class="label" data-sr="Faza 5: Serija naplata" data-en="Phase 5: Payment series">Faza 5: Serija naplata</div>
    <p data-sr="Bez uspešnog otkaza, naplata se ponavlja mesečno ili godišnje. Svaki pokušaj otkaza nailazi na iste prepreke ili na tvrdnju da je prethodni zahtev bio nevažeći." data-en="Without successful cancellation, billing repeats monthly or annually. Each cancellation attempt hits the same obstacles or the claim that the previous request was invalid.">Bez uspešnog otkaza, naplata se ponavlja mesečno ili godišnje. Svaki pokušaj otkaza nailazi na iste prepreke ili na tvrdnju da je prethodni zahtev bio nevažeći.</p>
    <ul class="bullets">
  ...
  <div class="phase">
    <div class="label" data-sr="Faza 6: Escalacija — pretnje kolekcijom" data-en="Phase 6: Escalation — collection threats">Faza 6: Escalacija — pretnje kolekcijom</div>
    <p data-sr="Ako kartica ne prolazi zbog blokade, servis može angažovati kolekcijsku agenciju ili slati pretnje tužbom za neplaćene pretplate." data-en="If the card fails due to a block, the service may engage a collection agency or send threats of lawsuit for unpaid subscriptions.">Ako kartica ne prolazi zbog blokade, servis može angažovati kolekcijsku agenciju ili slati pretnje tužbom za neplaćene pretplate.</p>
    <ul class="bullets">
...
<section class="content-section">
  ...
  <ul class="bullets">
    <li data-sr="Zahtev za kartičnim podacima za uslugu opisanu kao potpuno besplatnu." data-en="Request for card details for a service described as completely free.">Zahtev za kartičnim podacima za uslugu opisanu kao potpuno besplatnu.</li>
    <li data-sr="Polje za pristanak na pretplatu je unapred označeno ili skriveno na dnu stranice za prijavu." data-en="The subscription consent box is pre-checked or hidden at the bottom of the sign-up page.">Polje za pristanak na pretplatu je unapred označeno ili skriveno na dnu stranice za prijavu.</li>
    <li data-sr="Nema jasnog upozorenja e-poštom 3–7 dana pre isteka probe." data-en="No clear email warning 3–7 days before the trial expires.">Nema jasnog upozorenja e-poštom 3–7 dana pre isteka probe.</li>
    <li data-sr="Otkaz zahteva telefonski poziv umesto klika na dugme u nalogu." data-en="Cancellation requires a phone call rather than clicking a button in the account.">Otkaz zahteva telefonski poziv umesto klika na dugme u nalogu.</li>
    <li data-sr="Kompanija ima brojne pritužbe u recenzijama zbog automatske naplate i blokiranja otkaza." data-en="The company has numerous complaints in reviews about automatic billing and cancellation blocking.">Kompanija ima brojne pritužbe u recenzijama zbog automatske naplate i blokiranja otkaza.</li>
    <li data-sr="Uslovi korišćenja su dostupni samo kao PDF prilog, ne kao jasno vidljiv tekst tokom prijave." data-en="Terms of service are available only as a PDF attachment, not as clearly visible text during sign-up.">Uslovi korišćenja su dostupni samo kao PDF prilog, ne kao jasno vidljiv tekst tokom prijave.</li>
  </ul>
</section>
...
<section class="content-section">
  ...
  <ul class="bullets">
    ...
    <li data-sr="Koristite virtuelnu karticu s limitom za besplatne probe kad je to moguće." data-en="Use a virtual card with a limit for free trials where possible.">Koristite virtuelnu karticu s limitom za besplatne probe kad je to moguće.</li>
    <li data-sr="Proverite izvod kartice narednih 30–45 dana posle registracije za svaku neprepoznatu naplatu." data-en="Check the card statement for the next 30–45 days after registration for any unrecognized charge.">Proverite izvod kartice narednih 30–45 dana posle registracije za svaku neprepoznatu naplatu.</li>
  </ul>
</section>

<section class="content-section">
  <h2 data-sr="Checklista pre unosa kartičnih podataka za besplatnu probu" data-en="Checklist before entering card details for a free trial">Checklista pre unosa kartičnih podataka za besplatnu probu</h2>
  <ul class="bullets">
    <li data-sr="Da li su uslovi korišćenja jasno vidljivi i čitki tokom prijave?" data-en="Are the terms of service clearly visible and readable during sign-up?">Da li su uslovi korišćenja jasno vidljivi i čitki tokom prijave?</li>
    <li data-sr="Da li je polje za saglasnost s pretplatom jasno označeno i prikazano?" data-en="Is the subscription consent box clearly labeled and displayed?">Da li je polje za saglasnost s pretplatom jasno označeno i prikazano?</li>
    <li data-sr="Da li postoji jasno vidljivo dugme za otkaz u korisničkom nalogu?" data-en="Is there a clearly visible cancellation button in the user account?">Da li postoji jasno vidljivo dugme za otkaz u korisničkom nalogu?</li>
    <li data-sr="Da li je kompanija registrovana i ima fizičku adresu?" data-en="Is the company registered and does it have a physical address?">Da li je kompanija registrovana i ima fizičku adresu?</li>
    <li data-sr="Da li postoje nezavisne recenzije kompanije bez pritužbi na lažne naplate?" data-en="Are there independent company reviews without complaints about fraudulent charges?">Da li postoje nezavisne recenzije kompanije bez pritužbi na lažne naplate?</li>
    <li data-sr="Da li znam tačan datum isteka probe i imam li podsetnik?" data-en="Do I know the exact trial expiry date and do I have a reminder set?">Da li znam tačan datum isteka probe i imam li podsetnik?</li>
    <li data-sr="Da li ću moći da otkazem uslugu koristeći samo nalog na sajtu bez telefonskog poziva?" data-en="Will I be able to cancel the service using only the website account without a phone call?">Da li ću moći da otkazem uslugu koristeći samo nalog na sajtu bez telefonskog poziva?</li>
    <li data-sr="Da li koristim virtuelnu karticu ili jednu karticu s niskim limitom za ovu registraciju?" data-en="Am I using a virtual card or a low-limit card for this registration?">Da li koristim virtuelnu karticu ili jednu karticu s niskim limitom za ovu registraciju?</li>
    <li data-sr="Da li sam proverio iznos koji će biti naplaćen prvog dana po isteku probe?" data-en="Have I checked the amount that will be charged on the first day after the trial expires?">Da li sam proverio iznos koji će biti naplaćen prvog dana po isteku probe?</li>
    <li data-sr="Da li znam kontakt za podršku kompanije u slučaju spora?" data-en="Do I know the company support contact in case of a dispute?">Da li znam kontakt za podršku kompanije u slučaju spora?</li>
  </ul>
</section>
...
<section class="content-section">
  ...
  <ul class="bullets">
    <li data-sr="Odmah proverite izvod kartice i identifikujte sve naplate od tog servisa." data-en="Immediately check the card statement and identify all charges from that service.">Odmah proverite izvod kartice i identifikujte sve naplate od tog servisa.</li>
