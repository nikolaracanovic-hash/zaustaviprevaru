...
window.SCAM_CONTENT["funeral-donation-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Prevarant širi priču o porodici koja hitno skuplja sredstva za sahranu i traži brzu donaciju na privatni račun, novčanik ili sumnjiv link koji krade podatke." data-en="A fraudster spreads a story about a family urgently raising funeral funds and asks for a fast donation to a personal account, wallet, or suspicious link that steals data.">Prevarant širi priču o porodici koja hitno skuplja sredstva za sahranu i traži brzu donaciju na privatni račun, novčanik ili sumnjiv link koji krade podatke.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Priča → hitnost → donacija → privatni kanal → gubitak novca ili podataka." data-en="<strong>Model:</strong> Story → urgency → donation → private rails → money or data loss."><strong>Model:</strong> Priča → hitnost → donacija → privatni kanal → gubitak novca ili podataka.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnom donacijom za sahranu." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: fake funeral donation scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnom donacijom za sahranu.</p>
        <ul class="bullets">
