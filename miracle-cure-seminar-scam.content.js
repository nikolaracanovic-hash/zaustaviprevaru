...
window.SCAM_CONTENT["miracle-cure-seminar-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Seminar prodaje revolucionarni tretman uz ulaznicu, paket proizvoda i obećanje izlečenja bez dokaza, često uz pritisak na mesto." data-en="A seminar sells a revolutionary treatment with tickets, product bundles, and cure promises without evidence, often with on-site pressure.">Seminar prodaje revolucionarni tretman uz ulaznicu, paket proizvoda i obećanje izlečenja bez dokaza, često uz pritisak na mesto.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Prezentacija → strah → kupovina na licu mesta." data-en="<strong>Model:</strong> Presentation → fear → on-site purchase."><strong>Model:</strong> Prezentacija → strah → kupovina na licu mesta.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara seminarom čudotvornog leka." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: miracle cure seminar scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara seminarom čudotvornog leka.</p>
        <ul class="bullets">
