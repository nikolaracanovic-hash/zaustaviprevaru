...
window.SCAM_CONTENT["instant-payment-scam"] = {
  raw_html: `
    <section class="card">
      ...
      <p data-sr="Instant plaćanje je platni sistem koji prebacuje novac između bankovnih naloga za sekunde — bez mogućnosti povrata koja postoji kod kreditnih kartica ili klasičnih transfera. Prevara s instant plaćanjem koristi tu nepovratnost kao centralnu karakteristiku: napadač gradi urgentni scenario koji sprečava žrtvu da razmisli, a čim se plaćanje izvrši, novac je zauvek izgubljen bez saradnje primaoca." data-en="Instant payment is a payment system that transfers money between bank accounts within seconds — without the reversal option that exists with credit cards or classic transfers. The instant payment scam uses that irreversibility as its central feature: the attacker builds an urgent scenario preventing the victim from thinking, and once the payment is made, the money is permanently lost without the recipient's cooperation.">Instant plaćanje je nepovratno. Napadač koristi urgentnost da spreči razmišljanje — čim je plaćeno, nema povrata bez saradnje primaoca.</p>
      <p data-sr="Metode uključuju lažnog kupca koji šalje lažnu potvrdu plaćanja pre nego novac zaista stigne (radi isporuke pre primitka), lažni servis koji traži instant depozit za „verifikaciju“, lažnu banku koja instruira „hitni transfer“ ili marketplace prevaru gde kupac pritiska prodavca na instant transfer umesto platforme." data-en="Methods include a fake buyer who sends a fake payment confirmation before money actually arrives (to obtain delivery before receipt), a fake service requesting an instant deposit for 'verification', a fake bank instructing an 'urgent transfer', or a marketplace scam where a buyer pressures a seller into instant transfer instead of the platform.">Varijante: lažna potvrda uplate pre isporuke, lažni depozit za verifikaciju, lažna banka s hitnim transferom, marketplace pritisak na instant.</p>
