...
window.SCAM_CONTENT["free-health-check-sales-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Besplatno merenje pritiska ili skrining u tržnom centru ili na štandu prerasta u agresivnu prodaju suplemenata, paketa ili zakazivanje uz avans." data-en="A free blood pressure check or screening at a mall or booth turns into aggressive supplement sales, packages, or bookings with upfront payment.">Besplatno merenje pritiska ili skrining u tržnom centru ili na štandu prerasta u agresivnu prodaju suplemenata, paketa ili zakazivanje uz avans.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Besplatno → dijagnoza bez lekara → prodaja." data-en="<strong>Model:</strong> Free → non-doctor diagnosis → sales pitch."><strong>Model:</strong> Besplatno → dijagnoza bez lekara → prodaja.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara besplatnom zdravstvenom proverom kao prodajom." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: free health check sales scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara besplatnom zdravstvenom proverom kao prodajom.</p>
        <ul class="bullets">
