...
window.SCAM_CONTENT["fake-celebrity-scam"] = {
  raw_html: `
    <section class="card">
    ...
    <section class="card">
      ...
      <div class="grid-2">
        <div>
          ...
          <ul class="bullets">
            <li data-sr="Nalog kopira profilnu sliku, ime i stil objava prave osobe." data-en="Account copies the profile picture, name and posting style of the real person.">Nalog kopira profilnu sliku, ime i stil objava prave osobe.</li>
            <li data-sr="Poruka je personalizovana — pominje žrtvin sadržaj, komentar ili objavu." data-en="Message is personalised — mentions the victim's content, comment or post.">Poruka je personalizovana — pominje žrtvin sadržaj, komentar ili objavu.</li>
            <li data-sr="Razgovor se razvija postepeno — ne traži se odmah novac." data-en="Conversation develops gradually — money is not requested immediately.">Razgovor se razvija postepeno — ne traži se odmah novac.</li>
            <li data-sr="Napadač koristi detalje iz javnog života prave osobe da razgovor izgleda autentično." data-en="Attacker uses details from the real person's public life to make the conversation appear authentic.">Napadač koristi detalje iz javnog života prave osobe da razgovor izgleda autentično.</li>
          </ul>
        </div>
        <div>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Pronađite zvaničan verifikovani nalog osobe i uporedite ga sa ovim nalogom." data-en="Find the person's official verified account and compare it with this account.">Pronađite zvaničan verifikovani nalog osobe i uporedite ga sa ovim nalogom.</li>
        <li data-sr="Proverite datum kreiranja naloga — lažni nalozi su obično novi." data-en="Check the account creation date — fake accounts are usually new.">Proverite datum kreiranja naloga — lažni nalozi su obično novi.</li>
        <li data-sr="Pretražite poruku na internetu — isti tekst se koristi kod više žrtava." data-en="Search the message online — the same text is used with multiple victims.">Pretražite poruku na internetu — isti tekst se koristi kod više žrtava.</li>
        <li data-sr="Nikad ne šaljite novac osobi sa društvenih mreža bez fizičke verifikacije identiteta." data-en="Never send money to a person from social media without physical identity verification.">Nikad ne šaljite novac osobi sa društvenih mreža bez fizičke verifikacije identiteta.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ol class="bullets">
        <li data-sr="Da li nalog ima plavu verifikaciju na zvaničnoj platformi?" data-en="Does the account have blue verification on the official platform?">Da li nalog ima plavu verifikaciju na zvaničnoj platformi?</li>
        <li data-sr="Da li je ista osoba dostupna na drugoj platformi sa istim verifikovanim nalogom?" data-en="Is the same person available on another platform with the same verified account?">Da li je ista osoba dostupna na drugoj platformi sa istim verifikovanim nalogom?</li>
        <li data-sr="Da li je kontaktiranje baš mene od strane zvezde realistično?" data-en="Is it realistic that this celebrity would specifically contact me?">Da li je kontaktiranje baš mene od strane zvezde realistično?</li>
        <li data-sr="Da li postoji finansijski zahtev — koliko god mali?" data-en="Is there a financial request — however small?">Da li postoji finansijski zahtev — koliko god mali?</li>
        <li data-sr="Da li osoba odbija video poziv u realnom vremenu?" data-en="Does the person refuse a live video call?">Da li osoba odbija video poziv u realnom vremenu?</li>
      </ol>
    </section>
    ...
    <section class="card">
      ...
      <ol class="bullets">
        ...
        <li data-sr="Prijaviti lažni nalog platformi za uklanjanje." data-en="Report the fake account to the platform for removal.">Prijaviti lažni nalog platformi za uklanjanje.</li>
        ...
        <li data-sr="Sačuvati snimke ekrana razgovora kao dokaz." data-en="Save screenshots of the conversation as evidence.">Sačuvati snimke ekrana razgovora kao dokaz.</li>
      </ol>
    </section>
