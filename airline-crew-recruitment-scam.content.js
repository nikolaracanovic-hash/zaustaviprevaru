...
window.SCAM_CONTENT["airline-crew-recruitment-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Lažni trening centar tvrdi saradnju sa aviokompanijom i traži depozit. Zvanični proces ide kroz sajt ili odobrene centre." data-en="A fake training centre claims airline partnership and asks a deposit. Official hiring goes through the site or approved centres.">Lažni trening centar tvrdi saradnju sa aviokompanijom i traži depozit. Zvanični proces ide kroz sajt ili odobrene centre.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se prestiž kabinskog posla i konkurencija." data-en="Cabin crew prestige and competition are exploited.">Koristi se prestiž kabinskog posla i konkurencija.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Obećanje brzog zaposlenja uz minimalnu visinu ili jezik bez testa." data-en="Quick hiring with minimal height or language promises without testing.">Obećanje brzog zaposlenja uz minimalnu visinu ili jezik bez testa.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Karijerni sajt aviokompanije nema istu ponudu ili ime trening centra." data-en="The airline careers site has no matching offer or training centre name.">Karijerni sajt aviokompanije nema istu ponudu ili ime trening centra.</li>
        ...
        <li data-sr="Priča o aviokompaniji se menja kada tražiš pauzu od 24 sata." data-en="The story about the airline changes when you ask for a 24-hour pause.">Priča o aviokompaniji se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za zapošljavanju u aviokompaniji. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to airline hiring. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za zapošljavanju u aviokompaniji. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Trening mora biti plaćen pre poziva na zvanični intervju." data-en="Training must be paid before an official interview invite.">Trening mora biti plaćen pre poziva na zvanični intervju.</li>
        <li data-sr="Cena treninga je neobično visoka za tržište." data-en="Training price is unusually high for the market.">Cena treninga je neobično visoka za tržište.</li>
        <li data-sr="Sertifikat nije na listi koju aviokompanija objavljuje." data-en="The certificate is not on a list the airline publishes.">Sertifikat nije na listi koju aviokompanija objavljuje.</li>
        <li data-sr="Uplata ide na lični račun instruktora." data-en="Payment goes to an instructor’s personal account.">Uplata ide na lični račun instruktora.</li>
        <li data-sr="Traže se fotografije u uniformi pre ugovora." data-en="Uniform photos are requested before a contract.">Traže se fotografije u uniformi pre ugovora.</li>
        <li data-sr="Lažni sajt kopira logo aviokompanije." data-en="A fake site copies the airline logo.">Lažni sajt kopira logo aviokompanije.</li>
        <li data-sr="Nema broja predmeta prijave koji proveravaš kod HR." data-en="There is no application reference you can verify with HR.">Nema broja predmeta prijave koji proveravaš kod HR.</li>
        <li data-sr="Zabrana kontakta sa unionom ili postojećom posadom." data-en="Contact with the union or existing crew is discouraged.">Zabrana kontakta sa unionom ili postojećom posadom.</li>
        <li data-sr="Hitnost jer grupa se puni sutra." data-en="Urgency because the group fills tomorrow.">Hitnost jer grupa se puni sutra.</li>
        <li data-sr="Komunikacija je WhatsApp bez identifikacije." data-en="Communication is WhatsApp without identification.">Komunikacija je WhatsApp bez identifikacije.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za zapošljavanju u aviokompaniji." data-en="Can I find the same offer on an official site or vacancy for airline hiring.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za zapošljavanju u aviokompaniji.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Kandidat želi letenje kao karijeru. Pozovite aviokompaniju na javni careers kontakt." data-en="The candidate wants flying as a career. Call the airline on the public careers contact.">Kandidat želi letenje kao karijeru. Pozovite aviokompaniju na javni careers kontakt.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za zapošljavanju u aviokompaniji." data-en="Have you ever seen a real employer ask for the same step for airline hiring.">Da li si ikada video da pravi poslodavac traži isti korak za zapošljavanju u aviokompaniji.</li>
