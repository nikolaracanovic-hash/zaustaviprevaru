...
window.SCAM_CONTENT["home-caregiver-theft-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Zaposleni ili lažni negovatelj koristi pristup kući da ukrade gotovinu, kartice ili podatke, ili izoluje stariju osobu od porodice radi kontrole finansija." data-en="A hired or fake caregiver uses home access to steal cash, cards, or data, or isolates an older person from family to control finances.">Zaposleni ili lažni negovatelj koristi pristup kući da ukrade gotovinu, kartice ili podatke, ili izoluje stariju osobu od porodice radi kontrole finansija.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Poverenje → pristup → pritisak ili krađa → šteta." data-en="<strong>Model:</strong> Trust → access → pressure or theft → harm."><strong>Model:</strong> Poverenje → pristup → pritisak ili krađa → šteta.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: krađa i zloupotreba poverenja kućnog negovača." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: home caregiver theft and trust abuse scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: krađa i zloupotreba poverenja kućnog negovača.</p>
        <ul class="bullets">
