  ...
  raw_html: `
    ...
    <section class="card">
      ...
      <article class="phase bad">
        ...
        <p data-sr="Karticni podaci se koriste za neovlašćene transakcije. Meta saznaje o krađi iz bankovnih obaveštenja." data-en="Card data is used for unauthorized transactions, sale on the black market, or creation of virtual card copies. The target discovers the theft only from bank notifications about unknown transactions.">Karticni podaci se koriste za neovlašćene transakcije. Meta saznaje o krađi iz bankovnih obaveštenja.</p>
