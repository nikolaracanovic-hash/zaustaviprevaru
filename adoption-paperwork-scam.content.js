...
window.SCAM_CONTENT["adoption-paperwork-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Lažni posrednik ili advokat traži seriju naknada za overe, prevode i hitne takse pre zvaničnog procesa koji on ne vodi." data-en="A fake intermediary or lawyer requests repeated fees for stamps, translations, and urgent charges before an official process they do not control.">Lažni posrednik ili advokat traži seriju naknada za overe, prevode i hitne takse pre zvaničnog procesa koji on ne vodi.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Kontakt → lista naknada → žurba → gubitak." data-en="<strong>Model:</strong> Contact → fee list → rush → loss."><strong>Model:</strong> Kontakt → lista naknada → žurba → gubitak.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara naknadama za dokumenta usvajanja." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: adoption paperwork fee scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara naknadama za dokumenta usvajanja.</p>
        <ul class="bullets">
