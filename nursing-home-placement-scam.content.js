...
window.SCAM_CONTENT["nursing-home-placement-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Agent prodaje garantovano mesto u domu uz nagradu ili avans, bez ugovora sa stvarnom ustanovom i bez proverljivog kontakta." data-en="An agent sells a guaranteed nursing home spot for a fee or advance, without a contract with a real facility and without verifiable contacts.">Agent prodaje garantovano mesto u domu uz nagradu ili avans, bez ugovora sa stvarnom ustanovom i bez proverljivog kontakta.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Hitnost → uplata → mesto ne postoji." data-en="<strong>Model:</strong> Urgency → payment → spot does not exist."><strong>Model:</strong> Hitnost → uplata → mesto ne postoji.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnim smeštajem u dom starosti." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: nursing home placement scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnim smeštajem u dom starosti.</p>
        <ul class="bullets">
