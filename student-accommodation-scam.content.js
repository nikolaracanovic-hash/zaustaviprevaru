...
window.SCAM_CONTENT["student-accommodation-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Oglas ima odlične fotografije i nisku cenu. Traži se depozit da zadržiš sobu jer drugi studenti čekaju." data-en="The ad has great photos and a low price. A deposit is requested to hold the room because other students are waiting.">Oglas ima odlične fotografije i nisku cenu. Traži se depozit da zadržiš sobu jer drugi studenti čekaju.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se žurba pred početak godine." data-en="Rush before the school year starts is exploited.">Koristi se žurba pred početak godine.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Cena je ispod tržišta za lokaciju." data-en="The price is below market for the location.">Cena je ispod tržišta za lokaciju.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Vlasnik odbija video poziv iz stana." data-en="The owner refuses a video call from inside the flat.">Vlasnik odbija video poziv iz stana.</li>
        ...
        <li data-sr="Priča o smeštaju se menja kada tražiš pauzu od 24 sata." data-en="The story about housing changes when you ask for a 24-hour pause.">Priča o smeštaju se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za studentskom smeštaju. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to student housing. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za studentskom smeštaju. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Traži se depozit pre ugovora o zakupu." data-en="Deposit is asked before a lease.">Traži se depozit pre ugovora o zakupu.</li>
        <li data-sr="Vlasnik je u inostranstvu i šalje kurira za ključ." data-en="The owner is abroad and sends a courier for keys.">Vlasnik je u inostranstvu i šalje kurira za ključ.</li>
        <li data-sr="Adresa ne postoji ili je parking." data-en="The address does not exist or is a parking lot.">Adresa ne postoji ili je parking.</li>
        <li data-sr="Isti oglas na više sajtova sa različitim imenima." data-en="The same ad on multiple sites with different names.">Isti oglas na više sajtova sa različitim imenima.</li>
        <li data-sr="Uplata je samo kripto." data-en="Payment is crypto only.">Uplata je samo kripto.</li>
        <li data-sr="Traže se svi novci za prvi semestar odjednom." data-en="All money for the first semester is requested at once.">Traže se svi novci za prvi semestar odjednom.</li>
        <li data-sr="Nema upisnika zemljišnih knjiga ili potvrde stanara." data-en="There is no land-registry excerpt or tenant confirmation.">Nema upisnika zemljišnih knjiga ili potvrde stanara.</li>
        <li data-sr="Pritisak da platiš u roku od jednog sata." data-en="Pressure to pay within one hour.">Pritisak da platiš u roku od jednog sata.</li>
        <li data-sr="Gramatičke greške u ugovoru." data-en="Grammar errors in the contract.">Gramatičke greške u ugovoru.</li>
        <li data-sr="Zabrana obaveštavanja roditelja." data-en="Parents must not be informed.">Zabrana obaveštavanja roditelja.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za studentskom smeštaju." data-en="Can I find the same offer on an official site or vacancy for student housing.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za studentskom smeštaju.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Student traži sobu iz daleka. Predložite video obilazak uživo i odgodu depozita do potpisa pred advokatom ili upravom doma." data-en="The student searches from afar. Suggest a live video tour and delaying deposit until signing with a lawyer or dorm admin.">Student traži sobu iz daleka. Predložite video obilazak uživo i odgodu depozita do potpisa pred advokatom ili upravom doma.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za studentskom smeštaju." data-en="Have you ever seen a real employer ask for the same step for student housing.">Da li si ikada video da pravi poslodavac traži isti korak za studentskom smeštaju.</li>
