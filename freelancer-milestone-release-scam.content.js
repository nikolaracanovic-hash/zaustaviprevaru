...
window.SCAM_CONTENT["freelancer-milestone-release-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Nakon dogovora o poslu klijent traži malu uplatu da aktivira escrow, platni nalog ili depozit dobrih namera van platforme." data-en="After agreeing work, the client asks for a small payment to activate escrow, a payment order, or a goodwill deposit off-platform.">Nakon dogovora o poslu klijent traži malu uplatu da aktivira escrow, platni nalog ili depozit dobrih namera van platforme.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se nepoznavanje pravila freelancing platformi." data-en="Unfamiliarity with freelancing platform rules is exploited.">Koristi se nepoznavanje pravila freelancing platformi.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Projekat deluje dobro plaćen sa malo pitanja o portfoliju." data-en="The project looks well paid with few portfolio questions.">Projekat deluje dobro plaćen sa malo pitanja o portfoliju.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Platforma u svom centru za pomoć kaže da se ne plaća klijentu direktno za otključavanje." data-en="The platform help centre says you do not pay the client directly to unlock funds.">Platforma u svom centru za pomoć kaže da se ne plaća klijentu direktno za otključavanje.</li>
        ...
        <li data-sr="Priča o milestone isplati se menja kada tražiš pauzu od 24 sata." data-en="The story about the milestone changes when you ask for a 24-hour pause.">Priča o milestone isplati se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za isplatu po milestone-u. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to milestone payout. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za isplatu po milestone-u. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Traži se prenos na lični račun jer je platforma spora." data-en="Transfer to a personal account is requested because the platform is slow.">Traži se prenos na lični račun jer je platforma spora.</li>
        <li data-sr="Klijent šalje lažan screenshot isplate." data-en="The client sends a fake payout screenshot.">Klijent šalje lažan screenshot isplate.</li>
        <li data-sr="Komunikacija se prebacuje odmah van platforme." data-en="Communication is moved off-platform immediately.">Komunikacija se prebacuje odmah van platforme.</li>
        <li data-sr="Traže se naknade za porez ili compliance pre isplate." data-en="Tax or compliance fees are requested before payout.">Traže se naknade za porez ili compliance pre isplate.</li>
        <li data-sr="Nalog klijenta je nov sa nultom istorijom." data-en="The client account is new with zero history.">Nalog klijenta je nov sa nultom istorijom.</li>
        <li data-sr="Ponuda krši pravila platforme o plaćanju." data-en="The offer breaks platform payment rules.">Ponuda krši pravila platforme o plaćanju.</li>
        <li data-sr="Traže se pristup tvom nalogu da podesi milestone." data-en="Access to your account is requested to set the milestone.">Traže se pristup tvom nalogu da podesi milestone.</li>
        <li data-sr="Ugovor je samo PDF bez potpisa na platformi." data-en="The contract is only a PDF with no on-platform signature.">Ugovor je samo PDF bez potpisa na platformi.</li>
        <li data-sr="Klijent odbija koristiti zvanični dispute mehanizam." data-en="The client refuses the official dispute mechanism.">Klijent odbija koristiti zvanični dispute mehanizam.</li>
        <li data-sr="Isti korisnik je prijavljen na forumima kao prevara." data-en="The same user is reported on forums as a scam.">Isti korisnik je prijavljen na forumima kao prevara.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za isplatu po milestone-u." data-en="Can I find the same offer on an official site or vacancy for milestone payout.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za isplatu po milestone-u.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Freelancer želi prvi posao. Podsetite da sva plaćanja ostanu unutar platforme dok ne poznaju klijenta." data-en="The freelancer wants a first job. Remind them to keep all payments inside the platform until they know the client.">Freelancer želi prvi posao. Podsetite da sva plaćanja ostanu unutar platforme dok ne poznaju klijenta.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za isplatu po milestone-u." data-en="Have you ever seen a real employer ask for the same step for milestone payout.">Da li si ikada video da pravi poslodavac traži isti korak za isplatu po milestone-u.</li>
