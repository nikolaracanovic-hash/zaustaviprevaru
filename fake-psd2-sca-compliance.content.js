...
window.SCAM_CONTENT["fake-psd2-sca-compliance"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: lažna PSD2 ili SCA provera" data-en="Introduction: fake PSD2 or SCA check">Uvod: lažna PSD2 ili SCA provera</h2>
      <p data-sr="Imejl ili poziv traži hitnu instalaciju aplikacije, probnu uplatu ili deljenje OTP koda pod izgovorom regulatorne obaveze." data-en="Email or call demands urgent app install, test payment, or OTP sharing under regulatory pretense.">Imejl ili poziv traži hitnu instalaciju aplikacije, probnu uplatu ili deljenje OTP koda pod izgovorom regulatorne obaveze.</p>
      <p data-sr="Link ne vodi na domen koji je štampan na kartici ili ugovoru." data-en="Link does not lead to the domain printed on card or contract.">Link ne vodi na domen koji je štampan na kartici ili ugovoru.</p>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
            <li data-sr="Traže da ponovite OTP naglas ili ga ukucate na sajtu koji nije banka." data-en="They ask you to speak OTP aloud or type it on a non-bank site.">Traže da ponovite OTP naglas ili ga ukucate na sajtu koji nije banka.</li>
            <li data-sr="Kažu da će račun biti blokiran ako odbijete SCA ažuriranje." data-en="They say account will be blocked if you refuse SCA update.">Kažu da će račun biti blokiran ako odbijete SCA ažuriranje.</li>
            <li data-sr="Aplikacija traži dozvolu za čitanje SMS poruka drugih aplikacija." data-en="App asks permission to read SMS of other apps.">Aplikacija traži dozvolu za čitanje SMS poruka drugih aplikacija.</li>
            <li data-sr="Generički tekst bez vašeg imena i delimičnog broja računa." data-en="Generic text without your name and partial account number.">Generički tekst bez vašeg imena i delimičnog broja računa.</li>
            <li data-sr="Broj pozivaoca ne odgovara broju na poleđini kartice." data-en="Caller number does not match number on card back.">Broj pozivaoca ne odgovara broju na poleđini kartice.</li>
            <li data-sr="Traže da deaktivirate postojeći token ili aplikaciju banke." data-en="They ask you to deactivate existing bank token or app.">Traže da deaktivirate postojeći token ili aplikaciju banke.</li>
            <li data-sr="Link koristi nedavno registrovan domen." data-en="Link uses a recently registered domain.">Link koristi nedavno registrovan domen.</li>
            <li data-sr="Pritisak da završite tok za tri minuta." data-en="Pressure to finish flow within three minutes.">Pritisak da završite tok za tri minuta.</li>
            <li data-sr="Pitaju za PIN kartice radi navodne migracije na SCA v2." data-en="They ask for card PIN for alleged migration to SCA v2.">Pitaju za PIN kartice radi navodne migracije na SCA v2.</li>
            <li data-sr="Banka na zvaničnoj liniji kaže da nisu slali takav zahtev." data-en="Bank on official line says they did not send such request.">Banka na zvaničnoj liniji kaže da nisu slali takav zahtev.</li>
      </ul>
    </section>
