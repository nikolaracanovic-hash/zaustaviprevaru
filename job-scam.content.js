...
window.SCAM_CONTENT["job-scam"] = {
  raw_html: `
    ...
    <section class="card">
      ...
      <p
        data-sr="Job scam koristi potrebu za poslom kao okidač. Ponuda izgleda primamljivo: visoka plata, rad od kuće, fleksibilno radno vreme, bez iskustva. Proces selekcije je brz i površan. Cilj je ili uplata naknade („obuka", „oprema", „administrativni troškovi") ili prikupljanje ličnih podataka za krađu identiteta."
        data-en="Job scams use the need for work as a trigger. The offer looks attractive: high pay, work from home, flexible hours, no experience needed. The selection process is fast and superficial. The goal is either fee payment ("training", "equipment", "admin costs") or collecting personal data for identity theft."
      >Job scam koristi potrebu za poslom kao okidač. Ponuda izgleda primamljivo: visoka plata, rad od kuće, fleksibilno radno vreme, bez iskustva. Proces selekcije je brz i površan. Cilj je ili uplata naknade („obuka", „oprema", „administrativni troškovi") ili prikupljanje ličnih podataka za krađu identiteta.</p>
    ...
    <section class="card">
      ...
      <div class="grid-2">
        <div class="phase">
          ...
          <ul class="bullets">
            <li data-sr="„unos podataka" data-en=""data entry", "app testing", "reviews"">„unos podataka", „testiranje aplikacija", „recenzije"</li>
            ...
            <li data-sr="uplata za „pristup platformi" data-en="payment for "platform access" or "starter kit"">uplata za „pristup platformi" ili „startni paket"</li>
            <li data-sr="ponuđač: „garantovana zarada" data-en="offerer: "guaranteed income", "unlimited positions"">ponuđač: „garantovana zarada", „beskonačan broj pozicija"</li>
          </ul>
        </div>
        <div class="phase">
          <div class="label" data-sr="Pozicija u inostranstvu" data-en="Position abroad">Pozicija u inostranstvu</div>
          <ul class="bullets">
            <li data-sr="rad u UAE, Nemačkoj, Kanadi, Katar, Saudijska Arabija" data-en="work in UAE, Germany, Canada, Qatar, Saudi Arabia">rad u UAE, Nemačkoj, Kanadi, Katar, Saudijska Arabija</li>
        ...
        <div class="phase">
          <div class="label" data-sr="„Task-based" data-en=""Task-based" job (click farming)">„Task-based" posao (click farming)</div>
          <ul class="bullets">
            ...
            <li data-sr="zatim: „depozit za veće zadatke" data-en="then: "deposit for bigger tasks", "nadogradnju to premium"">zatim: „depozit za veće zadatke", „nadogradnju na premium"</li>
        ...
        <div class="phase">
          <div class="label" data-sr="Money mule / „finansijski agent""" data-en="Money mule / "financial agent"">Money mule / „finansijski agent"</div>
          <ul class="bullets">
            ...
            <li data-sr="„provizija" data-en=""commission" of 5–15% per transaction">„provizija" od 5–15% za svaku transakciju</li>
            ...
            <li data-sr="izgovor: „transferi za međunarodne klijente" data-en="excuse: "transfers for international clients", "temporary bank issue"">izgovor: „transferi za međunarodne klijente", „privremeni problem sa bankom"</li>
            <li data-sr="žrtva postaje prvi trag u istrazi, novac ukraden iz fišing/ransomware napada" data-en="victim becomes first lead in investigation, money stolen from phishing/ransomware attacks">žrtva postaje prvi trag u istrazi, novac ukraden iz fišing/ransomware napada</li>
          </ul>
        </div>
        <div class="phase">
          ...
          <ul class="bullets">
            <li data-sr="ponuda: „ekskluzivan pristup tržištu rada" data-en="offer: "exclusive job market access", "partners: known companies"">ponuda: „ekskluzivan pristup tržištu rada", „partneri: poznate firme"</li>
        ...
        <div class="phase">
          <div class="label" data-sr="Crypto / NFT / Web3 job scams" data-en="Crypto / NFT / Web3 job scams">Crypto / NFT / Web3 job scams</div>
          <ul class="bullets">
            <li data-sr="pozicije: community manager, moderator Discord/Telegram, tester NFT igre" data-en="positions: community manager, Discord/Telegram moderator, NFT game tester">pozicije: community manager, moderator Discord/Telegram, tester NFT igre</li>
            ...
            <li data-sr="zahtev: wallet, provera identiteta dokumenti, lični podaci za „plaćanje""" data-en="requirement: wallet, provera identiteta documents, personal data for "payment"">zahtev: wallet, provera identiteta dokumenti, lični podaci za „plaćanje"</li>
            <li data-sr="zatim: fišing link, drained wallet, krađa identiteta" data-en="then: phishing link, drained wallet, identity theft">zatim: fišing link, drained wallet, krađa identiteta</li>
          </ul>
        </div>
        <div class="phase">
          <div class="label" data-sr="Pyramid/MLM prerušen u job offer" data-en="Pyramid/MLM disguised as job offer">Pyramid/MLM prerušen u job offer</div>
          <ul class="bullets">
            <li data-sr="ponuda: „poslovni partner" data-en="offer: "business partner", "independent associate", "team manager"">ponuda: „poslovni partner", „samostalni saradnik", „menadžer tima"</li>
            ...
            <li data-sr="početni paket: 100–500 EUR za „startni inventar" data-en="starter pack: €100–500 for "starter inventory", "training", "licenses"">početni paket: 100–500 EUR za „startni inventar", „obuka", „licence"</li>
        ...
        <div class="phase">
          <div class="label" data-sr="Package forwarding / reshipping scam" data-en="Package forwarding / reshipping scam">Package forwarding / reshipping scam</div>
          <ul class="bullets">
            ...
            <li data-sr="izgovor: „kompanija koristi individualce za logistiku" data-en="excuse: "company uses individuals for logistics", "no costs for you"">izgovor: „kompanija koristi individualce za logistiku", „bez troškova za tebe"</li>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <ul class="bullets">
          ...
          <li data-sr="„primljeni ste" data-en=""you're hired" without reference check">„primljeni ste" bez provere referenci</li>
        </ul>
      </article>
      ...
      <article class="phase warn">
        ...
        <div class="grid-2">
          <div class="phase">
            ...
            <ul class="bullets">
              <li data-sr="„obuka" data-en=""training" — €100–500">„obuka" — 100–500 EUR</li>
              <li data-sr="„oprema/softver" data-en=""equipment/software" — €50–200">„oprema/softver" — 50–200 EUR</li>
              <li data-sr="„sertifikat" data-en=""certificate" — €100–300">„sertifikat" — 100–300 EUR</li>
              <li data-sr="„administrativni troškovi""" data-en=""administrative costs"">„administrativni troškovi"</li>
            </ul>
          </div>
          <div class="phase">
        ...
        <div class="branch">
          ...
          <ul class="bullets">
            <li data-sr="<strong>Uplata unapred:</strong> naknada za nepostojeće usluge ili „obradu“. (Povezano: <a href='advance-fee-fraud.html'>Uplata unapred</a>)" data-en="<strong>Advance-fee:</strong> fees for non-existent services. (Related: <a href='advance-fee-fraud.html'>Advance-fee</a>)"><strong>Uplata unapred:</strong> naknada za nepostojeće usluge ili „obradu“. (Povezano: <a href="advance-fee-fraud.html">Uplata unapred</a>)</li>
            <li data-sr="<strong>Fišing:</strong> lažna forma ili kopija sajta za unos lozinke i ličnih podataka. (Povezano: <a href='phishing.html'>Fišing</a>)" data-en="<strong>Phishing:</strong> a fake form or cloned site used to capture passwords and personal data. (Related: <a href='phishing.html'>Phishing</a>)"><strong>Fišing:</strong> lažna forma ili kopija sajta za unos lozinke i ličnih podataka. (Povezano: <a href="phishing.html">Fišing</a>)</li>
          </ul>
        </div>
      </article>
    ...
    <section class="card">
      <h2 data-sr="Crvene zastavice (50+ signala prepoznavanja)" data-en="Znakovi prevare (50+ recognition signals)">
      ...
      <div class="grid-2">
        <div class="phase">
          ...
          <ul class="bullets">
            <li data-sr="plata 2–3× iznad tržišnog proeka za poziciju" data-en="salary 2–3× above market average for position">plata 2–3× iznad tržišnog proeka za poziciju</li>
            <li data-sr="„bez iskustva" data-en=""no experience", "everyone qualified", "quick start"">„bez iskustva", „svi kvalifikovani", „brz početak"</li>
            <li data-sr="rad-zarada omjer ne funkcioniše: 2h dnevno za 1500 EUR" data-en="work-pay ratio doesn't work: 2h daily for €1500">rad-zarada omjer ne funkcioniše: 2h dnevno za 1500 EUR</li>
            <li data-sr="firma nema LinkedIn, sajt nov (< 3 meseca), adresa vodi u parkiralište" data-en="company has no LinkedIn, site new (< 3 months), address leads to parking lot">firma nema LinkedIn, sajt nov (< 3 meseca), adresa vodi u parkiralište</li>
            ...
            <li data-sr="gramatičke greške, loš prevod, copy-paste tekst" data-en="grammatical errors, poor translation, copy-paste text">gramatičke greške, loš prevod, copy-paste tekst</li>
            <li data-sr="hitnost: „pozicija puni se brzo" data-en="urgency: "position filling fast", "only first 50 candidates"">hitnost: „pozicija puni se brzo", „samo prvih 50 kandidata"</li>
            ...
            <li data-sr="„rad sa kriptovalutama" data-en=""work with crypto", "NFT project", "DeFi platform" — without verifiable project">„rad sa kriptovalutama", „NFT projekat", „DeFi platforma" — bez proverljivog projekta</li>
            ...
            <li data-sr="„ekskluzivna prilika" data-en=""exclusive opportunity", "privileged access", "closed group"">„ekskluzivna prilika", „povlašćen pristup", „zatvorena grupa"</li>
          </ul>
        </div>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
            ...
            <li data-sr="pitanja generička: „zašto želiš posao" data-en="questions generic: "why do you want the job", "how many hours can you work"">pitanja generička: „zašto želiš posao", „koliko sati možeš raditi"</li>
            ...
            <li data-sr="„primljen si" data-en=""you're hired" without CV check, references, diplomas">„primljen si" bez provere CV, referenci, diploma</li>
            <li data-sr="uplata tražena odmah: „obuka sutra" data-en="payment requested immediately: "training tomorrow", "start today"">uplata tražena odmah: „obuka sutra", „startuj danas"</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
            <li data-sr="pritisak: „ograničeno vreme" data-en="pressure: "limited time", "opportunity lost", "other candidates waiting"">pritisak: „ograničeno vreme", „gubi se prilika", „drugi kandidati čekaju"</li>
            <li data-sr="izbegavaju direktne odgovore: „detalji posle uplate" data-en="avoid direct answers: "details after payment", "everything in contract"">izbegavaju direktne odgovore: „detalji posle uplate", „sve piše u ugovoru"</li>
        ...
        <div class="phase warn">
          ...
          <ul class="bullets">
            ...
            <li data-sr="traže da instalirate daljinski pristup softver (TeamViewer, AnyDesk)" data-en="they ask you to install kontrola računara software (TeamViewer, AnyDesk)">traže da instalirate kontrola računara softver (TeamViewer, AnyDesk)</li>
          </ul>
        </div>
      </div>
    ...
    <section class="card">
      <h2 data-sr="Identity theft: šta dešava sa tvojim podacima" data-en="Identity theft: what happens with your data">
        Identity theft: šta dešava sa tvojim podacima
      </h2>
