...
window.SCAM_CONTENT["fake-call-scam"] = {
  raw_html: `
    ...
    <section class="card">
      ...
      <p
        data-sr="Maska poziva se menja: banka, policija, kurirska služba, platforma, operater, „bezbednosni tim“. Identitet služi kao ambalaža. Mehanika ostaje ista: zadržavanje mete na liniji, izolacija od provere, ubrzavanje radnji, izvlačenje autorizacije. Autoritet je sredstvo za prelazak praga, ne dokaz legitimnosti."
      ...
      >Maska poziva se menja: banka, policija, kurirska služba, platforma, operater, „bezbednosni tim“. Identitet služi kao ambalaža. Mehanika ostaje ista: zadržavanje mete na liniji, izolacija od provere, ubrzavanje radnji, izvlačenje autorizacije. Autoritet je sredstvo za prelazak praga, ne dokaz legitimnosti.</p>
      ...
      <div class="callout"
        data-sr="<strong>Model:</strong> poziv + autoritet → incident + rok → kontrola razgovora → prag (OTP/potvrda/daljinski pristup/uplata) → serijske posledice → presvlačenje identiteta → talas prevare povraćaja."
      ...
      ><strong>Model:</strong> poziv + autoritet → incident + rok → kontrola razgovora → prag (OTP/potvrda/daljinski pristup/uplata) → serijske posledice → presvlačenje identiteta → talas prevare povraćaja.</div>
    </section>
    ...
    <section class="card">
      ...
      <!-- FAZA 1 -->
      <article class="phase">
        <h3 class="phase-title" data-sr="Faza 1 — Kontakt: poziv kao ulaz" data-en="Phase 1 — Contact: the call as entry">Faza 1 — Kontakt: poziv kao ulaz</h3>
        ...
        <div class="grid-2">
          ...
          <div class="phase">
            ...
            <ul class="bullets">
              ...
              <li data-sr="prelaz na „korak 1“ bez provere identiteta." data-en="more to “step 1” without identity verification.">prelaz na „korak 1“ bez provere identiteta.</li>
            </ul>
          </div>
        </div>
      ...
      <!-- FAZA 2 -->
      <article class="phase">
        <h3 class="phase-title" data-sr="Faza 2 — Autoritet i sigurnost" data-en="Phase 2 — Authority and certainty">Faza 2 — Autoritet i sigurnost</h3>
      ...
      <!-- FAZA 3 -->
      <article class="phase">
        <h3 class="phase-title" data-sr="Faza 3 — Kontrola razgovora" data-en="Phase 3 — Conversation control">Faza 3 — Kontrola razgovora</h3>
        ...
        <div class="branch">
          ...
          <ul class="bullets">
            <li><strong>Fišing link:</strong> tokom poziva stiže link ka „verifikaciji“. Cilj: login, kartica, OTP. (Povezano: <a href="phishing.html">Fišing</a>).</li>

            <li><strong>SMS prevara nastavak:</strong> SMS sa linkom dok je meta na liniji. Cilj: klik bez pauze. (Povezano: <a href="smishing.html">Smišing</a>).</li>
          </ul>
        </div>

        <div class="callout"
          data-sr="<strong>Prag faze:</strong> meta ostaje na liniji i ulazi u „izvršavanje“, bez nezavisne provere."
          data-en="<strong>Threshold:</strong> the target stays on the line and enters execution more without independent verification."
        ><strong>Prag faze:</strong> meta ostaje na liniji i ulazi u „izvršavanje“, bez nezavisne provere.</div>
      </article>

      <!-- FAZA 4 -->
      <article class="phase warn">
        <h3 class="phase-title" data-sr="Faza 4 — Incident + rok" data-en="Phase 4 — Incident + deadline">Faza 4 — Incident + rok</h3>
      ...
      <article class="phase bad">
        <h3 class="phase-title" data-sr="Faza 5 — Prag (autorizacija)." data-en="Phase 5 — Threshold (authorization).">Faza 5 — Prag (autorizacija)</h3>
        ...
        <div class="grid-2">
          <div class="phase">
            ...
            <ul class="bullets">
              ...
              <li data-sr="transfer: „prebacite na siguran račun." data-en="transfer: “more to a safe account”">transfer: „prebacite na siguran račun“.</li>
            </ul>
          </div>
        ...
        <div class="branch">
          ...
          <ul class="bullets">
            ...
            <li><strong>Advance-fee:</strong> „takse“ kao uslov za „rešenje“ incidenta. (Povezano: <a href="advance-fee-fraud.html">Uplata unapred</a>).</li>
          </ul>
        </div>
      </article>
      ...
      <!-- FAZA 6 -->
      <article class="phase bad">
        <h3 class="phase-title" data-sr="Faza 6 — Serijske posledice" data-en="Phase 6 — Cascading consequences">Faza 6 — Serijske posledice</h3>
      ...
      <!-- FAZA 7 -->
      <article class="phase warn">
        <h3 class="phase-title" data-sr="Faza 7 — Pritisak i zatvaranje izlaza" data-en="Phase 7 — Pressure and locking the exit">Faza 7 — Pritisak i zatvaranje izlaza</h3>
      ...
      <!-- FAZA 8 -->
      <article class="phase bad">
        <h3 class="phase-title" data-sr="Faza 8 — Mutacije" data-en="Phase 8 — Mutations">Faza 8 — Mutacije</h3>
        ...
        <div class="branch">
          ...
          <ul class="bullets">
            <li><strong>Fišing:</strong> portal i forma za podatke. (Povezano: <a href="phishing.html">Fišing</a>).</li>

            <li><strong>SMS prevara:</strong> SMS link kao nastavak incidenta. (Povezano: <a href="smishing.html">Smišing</a>).</li>

            <li><strong>Advance-fee:</strong> „trošak obrade“ kao uslov. (Povezano: <a href="advance-fee-fraud.html">Uplata unapred</a>).</li>
          </ul>
        </div>
      </article>
      ...
      <!-- FAZA 9 -->
      <article class="phase warn">
        <h3 class="phase-title" data-sr="Faza 9 — Talas prevare povraćaja" data-en="Phase 9 — Recovery wave">Faza 9 — Talas prevare povraćaja</h3>
    ...
    <section class="card">
      ...
      <div class="grid-2">
        ...
        <div class="phase">
          ...
          <ul class="bullets">
            <li data-sr="starost 60+: 45% žrtava, 65% ukupnog gubitka." data-en="age 60+: 45% of victims, 65% of total loss.">starost 60+: 45% žrtava, 65% ukupnog gubitka.</li>
            <li data-sr="prosečan gubitak 60+: $4,800 (naspram $1,600 za 18-59)." data-en="average loss 60+: $4,800 (vs $1,600 for 18-59).">prosečan gubitak 60+: $4,800 (naspram $1,600 za 18-59).</li>
            <li data-sr="razlog: navika poverenja u telefon, poslušnost autoritetu i izolacija." data-en="reason: phone trust legacy + authority compliance + isolation.">razlog: navika poverenja u telefon, poslušnost autoritetu i izolacija.</li>
            <li data-sr="polna raspodela: 58% žene, 42% muškarci (bankarski/državni pozivi)." data-en="gender split: 58% female, 42% male (bank/government calls).">polna raspodela: 58% žene, 42% muškarci (bankarski/državni pozivi).</li>
            <li data-sr="vršno vreme: ponedeljak 10-12h, utorak 14-16h (radno vreme)." data-en="peak timing: Monday 10am-12pm, Tuesday 2-4pm (business hours).">vršno vreme: ponedeljak 10-12h, utorak 14-16h (radno vreme).</li>
        ...
        <div class="phase">
          <div class="label" data-sr="Tipovi poziva (raspodela)." data-en="Call types (distribution).">Tipovi poziva (raspodela)</div>
          <ul class="bullets">
            <li data-sr="banka/upozorenje na prevaru: 35% svih lažnih poziva (najveća uspešnost)." data-en="bank/fraud alert: 35% of all fake calls (highest conversion).">banka/upozorenje na prevaru: 35% svih lažnih poziva (najveća uspešnost).</li>
            <li data-sr="lažna tehnička podrška: 25% (fokus na daljinski pristup)." data-en="tech support: 25% (remote-access focus).">lažna tehnička podrška: 25% (fokus na daljinski pristup).</li>
            <li data-sr="državne institucije/IRS/SSA: 20% (sezonski vrhovi april-maj)." data-en="government/IRS/SSA: 20% (seasonal peaks April-May).">državne institucije/IRS/SSA: 20% (sezonski vrhovi april-maj).</li>
            <li data-sr="dostava/paket: 10% (veza sa SMS prevarama)." data-en="delivery/package: 10% (links to smishing).">dostava/paket: 10% (veza sa SMS prevarama).</li>
            <li data-sr="ostalo (komunalije, osiguranje, humanitarne akcije): 10%." data-en="other (utility, insurance, charity): 10%">ostalo (komunalije, osiguranje, humanitarne akcije): 10%.</li>
          </ul>
        </div>

        <div class="phase">
          <div class="label" data-sr="Ishodi i metrike" data-en="Outcome metrics">Ishodi i metrike</div>
          <ul class="bullets">
            ...
            <li data-sr="stopa zadržavanja: 30-40% (od odgovora, 30-40% ostane na liniji duže od jednog minuta)." data-en="engagement rate: 30-40% (of answers, 30-40% stay on the line 1+ min).">stopa zadržavanja: 30-40% (od odgovora, 30-40% ostane na liniji duže od jednog minuta).</li>
            <li data-sr="uspešnost prevare (data autorizacija): 5-10% od poziva koji su zadržali metu." data-en="scam success rate (authorization given): 5-10% of engaged calls.">uspešnost prevare (data autorizacija): 5-10% od poziva koji su zadržali metu.</li>
            <li data-sr="ROI za operatera: oko 100:1 (trošak poziva naspram prosečnog gubitka žrtve)." data-en="ROI for operator: ~100:1 (call costs vs avg victim loss).">ROI za operatera: oko 100:1 (trošak poziva naspram prosečnog gubitka žrtve).</li>
            <li data-sr="tok vremena: 70% štete nastane u prvom pozivu, 30% u naknadnom pozivu." data-en="timeline: 70% of damage in first call, 30% in follow-up.">tok vremena: 70% štete nastane u prvom pozivu, 30% u naknadnom pozivu.</li>
            <li data-sr="ponovno gađanje: 50% žrtava dobija novi poziv u roku od 72 sata." data-en="repeat targeting: 50% of victims get follow-up call within 72h.">ponovno gađanje: 50% žrtava dobija novi poziv u roku od 72 sata.</li>
          </ul>
        </div>
      </div>
    ...
    <section class="card">
      <h2 data-sr="Automatski pozivi: kako zovu milione ljudi" data-en="Automated calls: how they call millions of people">Automatski pozivi: kako zovu milione ljudi</h2>
      ...
      <div class="grid-2">
        <div class="phase">
          ...
          <ul class="bullets">
            <li data-sr="automatski birač: softver pravi 100-1,000 poziva istovremeno." data-en="auto-dialer: software makes 100-1,000 calls simultaneously.">automatski birač: softver pravi 100-1,000 poziva istovremeno.</li>
            <li data-sr="unapred snimljena poruka: upozorenje banke, poresko upozorenje, lažna tehnička podrška." data-en="pre-recorded message: bank alert, IRS warning, tech support.">unapred snimljena poruka: upozorenje banke, poresko upozorenje, lažna tehnička podrška.</li>
            <li data-sr="„pritisnite 1 za nastavak“: mehanizam filtriranja ko je spreman da reaguje." data-en="press 1 to continue: filtering mechanism (who's ready to respond).">„pritisnite 1 za nastavak“: mehanizam filtriranja ko je spreman da reaguje.</li>
            <li data-sr="prebacivanje na živog operatera: meta koja pritisne 1 dobija ljudskog operatera." data-en="transfer to live operator: target who presses 1 gets human operator.">prebacivanje na živog operatera: meta koja pritisne 1 dobija ljudskog operatera.</li>
        ...
        <div class="phase">
          <div class="label" data-sr="Efikasnost filtriranja automatskog sistema poziva" data-en="automated call system filtering efficiency">Efikasnost filtriranja automatskog sistema poziva</div>
          <ul class="bullets">
            ...
            <li data-sr="700 odgovora → 200 pritisne taster (28% zadržavanja)." data-en="700 answers → 200 press a button (28% engagement).">700 odgovora → 200 pritisne taster (28% zadržavanja).</li>
            ...
            <li data-sr="operater dobija samo mete koje su već pokazale spremnost." data-en="operator gets ONLY targets who already showed willingness.">operater dobija samo mete koje su već pokazale spremnost.</li>
          </ul>
        </div>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
            <li data-sr="ne odgovaraj na nepoznate brojeve - pusti ih na govornu poštu." data-en="DON'T answer unknown numbers - push to voicemail.">ne odgovaraj na nepoznate brojeve - pusti ih na govornu poštu.</li>
            <li data-sr="ne pritiskaj tastere (1, 9) - to potvrđuje da je broj aktivan." data-en="DON'T press a buttons (1, 9) - confirms the number is active.">ne pritiskaj tastere (1, 9) - to potvrđuje da je broj aktivan.</li>
            ...
            <li data-sr="porodični hitni protokol: proveri kroz drugi kanal (SMS, povratni poziv)." data-en="family emergency protocol: verify through SECOND channel (SMS, callback).">porodični hitni protokol: proveri kroz drugi kanal (SMS, povratni poziv).</li>
          </ul>
        </div>
      </div>
...
<section class="content-section">
  ...
  <ul class="bullets">
    ...
    <li><a href="tech-support-scam.html" data-sr="Prevara tehničke podrške" data-en="Tech support scam">Prevara tehničke podrške</a></li>
