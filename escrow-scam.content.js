...
<section class="content-section">
  ...
  <div class="phase">
    ...
    <div class="callout" data-sr="Prag faze: Verifikujte status escrow uplate direktno na sajtu servisa, ne samo putem e-pošte." data-en="Phase threshold: Verify the escrow payment status directly on the service's website, not just via email."><strong>Prag faze:</strong> Verifikujte status escrow uplate direktno na sajtu servisa, ne samo putem e-pošte.</div>
  </div>
  ...
  <div class="phase">
    ...
    <div class="callout" data-sr="Prag faze: Pokrenite chargeback odmah — ne plaćajte dodatne naknade escrow-u koji ne može osloboditi vaše vlasne fondove." data-en="Phase threshold: Initiate a chargeback immediately — do not pay additional fees to an escrow that cannot release your own funds."><strong>Prag faze:</strong> Pokrenite chargeback odmah — ne plaćajte dodatne naknade escrow-u koji ne može osloboditi vaše vlastite fondove.</div>
  </div>
...
<section class="content-section">
  ...
  <ul class="bullets">
    ...
    <li data-sr="Pomozi osobi da pokrene chargeback i prijavi slučaj financijskim regulatorima odmah." data-en="Help the person initiate a chargeback and report the case to financial regulators immediately.">Pomozi osobi da pokrene chargeback i prijavi slučaj finansijskim regulatorima odmah.</li>
  </ul>
</section>
...
<section class="content-section">
  ...
  <ul class="bullets">
    <li><a href="real-estate-purchase-scam.html" data-sr="Prevara kupovinom nekretnine — escrow u transakcijama nekretnina" data-en="Real estate purchase scam — escrow in property transactions">Prevara kupovinom nekretnine — escrow u transakcijama nekretnina</a></li>
    <li><a href="social-media-shop-scam.html" data-sr="Prevara na društvenim mrežama — predlog lažnog escrow-a u offline kupovini" data-en="Social media shop scam — fake escrow proposal in offline purchases">Prevara na društvenim mrežama — predlog lažnog escrow-a u offline kupovini</a></li>
    <li><a href="marketplace-scam.html" data-sr="Prevara na tržištu — kontekst van platforme i escrow predlozi" data-en="Marketplace scam — off-platform context and escrow proposals">Prevara na tržištu — kontekst van platforme i escrow predlozi</a></li>
    <li><a href="advance-fee-fraud.html" data-sr="Prevara avansnom naknadom — naknade za oslobađanje sredstava" data-en="Advance fee fraud — fees for releasing funds">Prevara avansnom naknadom — naknade za oslobađanje sredstava</a></li>
  </ul>
</section>
`
};
