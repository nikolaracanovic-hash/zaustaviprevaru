...
window.SCAM_CONTENT["fake-lab-result-phishing"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Obaveštenje tvrdi da je nalaz spreman ili abnormalan i traži prijavu na lažnom portalu radi preuzimanja PDF-a ili plaćanja, što krade pristupne podatke." data-en="A notice claims results are ready or abnormal and asks you to sign in on a fake portal to download a PDF or pay, stealing login or card data.">Obaveštenje tvrdi da je nalaz spreman ili abnormalan i traži prijavu na lažnom portalu radi preuzimanja PDF-a ili plaćanja, što krade pristupne podatke.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Obaveštenje → strah ili žurba → link → lažni portal." data-en="<strong>Model:</strong> Notice → fear or rush → link → fake portal."><strong>Model:</strong> Obaveštenje → strah ili žurba → link → lažni portal.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: fišing lažnih laboratorijskih nalaza." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: fake lab result phishing.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: fišing lažnih laboratorijskih nalaza.</p>
        <ul class="bullets">
