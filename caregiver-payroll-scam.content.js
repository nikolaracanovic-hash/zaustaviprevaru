...
window.SCAM_CONTENT["caregiver-payroll-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Lažni poslodavac za negu traži naknadu za uniformu, obuku, proveru ili softver pre prvog dana rada, a posao ne postoji." data-en="A fake care employer charges for a uniform, training, checks, or software before the first day of work, while the job does not exist.">Lažni poslodavac za negu traži naknadu za uniformu, obuku, proveru ili softver pre prvog dana rada, a posao ne postoji.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Oglas → intervju → naknada unapred → tišina." data-en="<strong>Model:</strong> Listing → interview → upfront fee → silence."><strong>Model:</strong> Oglas → intervju → naknada unapred → tišina.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnim poslom negovača ili platnom listom." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: caregiver payroll scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnim poslom negovača ili platnom listom.</p>
        <ul class="bullets">
