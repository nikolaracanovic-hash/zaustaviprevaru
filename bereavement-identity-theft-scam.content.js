...
window.SCAM_CONTENT["bereavement-identity-theft-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Prevarant koristi javne osmrtnice ili objave na mreži da kontaktira ožalošćene sa lažnim računom, ažuriranjem podataka ili nasledstvom." data-en="A fraudster uses public obituaries or social posts to contact grieving relatives with fake bills, data updates, or inheritance claims.">Prevarant koristi javne osmrtnice ili objave na mreži da kontaktira ožalošćene sa lažnim računom, ažuriranjem podataka ili nasledstvom.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Javni podatak → kontakt → forma ili uplata → krađa." data-en="<strong>Model:</strong> Public data → contact → form or payment → theft."><strong>Model:</strong> Javni podatak → kontakt → forma ili uplata → krađa.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: krađa identiteta posle žalosti ili smrti u porodici." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: bereavement identity theft scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: krađa identiteta posle žalosti ili smrti u porodici.</p>
        <ul class="bullets">
