...
window.SCAM_CONTENT["pet-adoption-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Oglas za besplatno ili jeftino štene traži depozit, transport ili osiguranje unapred, a životinja ne postoji ili nikad ne stiže." data-en="A listing for a free or cheap pet asks for a deposit, shipping, or insurance upfront, while the animal does not exist or never arrives.">Oglas za besplatno ili jeftino štene traži depozit, transport ili osiguranje unapred, a životinja ne postoji ili nikad ne stiže.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Oglas → privatni chat → naknada unapred → nestanak prodavca." data-en="<strong>Model:</strong> Listing → private chat → upfront fee → seller disappears."><strong>Model:</strong> Oglas → privatni chat → naknada unapred → nestanak prodavca.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnim usvajanjem ljubimca." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: pet adoption scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnim usvajanjem ljubimca.</p>
        <ul class="bullets">
