...
window.SCAM_CONTENT["fake-copyright-strike-removal"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Stiže imejl ili poruka koja izgleda kao platforma i tvrdi da moraš platiti taksi ili potvrditi nalog da izbegneš gašenje kanala." data-en="Email or a message that looks like the platform claims you must pay a fee or confirm the account to avoid channel shutdown.">Stiže imejl ili poruka koja izgleda kao platforma i tvrdi da moraš platiti taksi ili potvrditi nalog da izbegneš gašenje kanala.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se strah od gubitka publike i prihoda od sadržaja." data-en="Fear of losing audience and content revenue is exploited.">Koristi se strah od gubitka publike i prihoda od sadržaja.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Ekran ili PDF liči na zvanično upozorenje platforme." data-en="A screen or PDF looks like an official platform warning.">Ekran ili PDF liči na zvanično upozorenje platforme.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Link ne vodi na domen platforme koji vidiš u browser adresi kad si ulogovan legalno." data-en="The link does not lead to the platform domain you see when logged in legitimately.">Link ne vodi na domen platforme koji vidiš u browser adresi kad si ulogovan legalno.</li>
        ...
        <li data-sr="Priča o strike-u se menja kada tražiš pauzu od 24 sata." data-en="The story about the strike changes when you ask for a 24-hour pause.">Priča o strike-u se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za uklanjanju copyright strike-a. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to copyright strike removal. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za uklanjanju copyright strike-a. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Traži se uplata u kriptu ili darovne kartice za rešavanje spora." data-en="Crypto or gift cards are requested to resolve a dispute.">Traži se uplata u kriptu ili darovne kartice za rešavanje spora.</li>
        <li data-sr="Poruka traži šifru naloga ili API ključ." data-en="The message asks for account password or API key.">Poruka traži šifru naloga ili API ključ.</li>
        <li data-sr="Adresa imejla je blago drugačija od zvanične." data-en="The email address is slightly different from the official one.">Adresa imejla je blago drugačija od zvanične.</li>
        <li data-sr="Tvrdi se rok od nekoliko sati pre brisanja." data-en="A deadline of hours before deletion is claimed.">Tvrdi se rok od nekoliko sati pre brisanja.</li>
        <li data-sr="U zvaničnom centru platforme nema istog upozorenja." data-en="The same warning does not appear in the official platform centre.">U zvaničnom centru platforme nema istog upozorenja.</li>
        <li data-sr="Traže se podaci vlasnika kanala i broj kartice." data-en="Channel owner details and card number are requested.">Traže se podaci vlasnika kanala i broj kartice.</li>
        <li data-sr="Ponuda advokata stiže minut posle upozorenja." data-en="A lawyer offer arrives minutes after the warning.">Ponuda advokata stiže minut posle upozorenja.</li>
        <li data-sr="Link koristi homograf domena." data-en="The link uses a homograph domain.">Link koristi homograf domena.</li>
        <li data-sr="Traži se instalacija ekstenzije u browser." data-en="Browser extension install is requested.">Traži se instalacija ekstenzije u browser.</li>
        <li data-sr="Nema case ID koji se poklapa u centru naloga." data-en="There is no case ID that matches in the account centre.">Nema case ID koji se poklapa u centru naloga.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za uklanjanju strike-a." data-en="Can I find the same offer on an official site or vacancy for strike removal.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za uklanjanju strike-a.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Kreator paniči. Otvorite zvanični centar za autorska prava ulogovani na nalog, ne kroz link iz poruke." data-en="The creator panics. Open the official copyright centre while logged in, not via the message link.">Kreator paniči. Otvorite zvanični centar za autorska prava ulogovani na nalog, ne kroz link iz poruke.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za uklanjanju copyright strike-a." data-en="Have you ever seen a real employer ask for the same step for copyright strike removal.">Da li si ikada video da pravi poslodavac traži isti korak za uklanjanju copyright strike-a.</li>
