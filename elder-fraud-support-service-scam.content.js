...
window.SCAM_CONTENT["elder-fraud-support-service-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Nakon incidenta, novi kontakt nudi povrat novca uz proviziju, softver za zaštitu ili advokatsku pomoć uz uplatu unapred, što je nastavak iste šeme." data-en="After an incident, a new contact offers recovery for a fee, protective software, or legal help with upfront payment, continuing the same pattern.">Nakon incidenta, novi kontakt nudi povrat novca uz proviziju, softver za zaštitu ili advokatsku pomoć uz uplatu unapred, što je nastavak iste šeme.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Poziv → obećanje povrata → uplata → gubitak." data-en="<strong>Model:</strong> Call → recovery promise → payment → loss."><strong>Model:</strong> Poziv → obećanje povrata → uplata → gubitak.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara servisa za žrtve prevare starijih." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: elder fraud support service scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara servisa za žrtve prevare starijih.</p>
        <ul class="bullets">
