  ...
  raw_html: `
    ...
    <section class="card">
      ...
      <ul class="bullets">
        ...
        <li data-sr="'Provjeri u podešavanjima koje aplikacije imaju pristup tvom nalogu i ukloni one koje ne poznaješ.'" data-en="'Check in settings which apps have access to your account and remove any you do not recognise.'">'Provjeri u podešavanjima koje aplikacije imaju pristup tvom nalogu i ukloni one koje ne poznaješ.'</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li><a href="account-recovery-scam.html" data-sr="Prevara sa oporavkom naloga" data-en="Account recovery scam">Prevara sa oporavkom naloga</a></li>
