...
<section class="content-section">
  <h2 data-sr="Uvod: kako radi prevara sa zlonamерnom aplikacijom" data-en="Introduction: how the malicious app scam works">Uvod: kako radi prevara sa zlonamernom aplikacijom</h2>
...
<section class="content-section">
  ...
  <div class="grid-2">
    ...
    <div class="phase">
      ...
      <ul class="bullets">
        <li data-sr="Dozvole se traže postepeno — neke pri instalaciji, neke pri prvoj upotrebi, neke po „update-u."." data-en="Permissions are requested gradually — some at installation, some on first use, some after an update.">Dozvole se traže postepeno — neke pri instalaciji, neke pri prvoj upotrebi, neke po „update-u?“.</li>
...
<section class="content-section">
  ...
  <article class="phase">
    ...
    <ul class="bullets">
      ...
      <li data-sr="Fišing imejl ili SMS sadrži link koji simulira zvaničnu obaveštenje o „update-u."." data-en="A phishing email or SMS contains a link simulating an official update notification.">Fišing imejl ili SMS sadrži link koji simulira zvaničnu obaveštenje o „update-u?“.</li>
    </ul>
  ...
  <article class="phase">
    ...
    <ul class="bullets">
      ...
      <li data-sr="SMS modul čita i prosleđuje sve dolažne kodove pre nego što korisnik stignet da ih vidi." data-en="The SMS module reads and forwards all incoming codes before the user can see them.">SMS modul čita i prosleđuje sve dolažne kodove pre nego što korisnik stigne da ih vidi.</li>
  ...
  <article class="phase">
    ...
    <div class="callout"><strong data-sr="Prag faze:" data-en="Phase threshold:">Prag faze:</strong> <span data-sr="Promena recovery podataka — žrtva je zaključana iz sopstvenog naloga." data-en="Recovery data is changed — the victim is locked out of their own account.">Promena recovery podataka — žrtva je zaključana iz sopstvenog naloga.</span></div>
    <div class="branch">
      <strong data-sr="Grananja u ovoj fazi:" data-en="Branching at this phase:">Grananja u ovoj fazi:</strong>
      <ul class="bullets">
...
<section class="content-section">
  ...
  <ul class="bullets">
    <li><a href="app-clone-scam.html" data-sr="Klon aplikacija — kopija zvanične aplikacije sa ugrađenim malverom." data-en="App clone scam — copy of official app with embedded malware.">Klon aplikacija — kopija zvanične aplikacije sa ugrađenim malverom</a></li>
    <li><a href="fake-update-scam.html" data-sr="Lažni update — malver koji se maskira kao sistemsko ažuriranje." data-en="Fake update scam — malware disguised as a system update.">Lažni update — malver koji se maskira kao sistemsko ažuriranje</a></li>
    <li><a href="browser-extension-scam.html" data-sr="Zlonameran browser dodatak — proširenja koja kradu podatke iz browsera." data-en="Browser extension scam — extensions that steal data from the browser.">Zlonameran browser dodatak — proširenja koja kradu podatke iz browsera</a></li>
    <li><a href="account-takeover.html" data-sr="Preuzimanje naloga — direktna posledica uspešnog malvera na uređaju." data-en="Account takeover — direct consequence of successful malware on the device.">Preuzimanje naloga — direktna posledica uspešnog malvera na uređaju</a></li>
    <li><a href="phishing.html" data-sr="Fišing — čest vektor za distribuciju zlonamernih aplikacija." data-en="Phishing — common distribution vector for malicious apps.">Fišing — čest vektor za distribuciju zlonamernih aplikacija</a></li>
    <li><a href="identity-theft.html" data-sr="Krađa identiteta — malver koji krade lične dokumente i podatke." data-en="Identity theft — malware that steals personal documents and data.">Krađa identiteta — malver koji krade lične dokumente i podatke</a></li>
  </ul>
</section>
`
};
