...
window.SCAM_CONTENT["remote-payroll-setup-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Nakon brzog prijema traže se podaci direktnog zaduženja, šifra HR portala ili kopija čeka da bi isplata krenula." data-en="After quick acceptance, direct deposit details, HR portal password, or a cheque copy are requested so pay can start.">Nakon brzog prijema traže se podaci direktnog zaduženja, šifra HR portala ili kopija čeka da bi isplata krenula.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se očekivanje prvog dana i žurba oko papira." data-en="Expectation of the first day and paperwork rush are exploited.">Koristi se očekivanje prvog dana i žurba oko papira.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Poruka izgleda kao onboarding lista sa logotipom." data-en="The message looks like an onboarding checklist with a logo.">Poruka izgleda kao onboarding lista sa logotipom.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Nalog za isplatu se traži pre nego što si potpisao ugovor uživo ili elektronski sa verifikacijom." data-en="Payout account is requested before you signed a contract live or electronically with verification.">Nalog za isplatu se traži pre nego što si potpisao ugovor uživo ili elektronski sa verifikacijom.</li>
        ...
        <li data-sr="Priča o isplati se menja kada tražiš pauzu od 24 sata." data-en="The story about payroll changes when you ask for a 24-hour pause.">Priča o isplati se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za postavljanju isplate. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to payroll setup. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za postavljanju isplate. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Traže se lozinka za HR portal i MFA kod." data-en="HR portal password and MFA code are requested.">Traže se lozinka za HR portal i MFA kod.</li>
        <li data-sr="Pita se za PIN debit kartice." data-en="Debit card PIN is asked.">Pita se za PIN debit kartice.</li>
        <li data-sr="Link za formu nije na domen poslodavca." data-en="The form link is not on the employer domain.">Link za formu nije na domen poslodavca.</li>
        <li data-sr="Zaposlenje nema zvaničan konkurs koji možeš citirati." data-en="There is no official vacancy you can cite.">Zaposlenje nema zvaničan konkurs koji možeš citirati.</li>
        <li data-sr="Test transakcija sa tvog naloga je tražena." data-en="A test transaction from your account is requested.">Test transakcija sa tvog naloga je tražena.</li>
        <li data-sr="Ime HR osobe ne postoji na LinkedIn kompanije." data-en="The HR person’s name does not appear on company LinkedIn.">Ime HR osobe ne postoji na LinkedIn kompanije.</li>
        <li data-sr="Traže se podaci supružnog naloga." data-en="Spouse account details are requested.">Traže se podaci supružnog naloga.</li>
        <li data-sr="Datum početka rada je sutra bez intervjua." data-en="Start date is tomorrow with no interview.">Datum početka rada je sutra bez intervjua.</li>
        <li data-sr="Komunikacija je samo Signal ili Telegram." data-en="Communication is only Signal or Telegram.">Komunikacija je samo Signal ili Telegram.</li>
        <li data-sr="Plata je neobično visoka za ulaznu poziciju." data-en="Pay is unusually high for an entry role.">Plata je neobično visoka za ulaznu poziciju.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za postavljanju isplate." data-en="Can I find the same offer on an official site or vacancy for payroll setup.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za postavljanju isplate.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Neko veruje da je zaposlen. Proverite da li ugovor postoji kod pravog HR-a na javnom broju." data-en="Someone believes they are hired. Check whether a contract exists with real HR on a public number.">Neko veruje da je zaposlen. Proverite da li ugovor postoji kod pravog HR-a na javnom broju.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za postavljanju isplate." data-en="Have you ever seen a real employer ask for the same step for payroll setup.">Da li si ikada video da pravi poslodavac traži isti korak za postavljanju isplate.</li>
