...
window.SCAM_CONTENT["virtual-assistant-payment-forwarding"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Nudi se rad od kuće kao asistent uz obračun računa klijenata. Novac stiže na tvoj nalog i šalješ ga dalje uz obećanu proviziju." data-en="Remote work as an assistant is offered to handle client invoices. Money hits your account and you forward it for a promised commission.">Nudi se rad od kuće kao asistent uz obračun računa klijenata. Novac stiže na tvoj nalog i šalješ ga dalje uz obećanu proviziju.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se potreba za fleksibilnim poslom i niskim pragom ulaska." data-en="The need for flexible work and a low entry bar is exploited.">Koristi se potreba za fleksibilnim poslom i niskim pragom ulaska.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Obećanje stabilnog priliva malih transakcija i provizije." data-en="A promise of steady small transactions and commission.">Obećanje stabilnog priliva malih transakcija i provizije.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Posao je skoro isključivo kretanje novca, bez drugih zadataka." data-en="The job is almost only moving money, with no other tasks.">Posao je skoro isključivo kretanje novca, bez drugih zadataka.</li>
        ...
        <li data-sr="Priča o asistent poslu se menja kada tražiš pauzu od 24 sata." data-en="The story about assistant job changes when you ask for a 24-hour pause.">Priča o asistent poslu se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za prosleđivanju uplata kao asistent. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to forwarding payments as an assistant. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za prosleđivanju uplata kao asistent. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Traže se pristup e-bankarstvu ili token-u." data-en="E-banking or token access is requested.">Traže se pristup e-bankarstvu ili token-u.</li>
        <li data-sr="Klijenti su anonimni i ne postoje ugovori koje vidiš." data-en="Clients are anonymous and you see no contracts.">Klijenti su anonimni i ne postoje ugovori koje vidiš.</li>
        <li data-sr="Provizija je visoka za minimalan rad." data-en="Commission is high for minimal work.">Provizija je visoka za minimalan rad.</li>
        <li data-sr="Zabrana razgovora sa bankom o svrhi priliva." data-en="You are told not to discuss incoming purpose with the bank.">Zabrana razgovora sa bankom o svrhi priliva.</li>
        <li data-sr="Račun se otvara na tvoje ime za firmu." data-en="An account is opened in your name for the company.">Račun se otvara na tvoje ime za firmu.</li>
        <li data-sr="Uputstva dolaze u različitim vremenskim zonama bez sastanaka." data-en="Instructions arrive across time zones with no meetings.">Uputstva dolaze u različitim vremenskim zonama bez sastanaka.</li>
        <li data-sr="Novac dolazi od sumnjivih primalaca." data-en="Money comes from suspicious senders.">Novac dolazi od sumnjivih primalaca.</li>
        <li data-sr="Traže se screenshot stanja računa posle svake transakcije." data-en="Account balance screenshots are requested after each transaction.">Traže se screenshot stanja računa posle svake transakcije.</li>
        <li data-sr="Firma nema poreski broj koji možeš proveriti." data-en="The company has no tax ID you can verify.">Firma nema poreski broj koji možeš proveriti.</li>
        <li data-sr="Posao počinje odmah bez intervjua uživo." data-en="The job starts immediately without a live interview.">Posao počinje odmah bez intervjua uživo.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za asistentu sa prosleđivanjem novca." data-en="Can I find the same offer on an official site or vacancy for assistant forwarding money.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za asistentu sa prosleđivanjem novca.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Osoba veruje da je samo administracija. Objasnite da je prenos tuđeg novca kroz lični nalog rizičan po zakon." data-en="The person believes it is just admin. Explain that moving others’ money through a personal account is legally risky.">Osoba veruje da je samo administracija. Objasnite da je prenos tuđeg novca kroz lični nalog rizičan po zakon.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za prosleđivanju uplata kao asistent." data-en="Have you ever seen a real employer ask for the same step for forwarding payments as an assistant.">Da li si ikada video da pravi poslodavac traži isti korak za prosleđivanju uplata kao asistent.</li>
