...
window.SCAM_CONTENT["missing-child-donation-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Lažna kampanja koristi ukradenu ili izmišljenu fotografiju i traži deljenje uz donaciju, često kroz lažni link ili broj računa koji ne pripada porodici." data-en="A fake campaign uses a stolen or invented photo and asks for shares plus donations, often via a fake link or account number that does not belong to the family.">Lažna kampanja koristi ukradenu ili izmišljenu fotografiju i traži deljenje uz donaciju, često kroz lažni link ili broj računa koji ne pripada porodici.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Emotivna priča → deljenje → hitna uplata → lažni kanal → gubitak." data-en="<strong>Model:</strong> Emotional story → sharing → urgent payment → fake channel → loss."><strong>Model:</strong> Emotivna priča → deljenje → hitna uplata → lažni kanal → gubitak.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnom donacijom za nestalo dete." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: missing child donation scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnom donacijom za nestalo dete.</p>
        <ul class="bullets">
