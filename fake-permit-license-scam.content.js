...
window.SCAM_CONTENT["fake-permit-license-scam"] = {
  raw_html: `
    ...
    <section class="card">
      <h2 data-sr="Kako generalno radi: mehanika lažnog posrednika za dozvole" data-en="How it works: fake permit intermediary mechanics">Kako generalno radi: mehanika lažnog posrednika za dozvole</h2>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta gradi poverenje u agenciju" data-en="What builds trust in the agency">Šta gradi poverenje u agenciju</div>
          <ul class="bullets">
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <div class="callout" data-sr="<strong>Prag faze:</strong> meta uplati avans za pokretanje procedure." data-en="<strong>Threshold:</strong> the target pays an advance for starting the procedure."><strong>Prag faze:</strong> meta uplati avans za pokretanje procedure.</div>
      </article>
      ...
      <article class="phase warn">
        ...
        <div class="branch">
          ...
          <ul class="bullets">
            <li><a href="education-ministry-impersonation.html" data-sr="Prevare s lažnim ministarstvom prosvete" data-en="Education authority impersonation">Prevare s lažnim ministarstvom prosvete</a></li>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="agencija nema registraciju ili licencu za posredovanje koja se može proveriti." data-en="the agency has no registration or intermediary license that can be verified.">agencija nema registraciju ili licencu za posredovanje koja se može proveriti.</li>
    ...
    <section class="card">
      <h2 data-sr="Checklista: 10 pitanja pre uplate za dozvolu putem agencije" data-en="Checklist: 10 questions before paying for a permit through an agency">Checklista: 10 pitanja pre uplate za dozvolu putem agencije</h2>
      <ul class="bullets">
        <li data-sr="Da li se ta dozvola može dobiti direktno od nadležnog organa bez agencije?" data-en="Can this permit be obtained directly from the responsible authority without an agency?">Da li se ta dozvola može dobiti direktno od nadležnog organa bez agencije?</li>
        <li data-sr="Da li je agencija registrovana kao posrednik kod nadležnog ministarstva ili registra?" data-en="Is the agency registered as an intermediary with the responsible ministry or registry?">Da li je agencija registrovana kao posrednik kod nadležnog ministarstva ili registra?</li>
        <li data-sr="Da li je zvanična taksa za tu dozvolu javno objavljena na sajtu nadležnog organa?" data-en="Is the official fee for this permit publicly listed on the responsible authority's website?">Da li je zvanična taksa za tu dozvolu javno objavljena na sajtu nadležnog organa?</li>
        <li data-sr="Da li je nadležni organ potvrdio da prima zahteve kroz tu agenciju?" data-en="Has the responsible authority confirmed it accepts applications through this agency?">Da li je nadležni organ potvrdio da prima zahteve kroz tu agenciju?</li>
        <li data-sr="Da li je iznos avansa agencije veći od zvanične takse nadležnog organa?" data-en="Is the agency's advance amount greater than the official fee from the responsible authority?">Da li je iznos avansa agencije veći od zvanične takse nadležnog organa?</li>
        <li data-sr="Da li je posle avansa stigao novi zahtev za taksama pod novim osnovom?" data-en="Has a new fee demand arrived after the advance under a new basis?">Da li je posle avansa stigao novi zahtev za taksama pod novim osnovom?</li>
        <li data-sr="Da li se dozvola može verifikovati direktno kod nadležnog organa pod brojem koji agencija navodi?" data-en="Can the permit be verified directly with the responsible authority under the number the agency cites?">Da li se dozvola može verifikovati direktno kod nadležnog organa pod brojem koji agencija navodi?</li>
        <li data-sr="Da li je dozvola isporučena u roku koji je agencija obećala?" data-en="Was the permit delivered in the timeframe the agency promised?">Da li je dozvola isporučena u roku koji je agencija obećala?</li>
        <li data-sr="Da li agencija može dati pisanu garanciju sa jasnom klauzulom o povraćaju novca?" data-en="Can the agency provide a written guarantee with a clear refund clause?">Da li agencija može dati pisanu garanciju sa jasnom klauzulom o povraćaju novca?</li>
    ...
    <section class="card">
      ...
      <ol class="steps">
        <li data-sr="kontaktiraj nadležni organ direktno i pitaj o toj vrsti dozvole i proceduri." data-en="contact the responsible authority directly and ask about that type of permit and procedure.">kontaktiraj nadležni organ direktno i pitaj o toj vrsti dozvole i proceduri.</li>
        <li data-sr="proveri da li je agencija registrovana u zvaničnom registru posrednika." data-en="verify whether the agency is registered in the official intermediary registry.">proveri da li je agencija registrovana u zvaničnom registru posrednika.</li>
        <li data-sr="zaustavi dalje uplate agenciji dok ne dobis pisanu potvrdu od nadležnog organa." data-en="stop further payments to the agency until you receive written confirmation from the responsible authority.">zaustavi dalje uplate agenciji dok ne dobis pisanu potvrdu od nadležnog organa.</li>
        <li data-sr="podnesi zahtev direktno kod nadležnog organa bez agencije." data-en="submit the application directly with the responsible authority without the agency.">podnesi zahtev direktno kod nadležnog organa bez agencije.</li>
        <li data-sr="prijavi incident nadležnom organu i policiji." data-en="report the incident to the responsible authority and police.">prijavi incident nadležnom organu i policiji.</li>
      </ol>
    </section>
    ...
    <section class="card">
      ...
      <div class="grid-2">
        <div class="phase">
          ...
          <ul class="bullets">
            <li data-sr="Da li je agencija registrovana u zvaničnom registru?" data-en="Is the agency registered in the official registry?">Da li je agencija registrovana u zvaničnom registru?</li>
            <li data-sr="Da li dozvola može biti dobijena direktno od nadležnog organa?" data-en="Can the permit be obtained directly from the responsible authority?">Da li dozvola može biti dobijena direktno od nadležnog organa?</li>
            <li data-sr="Da li je posle avansa stigao novi zahtev za taksama?" data-en="Has a new fee demand arrived after the advance?">Da li je posle avansa stigao novi zahtev za taksama?</li>
          </ul>
        </div>
        <div class="phase">
          <div class="label" data-sr="Rečenice koje rade" data-en="Phrases that work">Rečenice koje rade</div>
          <ul class="bullets">
            <li data-sr="Hajde da proverimo zvaničnu proceduru direktno kod nadležnog organa pre sledeće uplate." data-en="Let's check the official procedure directly with the responsible authority before the next payment.">Hajde da proverimo zvaničnu proceduru direktno kod nadležnog organa pre sledeće uplate.</li>
            <li data-sr="Serija uplata s novim opravdanjima je klasični obrazac avansne prevare." data-en="A series of payments with new justifications is the classic advance-fee scam pattern.">Serija uplata s novim opravdanjima je klasični obrazac avansne prevare.</li>
            <li data-sr="Legitimna agencija može čekati 48h dok proverujes njenu registraciju." data-en="A legitimate agency can wait 48 hours while you verify its registration.">Legitimna agencija može čekati 48h dok proverujes njenu registraciju.</li>
          </ul>
        </div>
      </div>
    </section>
