...
window.SCAM_CONTENT["business-debit-mandate"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: lažni mandat za direktno zaduženje firme" data-en="Introduction: fake business direct debit mandate">Uvod: lažni mandat za direktno zaduženje firme</h2>
      <p data-sr="Lažan mandat ili obrazac traži odobrenje zaduženja na novi ID poverioca koji kontroliše napadač." data-en="Fake mandate or form requests approval to debit a new creditor ID the attacker controls.">Lažan mandat ili obrazac traži odobrenje zaduženja na novi ID poverioca koji kontroliše napadač.</p>
      <p data-sr="Dokument izgleda kao SEPA ili lokalni obrazac, ali stiže samo elektronski bez poziva iz uobičajenog kanala." data-en="Document looks like SEPA or local form, but arrives electronically only without call on the usual channel.">Dokument izgleda kao SEPA ili lokalni obrazac, ali stiže samo elektronski bez poziva iz uobičajenog kanala.</p>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
            <li data-sr="Mandat stiže samo imejlom bez papirnog traga koji ste ranije imali." data-en="Mandate arrives by email only without paper trail you had before.">Mandat stiže samo imejlom bez papirnog traga koji ste ranije imali.</li>
            <li data-sr="ID poverioca ne postoji u javnoj bazi ili se ne poklapa sa imenom." data-en="Creditor ID is missing in public lookup or name mismatch.">ID poverioca ne postoji u javnoj bazi ili se ne poklapa sa imenom.</li>
            <li data-sr="Traže hitno odobrenje pre sledećeg ciklusa naplate istog dana." data-en="Urgent approval is demanded before the same day&#x27;s collection cycle.">Traže hitno odobrenje pre sledećeg ciklusa naplate istog dana.</li>
            <li data-sr="Potpis na mandatu liči na sliku, ne na kvalifikovani potpis." data-en="Signature on mandate looks like an image, not qualified.">Potpis na mandatu liči na sliku, ne na kvalifikovani potpis.</li>
            <li data-sr="Ime poverioca je skoro isto kao pravog ali sa jednom izmenom slova." data-en="Creditor name is almost like the real one with one letter change.">Ime poverioca je skoro isto kao pravog ali sa jednom izmenom slova.</li>
            <li data-sr="Finansije nemaju tiket ili broj zahteva iz pravog odeljenja partnera." data-en="Finance has no ticket or request number from partner&#x27;s real department.">Finansije nemaju tiket ili broj zahteva iz pravog odeljenja partnera.</li>
            <li data-sr="Zaduženje je u nekojoj valuti koja nije u ugovoru." data-en="Debit is in a currency not in the contract.">Zaduženje je u nekojoj valuti koja nije u ugovoru.</li>
            <li data-sr="Ponavljaju mandat ako prvi put odbijete." data-en="They resend mandate if you reject the first time.">Ponavljaju mandat ako prvi put odbijete.</li>
            <li data-sr="Traže da preskočite interni četvorooki pregled." data-en="They ask you to skip internal four-eyes review.">Traže da preskočite interni četvorooki pregled.</li>
            <li data-sr="Pravi poverilac kasnije potvrđuje da nisu menjali mandat." data-en="Real creditor later confirms they did not change the mandate.">Pravi poverilac kasnije potvrđuje da nisu menjali mandat.</li>
      </ul>
    </section>
