...
window.SCAM_CONTENT["payment-gateway-onboarding"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: lažni onboarding platnog provajdera" data-en="Introduction: fake payment gateway onboarding">Uvod: lažni onboarding platnog provajdera</h2>
      <p data-sr="Lažni PSP traži dokumenta, API ključeve i naknadu pre aktivacije prihvata kartica, a firma provajdera ne postoji ili je klon." data-en="Fake PSP requests documents, API keys, and a fee before card acceptance goes live, while the provider is nonexistent or cloned.">Lažni PSP traži dokumenta, API ključeve i naknadu pre aktivacije prihvata kartica, a firma provajdera ne postoji ili je klon.</p>
      <p data-sr="Domen je skoro isti poznatom brendu, a ugovor ima prazna polja za registracioni broj." data-en="Domain is almost a known brand, and contract has empty fields for registration number.">Domen je skoro isti poznatom brendu, a ugovor ima prazna polja za registracioni broj.</p>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
            <li data-sr="Registracioni broj u ugovoru ne postoji u javnom registru privrednih subjekata." data-en="Registration number in contract does not exist in public business registry.">Registracioni broj u ugovoru ne postoji u javnom registru privrednih subjekata.</li>
            <li data-sr="Traže root API ključeve ili admin nalog umesto ograničenog testnog okruženja." data-en="Root API keys or admin account requested instead of limited sandbox.">Traže root API ključeve ili admin nalog umesto ograničenog testnog okruženja.</li>
            <li data-sr="Naknada ide na račun koji nije nazvan kao pravni entitet provajdera." data-en="Fee goes to an account not named as the provider legal entity.">Naknada ide na račun koji nije nazvan kao pravni entitet provajdera.</li>
            <li data-sr="Hitno traže potpis pre nego što pravnik pregleda." data-en="Signature demanded urgently before legal review.">Hitno traže potpis pre nego što pravnik pregleda.</li>
            <li data-sr="Kontakt koristi besplatni imejl domen umesto korporativnog." data-en="Contact uses free email domain instead of corporate.">Kontakt koristi besplatni imejl domen umesto korporativnog.</li>
            <li data-sr="Ne mogu da daju referencu postojećeg trgovca koga možete pozvati." data-en="They cannot give a merchant reference you can call.">Ne mogu da daju referencu postojećeg trgovca koga možete pozvati.</li>
            <li data-sr="SSL sertifikat sajta ne poklapa se sa imenom firme." data-en="Site TLS certificate does not match company name.">SSL sertifikat sajta ne poklapa se sa imenom firme.</li>
            <li data-sr="Traže snimke ekrana svih transakcija umesto agregiranih izveštaja." data-en="Screenshots of all transactions requested instead of aggregated reports.">Traže snimke ekrana svih transakcija umesto agregiranih izveštaja.</li>
            <li data-sr="Ponude su znatno ispod tržišnih cena za iste usluge." data-en="Offers are far below market rates for the same services.">Ponude su znatno ispod tržišnih cena za iste usluge.</li>
            <li data-sr="Zahtevaju pristup vašem web panelu hosting provajdera." data-en="They request access to your hosting provider panel.">Zahtevaju pristup vašem web panelu hosting provajdera.</li>
      </ul>
    </section>
