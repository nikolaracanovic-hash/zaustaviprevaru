...
window.SCAM_CONTENT["timesheet-correction-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Stiže imejl ili SMS da moraš potvrditi sate ili bankovni nalog da bi isplata prošla. Link vodi na lažnu prijavnu stranu." data-en="Email or SMS says you must confirm hours or bank details so pay can go through. The link leads to a fake login page.">Stiže imejl ili SMS da moraš potvrditi sate ili bankovni nalog da bi isplata prošla. Link vodi na lažnu prijavnu stranu.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se rutina isplate da žrtva reaguje brzo bez provere linka." data-en="Payroll routine is used so the victim reacts quickly without checking the link.">Koristi se rutina isplate da žrtva reaguje brzo bez provere linka.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Poruka koristi terminologiju o platnom periodu i satima." data-en="The message uses payroll period and hours terminology.">Poruka koristi terminologiju o platnom periodu i satima.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="URL u browseru nije isti kao zvanični payroll ili HR portal." data-en="The browser URL is not the same as the official payroll or HR portal.">URL u browseru nije isti kao zvanični payroll ili HR portal.</li>
        ...
        <li data-sr="Priča o ispravci evidencije se menja kada tražiš pauzu od 24 sata." data-en="The story about timesheet correction changes when you ask for a 24-hour pause.">Priča o ispravci evidencije se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za ispravci evidencije rada. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to timesheet corrections. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za ispravci evidencije rada. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Hitnost: isplata će biti blokirana večeras." data-en="Urgency: pay will be blocked tonight.">Hitnost: isplata će biti blokirana večeras.</li>
        <li data-sr="Traže se šifra i MFA kod u istoj formi." data-en="Password and MFA code are requested in the same form.">Traže se šifra i MFA kod u istoj formi.</li>
        <li data-sr="Pošiljalac je generički Payroll Team bez imena." data-en="The sender is a generic Payroll Team without a name.">Pošiljalac je generički Payroll Team bez imena.</li>
        <li data-sr="Link je skraćenica ili QR bez jasnog domena." data-en="The link is a short URL or QR without a clear domain.">Link je skraćenica ili QR bez jasnog domena.</li>
        <li data-sr="Isti tekst stiže kolegama koji rade kod drugih firmi." data-en="The same text reaches colleagues at other companies.">Isti tekst stiže kolegama koji rade kod drugih firmi.</li>
        <li data-sr="Traže se podaci kartice za verifikaciju isplate." data-en="Card details are requested to verify payout.">Traže se podaci kartice za verifikaciju isplate.</li>
        <li data-sr="Poruka stiže sa ličnog Gmail naloga." data-en="The message comes from a personal Gmail account.">Poruka stiže sa ličnog Gmail naloga.</li>
        <li data-sr="Nema broja službe za platu koji možeš pozvati." data-en="There is no payroll desk number you can call.">Nema broja službe za platu koji možeš pozvati.</li>
        <li data-sr="Forma traži i lični email i šifru za sinhronizaciju." data-en="The form asks for personal email and password for sync.">Forma traži i lični email i šifru za sinhronizaciju.</li>
        <li data-sr="Browser upozorava na nebezbedan sajt." data-en="The browser warns the site is unsafe.">Browser upozorava na nebezbedan sajt.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za ispravci evidencije rada." data-en="Can I find the same offer on an official site or vacancy for timesheet corrections.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za ispravci evidencije rada.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Zaposleni žure pred kraj meseca. Predložite poziv internom HR broju iz imenika, ne iz poruke." data-en="Staff rush at month-end. Suggest calling internal HR from the directory, not from the message.">Zaposleni žure pred kraj meseca. Predložite poziv internom HR broju iz imenika, ne iz poruke.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za ispravci evidencije rada." data-en="Have you ever seen a real employer ask for the same step for timesheet corrections.">Da li si ikada video da pravi poslodavac traži isti korak za ispravci evidencije rada.</li>
