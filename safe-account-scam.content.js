  ...
  raw_html: `
    ...
    <section class="card">
      ...
      <article class="phase warn">
        ...
        <div class="callout" data-sr="<strong>Prag faze:</strong> žrtva prvog transfera na 'bezbedni nalog'." data-en="<strong>Threshold:</strong> the victims first transfer to the safe account'."><strong>Prag faze:</strong> žrtva prvog transfera na 'bezbedni nalog'.</div>
      </article>
      ...
      <article class="phase bad">
        ...
        <p data-sr="Serija transfera uz produžavanje 'istrage'. Napadač na kraju nestaje." data-en="After the first transfer, more follow — the account is filled gradually. The attacker explains that the 'investigation is being extended' or there are new 'findings'. Eventually the attacker disappears and the account is empty.">Serija transfera uz produžavanje 'istrage'. Napadač na kraju nestaje.</p>
