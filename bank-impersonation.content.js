  ...
  raw_html: `
    ...
    <section class="card">
      ...
      <article class="phase bad">
        ...
        <p data-sr="Dolazi do konkretnog zahteva: prenesite novac na „bezbedni nalog“, otkrijte OTP kod za „poništavanje“ transakcije, ili pustite kurira da preuzme karticu. Svaki zahtev se predstavlja kao jedini način zaštite." data-en="A concrete demand arrives: transfer money to a 'safe account', reveal an OTP code to 'cancel' a transaction, or allow a courier to collect the card. Each demand is framed as the only protective option.">Konkretan zahtev: transfer, OTP ili kartica. Svaki je predstavljen kao jedina zaštitna mera.</p>
        <div class="branch">
