...
window.SCAM_CONTENT["recovery-scam"] = {
  raw_html: `
    ...
    <section class="card">
      <h2 data-sr="Uvod: prevara povraćaja kao drugi napad" data-en="Introduction: recovery scams as the second attack">
        Uvod: prevara povraćaja kao drugi napad
      </h2>

      <p
        data-sr="Prevara povraćaja cilja ljude posle gubitka. Ulaz je potreba za poništenjem štete: povrat novca, povrat naloga, zamrznuta sredstva, refund, chargeback pomoć, tracing. Ponuda deluje kao izlaz, ali mehanika ostaje ista: uplata unapred kao uslov za postupak. U praksi, recovery prevara nastavlja tamo gde je prethodna stala: meta je već u režimu rešavanja problema, samo se promeni kostim."
      ...
      >Prevara povraćaja cilja ljude posle gubitka. Ulaz je potreba za poništenjem štete: povrat novca, povrat naloga, zamrznuta sredstva, refund, chargeback pomoć, tracing. Ponuda deluje kao izlaz, ali mehanika ostaje ista: uplata unapred kao uslov za postupak. U praksi, recovery prevara nastavlja tamo gde je prethodna stala: meta je već u režimu rešavanja problema, samo se promeni kostim.</p>
    ...
    <section class="card">
      <h2 data-sr="Kako funkcioniše posle gubitka" data-en="How it works after a loss">
        Kako funkcioniše posle gubitka
      </h2>

      <p
        data-sr="Posle prevare meta često ulazi u tunelski fokus: povrat deluje kao jedina stvar koja ispravlja situaciju. U tom stanju proceduralni jezik deluje kao put ka izlazu, a autoritet deluje kao rešenje. Prevara povraćaja koristi i sram: meta želi da reši problem bez širenja priče, pa traži brzi, tihi izlaz. To se pretvara u preduslov: ne pričajte nikome dok traže postupak."
      ...
      >Posle prevare meta često ulazi u tunelski fokus: povrat deluje kao jedina stvar koja ispravlja situaciju. U tom stanju proceduralni jezik deluje kao put ka izlazu, a autoritet deluje kao rešenje. Prevara povraćaja koristi i sram: meta želi da reši problem bez širenja priče, pa traži brzi, tihi izlaz. To se pretvara u preduslov: ne pričajte nikome dok traže postupak.</p>
    ...
    <section class="card">
      ...
      <p class="muted"
        data-sr="Faze su prikazane kao operativni tok: ulaz, provera mete, prag, serija taksi, eskalacija, mutacije i talas prevare povraćaja posle drugog gubitka."
      ...
      >Faze su prikazane kao operativni tok: ulaz, provera mete, prag, serija taksi, eskalacija, mutacije i talas prevare povraćaja posle drugog gubitka.</p>
      ...
      <!-- FAZA 2 -->
      <article class="phase">
        <h3 class="phase-title" data-sr="Faza 2 — Pitanja za procenu mete" data-en="Phase 2 — Screening questions">
          Faza 2 — Pitanja za procenu mete
        </h3>
      ...
      <article class="phase bad">
        ...
        <p
          data-sr="Prva taksa se uvodi kao proceduralna stavka: naknada za obradu, izveštaj, predmet ili verifikaciju. Iznos često deluje izvodljivo u odnosu na gubitak, jer cilj nije jednokratna uplata, već otvaranje serije."
        ...
        >Prva taksa se uvodi kao proceduralna stavka: naknada za obradu, izveštaj, predmet ili verifikaciju. Iznos često deluje izvodljivo u odnosu na gubitak, jer cilj nije jednokratna uplata, već otvaranje serije.</p>
        ...
        <ul class="bullets">
          ...
          <li data-sr="obećanje: posle takse ide oslobađanje sredstava." data-en="promise: after the fee comes release">obećanje: posle takse ide oslobađanje sredstava.</li>
        </ul>
      ...
      <article class="phase bad">
        ...
        <p
          data-sr="Posle prve takse dolazi nova prepreka: naknada za oslobađanje sredstava, otključavanje, kauciju, proveru protiv pranja novca, overu ili sudsku prijavu. Razlog se menja, funkcija ostaje ista: uplata kao uslov. Svaki zahtev se prodaje kao poslednji korak."
          data-en="After the first fee comes a new obstacle: release fee, naknada za otključavanje, bond deposit, provera protiv pranja novca fee, notary fee, court fišing. The reason changes; the function stays: payment as a condition. Each demand is sold as the final step."
        >Posle prve takse dolazi nova prepreka: naknada za oslobađanje sredstava, otključavanje, kauciju, proveru protiv pranja novca, overu ili sudsku prijavu. Razlog se menja, funkcija ostaje ista: uplata kao uslov. Svaki zahtev se prodaje kao poslednji korak.</p>

        <div class="grid-2">
          <div class="phase">
            <div class="label" data-sr="Promenljive oznake" data-en="Rotating labels">Promenljive oznake</div>
            <ul class="bullets">
              <li data-sr="obrada / administracija." data-en="processing / administration.">obrada / administracija.</li>
              <li data-sr="verifikacija / usklađenost / provera identiteta." data-en="verification / compliance / provera identiteta.">verifikacija / usklađenost / provera identiteta.</li>
              <li data-sr="porez / oslobađanje / dažbina." data-en="tax / clearance / duty.">porez / oslobađanje / dažbina.</li>
              <li data-sr="depozit / kaucija / osiguranje." data-en="deposit / bond / insurance.">depozit / kaucija / osiguranje.</li>
              <li data-sr="oslobađanje / otključavanje." data-en="release / unlock.">oslobađanje / otključavanje.</li>
            </ul>
          </div>

          <div class="phase">
            <div class="label" data-sr="Kako se održava tempo" data-en="How pace is maintained">Kako se održava tempo</div>
            <ul class="bullets">
      ...
      <article class="phase warn">
        <h3 class="phase-title" data-sr="Faza 5 — Autoritet, dokumenti i klonirane firme" data-en="Phase 5 — Authority, documents, clone firms">
          Faza 5 — Autoritet, dokumenti i klonirane firme
        </h3>

        <p
          data-sr="Kada se pojavi sumnja, uvodi se autoritet: advokat, regulator, forenzika, bankarska usklađenost. Često stiže PDF, logo, broj predmeta, portal ili imejl sa sličnim domenom. Forma izgleda kao legitimna administracija, ali funkcija ostaje finansijska: nova uplata."
        ...
        >Kada se pojavi sumnja, uvodi se autoritet: advokat, regulator, forenzika, bankarska usklađenost. Često stiže PDF, logo, broj predmeta, portal ili imejl sa sličnim domenom. Forma izgleda kao legitimna administracija, ali funkcija ostaje finansijska: nova uplata.</p>
      ...
      <!-- FAZA 6 -->
      <article class="phase warn">
        <h3 class="phase-title" data-sr="Faza 6 — Drugi gubitak i novi talas prevare povraćaja" data-en="Phase 6 — Second loss and a new recovery wave">
          Faza 6 — Drugi gubitak i novi talas prevare povraćaja
        </h3>

        <p
          data-sr="Ako meta uplati, a rezultat izostane, pojavljuje se novi identitet sa novim objašnjenjem: prethodni agent je pogrešio, potreban je viši nivo, sad ide stvarni postupak. Time se prevara povraćaja pretvara u tok prevare povraćaja na prevaru povraćaja."
        ...
        >Ako meta uplati, a rezultat izostane, pojavljuje se novi identitet sa novim objašnjenjem: prethodni agent je pogrešio, potreban je viši nivo, sad ide stvarni postupak. Time se prevara povraćaja pretvara u tok prevare povraćaja na prevaru povraćaja.</p>
      </article>
    </section>

    <!-- 4) MINI-SCENARIJI (MAPA PREPOZNAVANJA) -->
    <section class="card">
      <h2 data-sr="Mini-scenariji: kako prevara povraćaja izgleda u praksi" data-en="Mini-scenarios: what recovery looks like in practice">
        Mini-scenariji: kako prevara povraćaja izgleda u praksi
      </h2>
      ...
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Agent za povraćaj" data-en="Refund agent">Agent za povraćaj</div>
          <ul class="bullets">
        ...
        <div class="phase">
          ...
          <ul class="bullets">
            ...
            <li data-sr="takse: court fišing / notary / tax clearance." data-en="fees: court fišing / notary / tax clearance.">takse: court fišing / notary / tax clearance.</li>
        ...
        <div class="phase">
          <div class="label" data-sr="Praćenje / forenzika" data-en="Tracing / forensics">Praćenje / forenzika</div>
          <ul class="bullets">
    ...
    <section class="card">
      <h2 data-sr="Primeri (biblioteka slučajeva)" data-en="Examples (case library).">Primeri (biblioteka slučajeva)</h2>
      <div data-cases></div>
    </section>
    ...
    <section class="card">
      ...
      <div class="callout"
        data-sr="<strong>Brzi filter:</strong> ponuda za povraćaj + uplata unapred = obrazac."
        data-en="<strong>Fast filter:</strong> recovery offer + upfront payment = pattern."
      ><strong>Brzi filter:</strong> ponuda za povraćaj + uplata unapred = obrazac.</div>
    </section>


    <!-- 8) STATISTIKE I EKONOMIJA RECOVERY PREVARA -->
    <section class="card">
      <h2 data-sr="Statistika i ekonomija prevare povraćaja" data-en="Recovery scam statistics and economics">
        Statistika i ekonomija prevare povraćaja
      </h2>
      ...
      <div class="grid-2">
        <div class="phase">
          ...
          <ul class="bullets">
            <li data-sr="prevare povraćaja su sekundarna viktimizacija posle crypto/romance scams." data-en="recovery scams are secondary victimization after crypto/romance scams.">prevare povraćaja su sekundarna viktimizacija posle crypto/romance scams.</li>
            ...
            <li data-sr="sekundarna viktimizacija: 15-25% žrtava originalne prevare padne na prevaru povraćaja." data-en="SECONDARY VICTIMIZATION: 15-25% of original scam victims fall for recovery scam.">sekundarna viktimizacija: 15-25% žrtava originalne prevare padne na prevaru povraćaja.</li>
            <li data-sr="ukupni gubitak (originalna prevara + prevara povraćaja): prosečno $18,000-$25,000." data-en="combined loss (original + recovery): avg $18,000-$25,000.">ukupni gubitak (originalna prevara + prevara povraćaja): prosečno $18,000-$25,000.</li>
        ...
        <div class="phase">
          <div class="label" data-sr="Demografija (ko pada na prevaru povraćaja)" data-en="Demographics (who falls for recovery scam).">Demografija (ko pada na prevaru povraćaja)</div>
          <ul class="bullets">
            ...
            <li data-sr="vreme od originalne prevare do kontakta za povraćaj: 1-4 nedelje (medijan: 2 nedelje)." data-en="time from original scam to recovery contact: 1-4 weeks (median: 2 weeks).">vreme od originalne prevare do kontakta za povraćaj: 1-4 nedelje (medijan: 2 nedelje).</li>
        ...
        <div class="phase">
          <div class="label" data-sr="Tok vremena i angažovanje" data-en="Timeline and engagement">Tok vremena i angažovanje</div>
          <ul class="bullets">
      ...
      <div class="callout"
        data-sr="<strong>Ekonomski profil:</strong> prevara povraćaja ima viši povraćaj ulaganja od većine originalnih prevara (5,000-10,000%) jer su troškovi niski (liste meta, bez građenja odnosa), a konverzija visoka (15-25% očajnih žrtava). Zato isti prevarant često prvo izvede originalnu prevaru, pa posle dve nedelje kontaktira istu žrtvu kao agent za povraćaj. Dvostruka žetva."
        ...
        <strong>Ekonomski profil:</strong> prevara povraćaja ima viši povraćaj ulaganja od većine originalnih prevara (5,000-10,000%) jer su troškovi niski (liste meta, bez građenja odnosa), a konverzija visoka (15-25% očajnih žrtava). Zato isti prevarant često prvo izvede originalnu prevaru, pa posle dve nedelje kontaktira istu žrtvu kao agent za povraćaj. Dvostruka žetva.
      </div>
