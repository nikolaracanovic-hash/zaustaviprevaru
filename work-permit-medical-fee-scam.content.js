...
window.SCAM_CONTENT["work-permit-medical-fee-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Tvrdi se da postoji zauzetost sistema i da moraš platiti posrednika za termin ili ubrzanje. Zvanični portali imaju jasne cene i redosled." data-en="The system is claimed to be busy and you must pay a broker for a slot or speed. Official portals have clear prices and order.">Tvrdi se da postoji zauzetost sistema i da moraš platiti posrednika za termin ili ubrzanje. Zvanični portali imaju jasne cene i redosled.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se nepoznavanje imigracionih koraka." data-en="Unfamiliarity with immigration steps is exploited.">Koristi se nepoznavanje imigracionih koraka.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Hitnost jer termin ističe sutra." data-en="Urgency because the slot expires tomorrow.">Hitnost jer termin ističe sutra.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Zvanični sajt ne navodi ovog posrednika ni ovaj način uplate." data-en="The official site does not list this broker or payment method.">Zvanični sajt ne navodi ovog posrednika ni ovaj način uplate.</li>
        ...
        <li data-sr="Priča o dozvoli se menja kada tražiš pauzu od 24 sata." data-en="The story about the permit changes when you ask for a 24-hour pause.">Priča o dozvoli se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za medicinskom trošku za dozvolu. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to permit medical fee. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za medicinskom trošku za dozvolu. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Uplata ide na fizičko lice koordinatora." data-en="Payment goes to a coordinator’s personal name.">Uplata ide na fizičko lice koordinatora.</li>
        <li data-sr="Klinika nije na listi odobrenih ustanova." data-en="The clinic is not on the approved list.">Klinika nije na listi odobrenih ustanova.</li>
        <li data-sr="Cena je viša od zvaničnog cenovnika." data-en="The price is above the official price list.">Cena je viša od zvaničnog cenovnika.</li>
        <li data-sr="Traže se novac i pasoš u istom paketu kurira." data-en="Cash and passport are requested in one courier package.">Traže se novac i pasoš u istom paketu kurira.</li>
        <li data-sr="Tvrdi se da je lekar vezan samo za agenciju." data-en="You are told the doctor works only with the agency.">Tvrdi se da je lekar vezan samo za agenciju.</li>
        <li data-sr="Nema broja predmeta u državnom sistemu." data-en="There is no file number in the government system.">Nema broja predmeta u državnom sistemu.</li>
        <li data-sr="Zabrana direktnog zakazivanja kod klinike." data-en="Direct booking with the clinic is discouraged.">Zabrana direktnog zakazivanja kod klinike.</li>
        <li data-sr="Zahtev za kripto jer je brže." data-en="Crypto is requested because it is faster.">Zahtev za kripto jer je brže.</li>
        <li data-sr="Isti broj šalje ponude za više zemalja." data-en="The same number sends offers for multiple countries.">Isti broj šalje ponude za više zemalja.</li>
        <li data-sr="PDF potvrda nema serijski broj koji proveravaš." data-en="The PDF confirmation has no serial you can verify.">PDF potvrda nema serijski broj koji proveravaš.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za medicinskom trošku za dozvolu." data-en="Can I find the same offer on an official site or vacancy for permit medical fee.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za medicinskom trošku za dozvolu.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Kandidat žuri zbog rokova. Otvorite zvanični imigracioni sajt i uporedite cene i korake." data-en="The candidate rushes on deadlines. Open the official immigration site and compare prices and steps.">Kandidat žuri zbog rokova. Otvorite zvanični imigracioni sajt i uporedite cene i korake.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za medicinskom trošku za dozvolu." data-en="Have you ever seen a real employer ask for the same step for permit medical fee.">Da li si ikada video da pravi poslodavac traži isti korak za medicinskom trošku za dozvolu.</li>
