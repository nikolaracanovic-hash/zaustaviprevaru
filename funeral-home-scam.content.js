...
window.SCAM_CONTENT["funeral-home-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Lažni agent ili neoznačeni posrednik prodaje skup paket usluga, dodaje skrivene stavke na račun ili traži avans na sumnjiv račun van uobičajene prakse ustanove." data-en="A fake agent or unmarked intermediary sells an expensive package, adds hidden invoice lines, or demands advance payment to a suspicious account outside normal funeral home practice.">Lažni agent ili neoznačeni posrednik prodaje skup paket usluga, dodaje skrivene stavke na račun ili traži avans na sumnjiv račun van uobičajene prakse ustanove.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Kontakt → paket → pritisak → uplata van standardnog toka." data-en="<strong>Model:</strong> Contact → package → pressure → payment outside normal flow."><strong>Model:</strong> Kontakt → paket → pritisak → uplata van standardnog toka.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara pogrebnog preduzeća ili lažnog agenta." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: funeral home or fake funeral agent scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara pogrebnog preduzeća ili lažnog agenta.</p>
        <ul class="bullets">
