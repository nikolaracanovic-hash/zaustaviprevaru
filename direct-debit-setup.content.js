...
window.SCAM_CONTENT["direct-debit-setup"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: lažno podešavanje direktnog zaduženja" data-en="Introduction: fake direct debit setup">Uvod: lažno podešavanje direktnog zaduženja</h2>
      <p data-sr="Link ili PDF vodi na obrazac koji aktivira zaduženje na tuđi ID poverioca pod izgovorom obnove usluge." data-en="Link or PDF leads to a form activating debit to someone else&#x27;s creditor ID under a service renewal pretext.">Link ili PDF vodi na obrazac koji aktivira zaduženje na tuđi ID poverioca pod izgovorom obnove usluge.</p>
      <p data-sr="Poruka glumi komunalno ili osiguranje i traži jedan klik potvrde." data-en="Message pretends to be utility or insurance and asks for one-click confirm.">Poruka glumi komunalno ili osiguranje i traži jedan klik potvrde.</p>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
            <li data-sr="Link je skraćenica koja sakriva pravi domen." data-en="Link is a short URL hiding the real domain.">Link je skraćenica koja sakriva pravi domen.</li>
            <li data-sr="Obrazac ne sadrži referencu korisnika sa papirnog računa." data-en="Form lacks the customer reference from the paper bill.">Obrazac ne sadrži referencu korisnika sa papirnog računa.</li>
            <li data-sr="Traže pun broj bankovnog računa i adresu za navodnu validaciju." data-en="Full bank account number and address requested for alleged validation.">Traže pun broj bankovnog računa i adresu za navodnu validaciju.</li>
            <li data-sr="Nema opcije da pozovete kompaniju na broj sa računa." data-en="No option to call the company on the bill number.">Nema opcije da pozovete kompaniju na broj sa računa.</li>
            <li data-sr="Jedan klik automatski šalje saglasnost bez čitanja uslova." data-en="One click sends consent without reading terms.">Jedan klik automatski šalje saglasnost bez čitanja uslova.</li>
            <li data-sr="Direktno zaduženje je u valuti koja nije vaša lokalna bez objašnjenja." data-en="Direct debit is in a non-local currency without explanation.">Direktno zaduženje je u valuti koja nije vaša lokalna bez objašnjenja.</li>
            <li data-sr="Ponavljaju SMS dok ne kliknete." data-en="SMS repeats until you click.">Ponavljaju SMS dok ne kliknete.</li>
            <li data-sr="Aplikacija traži dozvole za SMS i pozive van uobičajenog okvira." data-en="App requests SMS and call permissions outside normal scope.">Aplikacija traži dozvole za SMS i pozive van uobičajenog okvira.</li>
            <li data-sr="Nakon klika, izvod pokazuje zaduženje na nepoznatog primaoca." data-en="After click, statement shows debit to unknown beneficiary.">Nakon klika, izvod pokazuje zaduženje na nepoznatog primaoca.</li>
            <li data-sr="Pravi dobavljač kaže da nisu slali obnovu mandata." data-en="Real supplier says they did not send mandate renewal.">Pravi dobavljač kaže da nisu slali obnovu mandata.</li>
      </ul>
    </section>
