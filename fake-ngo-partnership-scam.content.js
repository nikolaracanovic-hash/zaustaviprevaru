...
window.SCAM_CONTENT["fake-ngo-partnership-scam"] = {
  raw_html: `
<section class="content-section">
  <h2 data-sr="Uvod: kako radi prevara lažnog NGO partnerstva" data-en="Intro: how the fake NGO partnership scam works">Uvod: kako radi prevara lažnog NGO partnerstva</h2>
  <p data-sr="Lažni NGO kontaktira organizaciju ili fizičko lice s ponudom za partnerstvo: zajednički projekat, suko-finansiranje granta, program obuke ili razvojna saradnja. Pre nego što partnerstvo ili grant mogu biti formalizovani, traže se naknade za registraciju, usaglašenost, notarizaciju ili obradu dokumentacije. Svaka uplata otkriva novu blokadu." data-en="A fake NGO contacts an organization or individual with a partnership offer: a joint project, grant co-financing, a training program, or development cooperation. Before the partnership or grant can be formalized, fees are requested for registration, compliance, notarization, or document processing. Each payment reveals a new blockage.">Lažni NGO kontaktira organizaciju ili fizičko lice s ponudom za partnerstvo: zajednički projekat, suko-finansiranje granta, program obuke ili razvojna saradnja. Pre nego što partnerstvo ili grant mogu biti formalizovani, traže se naknade za registraciju, usaglašenost, notarizaciju ili obradu dokumentacije. Svaka uplata otkriva novu blokadu.</p>
</section>
...
<section class="content-section">
  ...
  <div class="phase">
    ...
    <p data-sr="Lažni NGO → ponuda partnerstva ili granta → naknada za registraciju ili usaglašenost → serija novih naknada → partnerstvo ne postoji → gubitak" data-en="Fake NGO → partnership or grant offer → registration or compliance fee → series of new fees → partnership does not exist → loss">Lažni NGO → ponuda partnerstva ili granta → naknada za registraciju ili usaglašenost → serija novih naknada → partnerstvo ne postoji → gubitak</p>
  </div>
  <div class="callout">
    <strong data-sr="Prag:" data-en="Threshold:">Prag:</strong>
    <span data-sr="Svaki NGO koji traži naknadu pre potpisivanja partnerskog sporazuma ili pre apliciranja za zajednički grant je alarm." data-en="Any NGO requesting a fee before signing a partnership agreement or before joint grant application is an alarm.">Svaki NGO koji traži naknadu pre potpisivanja partnerskog sporazuma ili pre apliciranja za zajednički grant je alarm.</span>
  </div>
</section>
...
<section class="content-section">
  ...
  <div class="phase">
    <div class="label" data-sr="Faza 1: Inicijalni kontakt — ponuda partnerstva" data-en="Phase 1: Initial contact — partnership offer">Faza 1: Inicijalni kontakt — ponuda partnerstva</div>
    <p data-sr="Meta prima e-poruku ili LinkedIn poruku s ponudom za saradnju: specifičan projekat, poziv za prijavu na grant program ili ponuda za koprodukciju publikacije. Poruka zvuči stručno i personalizovano." data-en="The target receives an email or LinkedIn message with a collaboration offer: a specific project, invitation to apply for a grant program, or an offer for co-production of a publication. The message sounds professional and personalized.">Meta prima e-poruku ili LinkedIn poruku s ponudom za saradnju: specifičan projekat, poziv za prijavu na grant program ili ponuda za koprodukciju publikacije. Poruka zvuči stručno i personalizovano.</p>
    <ul class="bullets">
...
<section class="content-section">
  ...
  <ul class="bullets">
    <li data-sr="NGO nije registrovan ni u jednom dostupnom registru nevladinih organizacija." data-en="The NGO is not registered in any accessible register of non-governmental organizations.">NGO nije registrovan ni u jednom dostupnom registru nevladinih organizacija.</li>
    <li data-sr="Ponuda stiže bez prethodnog poznanstva ili veze s nekom zajedničkom mrežom." data-en="The offer arrives without prior acquaintance or connection through a shared network.">Ponuda stiže bez prethodnog poznanstva ili veze s nekom zajedničkom mrežom.</li>
    <li data-sr="Naknada se traži pre potpisivanja ugovora ili pre apliciranja za grant." data-en="A fee is requested before signing a contract or before applying for a grant.">Naknada se traži pre potpisivanja ugovora ili pre apliciranja za grant.</li>
    <li data-sr="Naknada se šalje na privatno ime ili na kriptovalutni novčanik." data-en="The fee is sent to a private individual's name or to a cryptocurrency wallet.">Naknada se šalje na privatno ime ili na kriptovalutni novčanik.</li>
    <li data-sr="NGO navodi poznate organizacije kao partnere, ali oni ne potvrđuju saradnju." data-en="The NGO cites well-known organizations as partners, but they do not confirm the collaboration.">NGO navodi poznate organizacije kao partnere, ali oni ne potvrđuju saradnju.</li>
    <li data-sr="Kontakt osoba komunicira s Gmailom ili privatnim e-mailom umesto s korporativnim domenom NGO-a." data-en="The contact person communicates via Gmail or a private email rather than the NGO's corporate domain.">Kontakt osoba komunicira s Gmailom ili privatnim e-mailom umesto s korporativnim domenom NGO-a.</li>
  </ul>
</section>
...
<section class="content-section">
  ...
  <ul class="bullets">
    <li data-sr="Pretražite naziv NGO-a u registru nevladinih organizacija matične države organizacije." data-en="Search the NGO name in the register of non-governmental organizations of the organization's home country.">Pretražite naziv NGO-a u registru nevladinih organizacija matične države organizacije.</li>
    <li data-sr="Pozovite telefon naveden na sajtu NGO-a — proverite da li vam ko javi." data-en="Call the phone number listed on the NGO's website — verify whether someone answers.">Pozovite telefon naveden na sajtu NGO-a — proverite da li vam ko javi.</li>
    <li data-sr="Pretražite ime kontakt osobe na LinkedIn-u i proverite da li njena karijerna istorija odgovara navedenom NGO-u." data-en="Search the contact person's name on LinkedIn and verify whether their career history matches the stated NGO.">Pretražite ime kontakt osobe na LinkedIn-u i proverite da li njena karijerna istorija odgovara navedenom NGO-u.</li>
    <li data-sr="Kontaktirajte navedene partnerske organizacije direktno da potvrde saradnju s ovim NGO-om." data-en="Contact the listed partner organizations directly to confirm their collaboration with this NGO.">Kontaktirajte navedene partnerske organizacije direktno da potvrde saradnju s ovim NGO-om.</li>
    <li data-sr="Proverite datum registracije domena sajta NGO-a — novi domen s profesionalnim izgledom je alarm." data-en="Check the registration date of the NGO website's domain — a new domain with a professional appearance is an alarm.">Proverite datum registracije domena sajta NGO-a — novi domen s profesionalnim izgledom je alarm.</li>
  </ul>
</section>

<section class="content-section">
  <h2 data-sr="Checklista pre potpisivanja NGO partnerskog sporazuma" data-en="Checklist before signing an NGO partnership agreement">Checklista pre potpisivanja NGO partnerskog sporazuma</h2>
  <ul class="bullets">
    <li data-sr="Da li je NGO registrovan u dostupnom registru nevladinih organizacija?" data-en="Is the NGO registered in an accessible register of non-governmental organizations?">Da li je NGO registrovan u dostupnom registru nevladinih organizacija?</li>
    <li data-sr="Da li NGO ima finansijski izveštaj za prethodnu godinu koji je javno dostupan?" data-en="Does the NGO have a publicly available financial report for the previous year?">Da li NGO ima finansijski izveštaj za prethodnu godinu koji je javno dostupan?</li>
    <li data-sr="Da li kontakt osoba komunicira s korporativnog e-mail domena NGO-a?" data-en="Does the contact person communicate from the NGO's corporate email domain?">Da li kontakt osoba komunicira s korporativnog e-mail domena NGO-a?</li>
...
<section class="content-section">
  ...
  <ul class="bullets">
    <li data-sr="Zaustavite sve naknade odmah — svaka nova uplata samo potvrđuje da funkcionišete kao meta." data-en="Stop all fees immediately — every new payment only confirms you are functioning as a target.">Zaustavite sve naknade odmah — svaka nova uplata samo potvrđuje da funkcionišete kao meta.</li>
    ...
    <li data-sr="Sačuvajte svu dokumentaciju — e-poruke, ugovore, potvrde uplata, profile na društvenim mrežama." data-en="Preserve all documentation — emails, contracts, payment confirmations, social media profiles.">Sačuvajte svu dokumentaciju — e-poruke, ugovore, potvrde uplata, profile na društvenim mrežama.</li>
    <li data-sr="Prijavite NGO lokalnoj policiji, registru NGO-a i FATF-u." data-en="Report the NGO to the local police, the NGO register, and FATF.">Prijavite NGO lokalnoj policiji, registru NGO-a i FATF-u.</li>
    <li data-sr="Upozorite kolege i partnersku mrežu — prevaranti rade na istom tematskom polju i ciljaju slične organizacije." data-en="Warn colleagues and partner networks — fraudsters operate in the same thematic field and target similar organizations.">Upozorite kolege i partnersku mrežu — prevaranti rade na istom tematskom polju i ciljaju slične organizacije.</li>
  </ul>
</section>
