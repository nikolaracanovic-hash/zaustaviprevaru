...
window.SCAM_CONTENT["surrogacy-fertility-arrangement-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Lažna klinika ili posrednik traži veliki depozit za program koji ne postoji, koristi lažne profile surrogate majki i izbegava licencirane kanale." data-en="A fake clinic or broker demands a large deposit for a program that does not exist, uses invented surrogate profiles, and avoids licensed channels.">Lažna klinika ili posrednik traži veliki depozit za program koji ne postoji, koristi lažne profile surrogate majki i izbegava licencirane kanale.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Oglas → ugovor → depozit → nestanak." data-en="<strong>Model:</strong> Ad → contract → deposit → disappearance."><strong>Model:</strong> Oglas → ugovor → depozit → nestanak.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnim surrogacy ili fertilitet aranžmanom." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: fake surrogacy or fertility arrangement scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnim surrogacy ili fertilitet aranžmanom.</p>
        <ul class="bullets">
