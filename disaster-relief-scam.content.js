...
window.SCAM_CONTENT["disaster-relief-scam"] = {
  raw_html: `
...
<section class="content-section">
  ...
  <div class="phase">
    ...
    <p data-sr="Katastrofa → lažni fond za pomoć ili lažna državna pomoć → uplata procesne naknade ili predaja podataka → novac ili podaci odlaze prevarantu → pomoć ne dolazi → gubitak" data-en="Disaster → fake relief fund or fake government aid → payment of processing fee or data handover → money or data goes to fraudster → assistance never arrives → loss">Katastrofa → lažni fond za pomoć ili lažna državna pomoć → uplata procesne naknade ili predaja podataka → novac ili podaci odlaze prevarantu → pomoć ne dolazi → gubitak</p>
  </div>
  <div class="callout">
    <strong data-sr="Prag:" data-en="Threshold:">Prag:</strong>
    <span data-sr="Prava državna pomoć ne traži unaprednu uplatu — svaki zahtev za uplatom radi primanja pomoći je signal prevare." data-en="Real government aid does not require upfront payment — any payment request to receive aid is a fraud signal.">Prava državna pomoć ne traži unaprednu uplatu — svaki zahtev za uplatom radi primanja pomoći je signal prevare.</span>
  </div>
</section>
...
<section class="content-section">
  ...
  <div class="grid-2">
    <article>
      ...
      <ul class="bullets">
        <li data-sr="Lažni agenti referišu na stvarni fond za pomoć koji vlada jeste najavila — ali ne kroz taj kanal." data-en="Fake agents reference a real relief fund that the government has announced — but not through that channel.">Lažni agenti referišu na stvarni fond za pomoć koji vlada jeste najavila — ali ne kroz taj kanal.</li>
        <li data-sr="Komunikacija koristi zvanični izgled — logotipe državnih organa, referentne brojeve, pečate." data-en="Communication uses an official appearance — logos of state authorities, reference numbers, stamps.">Komunikacija koristi zvanični izgled — logotipe državnih organa, referentne brojeve, pečate.</li>
        <li data-sr="Prevarant može navesti tačnu lokaciju i podatke o imovini žrtve koji su dostupni iz javnih izvora posle katastrofe." data-en="The fraudster may state the victim's exact location and property details available from public sources after the disaster.">Prevarant može navesti tačnu lokaciju i podatke o imovini žrtve koji su dostupni iz javnih izvora posle katastrofe.</li>
        <li data-sr="Atmosfera hitnosti i haosa posle katastrofe smanjuje kritičku otpornost žrtava." data-en="The atmosphere of urgency and chaos after a disaster reduces victims' critical resistance.">Atmosfera hitnosti i haosa posle katastrofe smanjuje kritičku otpornost žrtava.</li>
      </ul>
    </article>
    <article>
...
<section class="content-section">
  ...
  <div class="phase">
    <div class="label" data-sr="Faza 1: Katastrofa i haos" data-en="Phase 1: Disaster and chaos">Faza 1: Katastrofa i haos</div>
    <p data-sr="Katastrofa se desi — potres, poplava, požar, rat. Prevaranti prate medijsko izveštavanje i unutar 24–48 sati lansiraju kampanje ili počinju da kontaktiraju žrtve." data-en="A disaster occurs — earthquake, flood, fire, war. Fraudsters monitor media coverage and within 24–48 hours launch campaigns or begin contacting victims.">Katastrofa se desi — potres, poplava, požar, rat. Prevaranti prate medijsko izveštavanje i unutar 24–48 sati lansiraju kampanje ili počinju da kontaktiraju žrtve.</p>
    <ul class="bullets">
...
<section class="content-section">
  ...
  <ul class="bullets">
    <li data-sr="Kontakt o državnoj pomoći dolazi u prvim danima posle katastrofe bez zvanične najave programa." data-en="Aid contact arrives in the first days after a disaster without an official program announcement.">Kontakt o državnoj pomoći dolazi u prvim danima posle katastrofe bez zvanične najave programa.</li>
    <li data-sr="Naknada za registraciju, obradu ili pristup fondu za pomoć se traži pre isplate." data-en="A fee for registration, processing, or access to the relief fund is requested before disbursement.">Naknada za registraciju, obradu ili pristup fondu za pomoć se traži pre isplate.</li>
    <li data-sr="Traže se podaci o bankovnom računu kroz telefonski poziv ili SMS — bez zvaničnog portala." data-en="Bank account details are requested through a phone call or SMS — without an official portal.">Traže se podaci o bankovnom računu kroz telefonski poziv ili SMS — bez zvaničnog portala.</li>
    <li data-sr="Kontakt dolazi s broja koji nije naveden na zvaničnom sajtu nadležne agencije." data-en="Contact comes from a number not listed on the official website of the competent agency.">Kontakt dolazi s broja koji nije naveden na zvaničnom sajtu nadležne agencije.</li>
    <li data-sr="Agent insistira na hitnosti i tvrdi da rok za prijavu ističe u roku od nekoliko sati." data-en="The agent insists on urgency and claims that the application deadline expires within a few hours.">Agent insistira na hitnosti i tvrdi da rok za prijavu ističe u roku od nekoliko sati.</li>
  </ul>
</section>
...
<section class="content-section">
  ...
  <ul class="bullets">
    <li data-sr="Pretražite zvanični sajt nadležne vladine agencije za pomoć u katastrofama u vašoj državi." data-en="Search the official website of the competent government disaster relief agency in your country.">Pretražite zvanični sajt nadležne vladine agencije za pomoć u katastrofama u vašoj državi.</li>
    <li data-sr="Pozovite zvaničnu kontakt liniju agencije — ne broj koji vam je dao napadač." data-en="Call the official contact line of the agency — not the number the attacker gave you.">Pozovite zvaničnu kontakt liniju agencije — ne broj koji vam je dao napadač.</li>
    <li data-sr="Proverite vladine vesti o aktivnim programima pomoći — pravi programi su javno najavljeni." data-en="Check government news for active assistance programs — real programs are publicly announced.">Proverite vladine vesti o aktivnim programima pomoći — pravi programi su javno najavljeni.</li>
    <li data-sr="Prava pomoć u katastrofi se nikad ne naplaćuje unapred — ovo je apsolutan princip svih legitimnih programa." data-en="Real disaster aid is never charged upfront — this is an absolute principle of all legitimate programs.">Prava pomoć u katastrofi se nikad ne naplaćuje unapred — ovo je apsolutan princip svih legitimnih programa.</li>
    <li data-sr="Proverite broj pozivaoca pretragom online da li je prijavivan u kontekstu prevara po katastrofi." data-en="Check the caller's number online to see whether it has been reported in the context of post-disaster fraud.">Proverite broj pozivaoca pretragom online da li je prijavivan u kontekstu prevara po katastrofi.</li>
  </ul>
</section>

<section class="content-section">
  <h2 data-sr="Checklista pre uplate za fond za pomoć u katastrofi" data-en="Checklist before paying for a disaster relief fund">Checklista pre uplate za fond za pomoć u katastrofi</h2>
  <ul class="bullets">
    <li data-sr="Da li je ovaj program pomoći zvanično najavljivan od strane vladine agencije?" data-en="Has this assistance program been officially announced by a government agency?">Da li je ovaj program pomoći zvanično najavljivan od strane vladine agencije?</li>
    <li data-sr="Da li se traži unapredna naknada za pristup pomoći — što nikad nije slučaj u legitimnim programima?" data-en="Is an upfront fee requested for access to assistance — which is never the case in legitimate programs?">Da li se traži unapredna naknada za pristup pomoći — što nikad nije slučaj u legitimnim programima?</li>
    <li data-sr="Da li kontakt dolazi s broja navedenog na zvaničnom sajtu agencije?" data-en="Does the contact come from a number listed on the official agency website?">Da li kontakt dolazi s broja navedenog na zvaničnom sajtu agencije?</li>
    <li data-sr="Da li se traže podaci o bankovnom računu kroz telefonski poziv ili SMS bez zvaničnog portala?" data-en="Are bank account details requested through a phone call or SMS without an official portal?">Da li se traže podaci o bankovnom računu kroz telefonski poziv ili SMS bez zvaničnog portala?</li>
    <li data-sr="Da li sam pozvao zvaničnu kontakt liniju agencije da potvrdim program?" data-en="Have I called the official agency contact line to confirm the program?">Da li sam pozvao zvaničnu kontakt liniju agencije da potvrdim program?</li>
    <li data-sr="Da li postoji rok kraći od jednog radnog dana za odluku — što je signal prevare, ne legitimnog programa?" data-en="Is there a deadline shorter than one business day — which is a fraud signal, not a legitimate program?">Da li postoji rok kraći od jednog radnog dana za odluku — što je signal prevare, ne legitimnog programa?</li>
  </ul>
</section>
...
<section class="content-section">
  ...
  <ul class="bullets">
    <li data-sr="Prekinite kontakt odmah i ne dajte nikakve podatke o bankovnom računu." data-en="End contact immediately and do not provide any bank account information.">Prekinite kontakt odmah i ne dajte nikakve podatke o bankovnom računu.</li>
    <li data-sr="Ako ste dali podatke o računu, odmah blokirajte karticu i pozovite banku." data-en="If you provided account information, immediately block the card and call the bank.">Ako ste dali podatke o računu, odmah blokirajte karticu i pozovite banku.</li>
    <li data-sr="Prijavite incident policiji s detaljima kontakta i komunikacije." data-en="Report the incident to the police with contact and communication details.">Prijavite incident policiji s detaljima kontakta i komunikacije.</li>
    <li data-sr="Prijavite lažni program nadležnoj agenciji za pomoć radi upozorenja i istrage." data-en="Report the fake program to the competent aid agency for warning and investigation.">Prijavite lažni program nadležnoj agenciji za pomoć radi upozorenja i istrage.</li>
    <li data-sr="Upozorite komšije i lokalnu zajednicu — prevaranti u postkriznim situacijama ciljaju geografski koncentrisane oblasti." data-en="Warn neighbors and the local community — fraudsters in post-crisis situations target geographically concentrated areas.">Upozorite komšije i lokalnu zajednicu — prevaranti u postkriznim situacijama ciljaju geografski koncentrisane oblasti.</li>
  </ul>
</section>
