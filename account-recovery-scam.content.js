...
<section class="content-section">
  ...
  <p data-sr="Za razliku od prevare u kojoj prijatelj u četu traži kod za oporavak, ovde napad počinje tek pošto je pristup već izgubljen i meta sama traži pomoć. Glavni mamac nije lični odnos nego lažni autoritet podrške, oglasa ili specijaliste za recovery koji presreće potragu za rešenjem." data-en="Unlike the chat-app pattern where a friend asks for a recovery code, this attack starts only after access has already been lost and the target begins searching for help. The main lure is not a personal relationship but the fake authority of support, an ad, or a recovery specialist intercepting that search for a solution.">Za razliku od prevare u kojoj prijatelj u četu traži kod za oporavak, ovde napad počinje tek pošto je pristup već izgubljen i meta sama traži pomoć. Glavni mamac nije lični odnos nego lažni autoritet podrške, oglasa ili specijaliste za recovery koji presreće potragu za rešenjem.</p>
  <p data-sr="Efikasnost prevare leži u tome što cilja trenutak najveće ranjivosti: žrtva je već uznemirena gubitkom naloga i sklona je brzim odlukama. Lažna podrška deluje profesionalno — koristi logo platforme, stručnu terminologiju i obećava brzo rešenje, ali svaki korak oporavka zapravo vodi ka novoj predaji podataka, novcu ili daljem gubitku kontrole." data-en="The scam works by targeting the moment of greatest vulnerability: the victim is already distressed by losing access and prone to rushed decisions. Fake support looks professional, using platform branding, technical language, and promises of a quick fix, but each supposed recovery step actually leads to more data handover, more fees, or deeper loss of control.">Efikasnost prevare leži u tome što cilja trenutak najveće ranjivosti: žrtva je već uznemirena gubitkom naloga i sklona je brzim odlukama. Lažna podrška deluje profesionalno — koristi logo platforme, stručnu terminologiju i obećava brzo rešenje, ali svaki korak oporavka zapravo vodi ka novoj predaji podataka, novcu ili daljem gubitku kontrole.</p>
</section>
...
<section class="content-section">
  ...
  <div class="phase">
    ...
    <p data-sr="Žrtva pretražuje internet za podršku, broj službe, obrazac za žalbu ili brz recovery. Lažni rezultati se pojavljuju visoko u pretraživaču, u komentarima ispod zvaničnih objava ili u DM porukama koje nude prečicu umesto zvanične procedure." data-en="The victim searches online for support, a service number, a complaint form, or a fast recovery. Fake results appear high in search, in comments under official posts, or in DMs offering a shortcut instead of the official process.">Žrtva pretražuje internet za podršku, broj službe, obrazac za žalbu ili brz recovery. Lažni rezultati se pojavljuju visoko u pretraživaču, u komentarima ispod zvaničnih objava ili u DM porukama koje nude prečicu umesto zvanične procedure.</p>
    <ul>
  ...
  <div class="phase">
    ...
    <p data-sr="Napadač deluje profesionalno i traži informacije koje zvuče rutinski: korisničko ime, datum otvaranja naloga, poslednji uspešan pristup ili opis problema. Žrtva veruje da je u kontaktu sa pravom podrškom zato što pitanja liče na skriptu za proveru identiteta." data-en="The attacker acts professionally and asks for information that sounds routine: username, account creation date, last successful sign-in, or a description of the problem. The victim believes they are talking to real support because the questions resemble a standard identity-verification script.">Napadač deluje profesionalno i traži informacije koje zvuče rutinski: korisničko ime, datum otvaranja naloga, poslednji uspešan pristup ili opis problema. Žrtva veruje da je u kontaktu sa pravom podrškom zato što pitanja liče na skriptu za proveru identiteta.</p>
    <ul>
  ...
  <div class="phase">
    ...
    <ul>
      <li data-sr="Za verifikaciju nam je potreban OTP koji stiže na vaš telefon." data-en="'For verification you need to send us the OTP arriving on your phone.'.">Za verifikaciju nam je potreban OTP koji stiže na vaš telefon.</li>
...
<section class="content-section">
  ...
  <ul>
    ...
    <li data-sr="Ako ste već kontaktirali podršku, proverite da li vas je ikad uputila da sami otvorite zvanični sajt bez njihovog linka." data-en="If you already contacted support, check whether they ever told you to open the official website yourself without using their link.">Ako ste već kontaktirali podršku, proverite da li vas je ikad uputila da sami otvorite zvanični sajt bez njihovog linka.</li>
  </ul>
</section>
...
<section class="content-section">
  ...
  <ol>
    ...
    <li data-sr="Da li je podrška tražila da instaliram softver za udaljeni pristup?" data-en="Did the support ask me to install remote-access software?">Da li je podrška tražila da instaliram softver za udaljeni pristup?</li>
    ...
    <li data-sr="Da li me podrška vodi kroz njihov link umesto da mi kaže da sam ručno otvorim zvaničnu stranicu?" data-en="Is the support steering me through their link instead of telling me to open the official site manually?">Da li me podrška vodi kroz njihov link umesto da mi kaže da sam ručno otvorim zvaničnu stranicu?</li>
    <li data-sr="Da li se traženi koraci više bave uplatom i kodovima nego stvarnim dokazivanjem vlasništva nad nalogom?" data-en="Do the requested steps focus more on fees and codes than on real proof of account ownership?">Da li se traženi koraci više bave uplatom i kodovima nego stvarnim dokazivanjem vlasništva nad nalogom?</li>
  </ol>
</section>
