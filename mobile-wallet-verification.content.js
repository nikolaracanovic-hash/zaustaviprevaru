...
window.SCAM_CONTENT["mobile-wallet-verification"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: lažna verifikacija mobilnog novčanika" data-en="Introduction: fake mobile wallet verification">Uvod: lažna verifikacija mobilnog novčanika</h2>
      <p data-sr="SMS ili poziv traži link, kod ili probni transfer da navodno zaštitite novčanik, a cilj je preuzimanje naloga." data-en="SMS or call asks for link, code, or test transfer to supposedly secure the wallet, but the goal is account takeover.">SMS ili poziv traži link, kod ili probni transfer da navodno zaštitite novčanik, a cilj je preuzimanje naloga.</p>
      <p data-sr="Aplikacija se skida van zvanične prodavnice ili traži neobične dozvole." data-en="App is downloaded outside official store or asks unusual permissions.">Aplikacija se skida van zvanične prodavnice ili traži neobične dozvole.</p>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
            <li data-sr="Poruka stiže sa nepoznatog broja bez prethodnog tiketa." data-en="Message arrives from unknown number with no prior ticket.">Poruka stiže sa nepoznatog broja bez prethodnog tiketa.</li>
            <li data-sr="Link koristi domen koji liči na brend novčanika ali nije identičan." data-en="Link uses wallet-like domain but not identical.">Link koristi domen koji liči na brend novčanika ali nije identičan.</li>
            <li data-sr="Traže seed frazu ili recovery reči radi navodne sinhronizacije." data-en="Seed phrase or recovery words requested for alleged sync.">Traže seed frazu ili recovery reči radi navodne sinhronizacije.</li>
            <li data-sr="Pozivalac traži da instalirate APK direktno sa njihovog linka." data-en="Caller asks you to install APK directly from their link.">Pozivalac traži da instalirate APK direktno sa njihovog linka.</li>
            <li data-sr="Traže da prebacite sva sredstva na privremeni adresa za verifikaciju." data-en="They ask you to move all funds to temporary address for verification.">Traže da prebacite sva sredstva na privremeni adresa za verifikaciju.</li>
            <li data-sr="SMS sadrži hitnost u roku od nekoliko minuta." data-en="SMS contains urgency within minutes.">SMS sadrži hitnost u roku od nekoliko minuta.</li>
            <li data-sr="Traže da onemogućite 2FA privremeno." data-en="They ask you to disable 2FA temporarily.">Traže da onemogućite 2FA privremeno.</li>
            <li data-sr="Nakon klika, traže lozinku u običnoj HTTP formi." data-en="After click, password is asked in plain HTTP form.">Nakon klika, traže lozinku u običnoj HTTP formi.</li>
            <li data-sr="Zvanična aplikacija novčanika nema obaveštenje o potrebi verifikacije." data-en="Official wallet app shows no verification requirement notice.">Zvanična aplikacija novčanika nema obaveštenje o potrebi verifikacije.</li>
            <li data-sr="Broj za podršku u poruci ne postoji na zvaničnom sajtu." data-en="Support number in message is not on official site.">Broj za podršku u poruci ne postoji na zvaničnom sajtu.</li>
      </ul>
    </section>
