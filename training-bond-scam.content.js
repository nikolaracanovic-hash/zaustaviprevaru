...
window.SCAM_CONTENT["training-bond-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Tvrdi se da moraš ostaviti depozit jer je obuka skupa i firma se štiti. Pravi poslovi retko traže lični depozit pre prvog dana." data-en="You must leave a deposit because training is expensive and the company protects itself. Real jobs rarely ask a personal deposit before day one.">Tvrdi se da moraš ostaviti depozit jer je obuka skupa i firma se štiti. Pravi poslovi retko traže lični depozit pre prvog dana.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se strah od gubitka prilike ako ne potpišeš odmah." data-en="Fear of losing the opportunity if you do not sign immediately is exploited.">Koristi se strah od gubitka prilike ako ne potpišeš odmah.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Obećanje visoke zarade posle kratke obuke." data-en="High pay is promised after short training.">Obećanje visoke zarade posle kratke obuke.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Ugovor o bond-u nije pregledan od strane nezavisnog advokata." data-en="The bond agreement was not reviewed by an independent lawyer.">Ugovor o bond-u nije pregledan od strane nezavisnog advokata.</li>
        ...
        <li data-sr="Priča o bond-u se menja kada tražiš pauzu od 24 sata." data-en="The story about the bond changes when you ask for a 24-hour pause.">Priča o bond-u se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za obavezi obuke. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to training bond. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za obavezi obuke. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Depozit je veći od jedne plate." data-en="The deposit is larger than one paycheque.">Depozit je veći od jedne plate.</li>
        <li data-sr="Kazna za raskid je ekstremno visoka." data-en="Exit penalties are extremely high.">Kazna za raskid je ekstremno visoka.</li>
        <li data-sr="Tekst spominje da gubiš depozit pri bilo kom kašnjenju." data-en="Text says you lose the deposit for any lateness.">Tekst spominje da gubiš depozit pri bilo kom kašnjenju.</li>
        <li data-sr="Firma ne može pokazati licencu za obuku." data-en="The company cannot show a training licence.">Firma ne može pokazati licencu za obuku.</li>
        <li data-sr="Traže se roditelji kao garanti." data-en="Parents are asked as guarantors.">Traže se roditelji kao garanti.</li>
        <li data-sr="Potpisuješ pred kamerom bez čitanja." data-en="You sign on camera without reading.">Potpisuješ pred kamerom bez čitanja.</li>
        <li data-sr="Zabrana kopiranja ugovora." data-en="Copying the contract is forbidden.">Zabrana kopiranja ugovora.</li>
        <li data-sr="Refund se uslovljava novim troškovima." data-en="Refund is conditioned on new fees.">Refund se uslovljava novim troškovima.</li>
        <li data-sr="Adresa obuke je privremeni prostor." data-en="The training address is a temporary space.">Adresa obuke je privremeni prostor.</li>
        <li data-sr="Isti bond šablon za različite industrije." data-en="The same bond template is used across industries.">Isti bond šablon za različite industrije.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za obavezi obuke." data-en="Can I find the same offer on an official site or vacancy for training bond.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za obavezi obuke.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Mladi ulaze u prvi posao. Predložite advokata pre potpisa bilo kakvog bond-a." data-en="Young people enter a first job. Suggest a lawyer before signing any bond.">Mladi ulaze u prvi posao. Predložite advokata pre potpisa bilo kakvog bond-a.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za obavezi obuke." data-en="Have you ever seen a real employer ask for the same step for training bond.">Da li si ikada video da pravi poslodavac traži isti korak za obavezi obuke.</li>
