...
window.SCAM_CONTENT["festival-volunteer-fee-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Oglas obećava ulaz iza scene i susret sa izvođačima uz malu naknadu. Organizator na zvaničnom sajtu nema isti program." data-en="An ad promises backstage access and artist meetups for a small fee. The organizer on the official site has no matching programme.">Oglas obećava ulaz iza scene i susret sa izvođačima uz malu naknadu. Organizator na zvaničnom sajtu nema isti program.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se želja za besplatnim ulazom i iskustvom." data-en="The desire for free entry and experience is exploited.">Koristi se želja za besplatnim ulazom i iskustvom.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Hitnost jer su mesta ograničena." data-en="Urgency because spots are limited.">Hitnost jer su mesta ograničena.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Imejl domen nije isti kao zvanični festival sajt." data-en="The email domain is not the same as the official festival site.">Imejl domen nije isti kao zvanični festival sajt.</li>
        ...
        <li data-sr="Priča o volontiranju se menja kada tražiš pauzu od 24 sata." data-en="The story about volunteering changes when you ask for a 24-hour pause.">Priča o volontiranju se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za volonterskom mestu. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to volunteer spot. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za volonterskom mestu. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Volonter mora platiti akreditaciju u gotovom." data-en="The volunteer must pay accreditation in cash.">Volonter mora platiti akreditaciju u gotovom.</li>
        <li data-sr="Nema liste smena i kontakt osobe sa domena festivala." data-en="There is no shift list and contact from the festival domain.">Nema liste smena i kontakt osobe sa domena festivala.</li>
        <li data-sr="Traže se podaci kartice za depozit opreme." data-en="Card details are requested for equipment deposit.">Traže se podaci kartice za depozit opreme.</li>
        <li data-sr="Lokacija obuke je daleko od poznate lokacije festivala." data-en="Training location is far from the known festival site.">Lokacija obuke je daleko od poznate lokacije festivala.</li>
        <li data-sr="Isti oglas za različite festivale iste nedelje." data-en="The same ad for different festivals the same week.">Isti oglas za različite festivale iste nedelje.</li>
        <li data-sr="Komunikacija je WhatsApp grupa bez imena organizatora." data-en="Communication is a WhatsApp group without organizer names.">Komunikacija je WhatsApp grupa bez imena organizatora.</li>
        <li data-sr="Zabrana kontakta sa štabom preko zvaničnog mejla." data-en="Contact with HQ via official email is discouraged.">Zabrana kontakta sa štabom preko zvaničnog mejla.</li>
        <li data-sr="Traže se fotografije lične karte." data-en="ID photos are requested.">Traže se fotografije lične karte.</li>
        <li data-sr="Uplata ide na lično ime." data-en="Payment goes to a personal name.">Uplata ide na lično ime.</li>
        <li data-sr="Nema potpisanog volonterskog ugovora." data-en="There is no signed volunteer agreement.">Nema potpisanog volonterskog ugovora.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za volonterskom mestu." data-en="Can I find the same offer on an official site or vacancy for volunteer spot.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za volonterskom mestu.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Kandidat želi muziku uživo. Otvorite zvanični sajt festivala i odeljak volonteri." data-en="The candidate wants live music. Open the official festival site and the volunteers section.">Kandidat želi muziku uživo. Otvorite zvanični sajt festivala i odeljak volonteri.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za volonterskom mestu." data-en="Have you ever seen a real employer ask for the same step for volunteer spot.">Da li si ikada video da pravi poslodavac traži isti korak za volonterskom mestu.</li>
