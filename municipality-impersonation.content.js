  ...
  raw_html: `
      ...
      <div class="grid-2">
        ...
        <div class="phase">
          ...
          <ul class="bullets">
            ...
            <li data-sr="rok od 24–72 sata uz pretnju uvećanom kaznom ili deregistracijom adrese." data-en="24–72 hour deadline with a threat of an increased fine or address deregistration.">rok od 24–72 sata uz pretnju uvećanom kaznom ili deregistracijom adrese.</li>
    ...
    <section class="card">
      ...
      <article class="phase warn">
        ...
        <p data-sr="Posle prve uplate može doći novi inspektor ili neko nudi povraćaj uz novu uplatu — varijanta lažnog povraćaja." data-en="After the first payment, a new inspector may arrive with a new problem, or someone calls offering a refund of the previous payment for an advance. Both scenarios are a continuation of the same scheme.">Posle prve uplate može doći novi inspektor ili neko nudi povraćaj uz novu uplatu — varijanta lažnog povraćaja.</p>
      </article>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        ...
        <li data-sr="rok je 24h uz pretnju deregistracijom adrese ili većom kaznom." data-en="deadline is 24 hours with a threat of address deregistration or larger fine.">rok je 24h uz pretnju deregistracijom adrese ili većom kaznom.</li>
