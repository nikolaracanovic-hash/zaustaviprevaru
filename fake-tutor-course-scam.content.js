...
window.SCAM_CONTENT["fake-tutor-course-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Reklama obećava tačan skor ili prolaz uz tajne materijale. Nakon uplate linkovi ne rade ili su materijali besplatni sa interneta." data-en="Ads promise an exact score or pass with secret materials. After payment links break or materials are free from the internet.">Reklama obećava tačan skor ili prolaz uz tajne materijale. Nakon uplate linkovi ne rade ili su materijali besplatni sa interneta.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se strah od padanja godine." data-en="Fear of failing the year is exploited.">Koristi se strah od padanja godine.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Garantovan prolaz bez poznavanja tvog nivoa." data-en="Guaranteed pass without knowing your level.">Garantovan prolaz bez poznavanja tvog nivoa.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Tutor ne može pokazati diplome ili registraciju ustanove." data-en="The tutor cannot show diplomas or school registration.">Tutor ne može pokazati diplome ili registraciju ustanove.</li>
        ...
        <li data-sr="Priča o kursu se menja kada tražiš pauzu od 24 sata." data-en="The story about the course changes when you ask for a 24-hour pause.">Priča o kursu se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za tutorstvu ili kursu. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to tutoring or a course. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za tutorstvu ili kursu. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Cena je neobično visoka za broj časova." data-en="The price is unusually high for the number of lessons.">Cena je neobično visoka za broj časova.</li>
        <li data-sr="Traže se svi novci pre prvog susreta." data-en="All money is requested before the first meeting.">Traže se svi novci pre prvog susreta.</li>
        <li data-sr="Kontakt je samo Instagram ili TikTok." data-en="Contact is only Instagram or TikTok.">Kontakt je samo Instagram ili TikTok.</li>
        <li data-sr="Zabrana refund čak i ako ne kreneš." data-en="No refund even if you never start.">Zabrana refund čak i ako ne kreneš.</li>
        <li data-sr="Materijali su PDF sa vodenim žigom interneta." data-en="Materials are watermarked PDFs from the web.">Materijali su PDF sa vodenim žigom interneta.</li>
        <li data-sr="Isti tutor koristi različita imena." data-en="The same tutor uses different names.">Isti tutor koristi različita imena.</li>
        <li data-sr="Recenzije su generičke sa istim fotografijama." data-en="Reviews are generic with the same photos.">Recenzije su generičke sa istim fotografijama.</li>
        <li data-sr="Traže se podaci studentskog naloga." data-en="Student account credentials are requested.">Traže se podaci studentskog naloga.</li>
        <li data-sr="Ponuda spominje unutrašnje pitanje ispita." data-en="The offer mentions insider exam questions.">Ponuda spominje unutrašnje pitanje ispita.</li>
        <li data-sr="Nema ugovora o uslugama." data-en="There is no service contract.">Nema ugovora o uslugama.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za tutorstvu." data-en="Can I find the same offer on an official site or vacancy for tutoring.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za tutorstvu.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Student paniči pred ispit. Predložite probni čas uz malu naknadu ili besplatno uvodno savetovanje." data-en="The student panics before an exam. Suggest a trial lesson with a small fee or free intro consultation.">Student paniči pred ispit. Predložite probni čas uz malu naknadu ili besplatno uvodno savetovanje.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za tutorstvu ili kursu." data-en="Have you ever seen a real employer ask for the same step for tutoring or a course.">Da li si ikada video da pravi poslodavac traži isti korak za tutorstvu ili kursu.</li>
