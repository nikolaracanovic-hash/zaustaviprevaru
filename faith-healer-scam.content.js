...
window.SCAM_CONTENT["faith-healer-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Iscelitelj traži donacije, naknade za ritual ili kupovinu posvećenih predmeta uz obećanje izlečenja koje se odlikuje izbegavanjem zvanične medicine." data-en="A healer asks for donations, ritual fees, or purchases of blessed items while promising cures and steering away from legitimate medical care.">Iscelitelj traži donacije, naknade za ritual ili kupovinu posvećenih predmeta uz obećanje izlečenja koje se odlikuje izbegavanjem zvanične medicine.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Obećanje → uplata → ponavljanje bez rezultata." data-en="<strong>Model:</strong> Promise → payment → repeat without results."><strong>Model:</strong> Obećanje → uplata → ponavljanje bez rezultata.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnog iscelitelja ili duhovnog učitelja." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: faith healer scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnog iscelitelja ili duhovnog učitelja.</p>
        <ul class="bullets">
