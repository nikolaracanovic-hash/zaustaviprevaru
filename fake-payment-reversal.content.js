...
window.SCAM_CONTENT["fake-payment-reversal"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: lažna priča o stornu ili duploj uplati" data-en="Introduction: fake reversal or double-payment story">Uvod: lažna priča o stornu ili duploj uplati</h2>
      <p data-sr="Napadač tvrdi da je uplata stornirana, vraćena ili duplirana i traži da ponovo platite ili pošaljete ispravak na drugi račun." data-en="The attacker claims a payment was reversed, refunded, or duplicated and asks you to pay again or send a correction to another account.">Napadač tvrdi da je uplata stornirana, vraćena ili duplirana i traži da ponovo platite ili pošaljete ispravak na drugi račun.</p>
      <p data-sr="Narativ zvuči kao podrška banke ili partnera, ali kanal ne možete nezavisno potvrditi." data-en="The narrative sounds like bank or partner support, but you cannot independently verify the channel.">Narativ zvuči kao podrška banke ili partnera, ali kanal ne možete nezavisno potvrditi.</p>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
            <li data-sr="Pozivalac odbija da zakaže povratni poziv na broj sa izjave." data-en="Caller refuses a callback on the statement number.">Pozivalac odbija da zakaže povratni poziv na broj sa izjave.</li>
            <li data-sr="Priča o stornu ne postoji u e-bankingu ili mobilnoj aplikaciji." data-en="Reversal story does not appear in e-banking or mobile app.">Priča o stornu ne postoji u e-bankingu ili mobilnoj aplikaciji.</li>
            <li data-sr="Traži se tajnost prema kolegama ili revizoru." data-en="Secrecy toward colleagues or auditor is requested.">Traži se tajnost prema kolegama ili revizoru.</li>
            <li data-sr="Novi IBAN ili kanal plaćanja nije u ugovoru." data-en="New IBAN or payment rail is not in the contract.">Novi IBAN ili kanal plaćanja nije u ugovoru.</li>
            <li data-sr="Pritisak na minute i pretnja blokadom računa." data-en="Minute-level pressure and account block threats.">Pritisak na minute i pretnja blokadom računa.</li>
            <li data-sr="Lažni sken naloga sa niskom rezolucijom ili pogrešnim fontom." data-en="Fake slip with low resolution or wrong font.">Lažni sken naloga sa niskom rezolucijom ili pogrešnim fontom.</li>
            <li data-sr="Broj pozivaoca menja se između poziva." data-en="Caller ID changes between calls.">Broj pozivaoca menja se između poziva.</li>
            <li data-sr="Traže podatke kartice ili PIN za navodnu verifikaciju." data-en="Card data or PIN requested for alleged verification.">Traže podatke kartice ili PIN za navodnu verifikaciju.</li>
            <li data-sr="Govornik ne zna vaš interni broj klijenta kada ga zatražite." data-en="Speaker does not know your internal client number when asked.">Govornik ne zna vaš interni broj klijenta kada ga zatražite.</li>
            <li data-sr="Dva agenta daju različitu verziju istog događaja." data-en="Two agents give different versions of the same event.">Dva agenta daju različitu verziju istog događaja.</li>
      </ul>
    </section>
