...
window.SCAM_CONTENT["fake-recruiter-calendar-link"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Stiže poruka da izabereš termin intervjua. Link traži prijavu na imejl, LinkedIn ili Microsoft nalog koji kopira pravu stranicu." data-en="A message asks you to pick an interview slot. The link requests login to email, LinkedIn, or Microsoft and copies the real page.">Stiže poruka da izabereš termin intervjua. Link traži prijavu na imejl, LinkedIn ili Microsoft nalog koji kopira pravu stranicu.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se navika klika na kalendar bez provere URL-a." data-en="The habit of clicking calendar links without checking the URL is exploited.">Koristi se navika klika na kalendar bez provere URL-a.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Poruka koristi terminologiju regrutera i rokove za slot." data-en="The message uses recruiter language and slot deadlines.">Poruka koristi terminologiju regrutera i rokove za slot.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="URL ne pripada poznatom scheduleru (Calendly, Google) ili domen firme." data-en="The URL does not belong to a known scheduler or the company domain.">URL ne pripada poznatom scheduleru (Calendly, Google) ili domen firme.</li>
        ...
        <li data-sr="Priča o kalendarskom linku se menja kada tražiš pauzu od 24 sata." data-en="The story about calendar link changes when you ask for a 24-hour pause.">Priča o kalendarskom linku se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za linku kalendara regrutera. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to recruiter calendar link. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za linku kalendara regrutera. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Link traži šifru glavnog imejl naloga." data-en="The link asks for your main email password.">Link traži šifru glavnog imejl naloga.</li>
        <li data-sr="Stranica traži MFA odmah posle šifre." data-en="The page asks for MFA right after the password.">Stranica traži MFA odmah posle šifre.</li>
        <li data-sr="Imejl pošiljaoca je vizuelno sličan ali domen je pogrešan." data-en="The sender email looks similar but the domain is wrong.">Imejl pošiljaoca je vizuelno sličan ali domen je pogrešan.</li>
        <li data-sr="Nema imena konkretnog regrutera kog možeš naći na LinkedIn." data-en="There is no specific recruiter name you can find on LinkedIn.">Nema imena konkretnog regrutera kog možeš naći na LinkedIn.</li>
        <li data-sr="Poziv traži instalaciju ekstenzije." data-en="The invite asks to install an extension.">Poziv traži instalaciju ekstenzije.</li>
        <li data-sr="Kalendarski događaj nema liste učesnika sa domen firme." data-en="The calendar event has no attendees with a company domain.">Kalendarski događaj nema liste učesnika sa domen firme.</li>
        <li data-sr="Isti link traži prijavu na više servisa zaredom." data-en="The same link asks login to multiple services in a row.">Isti link traži prijavu na više servisa zaredom.</li>
        <li data-sr="Browser prikazuje upozorenje o krađi lozinke." data-en="The browser shows a password theft warning.">Browser prikazuje upozorenje o krađi lozinke.</li>
        <li data-sr="Poruka stiže minut posle nepostojeće prijave." data-en="The message arrives minutes after you did not apply anywhere.">Poruka stiže minut posle nepostojeće prijave.</li>
        <li data-sr="Traže se lični podaci pre prikazivanja termina." data-en="Personal data is requested before showing any slot.">Traže se lični podaci pre prikazivanja termina.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za kalendarskom linku." data-en="Can I find the same offer on an official site or vacancy for calendar link.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za kalendarskom linku.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Kandidat želi termin. Otvorite sajt firme ručno i uporedite ime regrutera sa tim kontaktom." data-en="The candidate wants a slot. Open the company site manually and compare the recruiter name with that contact.">Kandidat želi termin. Otvorite sajt firme ručno i uporedite ime regrutera sa tim kontaktom.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za linku kalendara regrutera." data-en="Have you ever seen a real employer ask for the same step for recruiter calendar link.">Da li si ikada video da pravi poslodavac traži isti korak za linku kalendara regrutera.</li>
