...
window.SCAM_CONTENT["fake-sepa-compliance"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: lažna SEPA usaglašenost ili naknada" data-en="Introduction: fake SEPA compliance or fee">Uvod: lažna SEPA usaglašenost ili naknada</h2>
      <p data-sr="Poruka traži naknadu ili formular za navodnu SEPA validaciju IBAN-a ili registracije pre sledeće uplate." data-en="Message requests a fee or form for supposed SEPA IBAN validation or registration before the next payment.">Poruka traži naknadu ili formular za navodnu SEPA validaciju IBAN-a ili registracije pre sledeće uplate.</p>
      <p data-sr="Jezik meša SEPA i lokalne regulatorne nazive bez konkretnog člana pravila." data-en="Language mixes SEPA and local regulator names without a specific rule cite.">Jezik meša SEPA i lokalne regulatorne nazive bez konkretnog člana pravila.</p>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
            <li data-sr="Naknada se plaća na račun fizičkog lica." data-en="Fee is paid to an individual&#x27;s account.">Naknada se plaća na račun fizičkog lica.</li>
            <li data-sr="Ne možete pronaći isti zahtev u zvaničnom portalu banke." data-en="You cannot find the same request on the bank official portal.">Ne možete pronaći isti zahtev u zvaničnom portalu banke.</li>
            <li data-sr="PDF nema kontakt telefon koji se poklapa sa poznatim brojem banke." data-en="PDF lacks a phone matching the known bank number.">PDF nema kontakt telefon koji se poklapa sa poznatim brojem banke.</li>
            <li data-sr="Traže broj kartice radi navodne SEPA verifikacije." data-en="Card number requested for alleged SEPA verification.">Traže broj kartice radi navodne SEPA verifikacije.</li>
            <li data-sr="Rok je istekao sutra u podne ako ne platite." data-en="Deadline expires tomorrow at noon if you do not pay.">Rok je istekao sutra u podne ako ne platite.</li>
            <li data-sr="Imejl traži odgovor na spoljašnji web formular umesto u e-bankingu." data-en="Email asks you to reply via external web form instead of e-banking.">Imejl traži odgovor na spoljašnji web formular umesto u e-bankingu.</li>
            <li data-sr="Isti šablon poruke prijavljen je od više nepovezanih firmi." data-en="Same message template reported by several unrelated firms.">Isti šablon poruke prijavljen je od više nepovezanih firmi.</li>
            <li data-sr="Nude sertifikat koji nema javnog izdavaoca." data-en="They offer a certificate with no public issuer.">Nude sertifikat koji nema javnog izdavaoca.</li>
            <li data-sr="Traže pristup internet bankarstvu da unesu navodnu registraciju." data-en="They ask for online banking access to enter alleged registration.">Traže pristup internet bankarstvu da unesu navodnu registraciju.</li>
            <li data-sr="Vaša banka kaže da SEPA ne funkcioniše preko ovakve naknade." data-en="Your bank says SEPA does not work through such a fee.">Vaša banka kaže da SEPA ne funkcioniše preko ovakve naknade.</li>
      </ul>
    </section>
