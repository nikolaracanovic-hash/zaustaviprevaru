...
window.SCAM_CONTENT["invoice-factoring-advance-scam"] = {
  raw_html: `
    <section class="card">
    ...
    <section class="card">
      <h2 data-sr="Hronološki tok: faze prevare faktoringa faktura" data-en="Timeline: invoice factoring advance scam phases">Hronološki tok: faze prevare faktoringa faktura</h2>

      <article class="phase">
        <h3 class="phase-title" data-sr="Faza 1 — Kontakt: ponuda faktoringa" data-en="Phase 1 — Contact: factoring offer">Faza 1 — Kontakt: ponuda faktoringa</h3>
        <p data-sr="Meta prima ponudu faktoring usluge — ili je traži sama u krizi likvidnosti. Napadač nudi 80–90% avansa na fakture, brzu obradu i bez zahtevanja kolaterala banke." data-en="The target receives a factoring service offer — or seeks one during a liquidity crisis. The attacker offers 80–90% advance on invoices, quick processing, and no bank collateral requirements.">Meta prima ponudu faktoring usluge — ili je traži sama u krizi likvidnosti. Napadač nudi 80–90% avansa na fakture, brzu obradu i bez zahtevanja kolaterala banke.</p>
        <ul class="bullets">
      ...
      <article class="phase">
        <h3 class="phase-title" data-sr="Faza 2 — Ugovor i naknada za obradu" data-en="Phase 2 — Agreement and processing fee">Faza 2 — Ugovor i naknada za obradu</h3>
      ...
      <article class="phase">
        ...
        <ul class="bullets">
          ...
          <li data-sr="napadač sve teže dostupan između zahteva." data-en="attacker increasingly unreachable between demands.">napadač sve teže dostupan između zahteva.</li>
          <li data-sr="meta je u dvostrukom pritisku: naknade rastu a fakture i dalje čekaju na naplatu." data-en="target is under double pressure: fees increase while invoices still await collection.">meta je u dvostrukom pritisku: naknade rastu a fakture i dalje čekaju na naplatu.</li>
        </ul>
        <p class="muted" data-sr="Prag faze 4: meta iscrpljuje sredstva ili odbija uplatu." data-en="Phase 4 threshold: target exhausts funds or refuses payment.">Prag faze 4: meta iscrpljuje sredstva ili odbija uplatu.</p>
      </article>
      ...
      <article class="phase">
        ...
        <p data-sr="Napadač prestaje da odgovara. Faktoring kompanija nije u zvaničnim finansijskim registrima. Meta ostaje bez avansa, bez naknada i s fakturama koje i dalje čekaju na naplatu." data-en="The attacker stops responding. The factoring company is not in official financial registries. The target is left without the advance, without the fees, and with invoices that still await collection.">Napadač prestaje da odgovara. Faktoring kompanija nije u zvaničnim finansijskim registrima. Meta ostaje bez avansa, bez naknada i s fakturama koje i dalje čekaju na naplatu.</p>
        <ul class="bullets">
      ...
      <article class="phase">
        <h3 class="phase-title" data-sr="Faza 6 — Sekundarna opasnost: zloupotreba faktura" data-en="Phase 6 — Secondary risk: invoice misuse">Faza 6 — Sekundarna opasnost: zloupotreba faktura</h3>
        <p data-sr="Meta je dostavila fakture s podacima o kupcima, iznosima i bankovnim računima. Napadač može ove podatke koristiti za BEC prevaru — kontaktira kupce mete i menja bankovne detalje za isplatu faktura." data-en="The target submitted invoices with customer data, amounts, and bank account details. The attacker can use this data for BEC fraud — contacting the target's customers and changing bank details for invoice payment.">Meta je dostavila fakture s podacima o kupcima, iznosima i bankovnim računima. Napadač može ove podatke koristiti za BEC prevaru — kontaktira kupce mete i menja bankovne detalje za isplatu faktura.</p>
        <ul class="bullets">
          <li data-sr="podaci o kupcima mete su sada u rukama napadača." data-en="the target's customer data is now in the attacker's hands.">podaci o kupcima mete su sada u rukama napadača.</li>
          <li data-sr="napadač može kontaktirati kupce i preusmeriti plaćanja." data-en="attacker can contact customers and redirect payments.">napadač može kontaktirati kupce i preusmeriti plaćanja.</li>
          <li data-sr="meta treba odmah obavestiti kupce o mogućoj zloupotrebi podataka." data-en="target must immediately notify customers of possible data misuse.">meta treba odmah obavestiti kupce o mogućoj zloupotrebi podataka.</li>
          <li data-sr="finansijska šteta može biti višestruka ako kupci uplata idu na lažan račun." data-en="financial damage can be multiple if customer payments go to a fake account.">finansijska šteta može biti višestruka ako kupci uplata idu na lažan račun.</li>
        </ul>
        <p class="muted" data-sr="Prag faze 6: meta obaveštava kupce i sprečava sekundarnu štetu." data-en="Phase 6 threshold: target notifies customers and prevents secondary damage.">Prag faze 6: meta obaveštava kupce i sprečava sekundarnu štetu.</p>
      </article>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        ...
        <li data-sr="nikad se ne nudi direktan poziv s menadžerom koji može da potvrdi avans." data-en="a direct call with a manager who can confirm the advance is never offered.">nikad se ne nudi direktan poziv s menadžerom koji može da potvrdi avans.</li>
        <li data-sr="ponuda za povraćaj stiže kratko posle nestanka faktoring kompanije." data-en="a recovery offer arrives shortly after the factoring company disappears.">ponuda za povraćaj stiže kratko posle nestanka faktoring kompanije.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="proveri faktoring kompaniju u registru Narodne banke ili finansijskog regulatora." data-en="verify the factoring company in the registry of the central bank or financial regulator.">proveri faktoring kompaniju u registru Narodne banke ili finansijskog regulatora.</li>
        <li data-sr="legitimni faktoring ne naplaćuje naknadu pre avansa — to je uvek red flag." data-en="legitimate factoring does not charge a fee before the advance — that is always a red flag.">legitimni faktoring ne naplaćuje naknadu pre avansa — to je uvek red flag.</li>
        <li data-sr="proveri poslovnu istoriju kompanije u CRIF ili sličnim bazama." data-en="verify the company's business history in CRIF or similar databases.">proveri poslovnu istoriju kompanije u CRIF ili sličnim bazama.</li>
        <li data-sr="konsultuj finansijskog savetnika pre potpisivanja faktoring ugovora." data-en="consult a financial advisor before signing the factoring agreement.">konsultuj finansijskog savetnika pre potpisivanja faktoring ugovora.</li>
        <li data-sr="zahtevaj fizičku adresu kompanije i poseti je pre potpisivanja." data-en="request the company's physical address and visit it before signing.">zahtevaj fizičku adresu kompanije i poseti je pre potpisivanja.</li>
        <li data-sr="nikad ne plaćaj faktoring naknadu na privatni račun." data-en="never pay a factoring fee to a private account.">nikad ne plaćaj faktoring naknadu na privatni račun.</li>
        <li data-sr="ako su fakture dostavljene sumnjivoj kompaniji, odmah obavesti kupce." data-en="if invoices were submitted to a suspicious company, immediately notify customers.">ako su fakture dostavljene sumnjivoj kompaniji, odmah obavesti kupce.</li>
        <li data-sr="prijavi sumnjivi faktoring regulatoru i policiji pre nego što nastaviš." data-en="report suspicious factoring to the regulator and police before proceeding.">prijavi sumnjivi faktoring regulatoru i policiji pre nego što nastaviš.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="da li je faktoring kompanija registrovana kod finansijskog regulatora?" data-en="is the factoring company registered with the financial regulator?">da li je faktoring kompanija registrovana kod finansijskog regulatora?</li>
        <li data-sr="da li legitimni faktoring naplaćuje naknadu pre avansa — ne, to je standard?" data-en="does legitimate factoring charge a fee before the advance — no, that is the standard?">da li legitimni faktoring naplaćuje naknadu pre avansa — ne, to je standard?</li>
        <li data-sr="da li naknada ide na poslovni račun faktoring kompanije, a ne privatan?" data-en="does the fee go to the factoring company's business account, not a private one?">da li naknada ide na poslovni račun faktoring kompanije, a ne privatan?</li>
        <li data-sr="da li je rok za uplatu naknade 24–48 sati?" data-en="is the fee payment deadline 24–48 hours?">da li je rok za uplatu naknade 24–48 sati?</li>
        <li data-sr="da li mi je ponuđena mogućnost da dobijem avans bez prethodne naknade?" data-en="was I offered the possibility to receive the advance without a prior fee?">da li mi je ponuđena mogućnost da dobijem avans bez prethodne naknade?</li>
        <li data-sr="da li faktoring ugovor sadrži klauzule o zaštiti u slučaju neizvršenja?" data-en="does the factoring contract contain protection clauses in case of non-performance?">da li faktoring ugovor sadrži klauzule o zaštiti u slučaju neizvršenja?</li>
        ...
        <li data-sr="da li ukupne naknade premašuju vrednost avansa koji se čeka?" data-en="do total fees exceed the advance value being awaited?">da li ukupne naknade premašuju vrednost avansa koji se čeka?</li>
        <li data-sr="da li sam konsultovao finansijskog savetnika pre potpisivanja ugovora?" data-en="have I consulted a financial advisor before signing the contract?">da li sam konsultovao finansijskog savetnika pre potpisivanja ugovora?</li>
        <li data-sr="da li sam proverio fizičku adresu i poslovnu istoriju faktoring kompanije?" data-en="have I verified the physical address and business history of the factoring company?">da li sam proverio fizičku adresu i poslovnu istoriju faktoring kompanije?</li>
        <li data-sr="da li je kompanija koja prima fakture poznata i verifikabilna?" data-en="is the company receiving invoices known and verifiable?">da li je kompanija koja prima fakture poznata i verifikabilna?</li>
        <li data-sr="da li sam obavestio kupce o dostavljanju faktura faktoring kompaniji?" data-en="have I notified customers about submitting invoices to the factoring company?">da li sam obavestio kupce o dostavljanju faktura faktoring kompaniji?</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        ...
        <li data-sr="odmah obavesti kupce čije su fakture dostavljene faktoring kompaniji." data-en="immediately notify customers whose invoices were submitted to the factoring company.">odmah obavesti kupce čije su fakture dostavljene faktoring kompaniji.</li>
        <li data-sr="sačuvaj svu komunikaciju, ugovor i potvrde o uplati." data-en="save all communication, contract, and payment confirmations.">sačuvaj svu komunikaciju, ugovor i potvrde o uplati.</li>
        ...
        <li data-sr="prijavi slučaj policiji i finansijskom regulatoru." data-en="report the case to police and the financial regulator.">prijavi slučaj policiji i finansijskom regulatoru.</li>
        <li data-sr="ne prihvataj ponude za povraćaj — nema privatnih agencija za povrat faktoring naknada." data-en="do not accept recovery offers — there are no private agencies for recovering factoring fees.">ne prihvataj ponude za povraćaj — nema privatnih agencija za povrat faktoring naknada.</li>
      </ul>
    </section>
