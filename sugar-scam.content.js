...
window.SCAM_CONTENT["sugar-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Lažni aranžman traži depozit, članarinu, verifikaciju identiteta uz uplatu ili porez pre prvog susreta, a novac odlazi bez dogovorenog odnosa." data-en="A fake arrangement asks for a deposit, membership, paid identity verification, or a tax before the first meeting, and money leaves without the promised relationship.">Lažni aranžman traži depozit, članarinu, verifikaciju identiteta uz uplatu ili porez pre prvog susreta, a novac odlazi bez dogovorenog odnosa.</p>
      <p data-sr="Model se ponavlja: emotivni ili zdravstveni okvir, pritisak na brzinu, privatni kanal plaćanja i odbijanje nezavisne provere." data-en="The pattern repeats: emotional or health framing, pressure to move fast, private payment rails, and refusal of independent verification.">Model se ponavlja: emotivni ili zdravstveni okvir, pritisak na brzinu, privatni kanal plaćanja i odbijanje nezavisne provere.</p>
      <div class="callout" data-sr="<strong>Model:</strong> Dogovor → pravila → naknada unapred → nestanak." data-en="<strong>Model:</strong> Agreement → rules → upfront fee → disappearance."><strong>Model:</strong> Dogovor → pravila → naknada unapred → nestanak.</div>
    ...
    <section class="card">
      ...
      <div class="grid-2">
        <div class="phase">
          ...
          <li data-sr="Hitnost vezana za zdravlje, decu, sahranu ili finansijsku krizu." data-en="Urgency tied to health, children, funerals, or financial crisis.">Hitnost vezana za zdravlje, decu, sahranu ili finansijsku krizu.</li>
        ...
        <div class="phase">
          ...
          <li data-sr="Link ka formi koja kopira izgled banke ili klinike." data-en="A link to a form that copies bank or clinic branding.">Link ka formi koja kopira izgled banke ili klinike.</li>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnim sugar aranžmanom." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: sugar arrangement scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: prevara lažnim sugar aranžmanom.</p>
        <ul class="bullets">
      ...
      <article class="phase">
        ...
        <ul class="bullets">
          ...
          <li data-sr="Razgovor naglašava tajnost i izbegavanje nesposobnih rođaka." data-en="The talk stresses secrecy and avoiding relatives who would slow things down.">Razgovor naglašava tajnost i izbegavanje nesposobnih rođaka.</li>
        </ul>
      ...
      <article class="phase">
        ...
        <p data-sr="Pojavljuje se mala ili srednja uplata kao taksa, depozit, participacija, dostava ili administracija, predstavljena kao jednokratni korak." data-en="A small or medium payment appears as a fee, deposit, copay, shipping, or admin step framed as one-time.">Pojavljuje se mala ili srednja uplata kao taksa, depozit, participacija, dostava ili administracija, predstavljena kao jednokratni korak.</p>
        <ul class="bullets">
        ...
        <div class="branch">
          ...
          <ul class="bullets">
            <li><a href="romantic-scam.html" data-sr="Romantične prevare" data-en="Romance scams">Romantične prevare</a></li>
            <li><a href="pig-butchering.html" data-sr="Pig butchering" data-en="Pig butchering">Pig butchering</a></li>
          </ul>
        </div>
      ...
      <article class="phase">
        ...
        <ul class="bullets">
          ...
          <li data-sr="Emocionalni pritisak: strah, sram ili žurba oko zdravlja ili dece." data-en="Emotional pressure: fear, shame, or urgency about health or children.">Emocionalni pritisak: strah, sram ili žurba oko zdravlja ili dece.</li>
    ...
    <section class="card">
      ...
      <ul class="bullets">
          <li data-sr="Hitnost i zabrana konsultacije sa porodicom ili lekarom pre uplate." data-en="Urgency and a ban on consulting family or a doctor before paying.">Hitnost i zabrana konsultacije sa porodicom ili lekarom pre uplate.</li>
          ...
          <li data-sr="Cena ili donacija znatno odstupa od uobičajenih tržišnih okvira bez objašnjenja." data-en="Price or donation is far outside normal market ranges without explanation.">Cena ili donacija znatno odstupa od uobičajenih tržišnih okvira bez objašnjenja.</li>
          <li data-sr="Pritisak da se odmah potpiše ugovor ili forma bez čitanja." data-en="Pressure to sign a contract or form immediately without reading.">Pritisak da se odmah potpiše ugovor ili forma bez čitanja.</li>
          ...
          <li data-sr="Lažna saglasnost da se instalira daljinski pristup računaru." data-en="Consent to install remote access on the computer.">Lažna saglasnost da se instalira daljinski pristup računaru.</li>
    ...
    <section class="card">
      ...
      <ol class="steps">
        ...
        <li data-sr="Pozovi pravu ustanovu ili kliniku preko zvaničnog broja i potvrdi da li postoji zahtev." data-en="Call the real institution or clinic via the official number and confirm whether a request exists.">Pozovi pravu ustanovu ili kliniku preko zvaničnog broja i potvrdi da li postoji zahtev.</li>
    ...
    <section class="card">
      ...
      <div class="grid-2">
        ...
        <div class="phase">
          ...
          <li data-sr="Pauza od jednog dana ne menja legitiman medicinski ili pravni proces." data-en="A one-day pause does not change a legitimate medical or legal process.">Pauza od jednog dana ne menja legitiman medicinski ili pravni proces.</li>
          <li data-sr="Pravi lekar ili služba ne traže kod iz SMS-a niti daljinski pristup računaru." data-en="A real doctor or service does not ask for SMS codes or remote PC access.">Pravi lekar ili služba ne traže kod iz SMS-a niti daljinski pristup računaru.</li>
