...
window.SCAM_CONTENT["fake-university-seat-reservation-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Stiže ponuda da zadržiš poslednje slobodno mesto na smeru uz uplatu depozita pre zvaničnog upisa ili objave liste kandidata." data-en="An offer arrives to hold the last free seat on a programme with a deposit before official enrollment or the published candidate list.">Stiže ponuda da zadržiš poslednje slobodno mesto na smeru uz uplatu depozita pre zvaničnog upisa ili objave liste kandidata.</p>
      <p data-sr="Upis i potvrda mesta dolaze kroz zvanični postupak ustanove i javno objavljen rezultat; privatna osoba ne može garantovati mesto uz uplate na svoj račun." data-en="Enrollment and seat confirmation follow the institution’s official process and public results; a private person cannot guarantee a seat with payments to their account.">Upis i potvrda mesta dolaze kroz zvanični postupak ustanove i javno objavljen rezultat; privatna osoba ne može garantovati mesto uz uplate na svoj račun.</p>
      <div class="callout" data-sr="<strong>Model:</strong> hitna ponuda → prag (depozit) → lažna potvrda → eskalacija → nestanak." data-en="<strong>Model:</strong> urgent offer → threshold (deposit) → fake confirmation → escalation → disappearance."><strong>Model:</strong> hitna ponuda → prag (depozit) → lažna potvrda → eskalacija → nestanak.</div>
    </section>
    <section class="card">
      <h2 data-sr="Kako generalno radi" data-en="How it generally works">Kako generalno radi</h2>
      <p data-sr="Koristi se žurba posle prijemnog ili liste čekanja i strah da će drugi kandidat uzeti mesto." data-en="Rush after entrance exams or waiting lists and fear that another candidate will take the seat are exploited.">Koristi se žurba posle prijemnog ili liste čekanja i strah da će drugi kandidat uzeti mesto.</p>
      <div class="grid-2">
        <div class="phase">
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt tvrdi da radi u ime sekretarijata i šalje šablon sa rokom isteka iste večeri da bi se uplatio depozit." data-en="The contact claims to work for the secretariat and sends a template expiring the same evening to collect a deposit.">Kontakt tvrdi da radi u ime sekretarijata i šalje šablon sa rokom isteka iste večeri da bi se uplatio depozit.</p>
        <ul class="bullets">
      ...
      <article class="phase">
        ...
        <p data-sr="Traže se lični podaci, broj telefona roditelja i avans na račun koji nije račun ustanove naveden na zvaničnom sajtu." data-en="Personal data, a parent’s phone, and an advance to an account that is not the institution account listed on the official site are requested.">Traže se lični podaci, broj telefona roditelja i avans na račun koji nije račun ustanove naveden na zvaničnom sajtu.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Mesto se prodaje uz garanciju pre objave zvaničnog rezultata upisa." data-en="A seat is sold with a guarantee before the official admission result is published.">Mesto se prodaje uz garanciju pre objave zvaničnog rezultata upisa.</li>
        <li data-sr="Uplata ide na fizičko lice ili firmu koja nema javni ugovor ili referencu na fakultet." data-en="Payment goes to a private person or company with no public contract or reference to the faculty.">Uplata ide na fizičko lice ili firmu koja nema javni ugovor ili referencu na fakultet.</li>
        <li data-sr="Pritisak da roditelj plati odmah dok dete čeka odgovor." data-en="Pressure for a parent to pay immediately while the student waits on the line.">Pritisak da roditelj plati odmah dok dete čeka odgovor.</li>
        <li data-sr="Nema broja predmeta koji sekretarijat može proveriti na javnom broju." data-en="There is no reference number the secretariat can verify on the public number.">Nema broja predmeta koji sekretarijat može proveriti na javnom broju.</li>
        <li data-sr="Isti broj traži uplatu od više kandidata za isto poslednje mesto." data-en="The same number asks payment from several candidates for the same last seat.">Isti broj traži uplatu od više kandidata za isto poslednje mesto.</li>
        <li data-sr="Zabranjuju ili ometaju poziv javnom broju fakulteta pre uplate." data-en="They forbid or obstruct calling the faculty public number before paying.">Zabranjuju ili ometaju poziv javnom broju fakulteta pre uplate.</li>
        <li data-sr="Šalju lažan PDF sa pečatom koji se ne poklapa sa javnim obrascima ustanove." data-en="They send a fake PDF stamp that does not match the institution’s public forms.">Šalju lažan PDF sa pečatom koji se ne poklapa sa javnim obrascima ustanove.</li>
        <li data-sr="Komunikacija je samo čet ili SMS, bez zvaničnog imejla sa domena fakulteta." data-en="Communication is only chat or SMS, with no official email from the faculty domain.">Komunikacija je samo čet ili SMS, bez zvaničnog imejla sa domena fakulteta.</li>
        <li data-sr="Traže darovne kartice kao brži način depozita." data-en="Gift cards are requested as a faster deposit.">Traže darovne kartice kao brži način depozita.</li>
        <li data-sr="Tvrdi se da ćeš izgubiti i stipendiju ako ne platiš odmah." data-en="They claim you will also lose a scholarship unless you pay now.">Tvrdi se da ćeš izgubiti i stipendiju ako ne platiš odmah.</li>
      </ul>
    </section>
    <section class="card">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mesto i kandidat postoje na zvaničnoj listi ili portalu upisa." data-en="Does the seat and candidate appear on the official list or enrollment portal.">Da li mesto i kandidat postoje na zvaničnoj listi ili portalu upisa.</li>
        <li data-sr="Da li sekretarijat na javnom broju potvrđuje ovu osobu za depozit." data-en="Does the secretariat on the public number confirm this person for deposits.">Da li sekretarijat na javnom broju potvrđuje ovu osobu za depozit.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Roditelj želi da sačuva mesto detetu. Predložite poziv na javni broj fakulteta i upoređivanje primaoca uplate sa zvaničnim podacima ustanove." data-en="A parent wants to secure a seat. Suggest calling the faculty’s public number and matching the payee with the institution’s official records.">Roditelj želi da sačuva mesto detetu. Predložite poziv na javni broj fakulteta i upoređivanje primaoca uplate sa zvaničnim podacima ustanove.</p>
      <div class="grid-2">
        <div class="phase">
