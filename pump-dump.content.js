...
window.SCAM_CONTENT["pump-dump"] = {
  raw_html: `
    <!-- 1) UVOD -->
    <section class="card">
      <h2 data-sr="Uvod: kako funkcioniše pump-and-dump prevara" data-en="Introduction: how pump-and-dump scams work">
        Uvod: kako funkcioniše pump-and-dump prevara
      </h2>
      ...
      <p
        ...
        data-en="Most common targets: (1) small, unknown stocks with low trading volume, (2) new or unknown cryptocurrencies, (3) NFT collections promoted by celebrities. Damage: (1) direct money loss when price drops, (2) inability to sell because no buyers, (3) emotional trauma from rapid large loss."
      >Najčešće mete su: (1) male, nepoznate akcije sa niskim obimom trgovanja, (2) nove ili nepoznate kriptovalute, (3) NFT kolekcije koje promoviraju poznate ličnosti. Šteta: (1) direktan gubitak novca kada cena padne, (2) nemogućnost prodaje jer nema kupaca, (3) emotivna trauma zbog brzog gubitka velike sume.</p>

      <div class="callout"
        data-sr="<strong>Model:</strong> organizatori tajno kupe jeftinu akciju/kripto → masovna promocija na društvenim mrežama → ljudi kupuju → cena raste → organizatori prodaju sve → cena pada → svi ostali gube."
        data-en="<strong>Model:</strong> organizers secretly buy cheap stock/crypto → mass promotion on social media → people buy → price rises → organizers sell everything → price crashes → everyone else loses."
      ><strong>Model:</strong> organizatori tajno kupe jeftinu akciju/kripto → masovna promocija na društvenim mrežama → ljudi kupuju → cena raste → organizatori prodaju sve → cena pada → svi ostali gube.</div>
    </section>

    <!-- 2) POZNATI SLUČAJEVI -->
    <section class="card">
      <h2 data-sr="Famous cases: pump-and-dump scams" data-en="Famous cases: pump-and-dump scams">
        Famous cases: pump-and-dump scams
      </h2>
      ...
      <div class="grid-2">
        <div class="phase warn">
          ...
          <ul class="bullets">
            ...
            <li data-sr="<strong>Meta:</strong> male kompanije (penny stocks) sa niskim obimom trgovanja." data-en="<strong>Target:</strong> small companies (penny stocks) with low trading volume."><strong>Meta:</strong> male kompanije (penny stocks) sa niskim obimom trgovanja.</li>
            <li data-sr="<strong>Gubici:</strong> preko 200 miliona dolara ukradeno od hiljada investitora." data-en="<strong>Losses:</strong> over $200 million stolen from thousands of investors."><strong>Gubici:</strong> preko 200 miliona dolara ukradeno od hiljada investitora.</li>
            <li data-sr="<strong>Kraj:</strong> uhapšen 1998, osuđen na 4 godine zatvora, morao da vrati 110 miliona dolara." data-en="<strong>Outcome:</strong> arrested 1998, sentenced to 4 years prison, ordered to pay back $110 million."><strong>Kraj:</strong> uhapšen 1998, osuđen na 4 godine zatvora, morao da vrati 110 miliona dolara.</li>
          </ul>
        </div>

        <div class="phase warn">
          <div class="label" data-sr="Kripto i tvitovi poznate ličnosti (2021, primer — anonimizovano)." data-en="Crypto and celebrity tweets (2021, example — anonymized).">Kripto i tvitovi poznate ličnosti (2021, primer — anonimizovano).</div>
          <ul class="bullets">
            <li data-sr="<strong>Kontekst:</strong> javne izjave poznatih ličnosti o određenim kriptovalutama mogu pokrenuti ogromne oscilacije cene." data-en="<strong>Context:</strong> public statements by celebrities about specific cryptocurrencies can trigger massive price swings."><strong>Kontekst:</strong> javne izjave poznatih ličnosti o određenim kriptovalutama mogu pokrenuti ogromne oscilacije cene.</li>
            <li data-sr="<strong>Pump:</strong> svaka objava može izazvati skok cene za 20–50% u roku od sati, što izaziva FOMO kupovinu." data-en="<strong>Pump:</strong> each post can trigger a 20–50% price jump within hours, causing FOMO buying."><strong>Pump:</strong> svaka objava može izazvati skok cene za 20–50% u roku od sati, što izaziva FOMO kupovinu.</li>
            <li data-sr="<strong>Dump:</strong> cena pada kada rani investitori prodaju; kasni kupci gube novac." data-en="<strong>Dump:</strong> price falls when early investors sell; late buyers lose money."><strong>Dump:</strong> cena pada kada rani investitori prodaju; kasni kupci gube novac.</li>
            <li data-sr="<strong>Pouka:</strong> javne izjave o kriptovalutama — čak i bez loše namere — mogu stvoriti pump-and-dump dinamiku." data-en="<strong>Lesson:</strong> public statements about cryptocurrencies — even without bad intent — can create pump-and-dump dynamics."><strong>Pouka:</strong> javne izjave o kriptovalutama — čak i bez loše namere — mogu stvoriti pump-and-dump dinamiku.</li>
          </ul>
        </div>
        ...
        <div class="phase warn">
          ...
          <ul class="bullets">
            ...
            <li data-sr="<strong>Razmere:</strong> stotine aktivnih grupa sa desetinama hiljada žrtava mesečno." data-en="<strong>Scale:</strong> hundreds of active groups with tens of thousands of victims monthly."><strong>Razmere:</strong> stotine aktivnih grupa sa desetinama hiljada žrtava mesečno.</li>
          </ul>
        </div>
        ...
        <div class="phase warn">
          ...
          <ul class="bullets">
            ...
            <li data-sr="<strong>Gubici:</strong> oko 3.3 miliona dolara ukradeno od hiljada investitora." data-en="<strong>Losses:</strong> about $3.3 million stolen from thousands of investors."><strong>Gubici:</strong> oko 3.3 miliona dolara ukradeno od hiljada investitora.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <!-- 3) KAKO PREPOZNATI -->
    <section class="card">
      <h2 data-sr="How to recognize a pump-and-dump scheme" data-en="How to recognize a pump-and-dump scheme">
    ...
    <!-- 4) FAZE -->
    <section class="card">
      <h2 data-sr="Typical phases of a pump-and-dump scheme" data-en="Typical phases of a pump-and-dump scheme">
        Typical phases of a pump-and-dump scheme
      </h2>

      <div class="phase-row">
        <div class="phase neutral">
          <div class="label" data-sr="1. Accumulation" data-en="1. Accumulation">1. Accumulation</div>
          <p data-sr="Organizatori tajno kupuju bezvrednu akciju/kripto po niskoj ceni tokom dugog perioda." data-en="Organizers secretly buy worthless stock/crypto at low price over extended period.">Organizatori tajno kupuju bezvrednu akciju/kripto po niskoj ceni tokom dugog perioda.</p>
        </div>

        <div class="phase warn">
          <div class="label" data-sr="2. Pump" data-en="2. Pump">2. Pump</div>
          <p data-sr="Masovna promocija na društvenim mrežama, plaćeni influenseri, lažne vesti. Cena raste brzo." data-en="Mass promotion on social media, paid influencers, fake news. Price rises rapidly.">Masovna promocija na društvenim mrežama, plaćeni influenseri, lažne vesti. Cena raste brzo.</p>
        </div>

        <div class="phase danger">
          <div class="label" data-sr="3. Dump" data-en="3. Dump">3. Dump</div>
          <p data-sr="Organizatori prodaju sve svoje delove na vrhuncu. Cena pada drastično za minute/sate." data-en="Organizers sell all their shares at peak. Price crashes drastically within minutes/hours.">Organizatori prodaju sve svoje delove na vrhuncu. Cena pada drastično za minute/sate.</p>
        </div>

        <div class="phase danger">
          <div class="label" data-sr="4. Collapse" data-en="4. Collapse">4. Collapse</div>
          <p data-sr="Svi ostali investitori drže bezvredne delove. Nema kupaca. Novac je izgubljen." data-en="All other investors hold worthless shares. No buyers. Money is lost.">Svi ostali investitori drže bezvredne delove. Nema kupaca. Novac je izgubljen.</p>
        </div>
      </div>
    </section>
    ...
    <!-- 5) PRAVNE POSLEDICE -->
    <section class="card">
      <h2 data-sr="Legal consequences and reporting" data-en="Legal consequences and reporting">
        Legal consequences and reporting
      </h2>

      <p
        data-sr="Pump and dump je kriminalno delo - tržišna manipulacija. Organizatori dobijaju dugogodišnje zatvorske kazne i ogromne novčane kazne. U SAD, SEC (Securities and Exchange Commission) aktivno goni ove prevare. U Srbiji, Komisija za hartije od vrednosti ima ovlašćenja za istragu."
        data-en="Pump and dump is a criminal offense - market manipulation. Organizers receive multi-year prison sentences and huge fines. In USA, SEC (Securities and Exchange Commission) actively prosecutes these scams. In Serbia, Securities Commission has investigative powers."
      >Pump and dump je kriminalno delo - tržišna manipulacija. Organizatori dobijaju dugogodišnje zatvorske kazne i ogromne novčane kazne. U SAD, SEC (Securities and Exchange Commission) aktivno goni ove prevare. U Srbiji, Komisija za hartije od vrednosti ima ovlašćenja za istragu.</p>

      <p
        data-sr="Ako ste žrtva: (1) dokumentujte sve promocije, poruke, transakcije, (2) prijavite Komisiji za hartije od vrednosti, (3) prijavite policiji ako ima dokaza o organizovanoj grupi, (4) kontaktirajte advokata ako su gubici veliki, (5) podelite iskustvo javno da upozorite druge."
        data-en="If you're a victim: (1) document all promotions, messages, transactions, (2) report to Securities Commission, (3) report to police if evidence of organized group, (4) contact lawyer if losses are large, (5) share experience publicly to warn others."
