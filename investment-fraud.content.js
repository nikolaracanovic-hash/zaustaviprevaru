...
window.SCAM_CONTENT["investment-fraud"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi investiciona prevara" data-en="Introduction: how investment fraud works">
        Uvod: kako radi investiciona prevara
      </h2>
    ...
    <section class="card">
      <h2 data-sr="Kako generalno radi: mehanika" data-en="How it works: mechanics">
        Kako generalno radi: mehanika
      </h2>
      <div class="grid-2">
        <div>
    ...
    <section class="card">
      ...
      <div class="phase">
        <div class="label" data-sr="Faza 1: Kontakt" data-en="Phase 1: Contact">Faza 1: Kontakt</div>
      ...
      <div class="phase">
        <div class="label" data-sr="Faza 2: Izgradnja odnosa" data-en="Phase 2: Relationship building">Faza 2: Izgradnja odnosa</div>
      ...
      <div class="phase">
        ...
        <div class="branches">
          ...
          <ul>
            <li data-sr="Žrtva dovodi prijatelje → oni postaju nove žrtve u Ponzi šemi." data-en="Victim brings friends → they become new victims in the Ponzi scheme.">Žrtva dovodi prijatelje → oni postaju nove žrtve u Ponzi šemi.</li>
            <li data-sr="Žrtva uzima kredit → gubitak postaje mnogo veći od inicijalnih uštedina." data-en="Victim takes a loan → loss becomes much larger than initial savings.">Žrtva uzima kredit → gubitak postaje mnogo veći od inicijalnih uštedina.</li>
          </ul>
        </div>
        <p class="phase-threshold" data-sr="Prag faze: žrtva je uložila znatne iznose i pita se kad može povući novac." data-en="Phase threshold: victim has invested significant amounts and wonders when they can withdraw.">Prag faze: žrtva je uložila znatne iznose i pita se kad može povući novac.</p>
      </div>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        ...
        <li data-sr="Nikad ne ulažite novac koji ne možete priuštiti da izgubite." data-en="Never invest money you cannot afford to lose.">Nikad ne ulažite novac koji ne možete priuštiti da izgubite.</li>
        <li data-sr="Konsultujte nezavisnog finansijskog savetnika pre veće uplate." data-en="Consult an independent financial adviser before a larger payment.">Konsultujte nezavisnog finansijskog savetnika pre veće uplate.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ol class="bullets">
        <li data-sr="Da li je platforma registrovana kod finansijskog regulatora?" data-en="Is the platform registered with a financial regulator?">Da li je platforma registrovana kod finansijskog regulatora?</li>
        <li data-sr="Da li je prinos koji obećavaju realan u poređenju sa tržištem?" data-en="Is the promised return realistic compared to the market?">Da li je prinos koji obećavaju realan u poređenju sa tržištem?</li>
        <li data-sr="Da li sam pronašao negativne recenzije ili upozorenja o ovoj platformi?" data-en="Have I found negative reviews or warnings about this platform?">Da li sam pronašao negativne recenzije ili upozorenja o ovoj platformi?</li>
        <li data-sr="Da li broker komunicira isključivo kroz neformalne kanale?" data-en="Does the broker communicate exclusively through informal channels?">Da li broker komunicira isključivo kroz neformalne kanale?</li>
        ...
        <li data-sr="Da li sam uspešno povukao testni iznos pre većeg ulaganja?" data-en="Have I successfully withdrawn a test amount before a larger investment?">Da li sam uspešno povukao testni iznos pre većeg ulaganja?</li>
        <li data-sr="Da li znam ko stoji iza platforme — ime, adresa, pravna forma?" data-en="Do I know who is behind the platform — name, address, legal form?">Da li znam ko stoji iza platforme — ime, adresa, pravna forma?</li>
        <li data-sr="Da li koristim novac koji mogu priuštiti da izgubim?" data-en="Am I using money I can afford to lose?">Da li koristim novac koji mogu priuštiti da izgubim?</li>
        <li data-sr="Da li sam razgovarao sa nekim od poverenja pre uplate?" data-en="Have I spoken to someone I trust before paying?">Da li sam razgovarao sa nekim od poverenja pre uplate?</li>
        <li data-sr="Da li broker traži da ne govorim o ovoj investiciji drugima?" data-en="Does the broker ask me not to tell others about this investment?">Da li broker traži da ne govorim o ovoj investiciji drugima?</li>
      </ol>
    </section>
    ...
    <section class="card">
      ...
      <ol class="bullets">
        <li data-sr="Odmah prestati sa novim uplatama — svaka nova uplata uvećava gubitak." data-en="Immediately stop new deposits — every new payment increases the loss.">Odmah prestati sa novim uplatama — svaka nova uplata uvećava gubitak.</li>
