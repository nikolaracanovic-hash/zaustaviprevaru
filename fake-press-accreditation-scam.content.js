...
window.SCAM_CONTENT["fake-press-accreditation-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod" data-en="Introduction">Uvod</h2>
      <p data-sr="Freelancer ili bloger dobija ponudu za akreditaciju na konferenciju ili koncert. Traži se brza uplata za badge ili sigurnosnu proveru." data-en="A freelancer or blogger gets an offer to accredit for a conference or concert. Fast payment is requested for a badge or security check.">Freelancer ili bloger dobija ponudu za akreditaciju na konferenciju ili koncert. Traži se brza uplata za badge ili sigurnosnu proveru.</p>
    ...
    <section class="card">
      ...
      <p data-sr="Koristi se želja za pristup i stručnim mrežama." data-en="The desire for access and professional networking is exploited.">Koristi se želja za pristup i stručnim mrežama.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Šta privlači žrtvu" data-en="What pulls the victim in">Šta privlači žrtvu</div>
          <ul class="bullets">
        <li data-sr="Obećanje intervjua sa poznatim imenima ili VIP zonom." data-en="Interviews with well-known names or a VIP zone are promised.">Obećanje intervjua sa poznatim imenima ili VIP zonom.</li>
        ...
        <div class="phase">
          ...
          <ul class="bullets">
        <li data-sr="Organizator na zvaničnom sajtu nema istu naknadu ni isti imejl kao u ponudi." data-en="The organizer on the official site shows neither the same fee nor the same email as the offer.">Organizator na zvaničnom sajtu nema istu naknadu ni isti imejl kao u ponudi.</li>
        ...
        <li data-sr="Priča o akreditaciji se menja kada tražiš pauzu od 24 sata." data-en="The story about accreditation changes when you ask for a 24-hour pause.">Priča o akreditaciji se menja kada tražiš pauzu od 24 sata.</li>
          </ul>
        </div>
      </div>
    </section>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Stiže poruka, oglas ili imejl sa ponudom vezanom za akreditaciji za štampu. Često deluje personalizovano i hitno, a kanal je privatni." data-en="A message, ad, or email arrives tied to press accreditation. It often feels personalized and urgent on a private channel.">Stiže poruka, oglas ili imejl sa ponudom vezanom za akreditaciji za štampu. Često deluje personalizovano i hitno, a kanal je privatni.</p>
        <ul class="bullets">
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Akreditacija se plaća pre objave na zvaničnom sajtu događaja." data-en="Accreditation is paid before it appears on the official event site.">Akreditacija se plaća pre objave na zvaničnom sajtu događaja.</li>
        <li data-sr="Lažni sajt kopira vizuelni identitet ali domen je drugačiji." data-en="A fake site copies branding but the domain differs.">Lažni sajt kopira vizuelni identitet ali domen je drugačiji.</li>
        <li data-sr="Traže se lični podaci i fotografija uz uplatu u istom koraku." data-en="Personal data and a photo are requested together with payment in one step.">Traže se lični podaci i fotografija uz uplatu u istom koraku.</li>
        <li data-sr="Kontakt odbija da potvrdi ime preko zvaničnog PR kontakta." data-en="The contact refuses to confirm the name via official PR.">Kontakt odbija da potvrdi ime preko zvaničnog PR kontakta.</li>
        <li data-sr="Cena akreditacije je neobično visoka za tip događaja." data-en="The accreditation price is unusually high for the event type.">Cena akreditacije je neobično visoka za tip događaja.</li>
        <li data-sr="Ponuda stiže preko Instagram DM bez prethodnog konteksta." data-en="The offer arrives via Instagram DM without prior context.">Ponuda stiže preko Instagram DM bez prethodnog konteksta.</li>
        <li data-sr="Traže se kripto ili instant plaćanje." data-en="Crypto or instant payment is requested.">Traže se kripto ili instant plaćanje.</li>
        <li data-sr="Nema jasnog refund pravila u pisanom obliku." data-en="There is no clear refund rule in writing.">Nema jasnog refund pravila u pisanom obliku.</li>
        <li data-sr="Lista novinara ne postoji na sajtu organizatora." data-en="A journalist list does not exist on the organizer site.">Lista novinara ne postoji na sajtu organizatora.</li>
        <li data-sr="Isti tekst ponude kruži za više gradova istovremeno." data-en="The same offer text circulates for multiple cities at once.">Isti tekst ponude kruži za više gradova istovremeno.</li>
      </ul>
    </section>
    ...
    <section class="card">
      ...
      <ul class="bullets">
        <li data-sr="Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za akreditaciji za štampu." data-en="Can I find the same offer on an official site or vacancy for press accreditation.">Da li mogu naći istu ponudu na zvaničnom sajtu ili konkursu za akreditaciji za štampu.</li>
    ...
    <section class="card">
      ...
      <p data-sr="Kolega želi ulaz na događaj. Zajedno nađite kontakt organizatora na zvaničnom sajtu." data-en="A colleague wants event access. Together find the organizer contact on the official site.">Kolega želi ulaz na događaj. Zajedno nađite kontakt organizatora na zvaničnom sajtu.</p>
      <div class="grid-2">
        <div class="phase">
          <div class="label" data-sr="Pitanja koja pomažu" data-en="Helpful questions">Pitanja koja pomažu</div>
          <ul class="bullets">
        <li data-sr="Da li si ikada video da pravi poslodavac traži isti korak za akreditaciji za štampu." data-en="Have you ever seen a real employer ask for the same step for press accreditation.">Da li si ikada video da pravi poslodavac traži isti korak za akreditaciji za štampu.</li>
