...
window.SCAM_CONTENT["military-romance-scam"] = {
  raw_html: `
    <section class="card">
      <h2 data-sr="Uvod: kako radi ova prevara" data-en="Introduction: how this scam works">Uvod: kako radi ova prevara</h2>
      <p data-sr="Kontakt se predstavlja kao vojnik na misiji, gradi odnos, zatim traži novac za put, dozvolu, kurir ili hitnu pomoć uz izgovor da vojska blokira komunikaciju." data-en="The contact poses as a deployed service member, builds a bond, then asks for money for travel, leave, a courier, or an emergency while claiming military rules block communication.">Kontakt se predstavlja kao vojnik na misiji, gradi odnos, zatim traži novac za put, dozvolu, kurir ili hitnu pomoć uz izgovor da vojska blokira komunikaciju.</p>
      ...
      <div class="callout" data-sr="<strong>Model:</strong> Uniforma kao autoritet → odnos → hitna uplata → novi izgovori." data-en="<strong>Model:</strong> Uniform as authority → bond → urgent payment → new excuses."><strong>Model:</strong> Uniforma kao autoritet → odnos → hitna uplata → novi izgovori.</div>
    ...
    <section class="card">
      ...
      <article class="phase">
        ...
        <p data-sr="Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: vojna romantična prevara." data-en="Contact arrives via ad, message, call, or post using familiar phrases and an official tone related to: military romance scam.">Kontakt stiže kroz oglas, poruku, poziv ili objavu koji koriste poznate fraze i ton zvaničnosti, vezane za temu: vojna romantična prevara.</p>
        <ul class="bullets">
